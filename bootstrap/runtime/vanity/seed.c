...
static struct { VBlob sym; char bytes[21]; } _V10_Dstring_D379 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 21 }, "_V0vanity_V0seed_V20" };
...
static struct { VBlob sym; char bytes[40]; } _V10_Dstring_D326 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 40 }, "set!: procedure doesn't have a setter: " };
...
static struct { VBlob sym; char bytes[41]; } _V10_Dstring_D320 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 41 }, "set!: procedure doesn't have a mutator: " };
...
static struct { VBlob sym; char bytes[31]; } _V10_Dstring_D274 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 31 }, "not a record of the right type" };
...
void _V50_V0vanity_V0seed_V0get__promise__kind__val_V0k14(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 ...
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // (if (bruijn ##.%p.74 0 0) (basic-block 1 1 (##.%r.130) ((##vcore.record-ref (bruijn ##.rec.26 2 1) 1)) ((bruijn ##.%k.73 2 0) (bruijn ##.%r.130 0 0))) (basic-block 2 2 (##.%x.131 ##.%x.132) ((##vcore.cons (bruijn ##.rec.26 2 1) '()) (##vcore.cons 'get-promise-kind-val (bruijn ##.%x.131 0 0))) (##vcore.record (close _V50_V0vanity_V0seed_V0get__promise__kind__val_V0k15) #f 'error (##string ##.string.274) (bruijn ##.%x.132 0 1))))
if(VDecodeBool(
_var0)) {
    {
    VEnv * statics = self;
...
void _V50_V0vanity_V0seed_V10vcore_Dmutator_V0k16(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 ...
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // (basic-block 3 3 (##.%r.136 ##.%r.137 ##.%k.138) ((##vcore.display-word (##string ##.string.320) (bruijn ##.err.30 1 0)) (##vcore.write (bruijn ##.func.29 3 1) (bruijn ##.err.30 1 0)) (##vcore.newline (bruijn ##.err.30 1 0))) (##vcore.abort (bruijn ##.%k.83 2 0)))
    {
    VEnv * statics = self;
    struct { VEnv self; VWORD argv[3]; } container;
    self = &container.self;
...
void _V50_V0vanity_V0seed_V10vcore_Dmutator_V0lambda3(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V50_V0vanity_V0seed_V10vcore_Dmutator_V0lambda3" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
...
void _V50_V0vanity_V0seed_V10vcore_Dsetter_V0k17(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 ...
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // (basic-block 3 3 (##.%r.139 ##.%r.140 ##.%k.141) ((##vcore.display-word (##string ##.string.326) (bruijn ##.err.32 1 0)) (##vcore.write (bruijn ##.func.31 3 1) (bruijn ##.err.32 1 0)) (##vcore.newline (bruijn ##.err.32 1 0))) (##vcore.abort (bruijn ##.%k.85 2 0)))
    {
    VEnv * statics = self;
    struct { VEnv self; VWORD argv[3]; } container;
    self = &container.self;
...
void _V50_V0vanity_V0seed_V10vcore_Dsetter_V0lambda4(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V50_V0vanity_V0seed_V10vcore_Dsetter_V0lambda4" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
...
static void _V0vanity_V0seed_V20_V0k33(VRuntime * runtime, VEnv * statics, int argc) {
  VEnv * self = statics;
  statics = self ? self->up : NULL;
  // (basic-block 1 1 (##.%x.142) ((##vcore.cons 'promise-box '(##pair ##.pair.293))) (set! (close _V0vanity_V0seed_V20_V0k34) (bruijn ##.promise-box.1.11 5 8) (bruijn ##.%x.142 0 0)))
    {
    VEnv * statics = self;
    struct { VEnv self; VWORD argv[1]; } container;
    self = &container.self;
    ...
    self->vars[0] = _VBasic_VCons2(runtime, NULL,
      _V0promise__box,
      VEncodePointer(&_V10_Dpair_D293, VPOINTER_PAIR));
    VCallDecodedWithGC(runtime, V_EDEN_INIT(runtime, VClosure, VMakeClosure2((VFunc)VSetEnvVar2, self)), 4,
...
static void _V0vanity_V0seed_V20_V0lambda5(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0vanity_V0seed_V20_V0lambda5" };
 VRecordCall2(runtime, &dbg);
  struct { VEnv self; VWORD argv[1]; } container;
  VEnv * self = &container.self;
  VInitEnv(self, 1, 1, statics);
...
static void _V0vanity_V0seed_V20_V0k1(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 ...
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // ((##intrinsic "VMultiImport") (close _V0vanity_V0seed_V20_V0lambda2) (##string ##.string.379) (bruijn ##.%x.116 0 0))
...
static __attribute__((constructor)) void VDllMain1() {
  ...
  _V10_Dpair_D378.rest = VEncodePointer(&_V10_Dpair_D332, VPOINTER_PAIR);
  ...
  _V10_Dpair_D371.rest = VEncodePointer(&_V10_Dpair_D341, VPOINTER_PAIR);
  _V10_Dpair_D370.first = VEncodePointer(&_V10_Dpair_D365, VPOINTER_PAIR);
  ...
  _V10_Dpair_D364.first = VEncodePointer(&_V10_Dpair_D167, VPOINTER_PAIR);
  ...
  _V10_Dpair_D362.first = VEncodePointer(&_V10_Dpair_D165, VPOINTER_PAIR);
  _V10_Dpair_D362.rest = VEncodePointer(&_V10_Dpair_D361, VPOINTER_PAIR);
  _V10_Dpair_D361.first = VEncodePointer(&_V10_Dpair_D357, VPOINTER_PAIR);
  _V10_Dpair_D361.rest = VEncodePointer(&_V10_Dpair_D349, VPOINTER_PAIR);
  _V10_Dpair_D360.first = VEncodePointer(&_V10_Dpair_D359, VPOINTER_PAIR);
  _V10_Dpair_D360.rest = VEncodePointer(&_V10_Dpair_D350, VPOINTER_PAIR);
  ...
  _V10_Dpair_D357.first = _V0_Mk;
  _V10_Dpair_D357.rest = VEncodePointer(&_V10_Dpair_D356, VPOINTER_PAIR);
  _V10_Dpair_D356.first = _V0pair;
  _V10_Dpair_D356.rest = VEncodePointer(&_V10_Dpair_D343, VPOINTER_PAIR);
  ...
  _V10_Dpair_D355.first = VEncodePointer(&_V10_Dpair_D167, VPOINTER_PAIR);
  ...
  _V10_Dpair_D353.first = VEncodePointer(&_V10_Dpair_D165, VPOINTER_PAIR);
  _V10_Dpair_D353.rest = VEncodePointer(&_V10_Dpair_D352, VPOINTER_PAIR);
  _V10_Dpair_D352.first = VEncodePointer(&_V10_Dpair_D346, VPOINTER_PAIR);
  _V10_Dpair_D352.rest = VEncodePointer(&_V10_Dpair_D349, VPOINTER_PAIR);
  _V10_Dpair_D351.first = VEncodePointer(&_V10_Dpair_D348, VPOINTER_PAIR);
  _V10_Dpair_D351.rest = VEncodePointer(&_V10_Dpair_D350, VPOINTER_PAIR);
  _V10_Dpair_D350.first = VEncodePointer(&_V10_Dpair_D349, VPOINTER_PAIR);
  _V10_Dpair_D350.rest = VNULL;
  _V10_Dpair_D349.first = VEncodePointer(&_V10_Dpair_D337, VPOINTER_PAIR);
  _V10_Dpair_D349.rest = VEncodePointer(&_V10_Dpair_D340, VPOINTER_PAIR);
  _V10_Dpair_D348.first = VEncodeBool(false);
  ...
  _V10_Dpair_D342.first = VEncodePointer(&_V10_Dpair_D339, VPOINTER_PAIR);
  ...
  _V10_Dpair_D340.first = VEncodePointer(&_V10_Dpair_D165, VPOINTER_PAIR);
  _V10_Dpair_D340.rest = VEncodePointer(&_V10_Dpair_D334, VPOINTER_PAIR);
  _V10_Dpair_D339.first = VEncodeBool(false);
  ...
  _V10_Dpair_D337.first = _V0set__mutator_B;
  _V10_Dpair_D337.rest = VNULL;
  _V10_Dpair_D336.first = VEncodePointer(&_V10_Dpair_D167, VPOINTER_PAIR);
  ...
  _V10_Dpair_D331.first = VEncodePointer(&_V10_Dpair_D165, VPOINTER_PAIR);
  _V10_Dpair_D331.rest = VEncodePointer(&_V10_Dpair_D197, VPOINTER_PAIR);
  ...
  _V10_Dpair_D328.first = _V0set__setter_B;
  _V10_Dpair_D328.rest = VNULL;
  _V10_Dpair_D327.first = VEncodePointer(&_V10_Dpair_D167, VPOINTER_PAIR);
  _V10_Dpair_D327.rest = VEncodePointer(&_V10_Dpair_D198, VPOINTER_PAIR);
  _V10_Dpair_D325.first = VEncodePointer(&_V10_Dpair_D324, VPOINTER_PAIR);
  _V10_Dpair_D325.rest = VEncodePointer(&_V10_Dpair_D198, VPOINTER_PAIR);
  _V10_Dpair_D324.first = VEncodePointer(&_V10_Dpair_D323, VPOINTER_PAIR);
  _V10_Dpair_D324.rest = VEncodePointer(&_V10_Dpair_D308, VPOINTER_PAIR);
  _V10_Dpair_D323.first = _V0vanity;
  _V10_Dpair_D323.rest = VEncodePointer(&_V10_Dpair_D322, VPOINTER_PAIR);
  _V10_Dpair_D322.first = _V0seed;
  _V10_Dpair_D322.rest = VEncodePointer(&_V10_Dpair_D321, VPOINTER_PAIR);
  _V10_Dpair_D321.first = _V10vcore_Dsetter;
  _V10_Dpair_D321.rest = VNULL;
  _V10_Dpair_D319.first = VEncodePointer(&_V10_Dpair_D316, VPOINTER_PAIR);
  ...
  _V10_Dpair_D317.first = VEncodePointer(&_V10_Dpair_D160, VPOINTER_PAIR);
  _V10_Dpair_D317.rest = VEncodePointer(&_V10_Dpair_D311, VPOINTER_PAIR);
  ...
  _V10_Dpair_D314.first = _V0err;
  _V10_Dpair_D314.rest = VNULL;
  _V10_Dpair_D313.first = VEncodePointer(&_V10_Dpair_D162, VPOINTER_PAIR);
  ...
  _V10_Dpair_D311.first = VEncodePointer(&_V10_Dpair_D307, VPOINTER_PAIR);
  _V10_Dpair_D311.rest = VEncodePointer(&_V10_Dpair_D197, VPOINTER_PAIR);
  _V10_Dpair_D310.first = VEncodePointer(&_V10_Dpair_D309, VPOINTER_PAIR);
  _V10_Dpair_D310.rest = VEncodePointer(&_V10_Dpair_D198, VPOINTER_PAIR);
  _V10_Dpair_D309.first = VEncodePointer(&_V10_Dpair_D305, VPOINTER_PAIR);
  ...
  _V10_Dpair_D306.first = _V0func;
  _V10_Dpair_D306.rest = VNULL;
  _V10_Dpair_D305.first = _V0vanity;
  _V10_Dpair_D305.rest = VEncodePointer(&_V10_Dpair_D304, VPOINTER_PAIR);
  _V10_Dpair_D304.first = _V0seed;
  _V10_Dpair_D304.rest = VEncodePointer(&_V10_Dpair_D303, VPOINTER_PAIR);
  _V10_Dpair_D303.first = _V10vcore_Dmutator;
  _V10_Dpair_D303.rest = VNULL;
  _V10_Dpair_D302.first = VEncodePointer(&_V10_Dpair_D301, VPOINTER_PAIR);
  _V10_Dpair_D302.rest = VEncodePointer(&_V10_Dpair_D198, VPOINTER_PAIR);
  _V10_Dpair_D301.first = VEncodePointer(&_V10_Dpair_D300, VPOINTER_PAIR);
  _V10_Dpair_D301.rest = VEncodePointer(&_V10_Dpair_D242, VPOINTER_PAIR);
  _V10_Dpair_D300.first = _V0vanity;
  _V10_Dpair_D300.rest = VEncodePointer(&_V10_Dpair_D299, VPOINTER_PAIR);
  _V10_Dpair_D299.first = _V0seed;
  _V10_Dpair_D299.rest = VEncodePointer(&_V10_Dpair_D298, VPOINTER_PAIR);
  _V10_Dpair_D298.first = _V10_D_Dvcore_Dpromise_Q_D2;
  _V10_Dpair_D298.rest = VNULL;
  _V10_Dpair_D297.first = VEncodePointer(&_V10_Dpair_D296, VPOINTER_PAIR);
  _V10_Dpair_D297.rest = VEncodePointer(&_V10_Dpair_D198, VPOINTER_PAIR);
  _V10_Dpair_D296.first = VEncodePointer(&_V10_Dpair_D292, VPOINTER_PAIR);
  _V10_Dpair_D296.rest = VEncodePointer(&_V10_Dpair_D295, VPOINTER_PAIR);
  _V10_Dpair_D295.first = VEncodePointer(&_V10_Dpair_D294, VPOINTER_PAIR);
  _V10_Dpair_D295.rest = VNULL;
  _V10_Dpair_D294.first = _V0_Mk;
  _V10_Dpair_D294.rest = VEncodePointer(&_V10_Dpair_D293, VPOINTER_PAIR);
  _V10_Dpair_D293.first = _V0kind__val;
  _V10_Dpair_D293.rest = VNULL;
  _V10_Dpair_D292.first = _V0vanity;
  _V10_Dpair_D292.rest = VEncodePointer(&_V10_Dpair_D291, VPOINTER_PAIR);
  _V10_Dpair_D291.first = _V0seed;
  _V10_Dpair_D291.rest = VEncodePointer(&_V10_Dpair_D290, VPOINTER_PAIR);
  _V10_Dpair_D290.first = _V0make__promise__impl;
  _V10_Dpair_D290.rest = VNULL;
  _V10_Dpair_D289.first = VEncodePointer(&_V10_Dpair_D167, VPOINTER_PAIR);
  ...
  _V10_Dpair_D287.first = VEncodePointer(&_V10_Dpair_D269, VPOINTER_PAIR);
  _V10_Dpair_D287.rest = VEncodePointer(&_V10_Dpair_D286, VPOINTER_PAIR);
  _V10_Dpair_D286.first = VEncodePointer(&_V10_Dpair_D209, VPOINTER_PAIR);
  _V10_Dpair_D286.rest = VEncodePointer(&_V10_Dpair_D283, VPOINTER_PAIR);
  _V10_Dpair_D285.first = VEncodePointer(&_V10_Dpair_D246, VPOINTER_PAIR);
  ...
  _V10_Dpair_D283.first = VEncodePointer(&_V10_Dpair_D279, VPOINTER_PAIR);
  _V10_Dpair_D283.rest = VEncodePointer(&_V10_Dpair_D197, VPOINTER_PAIR);
  _V10_Dpair_D282.first = VEncodePointer(&_V10_Dpair_D281, VPOINTER_PAIR);
  _V10_Dpair_D282.rest = VEncodePointer(&_V10_Dpair_D198, VPOINTER_PAIR);
  _V10_Dpair_D281.first = VEncodePointer(&_V10_Dpair_D277, VPOINTER_PAIR);
  ...
  _V10_Dpair_D278.first = _V0rec;
  _V10_Dpair_D278.rest = VNULL;
  _V10_Dpair_D277.first = _V0vanity;
  _V10_Dpair_D277.rest = VEncodePointer(&_V10_Dpair_D276, VPOINTER_PAIR);
  _V10_Dpair_D276.first = _V0seed;
  _V10_Dpair_D276.rest = VEncodePointer(&_V10_Dpair_D275, VPOINTER_PAIR);
  _V10_Dpair_D275.first = _V0get__promise__kind__val;
  _V10_Dpair_D275.rest = VNULL;
  _V10_Dpair_D273.first = VEncodePointer(&_V10_Dpair_D167, VPOINTER_PAIR);
  _V10_Dpair_D273.rest = VEncodePointer(&_V10_Dpair_D272, VPOINTER_PAIR);
  _V10_Dpair_D272.first = VEncodePointer(&_V10_Dpair_D271, VPOINTER_PAIR);
  _V10_Dpair_D272.rest = VNULL;
  _V10_Dpair_D271.first = VEncodePointer(&_V10_Dpair_D269, VPOINTER_PAIR);
  _V10_Dpair_D271.rest = VEncodePointer(&_V10_Dpair_D270, VPOINTER_PAIR);
  _V10_Dpair_D270.first = VEncodePointer(&_V10_Dpair_D209, VPOINTER_PAIR);
  _V10_Dpair_D270.rest = VEncodePointer(&_V10_Dpair_D266, VPOINTER_PAIR);
  _V10_Dpair_D269.first = _V0_Mx;
  _V10_Dpair_D269.rest = VEncodePointer(&_V10_Dpair_D165, VPOINTER_PAIR);
  _V10_Dpair_D268.first = VEncodePointer(&_V10_Dpair_D246, VPOINTER_PAIR);
  ...
  _V10_Dpair_D266.first = VEncodePointer(&_V10_Dpair_D262, VPOINTER_PAIR);
  _V10_Dpair_D266.rest = VEncodePointer(&_V10_Dpair_D197, VPOINTER_PAIR);
  _V10_Dpair_D265.first = VEncodePointer(&_V10_Dpair_D264, VPOINTER_PAIR);
  _V10_Dpair_D265.rest = VEncodePointer(&_V10_Dpair_D198, VPOINTER_PAIR);
  _V10_Dpair_D264.first = VEncodePointer(&_V10_Dpair_D260, VPOINTER_PAIR);
  ...
  _V10_Dpair_D262.first = _V0_Mk;
  _V10_Dpair_D262.rest = VEncodePointer(&_V10_Dpair_D261, VPOINTER_PAIR);
  _V10_Dpair_D261.first = _V0rec;
  _V10_Dpair_D261.rest = VEncodePointer(&_V10_Dpair_D240, VPOINTER_PAIR);
  _V10_Dpair_D260.first = _V0vanity;
  _V10_Dpair_D260.rest = VEncodePointer(&_V10_Dpair_D259, VPOINTER_PAIR);
  _V10_Dpair_D259.first = _V0seed;
  _V10_Dpair_D259.rest = VEncodePointer(&_V10_Dpair_D258, VPOINTER_PAIR);
  _V10_Dpair_D258.first = _V0set__promise__kind__val_B;
  _V10_Dpair_D258.rest = VNULL;
  _V10_Dpair_D257.first = VEncodePointer(&_V10_Dpair_D256, VPOINTER_PAIR);
  _V10_Dpair_D257.rest = VEncodePointer(&_V10_Dpair_D198, VPOINTER_PAIR);
  _V10_Dpair_D256.first = VEncodePointer(&_V10_Dpair_D252, VPOINTER_PAIR);
  ...
  _V10_Dpair_D253.first = _V0thunk;
  _V10_Dpair_D253.rest = VNULL;
  _V10_Dpair_D252.first = _V0vanity;
  _V10_Dpair_D252.rest = VEncodePointer(&_V10_Dpair_D251, VPOINTER_PAIR);
  _V10_Dpair_D251.first = _V0seed;
  _V10_Dpair_D251.rest = VEncodePointer(&_V10_Dpair_D250, VPOINTER_PAIR);
  _V10_Dpair_D250.first = _V10vcore_Ddelay__force__impl;
  _V10_Dpair_D250.rest = VNULL;
  _V10_Dpair_D249.first = VEncodePointer(&_V10_Dpair_D246, VPOINTER_PAIR);
  ...
  _V10_Dpair_D247.first = VEncodePointer(&_V10_Dpair_D241, VPOINTER_PAIR);
  _V10_Dpair_D247.rest = VEncodePointer(&_V10_Dpair_D197, VPOINTER_PAIR);
  _V10_Dpair_D246.first = VEncodeBool(false);
  _V10_Dpair_D246.rest = VEncodePointer(&_V10_Dpair_D245, VPOINTER_PAIR);
  _V10_Dpair_D245.first = VEncodePointer(&_V10_Dpair_D209, VPOINTER_PAIR);
  _V10_Dpair_D245.rest = VNULL;
  _V10_Dpair_D244.first = VEncodePointer(&_V10_Dpair_D243, VPOINTER_PAIR);
  _V10_Dpair_D244.rest = VEncodePointer(&_V10_Dpair_D198, VPOINTER_PAIR);
  _V10_Dpair_D243.first = VEncodePointer(&_V10_Dpair_D239, VPOINTER_PAIR);
  ...
  _V10_Dpair_D241.first = _V0_Mk;
  _V10_Dpair_D241.rest = VEncodePointer(&_V10_Dpair_D240, VPOINTER_PAIR);
  _V10_Dpair_D240.first = _V0x;
  _V10_Dpair_D240.rest = VNULL;
  _V10_Dpair_D239.first = _V0vanity;
  _V10_Dpair_D239.rest = VEncodePointer(&_V10_Dpair_D238, VPOINTER_PAIR);
  _V10_Dpair_D238.first = _V0seed;
  _V10_Dpair_D238.rest = VEncodePointer(&_V10_Dpair_D237, VPOINTER_PAIR);
  _V10_Dpair_D237.first = _V10vcore_Dmake__promise;
  _V10_Dpair_D237.rest = VNULL;
  _V10_Dpair_D236.first = VEncodePointer(&_V10_Dpair_D167, VPOINTER_PAIR);
  _V10_Dpair_D236.rest = VEncodePointer(&_V10_Dpair_D235, VPOINTER_PAIR);
  _V10_Dpair_D235.first = VEncodePointer(&_V10_Dpair_D234, VPOINTER_PAIR);
  _V10_Dpair_D235.rest = VNULL;
  _V10_Dpair_D234.first = VEncodePointer(&_V10_Dpair_D165, VPOINTER_PAIR);
  _V10_Dpair_D234.rest = VEncodePointer(&_V10_Dpair_D233, VPOINTER_PAIR);
  _V10_Dpair_D233.first = VEncodePointer(&_V10_Dpair_D165, VPOINTER_PAIR);
  _V10_Dpair_D233.rest = VEncodePointer(&_V10_Dpair_D224, VPOINTER_PAIR);
  _V10_Dpair_D232.first = VEncodePointer(&_V10_Dpair_D228, VPOINTER_PAIR);
  _V10_Dpair_D232.rest = VEncodePointer(&_V10_Dpair_D231, VPOINTER_PAIR);
  _V10_Dpair_D231.first = VEncodePointer(&_V10_Dpair_D230, VPOINTER_PAIR);
  _V10_Dpair_D231.rest = VNULL;
  _V10_Dpair_D230.first = _V0unquote;
  _V10_Dpair_D230.rest = VEncodePointer(&_V10_Dpair_D229, VPOINTER_PAIR);
  _V10_Dpair_D229.first = _V0unmangled__env;
  _V10_Dpair_D229.rest = VNULL;
  _V10_Dpair_D228.first = VEncodeBool(false);
  _V10_Dpair_D228.rest = VEncodePointer(&_V10_Dpair_D227, VPOINTER_PAIR);
  _V10_Dpair_D227.first = _V0_U;
  _V10_Dpair_D227.rest = VNULL;
  _V10_Dpair_D226.first = VEncodePointer(&_V10_Dpair_D167, VPOINTER_PAIR);
  ...
  _V10_Dpair_D224.first = VEncodePointer(&_V10_Dpair_D160, VPOINTER_PAIR);
  _V10_Dpair_D224.rest = VEncodePointer(&_V10_Dpair_D221, VPOINTER_PAIR);
  _V10_Dpair_D223.first = VEncodePointer(&_V10_Dpair_D162, VPOINTER_PAIR);
  _V10_Dpair_D223.rest = VEncodePointer(&_V10_Dpair_D222, VPOINTER_PAIR);
  _V10_Dpair_D222.first = VEncodePointer(&_V10_Dpair_D221, VPOINTER_PAIR);
  _V10_Dpair_D222.rest = VNULL;
  _V10_Dpair_D221.first = VEncodePointer(&_V10_Dpair_D219, VPOINTER_PAIR);
  _V10_Dpair_D221.rest = VEncodePointer(&_V10_Dpair_D220, VPOINTER_PAIR);
  _V10_Dpair_D220.first = VEncodePointer(&_V10_Dpair_D200, VPOINTER_PAIR);
  _V10_Dpair_D220.rest = VEncodePointer(&_V10_Dpair_D216, VPOINTER_PAIR);
  _V10_Dpair_D219.first = _V0_Mx;
  _V10_Dpair_D219.rest = VEncodePointer(&_V10_Dpair_D210, VPOINTER_PAIR);
  _V10_Dpair_D218.first = VEncodePointer(&_V10_Dpair_D202, VPOINTER_PAIR);
  ...
  _V10_Dpair_D216.first = VEncodePointer(&_V10_Dpair_D206, VPOINTER_PAIR);
  _V10_Dpair_D216.rest = VEncodePointer(&_V10_Dpair_D213, VPOINTER_PAIR);
  _V10_Dpair_D215.first = VEncodePointer(&_V10_Dpair_D208, VPOINTER_PAIR);
  ...
  _V10_Dpair_D213.first = VEncodePointer(&_V10_Dpair_D165, VPOINTER_PAIR);
  _V10_Dpair_D213.rest = VEncodePointer(&_V10_Dpair_D212, VPOINTER_PAIR);
  _V10_Dpair_D212.first = VEncodePointer(&_V10_Dpair_D210, VPOINTER_PAIR);
  _V10_Dpair_D212.rest = VEncodePointer(&_V10_Dpair_D211, VPOINTER_PAIR);
  _V10_Dpair_D211.first = VEncodePointer(&_V10_Dpair_D200, VPOINTER_PAIR);
  _V10_Dpair_D211.rest = VEncodePointer(&_V10_Dpair_D203, VPOINTER_PAIR);
  _V10_Dpair_D210.first = _V0_Mx;
  _V10_Dpair_D210.rest = VEncodePointer(&_V10_Dpair_D209, VPOINTER_PAIR);
  _V10_Dpair_D209.first = _V0_Mp;
  _V10_Dpair_D209.rest = VNULL;
  _V10_Dpair_D208.first = VEncodeBool(false);
  ...
  _V10_Dpair_D206.first = _V0promise_S;
  _V10_Dpair_D206.rest = VNULL;
  _V10_Dpair_D205.first = VEncodePointer(&_V10_Dpair_D202, VPOINTER_PAIR);
  ...
  _V10_Dpair_D203.first = VEncodePointer(&_V10_Dpair_D178, VPOINTER_PAIR);
  _V10_Dpair_D203.rest = VEncodePointer(&_V10_Dpair_D197, VPOINTER_PAIR);
  _V10_Dpair_D202.first = VEncodeBool(false);
  _V10_Dpair_D202.rest = VEncodePointer(&_V10_Dpair_D201, VPOINTER_PAIR);
  _V10_Dpair_D201.first = VEncodePointer(&_V10_Dpair_D200, VPOINTER_PAIR);
  _V10_Dpair_D201.rest = VNULL;
  _V10_Dpair_D200.first = _V0content;
  _V10_Dpair_D200.rest = VNULL;
  _V10_Dpair_D199.first = VEncodePointer(&_V10_Dpair_D180, VPOINTER_PAIR);
  ...
  _V10_Dpair_D198.rest = VNULL;
  _V10_Dpair_D197.first = VEncodePointer(&_V10_Dpair_D195, VPOINTER_PAIR);
  _V10_Dpair_D197.rest = VEncodePointer(&_V10_Dpair_D196, VPOINTER_PAIR);
  _V10_Dpair_D196.first = VNULL;
  _V10_Dpair_D196.rest = VEncodePointer(&_V10_Dpair_D171, VPOINTER_PAIR);
  _V10_Dpair_D195.first = _V0_Dvcore_Dforce;
  _V10_Dpair_D195.rest = VEncodePointer(&_V10_Dpair_D194, VPOINTER_PAIR);
  _V10_Dpair_D194.first = _V0_Dvcore_Dmake__promise;
  _V10_Dpair_D194.rest = VEncodePointer(&_V10_Dpair_D193, VPOINTER_PAIR);
  _V10_Dpair_D193.first = _V0_Dvcore_Ddelay__force__impl;
  _V10_Dpair_D193.rest = VEncodePointer(&_V10_Dpair_D192, VPOINTER_PAIR);
  _V10_Dpair_D192.first = _V0set__promise__kind__val_B;
  _V10_Dpair_D192.rest = VEncodePointer(&_V10_Dpair_D191, VPOINTER_PAIR);
  _V10_Dpair_D191.first = _V0get__promise__kind__val;
  _V10_Dpair_D191.rest = VEncodePointer(&_V10_Dpair_D190, VPOINTER_PAIR);
  _V10_Dpair_D190.first = _V0make__promise__impl;
  _V10_Dpair_D190.rest = VEncodePointer(&_V10_Dpair_D189, VPOINTER_PAIR);
  _V10_Dpair_D189.first = _V0_Dvcore_Dpromise_Q;
  _V10_Dpair_D189.rest = VEncodePointer(&_V10_Dpair_D188, VPOINTER_PAIR);
  _V10_Dpair_D188.first = _V0_Dvcore_Dpromise_Q_D2;
  _V10_Dpair_D188.rest = VEncodePointer(&_V10_Dpair_D187, VPOINTER_PAIR);
  _V10_Dpair_D187.first = _V0promise__box_D1;
  _V10_Dpair_D187.rest = VEncodePointer(&_V10_Dpair_D186, VPOINTER_PAIR);
  _V10_Dpair_D186.first = _V0_Dvcore_Dset__mutator_B;
  _V10_Dpair_D186.rest = VEncodePointer(&_V10_Dpair_D185, VPOINTER_PAIR);
  _V10_Dpair_D185.first = _V0_Dvcore_Dmutator;
  _V10_Dpair_D185.rest = VEncodePointer(&_V10_Dpair_D184, VPOINTER_PAIR);
  _V10_Dpair_D184.first = _V0mutator__table;
  _V10_Dpair_D184.rest = VEncodePointer(&_V10_Dpair_D183, VPOINTER_PAIR);
  _V10_Dpair_D183.first = _V0_Dvcore_Dset__setter_B;
  _V10_Dpair_D183.rest = VEncodePointer(&_V10_Dpair_D182, VPOINTER_PAIR);
  _V10_Dpair_D182.first = _V0_Dvcore_Dsetter;
  _V10_Dpair_D182.rest = VEncodePointer(&_V10_Dpair_D181, VPOINTER_PAIR);
  _V10_Dpair_D181.first = _V0setter__table;
  _V10_Dpair_D181.rest = VNULL;
  _V10_Dpair_D180.first = VEncodePointer(&_V10_Dpair_D176, VPOINTER_PAIR);
  _V10_Dpair_D180.rest = VEncodePointer(&_V10_Dpair_D179, VPOINTER_PAIR);
  _V10_Dpair_D179.first = VEncodePointer(&_V10_Dpair_D178, VPOINTER_PAIR);
  _V10_Dpair_D179.rest = VNULL;
  _V10_Dpair_D178.first = _V0_Mk;
  _V10_Dpair_D178.rest = VEncodePointer(&_V10_Dpair_D177, VPOINTER_PAIR);
  _V10_Dpair_D177.first = _V0promise;
  _V10_Dpair_D177.rest = VNULL;
  _V10_Dpair_D176.first = _V0vanity;
  _V10_Dpair_D176.rest = VEncodePointer(&_V10_Dpair_D175, VPOINTER_PAIR);
  _V10_Dpair_D175.first = _V0seed;
  _V10_Dpair_D175.rest = VEncodePointer(&_V10_Dpair_D174, VPOINTER_PAIR);
  _V10_Dpair_D174.first = _V10vcore_Dforce;
  _V10_Dpair_D174.rest = VNULL;
  _V10_Dpair_D173.first = VEncodePointer(&_V10_Dpair_D170, VPOINTER_PAIR);
  ...
  _V10_Dpair_D171.first = VEncodePointer(&_V10_Dpair_D165, VPOINTER_PAIR);
  _V10_Dpair_D171.rest = VEncodePointer(&_V10_Dpair_D161, VPOINTER_PAIR);
  _V10_Dpair_D170.first = VEncodeBool(false);
  _V10_Dpair_D170.rest = VEncodePointer(&_V10_Dpair_D163, VPOINTER_PAIR);
  _V40VMultiImport = VEncodePointer(VLookupConstant("_V40VMultiImport", &_VW_V40VMultiImport), VPOINTER_CLOSURE);
  _V10_Dpair_D169.first = VEncodePointer(&_V10_Dpair_D167, VPOINTER_PAIR);
  _V10_Dpair_D169.rest = VEncodePointer(&_V10_Dpair_D168, VPOINTER_PAIR);
  _V10_Dpair_D168.first = VEncodePointer(&_V10_Dpair_D161, VPOINTER_PAIR);
  _V10_Dpair_D168.rest = VNULL;
  _V10_Dpair_D167.first = VEncodeBool(false);
  _V10_Dpair_D167.rest = VEncodePointer(&_V10_Dpair_D166, VPOINTER_PAIR);
  _V10_Dpair_D166.first = VEncodePointer(&_V10_Dpair_D165, VPOINTER_PAIR);
  _V10_Dpair_D166.rest = VNULL;
  _V10_Dpair_D165.first = _V0_Mx;
  _V10_Dpair_D165.rest = VNULL;
  _V10_Dpair_D164.first = VEncodePointer(&_V10_Dpair_D162, VPOINTER_PAIR);
  _V10_Dpair_D164.rest = VEncodePointer(&_V10_Dpair_D163, VPOINTER_PAIR);
  _V10_Dpair_D163.first = VNULL;
  _V10_Dpair_D163.rest = VNULL;
  _V10_Dpair_D162.first = VEncodeBool(false);
  _V10_Dpair_D162.rest = VEncodePointer(&_V10_Dpair_D161, VPOINTER_PAIR);
  _V10_Dpair_D161.first = VEncodePointer(&_V10_Dpair_D160, VPOINTER_PAIR);
  _V10_Dpair_D161.rest = VNULL;
  _V10_Dpair_D160.first = _V0_Mk;
  _V10_Dpair_D160.rest = VNULL;
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0seed_V10vcore_Dforce_V0k9, VEncodePointer(&_V10_Dpair_D232, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0seed_V10vcore_Dforce_V0k8, VEncodePointer(&_V10_Dpair_D236, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0seed_V10vcore_Dforce_V0k7, VEncodePointer(&_V10_Dpair_D232, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0seed_V10vcore_Dforce_V0k6, VEncodePointer(&_V10_Dpair_D226, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0seed_V10vcore_Dforce_V0k5, VEncodePointer(&_V10_Dpair_D223, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0seed_V10vcore_Dforce_V0k10, VEncodePointer(&_V10_Dpair_D232, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0seed_V10vcore_Dforce_V0k4, VEncodePointer(&_V10_Dpair_D218, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0seed_V10vcore_Dforce_V0k3, VEncodePointer(&_V10_Dpair_D215, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0seed_V10vcore_Dforce_V0k2, VEncodePointer(&_V10_Dpair_D205, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0seed_V10vcore_Dforce, VEncodePointer(&_V10_Dpair_D199, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0seed_V10vcore_Dmake__promise_V0k11, VEncodePointer(&_V10_Dpair_D249, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0seed_V10vcore_Dmake__promise, VEncodePointer(&_V10_Dpair_D244, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0seed_V10vcore_Ddelay__force__impl, VEncodePointer(&_V10_Dpair_D257, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0seed_V0set__promise__kind__val_B_V0k13, VEncodePointer(&_V10_Dpair_D273, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0seed_V0set__promise__kind__val_B_V0k12, VEncodePointer(&_V10_Dpair_D268, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0seed_V0set__promise__kind__val_B, VEncodePointer(&_V10_Dpair_D265, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0seed_V0get__promise__kind__val_V0k15, VEncodePointer(&_V10_Dpair_D289, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0seed_V0get__promise__kind__val_V0k14, VEncodePointer(&_V10_Dpair_D285, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0seed_V0get__promise__kind__val, VEncodePointer(&_V10_Dpair_D282, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0seed_V0make__promise__impl, VEncodePointer(&_V10_Dpair_D297, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0seed_V10_D_Dvcore_Dpromise_Q_D2, VEncodePointer(&_V10_Dpair_D302, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0seed_V10vcore_Dmutator_V0k16, VEncodePointer(&_V10_Dpair_D319, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0seed_V10vcore_Dmutator_V0lambda3, VEncodePointer(&_V10_Dpair_D313, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0seed_V10vcore_Dmutator, VEncodePointer(&_V10_Dpair_D310, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0seed_V10vcore_Dsetter_V0k17, VEncodePointer(&_V10_Dpair_D319, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0seed_V10vcore_Dsetter_V0lambda4, VEncodePointer(&_V10_Dpair_D313, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0seed_V10vcore_Dsetter, VEncodePointer(&_V10_Dpair_D325, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0seed_V20_V0k35, VEncodePointer(&_V10_Dpair_D232, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0seed_V20_V0k34, VEncodePointer(&_V10_Dpair_D232, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0seed_V20_V0k33, VEncodePointer(&_V10_Dpair_D232, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0seed_V20_V0k32, VEncodePointer(&_V10_Dpair_D232, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0seed_V20_V0k36, VEncodePointer(&_V10_Dpair_D355, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0seed_V20_V0lambda7, VEncodePointer(&_V10_Dpair_D351, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0seed_V20_V0k31, VEncodePointer(&_V10_Dpair_D232, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0seed_V20_V0k37, VEncodePointer(&_V10_Dpair_D355, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0seed_V20_V0lambda8, VEncodePointer(&_V10_Dpair_D351, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0seed_V20_V0k30, VEncodePointer(&_V10_Dpair_D232, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0seed_V20_V0k38, VEncodePointer(&_V10_Dpair_D364, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0seed_V20_V0lambda9, VEncodePointer(&_V10_Dpair_D360, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0seed_V20_V0k29, VEncodePointer(&_V10_Dpair_D232, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0seed_V20_V0k39, VEncodePointer(&_V10_Dpair_D364, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0seed_V20_V0lambda10, VEncodePointer(&_V10_Dpair_D360, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0seed_V20_V0k28, VEncodePointer(&_V10_Dpair_D232, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0seed_V20_V0lambda6, VEncodePointer(&_V10_Dpair_D342, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V10_Dset__mutator_B_D36, VEncodePointer(&_V10_Dpair_D371, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0seed_V20_V0k27, VEncodePointer(&_V10_Dpair_D232, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0seed_V20_V0k26, VEncodePointer(&_V10_Dpair_D336, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0seed_V20_V0k25, VEncodePointer(&_V10_Dpair_D232, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0seed_V20_V0k24, VEncodePointer(&_V10_Dpair_D232, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0seed_V20_V0k23, VEncodePointer(&_V10_Dpair_D232, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0seed_V20_V0k22, VEncodePointer(&_V10_Dpair_D232, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0seed_V20_V0k21, VEncodePointer(&_V10_Dpair_D232, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0seed_V20_V0k20, VEncodePointer(&_V10_Dpair_D232, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0seed_V20_V0lambda5, VEncodePointer(&_V10_Dpair_D333, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V10_Dset__setter_B_D33, VEncodePointer(&_V10_Dpair_D378, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0seed_V20_V0k19, VEncodePointer(&_V10_Dpair_D232, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0seed_V20_V0k18, VEncodePointer(&_V10_Dpair_D327, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0seed_V20_V0lambda2, VEncodePointer(&_V10_Dpair_D173, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0seed_V20_V0k1, VEncodePointer(&_V10_Dpair_D169, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0seed_V20_V0lambda1, VEncodePointer(&_V10_Dpair_D164, VPOINTER_PAIR));
}
