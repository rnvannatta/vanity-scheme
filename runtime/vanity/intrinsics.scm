...
(define-library (vanity intrinsics)
  ...
  (define (lookup-intrinsic sym)
    (case sym
         ...
         ((##vcore.values) (##intrinsic "VValues2" 1 +))
         ...
         ; Vectors
         ((##vcore.vector) ##vcore.vector)
         ((##vcore.make-vector) ##vcore.make-vector)
