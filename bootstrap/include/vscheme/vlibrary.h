...
// u8vector reinterpret-cast accessors
#define IMPLEMENT_U8VECTOR_REINTERPRET_PROTOTYPES(Suffix) \
V_DECLARE_FUNC_BASIC(VU8VectorRef ## Suffix, buf, i); \
V_DECLARE_FUNC_BASIC(VU8VectorSet ## Suffix, buf, i, x);

IMPLEMENT_U8VECTOR_REINTERPRET_PROTOTYPES(Bool)
IMPLEMENT_U8VECTOR_REINTERPRET_PROTOTYPES(S8)
IMPLEMENT_U8VECTOR_REINTERPRET_PROTOTYPES(U8)
IMPLEMENT_U8VECTOR_REINTERPRET_PROTOTYPES(S16)
IMPLEMENT_U8VECTOR_REINTERPRET_PROTOTYPES(U16)
IMPLEMENT_U8VECTOR_REINTERPRET_PROTOTYPES(S32)
IMPLEMENT_U8VECTOR_REINTERPRET_PROTOTYPES(F32)
IMPLEMENT_U8VECTOR_REINTERPRET_PROTOTYPES(F64)
IMPLEMENT_U8VECTOR_REINTERPRET_PROTOTYPES(Pointer)
