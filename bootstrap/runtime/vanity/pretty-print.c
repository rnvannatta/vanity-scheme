...
#include <stdarg.h>
static struct { VBlob sym; char bytes[21]; } _V10_Dstring_D222 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 21 }, "_V0vanity_V0core_V20" };
static struct { VBlob sym; char bytes[30]; } _V10_Dstring_D221 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 30 }, "_V0vanity_V0pretty__print_V20" };
...
void _V50_V0vanity_V0pretty__print_V0print__indent_V0k14(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  VErrorC(runtime, "Not enough arguments to _V50_V0vanity_V0pretty__print_V0print__indent_V0k14, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
  ...
  self->vars[0] = _var0;
  // (basic-block 1 1 (##.reg.200) ((##vcore.- (bruijn ##.i.31 3 1) 1)) (##qualified-call (vanity pretty-print print-indent) (bruijn ##.print-indent.23 4 0) (bruijn ##.k.78 3 0) (bruijn ##.reg.200 0 0)))
    {
    VEnv * statics = self;
    struct { VEnv self; VWORD argv[1]; } container;
    self = &container.self;
...
void _V50_V0vanity_V0pretty__print_V0print__indent_V0k13(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // (if (bruijn ##.p.79 0 0) ((bruijn ##.x.68 12 0) (close _V50_V0vanity_V0pretty__print_V0print__indent_V0k14) #\space) ((bruijn ##.k.78 1 0) #f))
if(VDecodeBool(
_var0)) {
    VCallDecodedWithGC(runtime, VDecodeClosureApply2(runtime, VGetArg(statics, 12-1, 0)), 2,
      (VEncodeClosure(V_EDEN_INIT(runtime, VClosure, VMakeClosure2((VFunc)_V50_V0vanity_V0pretty__print_V0print__indent_V0k14, self)))),
      VEncodeChar(' '));
} else {
...
void _V50_V0vanity_V0pretty__print_V0print__indent(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0, VWORD _var1) {
 if(argc != 2) {
  ...
  self->vars[0] = _var0;
  self->vars[1] = _var1;
  // (##vcore.> (close _V50_V0vanity_V0pretty__print_V0print__indent_V0k13) (bruijn ##.i.31 0 1) 0)
...
void _V50_V0vanity_V0pretty__print_V0lengthof__atom_V0k18(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  VErrorC(runtime, "Not enough arguments to _V50_V0vanity_V0pretty__print_V0lengthof__atom_V0k18, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
  // ((bruijn ##.k.84 5 0) (bruijn ##.reg.201 1 0))
...
void _V50_V0vanity_V0pretty__print_V0lengthof__atom_V0k17(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // (basic-block 1 1 (##.reg.201) ((##vcore.string-length (bruijn ##.x.87 1 0))) ((bruijn ##.x.69 14 0) (close _V50_V0vanity_V0pretty__print_V0lengthof__atom_V0k18) (bruijn ##.port.34 3 0)))
    {
    VEnv * statics = self;
    struct { VEnv self; VWORD argv[1]; } container;
    self = &container.self;
    ...
    VCallDecodedWithGC(runtime, VDecodeClosureApply2(runtime, VGetArg(statics, 14-1, 0)), 2,
      (VEncodeClosure(V_EDEN_INIT(runtime, VClosure, VMakeClosure2((VFunc)_V50_V0vanity_V0pretty__print_V0lengthof__atom_V0k18, self)))),
      statics->up->up->vars[0]);
    }
}
void _V50_V0vanity_V0pretty__print_V0lengthof__atom_V0k16(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // ((bruijn ##.x.70 11 0) (close _V50_V0vanity_V0pretty__print_V0lengthof__atom_V0k17) (bruijn ##.port.34 1 0))
...
void _V50_V0vanity_V0pretty__print_V0lengthof__atom_V0k15(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // ((bruijn ##.x.71 9 0) (close _V50_V0vanity_V0pretty__print_V0lengthof__atom_V0k16) (bruijn ##.expr.33 1 1) (bruijn ##.port.34 0 0))
...
void _V50_V0vanity_V0pretty__print_V0lengthof__atom(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0, VWORD _var1) {
 if(argc != 2) {
  ...
  self->vars[0] = _var0;
  self->vars[1] = _var1;
  // ((bruijn ##.x.72 7 0) (close _V50_V0vanity_V0pretty__print_V0lengthof__atom_V0k15))
...
void _V50_V0vanity_V0pretty__print_V0short_Q_V10_Dlengthof__list_D39_V10_Dloop_D42_V0k20(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  VErrorC(runtime, "Not enough arguments to _V50_V0vanity_V0pretty__print_V0short_Q_V10_Dlengthof__list_D39_V10_Dloop_D42_V0k20, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
  struct { VEnv self; VWORD argv[1]; } container;
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // (basic-block 1 1 (##.reg.202) ((##vcore.+ (bruijn ##.n.44 3 2) (bruijn ##.x.95 1 0) 3)) ((bruijn ##.k.91 3 0) (bruijn ##.reg.202 0 0)))
    {
    VEnv * statics = self;
    struct { VEnv self; VWORD argv[1]; } container;
    self = &container.self;
...
void _V50_V0vanity_V0pretty__print_V0short_Q_V10_Dlengthof__list_D39_V10_Dloop_D42_V0k21(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  VErrorC(runtime, "Not enough arguments to _V50_V0vanity_V0pretty__print_V0short_Q_V10_Dlengthof__list_D39_V10_Dloop_D42_V0k21, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
  struct { VEnv self; VWORD argv[1]; } container;
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // (basic-block 1 1 (##.reg.203) ((##vcore.+ (bruijn ##.n.44 3 2) (bruijn ##.x.98 1 0) 1)) (##qualified-call (vanity pretty-print short? ##.lengthof-list.39 ##.loop.42) (bruijn ##.loop.42 4 0) (bruijn ##.k.91 3 0) (##inline ##vcore.cdr (bruijn ##.expr.43 3 1)) (bruijn ##.reg.203 0 0)))
    {
    VEnv * statics = self;
    struct { VEnv self; VWORD argv[1]; } container;
    self = &container.self;
...
void _V50_V0vanity_V0pretty__print_V0short_Q_V10_Dlengthof__list_D39_V10_Dloop_D42_V0k19(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // (if (bruijn ##.p.92 0 0) ((bruijn ##.return.38 5 1) (bruijn ##.k.91 1 0) #f) (if (##inline ##vcore.null? (bruijn ##.expr.43 1 1)) ((bruijn ##.k.91 1 0) (bruijn ##.n.44 1 2)) (if (##inline ##vcore.not (##inline ##vcore.pair? (bruijn ##.expr.43 1 1))) (##qualified-call (vanity pretty-print short? ##.lengthof.40) (bruijn ##.lengthof.40 4 1) (close _V50_V0vanity_V0pretty__print_V0short_Q_V10_Dlengthof__list_D39_V10_Dloop_D42_V0k20) (bruijn ##.expr.43 1 1)) (##qualified-call (vanity pretty-print short? ##.lengthof.40) (bruijn ##.lengthof.40 4 1) (close _V50_V0vanity_V0pretty__print_V0short_Q_V10_Dlengthof__list_D39_V10_Dloop_D42_V0k21) (##inline ##vcore.car (bruijn ##.expr.43 1 1))))))
if(VDecodeBool(
_var0)) {
...
VInlineNot2(runtime,
        ...
        statics->vars[1])))) {
  {
    ...
    VWORD _arg0 = 
      (VEncodeClosure(V_EDEN_INIT(runtime, VClosure, VMakeClosure2((VFunc)_V50_V0vanity_V0pretty__print_V0short_Q_V10_Dlengthof__list_D39_V10_Dloop_D42_V0k20, self))));
    VWORD _arg1 = 
      statics->vars[1];
    if(VStackOverflow(runtime)){
      VGarbageCollect2Closure(runtime, _closure, 2, _arg0, _arg1);
...
} else {
  {
    VClosure * _closure = VDecodeClosure(statics->up->up->up->vars[1]);
    VWORD _arg0 = 
      (VEncodeClosure(V_EDEN_INIT(runtime, VClosure, VMakeClosure2((VFunc)_V50_V0vanity_V0pretty__print_V0short_Q_V10_Dlengthof__list_D39_V10_Dloop_D42_V0k21, self))));
    VWORD _arg1 = 
      VInlineCar2(runtime,
        statics->vars[1]);
    if(VStackOverflow(runtime)){
...
void _V50_V0vanity_V0pretty__print_V0short_Q_V10_Dlengthof__list_D39_V10_Dloop_D42(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0, VWORD _var1, VWORD _var2) {
 if(argc != 3) {
  ...
  self->vars[1] = _var1;
  self->vars[2] = _var2;
  // (##vcore.> (close _V50_V0vanity_V0pretty__print_V0short_Q_V10_Dlengthof__list_D39_V10_Dloop_D42_V0k19) (bruijn ##.n.44 0 2) (bruijn ##.cutoff.37 5 2))
    VCallFuncWithGC(runtime, (VFunc)VCmpGt, 3,
...
void _V50_V0vanity_V0pretty__print_V0short_Q_V10_Dlengthof_D40_V0k27(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  VErrorC(runtime, "Not enough arguments to _V50_V0vanity_V0pretty__print_V0short_Q_V10_Dlengthof_D40_V0k27, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
  struct { VEnv self; VWORD argv[1]; } container;
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // (basic-block 1 1 (##.reg.204) ((##vcore.+ (bruijn ##.x.104 3 0) (bruijn ##.x.105 1 0))) ((bruijn ##.k.101 6 0) (bruijn ##.reg.204 0 0)))
    {
    VEnv * statics = self;
    struct { VEnv self; VWORD argv[1]; } container;
    self = &container.self;
...
void _V50_V0vanity_V0pretty__print_V0short_Q_V10_Dlengthof_D40_V0k26(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  VErrorC(runtime, "Not enough arguments to _V50_V0vanity_V0pretty__print_V0short_Q_V10_Dlengthof_D40_V0k26, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
  struct { VEnv self; VWORD argv[1]; } container;
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // (##qualified-call (vanity pretty-print short? ##.lengthof.40) (bruijn ##.lengthof.40 5 1) (close _V50_V0vanity_V0pretty__print_V0short_Q_V10_Dlengthof_D40_V0k27) (bruijn ##.x.106 0 0))
  {
    VClosure * _closure = VDecodeClosure(VGetArg(statics, 5-1, 1));
    VWORD _arg0 = 
      (VEncodeClosure(V_EDEN_INIT(runtime, VClosure, VMakeClosure2((VFunc)_V50_V0vanity_V0pretty__print_V0short_Q_V10_Dlengthof_D40_V0k27, self))));
    VWORD _arg1 = 
      _var0;
    if(VStackOverflow(runtime)){
      VGarbageCollect2Closure(runtime, _closure, 2, _arg0, _arg1);
...
void _V50_V0vanity_V0pretty__print_V0short_Q_V10_Dlengthof_D40_V0k25(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // ((bruijn ##.x.73 12 0) (close _V50_V0vanity_V0pretty__print_V0short_Q_V10_Dlengthof_D40_V0k26) (bruijn ##.expr.45 3 1))
    VCallDecodedWithGC(runtime, VDecodeClosureApply2(runtime, VGetArg(statics, 12-1, 0)), 2,
      (VEncodeClosure(V_EDEN_INIT(runtime, VClosure, VMakeClosure2((VFunc)_V50_V0vanity_V0pretty__print_V0short_Q_V10_Dlengthof_D40_V0k26, self)))),
      statics->up->up->vars[1]);
}
void _V50_V0vanity_V0pretty__print_V0short_Q_V10_Dlengthof_D40_V0k23(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // ((close _V50_V0vanity_V0pretty__print_V0short_Q_V10_Dlengthof_D40_V0k24) (close _V50_V0vanity_V0pretty__print_V0short_Q_V10_Dlengthof_D40_V0k25))
    VCallDecodedWithGC(runtime, V_EDEN_INIT(runtime, VClosure, VMakeClosure2((VFunc)_V50_V0vanity_V0pretty__print_V0short_Q_V10_Dlengthof_D40_V0k24, self)), 1,
...
void _V50_V0vanity_V0pretty__print_V0short_Q_V10_Dlengthof_D40_V0k22(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // (if (bruijn ##.p.103 0 0) (##vcore.eqv? (close _V50_V0vanity_V0pretty__print_V0short_Q_V10_Dlengthof_D40_V0k23) (##inline ##vcore.car (bruijn ##.expr.45 1 1)) 'unquote-splicing) (##qualified-call (vanity pretty-print short? ##.lengthof-list.39) (bruijn ##.lengthof-list.39 2 0) (bruijn ##.k.101 1 0) (bruijn ##.expr.45 1 1)))
if(VDecodeBool(
_var0)) {
...
VInlineNot2(runtime,
...
} else {
  {
    ...
    VWORD _arg0 = 
      (VEncodeClosure(V_EDEN_INIT(runtime, VClosure, VMakeClosure2((VFunc)_V50_V0vanity_V0pretty__print_V0short_Q_V10_Dlengthof_D40_V0k22, self))));
    VWORD _arg1 = 
      _var1;
    if(VStackOverflow(runtime)){
      VGarbageCollect2Closure(runtime, _closure, 2, _arg0, _arg1);
...
void _V50_V0vanity_V0pretty__print_V0short_Q_V0k29(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  VErrorC(runtime, "Not enough arguments to _V50_V0vanity_V0pretty__print_V0short_Q_V0k29, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
  // (if (bruijn ##.p.111 0 0) ((bruijn ##.return.38 3 1) (bruijn ##.k.89 3 0) #f) ((bruijn ##.k.89 3 0) #t))
if(VDecodeBool(
_var0)) {
...
void _V50_V0vanity_V0pretty__print_V0short_Q_V0k28(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  VErrorC(runtime, "Not enough arguments to _V50_V0vanity_V0pretty__print_V0short_Q_V0k28, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
  struct { VEnv self; VWORD argv[1]; } container;
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // (##vcore.> (close _V50_V0vanity_V0pretty__print_V0short_Q_V0k29) (bruijn ##.len.46 0 0) (bruijn ##.cutoff.37 3 2))
    VCallFuncWithGC(runtime, (VFunc)VCmpGt, 3,
      (VEncodeClosure(V_EDEN_INIT(runtime, VClosure, VMakeClosure2((VFunc)_V50_V0vanity_V0pretty__print_V0short_Q_V0k29, self)))),
      _var0,
      statics->up->up->vars[2]);
}
void _V50_V0vanity_V0pretty__print_V0short_Q_V0lambda2(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0, VWORD _var1) {
 if(argc != 2) {
  ...
  self->vars[0] = _var0;
  self->vars[1] = _var1;
  // (letrec 2 ((close "_V50_V0vanity_V0pretty__print_V0short_Q_V10_Dlengthof__list_D39") (close "_V50_V0vanity_V0pretty__print_V0short_Q_V10_Dlengthof_D40")) (##qualified-call (vanity pretty-print short? ##.lengthof.40) (bruijn ##.lengthof.40 0 1) (close _V50_V0vanity_V0pretty__print_V0short_Q_V0k28) (bruijn ##.expr.36 2 1)))
    {
    VEnv * statics = self;
    struct { VEnv self; VWORD argv[2]; } container;
    self = &container.self;
    ...
    self->vars[1] = (VEncodeClosure(V_EDEN_INIT(runtime, VClosure, VMakeClosure2((VFunc)_V50_V0vanity_V0pretty__print_V0short_Q_V10_Dlengthof_D40, self))));
  {
    ...
    VWORD _arg0 = 
      (VEncodeClosure(V_EDEN_INIT(runtime, VClosure, VMakeClosure2((VFunc)_V50_V0vanity_V0pretty__print_V0short_Q_V0k28, self))));
    VWORD _arg1 = 
      statics->up->vars[1];
    if(VStackOverflow(runtime)){
      VGarbageCollect2Closure(runtime, _closure, 2, _arg0, _arg1);
...
void _V50_V0vanity_V0pretty__print_V0quotation_Q_V0k30(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  VErrorC(runtime, "Not enough arguments to _V50_V0vanity_V0pretty__print_V0quotation_Q_V0k30, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
...
void _V50_V0vanity_V0pretty__print_V0quotation_Q(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0, VWORD _var1) {
 if(argc != 2) {
  ...
  self->vars[0] = _var0;
  self->vars[1] = _var1;
  // ((bruijn ##.x.74 5 0) (close _V50_V0vanity_V0pretty__print_V0quotation_Q_V0k30) (##inline ##vcore.car (bruijn ##.expr.47 0 1)) (##inline ##vcore.qcons (##inline ##vcore.qcons 'quote '(##string ##.string.213)) (##inline ##vcore.qcons (##inline ##vcore.qcons 'quasiquote '(##string ##.string.214)) (##inline ##vcore.qcons (##inline ##vcore.qcons 'unquote '(##string ##.string.215)) (##inline ##vcore.qcons (##inline ##vcore.qcons 'unquote-splicing '(##string ##.string.216)) '())))))
    VCallDecodedWithGC(runtime, VDecodeClosureApply2(runtime, VGetArg(statics, 5-1, 0)), 3,
      (VEncodeClosure(V_EDEN_INIT(runtime, VClosure, VMakeClosure2((VFunc)_V50_V0vanity_V0pretty__print_V0quotation_Q_V0k30, self)))),
      VInlineCar2(runtime,
        _var1),
...
void _V50_V0vanity_V0pretty__print_V0pretty__print_V0k31(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  VErrorC(runtime, "Not enough arguments to _V50_V0vanity_V0pretty__print_V0pretty__print_V0k31, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
...
void _V50_V0vanity_V0pretty__print_V0pretty__print(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0, VWORD _var1) {
 if(argc != 2) {
  ...
  self->vars[0] = _var0;
  self->vars[1] = _var1;
  // (##qualified-call (vanity pretty-print pretty-print-impl) (bruijn ##.pretty-print-impl.30 1 7) (close _V50_V0vanity_V0pretty__print_V0pretty__print_V0k31) (bruijn ##.expr.49 0 1) 0 #t 40)
  {
    VClosure * _closure = VDecodeClosure(statics->vars[7]);
    VWORD _arg0 = 
      (VEncodeClosure(V_EDEN_INIT(runtime, VClosure, VMakeClosure2((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print_V0k31, self))));
    VWORD _arg1 = 
      _var1;
    VWORD _arg2 = 
      VEncodeInt(0l);
...
void _V50_V0vanity_V0pretty__print_V0join__line_Q_V0k32(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  VErrorC(runtime, "Not enough arguments to _V50_V0vanity_V0pretty__print_V0join__line_Q_V0k32, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
...
void _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k41(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // (basic-block 1 1 (##.reg.205) ((##vcore.+ (bruijn ##.indent.53 8 2) (bruijn ##.x.150 1 0))) (##qualified-call (vanity pretty-print pretty-print-impl) (bruijn ##.pretty-print-impl.30 9 7) (bruijn ##.k.143 8 0) (bruijn ##.x.148 3 0) (bruijn ##.reg.205 0 0) #f 40))
    {
    VEnv * statics = self;
    struct { VEnv self; VWORD argv[1]; } container;
    self = &container.self;
...
void _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k39(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // ((close _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k40) (close _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k41))
    VCallDecodedWithGC(runtime, V_EDEN_INIT(runtime, VClosure, VMakeClosure2((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k40, self)), 1,
...
void _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k38(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // (##vcore.eqv? (close _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k39) (##inline ##vcore.car (bruijn ##.expr.52 5 1)) 'unquote-splicing)
    VCallFuncWithGC(runtime, (VFunc)VEqv, 3,
...
void _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k37(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // ((bruijn ##.x.73 10 0) (close _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k38) (bruijn ##.expr.52 4 1))
...
void _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k46(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // (basic-block 1 1 (##.reg.212) ((##vcore.+ 2 (bruijn ##.x.191 1 0))) ((bruijn ##.k.190 2 0) (bruijn ##.reg.212 0 0)))
    {
    VEnv * statics = self;
    struct { VEnv self; VWORD argv[1]; } container;
    self = &container.self;
...
void _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k45(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // (if (bruijn ##.join-line.58 1 0) (##qualified-call (vanity pretty-print lengthof-atom) (bruijn ##.lengthof-atom.25 9 2) (close _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k46) (##inline ##vcore.car (bruijn ##.expr.52 8 1))) ((bruijn ##.k.190 0 0) 1))
if(VDecodeBool(
statics->vars[0])) {
  {
...
void _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k48(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  VErrorC(runtime, "Not enough arguments to _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k48, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
...
void _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D61_V0k52(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  ...
  // (if (bruijn ##.p.179 1 0) ((bruijn ##.x.68 24 0) (bruijn ##.k.180 0 0) (##string ##.string.218)) ((bruijn ##.x.75 17 0) (bruijn ##.k.180 0 0)))
if(VDecodeBool(
statics->vars[0])) {
...
void _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D61_V0k58(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // (if (bruijn ##.p.169 1 0) (basic-block 2 2 (##.reg.208 ##.reg.209) ((##vcore.+ (bruijn ##.indent.53 17 2) (bruijn ##.new-indent.60 8 0)) (##vcore.- 80 (bruijn ##.reg.208 0 0))) ((bruijn ##.x.77 19 0) (bruijn ##.k.170 1 0) 40 (bruijn ##.reg.209 0 1))) ((bruijn ##.k.170 0 0) 40))
if(VDecodeBool(
statics->vars[0])) {
    {
    VEnv * statics = self;
...
void _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D61_V0k61(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // (##qualified-call (vanity pretty-print pretty-print-impl) (bruijn ##.pretty-print-impl.30 19 7) (close _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D61_V0k62) (##inline ##vcore.car (bruijn ##.rest.62 7 1)) (bruijn ##.reg.207 1 0) (##inline ##vcore.not (bruijn ##.x.167 0 0)) (bruijn ##.x.163 2 0))
  {
...
void _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D61_V0k59(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // (basic-block 1 1 (##.reg.207) ((##vcore.+ (bruijn ##.indent.53 17 2) (bruijn ##.x.162 3 0))) ((close _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D61_V0k60) (close _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D61_V0k61)))
    {
    VEnv * statics = self;
    struct { VEnv self; VWORD argv[1]; } container;
    self = &container.self;
    ...
    self->vars[0] = _VBasic_VAdd2(runtime, NULL,
      VGetArg(statics, 17-1, 2),
      statics->up->up->vars[0]);
    VCallDecodedWithGC(runtime, V_EDEN_INIT(runtime, VClosure, VMakeClosure2((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D61_V0k60, self)), 1,
...
void _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D61_V0k57(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // ((close _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D61_V0k58) (close _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D61_V0k59))
    VCallDecodedWithGC(runtime, V_EDEN_INIT(runtime, VClosure, VMakeClosure2((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D61_V0k58, self)), 1,
...
void _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D61_V0k55(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // ((close _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D61_V0k56) (close _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D61_V0k57))
    VCallDecodedWithGC(runtime, V_EDEN_INIT(runtime, VClosure, VMakeClosure2((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D61_V0k56, self)), 1,
      (VEncodeClosure(V_EDEN_INIT(runtime, VClosure, VMakeClosure2((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D61_V0k57, self)))));
}
void _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D61_V0k53(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // ((close _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D61_V0k54) (close _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D61_V0k55))
    VCallDecodedWithGC(runtime, V_EDEN_INIT(runtime, VClosure, VMakeClosure2((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D61_V0k54, self)), 1,
      (VEncodeClosure(V_EDEN_INIT(runtime, VClosure, VMakeClosure2((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D61_V0k55, self)))));
}
void _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D61_V0k51(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // ((close _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D61_V0k52) (close _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D61_V0k53))
    VCallDecodedWithGC(runtime, V_EDEN_INIT(runtime, VClosure, VMakeClosure2((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D61_V0k52, self)), 1,
      (VEncodeClosure(V_EDEN_INIT(runtime, VClosure, VMakeClosure2((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D61_V0k53, self)))));
}
void _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D61_V0k66(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  VErrorC(runtime, "Not enough arguments to _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D61_V0k66, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
  // ((bruijn ##.x.68 28 0) (bruijn ##.k.156 6 0) (##string ##.string.217))
...
void _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D61_V0k65(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  VErrorC(runtime, "Not enough arguments to _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D61_V0k65, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
  struct { VEnv self; VWORD argv[1]; } container;
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // (basic-block 1 1 (##.reg.211) ((##vcore.+ (bruijn ##.indent.53 16 2) 3)) (##qualified-call (vanity pretty-print pretty-print-impl) (bruijn ##.pretty-print-impl.30 17 7) (close _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D61_V0k66) (bruijn ##.rest.62 5 1) (bruijn ##.reg.211 0 0) #f 40))
    {
    VEnv * statics = self;
    struct { VEnv self; VWORD argv[1]; } container;
    self = &container.self;
      ...
      VEncodeInt(3l));
  {
    ...
    VWORD _arg0 = 
      (VEncodeClosure(V_EDEN_INIT(runtime, VClosure, VMakeClosure2((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D61_V0k66, self))));
    VWORD _arg1 = 
      VGetArg(statics, 5-1, 1);
    VWORD _arg2 = 
      self->vars[0];
...
void _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D61_V0k64(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  VErrorC(runtime, "Not enough arguments to _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D61_V0k64, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
  struct { VEnv self; VWORD argv[1]; } container;
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // ((bruijn ##.x.68 25 0) (close _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D61_V0k65) (##string ##.string.219))
    VCallDecodedWithGC(runtime, VDecodeClosureApply2(runtime, VGetArg(statics, 25-1, 0)), 2,
      (VEncodeClosure(V_EDEN_INIT(runtime, VClosure, VMakeClosure2((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D61_V0k65, self)))),
...
void _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D61_V0k63(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // (basic-block 1 1 (##.reg.210) ((##vcore.+ (bruijn ##.indent.53 13 2) 1)) (##qualified-call (vanity pretty-print print-indent) (bruijn ##.print-indent.23 14 0) (close _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D61_V0k64) (bruijn ##.reg.210 0 0)))
    {
    VEnv * statics = self;
    struct { VEnv self; VWORD argv[1]; } container;
    self = &container.self;
      ...
      VEncodeInt(1l));
  {
    ...
    VWORD _arg0 = 
      (VEncodeClosure(V_EDEN_INIT(runtime, VClosure, VMakeClosure2((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D61_V0k64, self))));
    VWORD _arg1 = 
      self->vars[0];
    if(VStackOverflow(runtime)){
      VGarbageCollect2Closure(runtime, _closure, 2, _arg0, _arg1);
...
void _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D61(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0, VWORD _var1, VWORD _var2) {
 if(argc != 3) {
  ...
  self->vars[1] = _var1;
  self->vars[2] = _var2;
  // (if (##inline ##vcore.null? (bruijn ##.rest.62 0 1)) ((bruijn ##.x.68 22 0) (bruijn ##.k.156 0 0) (##string ##.string.217)) (if (##inline ##vcore.pair? (bruijn ##.rest.62 0 1)) ((close _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D61_V0k50) (close _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D61_V0k51)) ((bruijn ##.x.68 22 0) (close _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D61_V0k63) #\newline)))
if(VDecodeBool(
VInlineNullP2(runtime,
        _var1))) {
...
VInlinePairP2(runtime,
        _var1))) {
    VCallDecodedWithGC(runtime, V_EDEN_INIT(runtime, VClosure, VMakeClosure2((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D61_V0k50, self)), 1,
      (VEncodeClosure(V_EDEN_INIT(runtime, VClosure, VMakeClosure2((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D61_V0k51, self)))));
} else {
    VCallDecodedWithGC(runtime, VDecodeClosureApply2(runtime, VGetArg(statics, 22-1, 0)), 2,
...
void _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k49(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  VErrorC(runtime, "Not enough arguments to _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k49, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
  struct { VEnv self; VWORD argv[1]; } container;
...
void _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k47(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  VErrorC(runtime, "Not enough arguments to _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k47, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
  struct { VEnv self; VWORD argv[1]; } container;
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // ((close _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k48) (close _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k49))
    VCallDecodedWithGC(runtime, V_EDEN_INIT(runtime, VClosure, VMakeClosure2((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k48, self)), 1,
      (VEncodeClosure(V_EDEN_INIT(runtime, VClosure, VMakeClosure2((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k49, self)))));
}
void _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k44(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // ((close _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k45) (close _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k47))
    VCallDecodedWithGC(runtime, V_EDEN_INIT(runtime, VClosure, VMakeClosure2((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k45, self)), 1,
      (VEncodeClosure(V_EDEN_INIT(runtime, VClosure, VMakeClosure2((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k47, self)))));
}
void _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k43(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // (##qualified-call (vanity pretty-print join-line?) (bruijn ##.join-line?.29 7 6) (close _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k44) (##inline ##vcore.car (bruijn ##.expr.52 6 1)))
  {
...
void _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k42(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // (basic-block 1 1 (##.reg.206) ((##vcore.+ (bruijn ##.indent.53 5 2) 1)) (##qualified-call (vanity pretty-print pretty-print-impl) (bruijn ##.pretty-print-impl.30 6 7) (close _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k43) (##inline ##vcore.car (bruijn ##.expr.52 5 1)) (bruijn ##.reg.206 0 0) #f 40))
    {
    VEnv * statics = self;
    struct { VEnv self; VWORD argv[1]; } container;
    self = &container.self;
...
void _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k36(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // (if (bruijn ##.x.0.56 0 0) ((bruijn ##.x.68 14 0) (close _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k37) (bruijn ##.x.0.56 0 0)) ((bruijn ##.x.68 14 0) (close _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k42) (##string ##.string.220)))
if(VDecodeBool(
_var0)) {
    VCallDecodedWithGC(runtime, VDecodeClosureApply2(runtime, VGetArg(statics, 14-1, 0)), 2,
      (VEncodeClosure(V_EDEN_INIT(runtime, VClosure, VMakeClosure2((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k37, self)))),
      _var0);
} else {
    VCallDecodedWithGC(runtime, VDecodeClosureApply2(runtime, VGetArg(statics, 14-1, 0)), 2,
      (VEncodeClosure(V_EDEN_INIT(runtime, VClosure, VMakeClosure2((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k42, self)))),
...
void _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k35(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // (if (bruijn ##.p.146 0 0) ((bruijn ##.x.71 10 0) (bruijn ##.k.143 2 0) (bruijn ##.expr.52 2 1)) (##qualified-call (vanity pretty-print quotation?) (bruijn ##.quotation?.27 3 4) (close _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k36) (bruijn ##.expr.52 2 1)))
if(VDecodeBool(
_var0)) {
    VCallDecodedWithGC(runtime, VDecodeClosureApply2(runtime, VGetArg(statics, 10-1, 0)), 2,
      statics->up->vars[0],
...
void _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k34(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // (if (##inline ##vcore.not (##inline ##vcore.pair? (bruijn ##.expr.52 1 1))) ((bruijn ##.x.71 9 0) (bruijn ##.k.143 1 0) (bruijn ##.expr.52 1 1)) (##qualified-call (vanity pretty-print short?) (bruijn ##.short?.26 2 3) (close _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k35) (bruijn ##.expr.52 1 1) (bruijn ##.short-threshold.55 1 4)))
if(VDecodeBool(
VInlineNot2(runtime,
        VInlinePairP2(runtime,
        statics->vars[1])))) {
...
void _V50_V0vanity_V0pretty__print_V0pretty__print__impl(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0, VWORD _var1, VWORD _var2, VWORD _var3, VWORD _var4) {
 if(argc != 5) {
  ...
  self->vars[3] = _var3;
  self->vars[4] = _var4;
  // ((close _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k33) (close _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k34))
    VCallDecodedWithGC(runtime, V_EDEN_INIT(runtime, VClosure, VMakeClosure2((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k33, self)), 1,
...
static void _V0vanity_V0pretty__print_V20_V0k1(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // (##vcore.make-import (close _V0vanity_V0pretty__print_V20_V0k2) (##string ##.string.221) (bruijn ##.x.199 0 0))
...
static void _V0vanity_V0pretty__print_V20_V0lambda1(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // (##vcore.load-library (close _V0vanity_V0pretty__print_V20_V0k1) (##string ##.string.222))
