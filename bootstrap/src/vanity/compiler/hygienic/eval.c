...
static struct { VBlob sym; char bytes[21]; } _V10_Dstring_D317 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 21 }, "_V0vanity_V0core_V20" };
static struct { VBlob sym; char bytes[21]; } _V10_Dstring_D316 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 21 }, "_V0vanity_V0list_V20" };
static struct { VBlob sym; char bytes[44]; } _V10_Dstring_D315 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 44 }, "_V0vanity_V0compiler_V0hygienic_V0types_V20" };
static struct { VBlob sym; char bytes[52]; } _V10_Dstring_D314 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 52 }, "_V0vanity_V0compiler_V0hygienic_V0global__forms_V20" };
static struct { VBlob sym; char bytes[43]; } _V10_Dstring_D313 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 43 }, "_V0vanity_V0compiler_V0hygienic_V0eval_V20" };
static struct { VBlob sym; char bytes[23]; } _V10_Dstring_D312 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 23 }, "too few args to lambda" };
static struct { VBlob sym; char bytes[24]; } _V10_Dstring_D311 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 24 }, "too many args to lambda" };
...
static struct { VBlob sym; char bytes[17]; } _V10_Dstring_D194 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 17 }, "eval: stray null" };
static struct { VBlob sym; char bytes[23]; } _V10_Dstring_D193 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 23 }, "eval: symbol not found" };
...
static VPair _V10_Dpair_D135 = { .base = { .tag = VPAIR, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, };
static VPair _V10_Dpair_D134 = { .base = { .tag = VPAIR, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, };
...
void _V50_V0vanity_V0compiler_V0hygienic_V0eval_V0eval_V0k6(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 ...
 if(argc != 1) {
  ...
  self->vars[0] = _var0;
  // (if (bruijn ##.lookup.23 0 0) (basic-block 1 1 (##.%r.100) ((##vcore.cdr (bruijn ##.lookup.23 1 0))) ((bruijn ##.%k.39 3 0) (bruijn ##.%r.100 0 0))) ((bruijn ##.error.7 4 6) (bruijn ##.%k.39 2 0) (##string ##.string.193) (bruijn ##.expr.21 2 1)))
if(VDecodeBool(
_var0)) {
    {
    VEnv * statics = self;
    ...
    VCallDecodedWithGC(runtime, VDecodeClosureApply2(runtime, statics->up->up->up->vars[6]), 3,
      statics->up->vars[0],
      VEncodePointer(&_V10_Dstring_D193.sym, VPOINTER_OTHER),
      statics->up->vars[1]);
}
}
...
void _V50_V0vanity_V0compiler_V0hygienic_V0eval_V0eval_V0lambda3(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0, ...) {
 static VDebugInfo dbg = { "_V50_V0vanity_V0compiler_V0hygienic_V0eval_V0eval_V0lambda3" };
 VRecordCall2(runtime, &dbg);
 if(argc < 1) {
...
static void _V0vanity_V0compiler_V0hygienic_V0eval_V20_V0k5(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 ...
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // ((##intrinsic "VMultiImport") (close _V0vanity_V0compiler_V0hygienic_V0eval_V20_V0lambda2) (##string ##.string.313) (bruijn ##.%x.94 0 0) 'map 'cadr 'caddr 'cadddr 'append 'for-each 'error 'assoc)
...
static void _V0vanity_V0compiler_V0hygienic_V0eval_V20_V0k3(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 ...
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // (##vcore.load-library (close _V0vanity_V0compiler_V0hygienic_V0eval_V20_V0k4) (##string ##.string.314))
...
static void _V0vanity_V0compiler_V0hygienic_V0eval_V20_V0k2(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 ...
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // (##vcore.load-library (close _V0vanity_V0compiler_V0hygienic_V0eval_V20_V0k3) (##string ##.string.315))
    VCallFuncWithGC(runtime, (VFunc)VLoadLibrary2, 2,
...
static void _V0vanity_V0compiler_V0hygienic_V0eval_V20_V0k1(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 ...
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // (##vcore.load-library (close _V0vanity_V0compiler_V0hygienic_V0eval_V20_V0k2) (##string ##.string.316))
    VCallFuncWithGC(runtime, (VFunc)VLoadLibrary2, 2,
...
static void _V0vanity_V0compiler_V0hygienic_V0eval_V20_V0lambda1(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 ...
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // (##vcore.load-library (close _V0vanity_V0compiler_V0hygienic_V0eval_V20_V0k1) (##string ##.string.317))
    VCallFuncWithGC(runtime, (VFunc)VLoadLibrary2, 2,
...
static __attribute__((constructor)) void VDllMain1() {
  ...
  _V10_Dpair_D310.rest = VEncodePointer(&_V10_Dpair_D183, VPOINTER_PAIR);
  _V10_Dpair_D309.first = VEncodePointer(&_V10_Dpair_D304, VPOINTER_PAIR);
  ...
  _V10_Dpair_D306.first = _V0formals;
  _V10_Dpair_D306.rest = VEncodePointer(&_V10_Dpair_D305, VPOINTER_PAIR);
  _V10_Dpair_D305.first = _V0args;
  _V10_Dpair_D305.rest = VEncodePointer(&_V10_Dpair_D174, VPOINTER_PAIR);
  ...
  _V10_Dpair_D302.first = _V0hygienic;
  _V10_Dpair_D302.rest = VEncodePointer(&_V10_Dpair_D180, VPOINTER_PAIR);
  _V10_Dpair_D301.first = VEncodePointer(&_V10_Dpair_D300, VPOINTER_PAIR);
  _V10_Dpair_D301.rest = VEncodePointer(&_V10_Dpair_D295, VPOINTER_PAIR);
  _V10_Dpair_D300.first = VEncodeBool(false);
  ...
  _V10_Dpair_D298.first = _V0_Mk;
  _V10_Dpair_D298.rest = VEncodePointer(&_V10_Dpair_D297, VPOINTER_PAIR);
  _V10_Dpair_D297.first = _V0e;
  _V10_Dpair_D297.rest = VNULL;
  _V10_Dpair_D296.first = VEncodePointer(&_V10_Dpair_D141, VPOINTER_PAIR);
  ...
  _V10_Dpair_D294.first = VEncodePointer(&_V10_Dpair_D139, VPOINTER_PAIR);
  _V10_Dpair_D294.rest = VEncodePointer(&_V10_Dpair_D293, VPOINTER_PAIR);
  _V10_Dpair_D293.first = VEncodePointer(&_V10_Dpair_D139, VPOINTER_PAIR);
  _V10_Dpair_D293.rest = VEncodePointer(&_V10_Dpair_D286, VPOINTER_PAIR);
  _V10_Dpair_D292.first = VEncodePointer(&_V10_Dpair_D141, VPOINTER_PAIR);
  _V10_Dpair_D292.rest = VEncodePointer(&_V10_Dpair_D287, VPOINTER_PAIR);
  _V10_Dpair_D291.first = VEncodePointer(&_V10_Dpair_D141, VPOINTER_PAIR);
  ...
  _V10_Dpair_D289.first = VEncodePointer(&_V10_Dpair_D283, VPOINTER_PAIR);
  _V10_Dpair_D289.rest = VEncodePointer(&_V10_Dpair_D286, VPOINTER_PAIR);
  _V10_Dpair_D288.first = VEncodePointer(&_V10_Dpair_D285, VPOINTER_PAIR);
  ...
  _V10_Dpair_D286.first = VEncodePointer(&_V10_Dpair_D139, VPOINTER_PAIR);
  _V10_Dpair_D286.rest = VEncodePointer(&_V10_Dpair_D280, VPOINTER_PAIR);
  _V10_Dpair_D285.first = VEncodeBool(false);
  ...
  _V10_Dpair_D283.first = _V0ret;
  _V10_Dpair_D283.rest = VNULL;
  _V10_Dpair_D282.first = VEncodePointer(&_V10_Dpair_D141, VPOINTER_PAIR);
  ...
  _V10_Dpair_D280.first = VEncodePointer(&_V10_Dpair_D198, VPOINTER_PAIR);
  _V10_Dpair_D280.rest = VEncodePointer(&_V10_Dpair_D274, VPOINTER_PAIR);
  _V10_Dpair_D279.first = VEncodePointer(&_V10_Dpair_D141, VPOINTER_PAIR);
  ...
  _V10_Dpair_D277.first = VEncodePointer(&_V10_Dpair_D139, VPOINTER_PAIR);
  _V10_Dpair_D277.rest = VEncodePointer(&_V10_Dpair_D274, VPOINTER_PAIR);
  _V10_Dpair_D276.first = VEncodePointer(&_V10_Dpair_D141, VPOINTER_PAIR);
  ...
  _V10_Dpair_D274.first = VEncodePointer(&_V10_Dpair_D198, VPOINTER_PAIR);
  _V10_Dpair_D274.rest = VEncodePointer(&_V10_Dpair_D263, VPOINTER_PAIR);
  _V10_Dpair_D273.first = VEncodePointer(&_V10_Dpair_D141, VPOINTER_PAIR);
  ...
  _V10_Dpair_D271.first = VEncodePointer(&_V10_Dpair_D188, VPOINTER_PAIR);
  _V10_Dpair_D271.rest = VEncodePointer(&_V10_Dpair_D268, VPOINTER_PAIR);
  _V10_Dpair_D270.first = VEncodePointer(&_V10_Dpair_D267, VPOINTER_PAIR);
  ...
  _V10_Dpair_D268.first = VEncodePointer(&_V10_Dpair_D139, VPOINTER_PAIR);
  _V10_Dpair_D268.rest = VEncodePointer(&_V10_Dpair_D263, VPOINTER_PAIR);
  _V10_Dpair_D267.first = VEncodeBool(false);
  _V10_Dpair_D267.rest = VEncodePointer(&_V10_Dpair_D266, VPOINTER_PAIR);
  _V10_Dpair_D266.first = VEncodePointer(&_V10_Dpair_D188, VPOINTER_PAIR);
  _V10_Dpair_D266.rest = VNULL;
  _V10_Dpair_D265.first = VEncodePointer(&_V10_Dpair_D141, VPOINTER_PAIR);
  ...
  _V10_Dpair_D263.first = VEncodePointer(&_V10_Dpair_D198, VPOINTER_PAIR);
  _V10_Dpair_D263.rest = VEncodePointer(&_V10_Dpair_D216, VPOINTER_PAIR);
  _V10_Dpair_D262.first = VEncodePointer(&_V10_Dpair_D257, VPOINTER_PAIR);
  _V10_Dpair_D262.rest = VEncodePointer(&_V10_Dpair_D223, VPOINTER_PAIR);
  _V10_Dpair_D261.first = VEncodePointer(&_V10_Dpair_D141, VPOINTER_PAIR);
  ...
  _V10_Dpair_D259.rest = VEncodePointer(&_V10_Dpair_D236, VPOINTER_PAIR);
  _V10_Dpair_D258.first = VEncodePointer(&_V10_Dpair_D257, VPOINTER_PAIR);
  _V10_Dpair_D258.rest = VEncodePointer(&_V10_Dpair_D237, VPOINTER_PAIR);
  _V10_Dpair_D257.first = VEncodeBool(false);
  ...
  _V10_Dpair_D254.first = _V0pair;
  _V10_Dpair_D254.rest = VNULL;
  _V10_Dpair_D253.first = VEncodePointer(&_V10_Dpair_D252, VPOINTER_PAIR);
  _V10_Dpair_D253.rest = VEncodePointer(&_V10_Dpair_D246, VPOINTER_PAIR);
  _V10_Dpair_D252.first = VEncodeBool(false);
  ...
  _V10_Dpair_D245.first = VEncodePointer(&_V10_Dpair_D233, VPOINTER_PAIR);
  _V10_Dpair_D245.rest = VEncodePointer(&_V10_Dpair_D236, VPOINTER_PAIR);
  ...
  _V10_Dpair_D236.first = VEncodePointer(&_V10_Dpair_D139, VPOINTER_PAIR);
  _V10_Dpair_D236.rest = VEncodePointer(&_V10_Dpair_D230, VPOINTER_PAIR);
  ...
  _V10_Dpair_D233.first = _V0vals;
  _V10_Dpair_D233.rest = VNULL;
  _V10_Dpair_D232.first = VEncodePointer(&_V10_Dpair_D141, VPOINTER_PAIR);
  ...
  _V10_Dpair_D230.first = VEncodePointer(&_V10_Dpair_D174, VPOINTER_PAIR);
  _V10_Dpair_D230.rest = VEncodePointer(&_V10_Dpair_D227, VPOINTER_PAIR);
  _V10_Dpair_D229.first = VEncodePointer(&_V10_Dpair_D226, VPOINTER_PAIR);
  _V10_Dpair_D229.rest = VEncodePointer(&_V10_Dpair_D228, VPOINTER_PAIR);
  _V10_Dpair_D228.first = VEncodePointer(&_V10_Dpair_D227, VPOINTER_PAIR);
  _V10_Dpair_D228.rest = VNULL;
  _V10_Dpair_D227.first = VEncodePointer(&_V10_Dpair_D219, VPOINTER_PAIR);
  _V10_Dpair_D227.rest = VEncodePointer(&_V10_Dpair_D222, VPOINTER_PAIR);
  _V10_Dpair_D226.first = VEncodeBool(false);
  _V10_Dpair_D226.rest = VEncodePointer(&_V10_Dpair_D225, VPOINTER_PAIR);
  _V10_Dpair_D225.first = VEncodePointer(&_V10_Dpair_D174, VPOINTER_PAIR);
  ...
  _V10_Dpair_D222.first = VEncodePointer(&_V10_Dpair_D139, VPOINTER_PAIR);
  ...
  _V10_Dpair_D219.first = _V0bindings;
  _V10_Dpair_D219.rest = VNULL;
  _V10_Dpair_D218.first = VEncodePointer(&_V10_Dpair_D141, VPOINTER_PAIR);
  ...
  _V10_Dpair_D216.first = VEncodePointer(&_V10_Dpair_D198, VPOINTER_PAIR);
  _V10_Dpair_D216.rest = VEncodePointer(&_V10_Dpair_D202, VPOINTER_PAIR);
  _V10_Dpair_D215.first = VEncodePointer(&_V10_Dpair_D141, VPOINTER_PAIR);
  ...
  _V10_Dpair_D213.first = VEncodePointer(&_V10_Dpair_D139, VPOINTER_PAIR);
  _V10_Dpair_D213.rest = VEncodePointer(&_V10_Dpair_D210, VPOINTER_PAIR);
  _V10_Dpair_D212.first = VEncodePointer(&_V10_Dpair_D141, VPOINTER_PAIR);
  ...
  _V10_Dpair_D210.first = VEncodePointer(&_V10_Dpair_D139, VPOINTER_PAIR);
  _V10_Dpair_D210.rest = VEncodePointer(&_V10_Dpair_D207, VPOINTER_PAIR);
  _V10_Dpair_D209.first = VEncodePointer(&_V10_Dpair_D141, VPOINTER_PAIR);
  ...
  _V10_Dpair_D207.rest = VEncodePointer(&_V10_Dpair_D202, VPOINTER_PAIR);
  _V10_Dpair_D206.first = _V0_Mk;
  _V10_Dpair_D206.rest = VEncodePointer(&_V10_Dpair_D205, VPOINTER_PAIR);
  _V10_Dpair_D205.first = _V0args;
  _V10_Dpair_D205.rest = VNULL;
  _V10_Dpair_D204.first = VEncodePointer(&_V10_Dpair_D197, VPOINTER_PAIR);
  ...
  _V10_Dpair_D201.first = VEncodePointer(&_V10_Dpair_D198, VPOINTER_PAIR);
  ...
  _V10_Dpair_D199.first = VEncodePointer(&_V10_Dpair_D188, VPOINTER_PAIR);
  _V10_Dpair_D199.rest = VEncodePointer(&_V10_Dpair_D190, VPOINTER_PAIR);
  _V10_Dpair_D198.first = _V0_Mx;
  _V10_Dpair_D198.rest = VEncodePointer(&_V10_Dpair_D188, VPOINTER_PAIR);
  _V10_Dpair_D197.first = VEncodeBool(false);
  _V10_Dpair_D197.rest = VEncodePointer(&_V10_Dpair_D196, VPOINTER_PAIR);
  _V10_Dpair_D196.first = VEncodePointer(&_V10_Dpair_D195, VPOINTER_PAIR);
  _V10_Dpair_D196.rest = VNULL;
  _V10_Dpair_D195.first = _V0_Mk;
  _V10_Dpair_D195.rest = _V0args;
  _V10_Dpair_D192.first = VEncodePointer(&_V10_Dpair_D187, VPOINTER_PAIR);
  _V10_Dpair_D192.rest = VEncodePointer(&_V10_Dpair_D191, VPOINTER_PAIR);
  _V10_Dpair_D191.first = VEncodePointer(&_V10_Dpair_D190, VPOINTER_PAIR);
  _V10_Dpair_D191.rest = VNULL;
  _V10_Dpair_D190.first = VEncodePointer(&_V10_Dpair_D188, VPOINTER_PAIR);
  ...
  _V10_Dpair_D189.rest = VEncodePointer(&_V10_Dpair_D182, VPOINTER_PAIR);
  _V10_Dpair_D188.first = _V0_Mp;
  _V10_Dpair_D188.rest = VNULL;
  _V10_Dpair_D187.first = VEncodeBool(false);
  ...
  _V10_Dpair_D185.first = _V0lookup;
  ...
  _V10_Dpair_D182.first = VEncodePointer(&_V10_Dpair_D180, VPOINTER_PAIR);
  _V10_Dpair_D182.rest = VEncodePointer(&_V10_Dpair_D181, VPOINTER_PAIR);
  _V10_Dpair_D181.first = VEncodePointer(&_V10_Dpair_D163, VPOINTER_PAIR);
  _V10_Dpair_D181.rest = VEncodePointer(&_V10_Dpair_D166, VPOINTER_PAIR);
  _V10_Dpair_D180.first = _V0eval;
  _V10_Dpair_D180.rest = VEncodePointer(&_V10_Dpair_D179, VPOINTER_PAIR);
  _V10_Dpair_D179.first = _V0bind__formals;
  _V10_Dpair_D179.rest = VNULL;
  _V10_Dpair_D178.first = VEncodePointer(&_V10_Dpair_D173, VPOINTER_PAIR);
  ...
  _V10_Dpair_D176.first = _V0_Mk;
  _V10_Dpair_D176.rest = VEncodePointer(&_V10_Dpair_D175, VPOINTER_PAIR);
  _V10_Dpair_D175.first = _V0expr;
  _V10_Dpair_D175.rest = VEncodePointer(&_V10_Dpair_D174, VPOINTER_PAIR);
  _V10_Dpair_D174.first = _V0env;
  _V10_Dpair_D174.rest = VNULL;
  _V10_Dpair_D173.first = _V0vanity;
  _V10_Dpair_D173.rest = VEncodePointer(&_V10_Dpair_D172, VPOINTER_PAIR);
  _V10_Dpair_D172.first = _V0compiler;
  _V10_Dpair_D172.rest = VEncodePointer(&_V10_Dpair_D171, VPOINTER_PAIR);
  _V10_Dpair_D171.first = _V0hygienic;
  _V10_Dpair_D171.rest = VEncodePointer(&_V10_Dpair_D170, VPOINTER_PAIR);
  _V10_Dpair_D170.first = _V0eval;
  _V10_Dpair_D170.rest = VEncodePointer(&_V10_Dpair_D169, VPOINTER_PAIR);
  _V10_Dpair_D169.first = _V0eval;
  _V10_Dpair_D169.rest = VNULL;
  _V10_Dpair_D168.first = VEncodePointer(&_V10_Dpair_D165, VPOINTER_PAIR);
  _V10_Dpair_D168.rest = VEncodePointer(&_V10_Dpair_D167, VPOINTER_PAIR);
  _V10_Dpair_D167.first = VEncodePointer(&_V10_Dpair_D166, VPOINTER_PAIR);
  _V10_Dpair_D167.rest = VNULL;
  _V10_Dpair_D166.first = VEncodePointer(&_V10_Dpair_D139, VPOINTER_PAIR);
  _V10_Dpair_D166.rest = VEncodePointer(&_V10_Dpair_D153, VPOINTER_PAIR);
  _V10_Dpair_D165.first = VEncodeBool(false);
  _V10_Dpair_D165.rest = VEncodePointer(&_V10_Dpair_D164, VPOINTER_PAIR);
  _V10_Dpair_D164.first = VEncodePointer(&_V10_Dpair_D163, VPOINTER_PAIR);
  _V10_Dpair_D164.rest = VNULL;
  _V10_Dpair_D163.first = _V0map;
  _V10_Dpair_D163.rest = VEncodePointer(&_V10_Dpair_D162, VPOINTER_PAIR);
  _V10_Dpair_D162.first = _V0cadr;
  _V10_Dpair_D162.rest = VEncodePointer(&_V10_Dpair_D161, VPOINTER_PAIR);
  _V10_Dpair_D161.first = _V0caddr;
  _V10_Dpair_D161.rest = VEncodePointer(&_V10_Dpair_D160, VPOINTER_PAIR);
  _V10_Dpair_D160.first = _V0cadddr;
  _V10_Dpair_D160.rest = VEncodePointer(&_V10_Dpair_D159, VPOINTER_PAIR);
  _V10_Dpair_D159.first = _V0append;
  _V10_Dpair_D159.rest = VEncodePointer(&_V10_Dpair_D158, VPOINTER_PAIR);
  _V10_Dpair_D158.first = _V0for__each;
  _V10_Dpair_D158.rest = VEncodePointer(&_V10_Dpair_D157, VPOINTER_PAIR);
  _V10_Dpair_D157.first = _V0error;
  _V10_Dpair_D157.rest = VEncodePointer(&_V10_Dpair_D156, VPOINTER_PAIR);
  _V10_Dpair_D156.first = _V0assoc;
  _V10_Dpair_D156.rest = VNULL;
  _V40VMultiImport = VEncodePointer(VLookupConstant("_V40VMultiImport", &_VW_V40VMultiImport), VPOINTER_CLOSURE);
  _V10_Dpair_D155.first = VEncodePointer(&_V10_Dpair_D141, VPOINTER_PAIR);
  _V10_Dpair_D155.rest = VEncodePointer(&_V10_Dpair_D154, VPOINTER_PAIR);
  _V10_Dpair_D154.first = VEncodePointer(&_V10_Dpair_D153, VPOINTER_PAIR);
  _V10_Dpair_D154.rest = VNULL;
  _V10_Dpair_D153.first = VEncodePointer(&_V10_Dpair_D139, VPOINTER_PAIR);
  _V10_Dpair_D153.rest = VEncodePointer(&_V10_Dpair_D150, VPOINTER_PAIR);
  _V10_Dpair_D152.first = VEncodePointer(&_V10_Dpair_D141, VPOINTER_PAIR);
  _V10_Dpair_D152.rest = VEncodePointer(&_V10_Dpair_D151, VPOINTER_PAIR);
  _V10_Dpair_D151.first = VEncodePointer(&_V10_Dpair_D150, VPOINTER_PAIR);
  _V10_Dpair_D151.rest = VNULL;
  _V10_Dpair_D150.first = VEncodePointer(&_V10_Dpair_D139, VPOINTER_PAIR);
  _V10_Dpair_D150.rest = VEncodePointer(&_V10_Dpair_D147, VPOINTER_PAIR);
  _V10_Dpair_D149.first = VEncodePointer(&_V10_Dpair_D141, VPOINTER_PAIR);
  _V10_Dpair_D149.rest = VEncodePointer(&_V10_Dpair_D148, VPOINTER_PAIR);
  _V10_Dpair_D148.first = VEncodePointer(&_V10_Dpair_D147, VPOINTER_PAIR);
  _V10_Dpair_D148.rest = VNULL;
  _V10_Dpair_D147.first = VEncodePointer(&_V10_Dpair_D139, VPOINTER_PAIR);
  _V10_Dpair_D147.rest = VEncodePointer(&_V10_Dpair_D144, VPOINTER_PAIR);
  _V10_Dpair_D146.first = VEncodePointer(&_V10_Dpair_D141, VPOINTER_PAIR);
  _V10_Dpair_D146.rest = VEncodePointer(&_V10_Dpair_D145, VPOINTER_PAIR);
  _V10_Dpair_D145.first = VEncodePointer(&_V10_Dpair_D144, VPOINTER_PAIR);
  _V10_Dpair_D145.rest = VNULL;
  _V10_Dpair_D144.first = VEncodePointer(&_V10_Dpair_D139, VPOINTER_PAIR);
  _V10_Dpair_D144.rest = VEncodePointer(&_V10_Dpair_D135, VPOINTER_PAIR);
  _V10_Dpair_D143.first = VEncodePointer(&_V10_Dpair_D141, VPOINTER_PAIR);
  _V10_Dpair_D143.rest = VEncodePointer(&_V10_Dpair_D142, VPOINTER_PAIR);
  _V10_Dpair_D142.first = VEncodePointer(&_V10_Dpair_D135, VPOINTER_PAIR);
  _V10_Dpair_D142.rest = VNULL;
  _V10_Dpair_D141.first = VEncodeBool(false);
  _V10_Dpair_D141.rest = VEncodePointer(&_V10_Dpair_D140, VPOINTER_PAIR);
  _V10_Dpair_D140.first = VEncodePointer(&_V10_Dpair_D139, VPOINTER_PAIR);
  _V10_Dpair_D140.rest = VNULL;
  _V10_Dpair_D139.first = _V0_Mx;
  _V10_Dpair_D139.rest = VNULL;
  _V10_Dpair_D138.first = VEncodePointer(&_V10_Dpair_D136, VPOINTER_PAIR);
  _V10_Dpair_D138.rest = VEncodePointer(&_V10_Dpair_D137, VPOINTER_PAIR);
  _V10_Dpair_D137.first = VNULL;
  _V10_Dpair_D137.rest = VNULL;
  _V10_Dpair_D136.first = VEncodeBool(false);
  _V10_Dpair_D136.rest = VEncodePointer(&_V10_Dpair_D135, VPOINTER_PAIR);
  _V10_Dpair_D135.first = VEncodePointer(&_V10_Dpair_D134, VPOINTER_PAIR);
  _V10_Dpair_D135.rest = VNULL;
  _V10_Dpair_D134.first = _V0_Mk;
  _V10_Dpair_D134.rest = VNULL;
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0hygienic_V0eval_V0eval_V0k6, VEncodePointer(&_V10_Dpair_D192, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0hygienic_V0eval_V0eval_V0k9, VEncodePointer(&_V10_Dpair_D215, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0hygienic_V0eval_V0eval_V0k8, VEncodePointer(&_V10_Dpair_D212, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0hygienic_V0eval_V0eval_V0k7, VEncodePointer(&_V10_Dpair_D209, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0hygienic_V0eval_V0eval_V0lambda3, VEncodePointer(&_V10_Dpair_D204, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0hygienic_V0eval_V0eval_V0k16, VEncodePointer(&_V10_Dpair_D247, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0hygienic_V0eval_V0eval_V0k15, VEncodePointer(&_V10_Dpair_D244, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0hygienic_V0eval_V0eval_V0lambda4, VEncodePointer(&_V10_Dpair_D253, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0hygienic_V0eval_V0eval_V0k14, VEncodePointer(&_V10_Dpair_D238, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0hygienic_V0eval_V0eval_V0k17, VEncodePointer(&_V10_Dpair_D261, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0hygienic_V0eval_V0eval_V0lambda5, VEncodePointer(&_V10_Dpair_D258, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0hygienic_V0eval_V0eval_V0k13, VEncodePointer(&_V10_Dpair_D232, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0hygienic_V0eval_V0eval_V0k12, VEncodePointer(&_V10_Dpair_D229, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0hygienic_V0eval_V0eval_V0k11, VEncodePointer(&_V10_Dpair_D224, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0hygienic_V0eval_V0eval_V0lambda6, VEncodePointer(&_V10_Dpair_D262, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0hygienic_V0eval_V0eval_V0k10, VEncodePointer(&_V10_Dpair_D218, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0hygienic_V0eval_V0eval_V0k20, VEncodePointer(&_V10_Dpair_D273, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0hygienic_V0eval_V0eval_V0k21, VEncodePointer(&_V10_Dpair_D273, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0hygienic_V0eval_V0eval_V0k19, VEncodePointer(&_V10_Dpair_D270, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0hygienic_V0eval_V0eval_V0k18, VEncodePointer(&_V10_Dpair_D265, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0hygienic_V0eval_V0eval_V0k24, VEncodePointer(&_V10_Dpair_D279, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0hygienic_V0eval_V0eval_V0k23, VEncodePointer(&_V10_Dpair_D244, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0hygienic_V0eval_V0eval_V0k22, VEncodePointer(&_V10_Dpair_D276, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0hygienic_V0eval_V0eval_V0k27, VEncodePointer(&_V10_Dpair_D291, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0hygienic_V0eval_V0eval_V0k26, VEncodePointer(&_V10_Dpair_D288, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0hygienic_V0eval_V0eval_V0k25, VEncodePointer(&_V10_Dpair_D282, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0hygienic_V0eval_V0eval_V0k29, VEncodePointer(&_V10_Dpair_D296, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0hygienic_V0eval_V0eval_V0lambda7, VEncodePointer(&_V10_Dpair_D301, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0hygienic_V0eval_V0eval_V0k28, VEncodePointer(&_V10_Dpair_D292, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0hygienic_V0eval_V0eval, VEncodePointer(&_V10_Dpair_D184, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0hygienic_V0eval_V0bind__formals, VEncodePointer(&_V10_Dpair_D310, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0compiler_V0hygienic_V0eval_V20_V0lambda2, VEncodePointer(&_V10_Dpair_D168, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0compiler_V0hygienic_V0eval_V20_V0k5, VEncodePointer(&_V10_Dpair_D155, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0compiler_V0hygienic_V0eval_V20_V0k4, VEncodePointer(&_V10_Dpair_D152, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0compiler_V0hygienic_V0eval_V20_V0k3, VEncodePointer(&_V10_Dpair_D149, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0compiler_V0hygienic_V0eval_V20_V0k2, VEncodePointer(&_V10_Dpair_D146, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0compiler_V0hygienic_V0eval_V20_V0k1, VEncodePointer(&_V10_Dpair_D143, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0compiler_V0hygienic_V0eval_V20_V0lambda1, VEncodePointer(&_V10_Dpair_D138, VPOINTER_PAIR));
}
