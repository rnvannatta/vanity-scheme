...
#include <stdarg.h>
static struct { VBlob sym; char bytes[21]; } _V10string_D215 = { { .base = { .tag = VSTRING }, 21 }, "_V0vanity_V0core_V20" };
static struct { VBlob sym; char bytes[21]; } _V10string_D214 = { { .base = { .tag = VSTRING }, 21 }, "_V0vanity_V0list_V20" };
static struct { VBlob sym; char bytes[33]; } _V10string_D213 = { { .base = { .tag = VSTRING }, 33 }, "_V0vanity_V0compiler_V0utils_V20" };
static struct { VBlob sym; char bytes[35]; } _V10string_D212 = { { .base = { .tag = VSTRING }, 35 }, "_V0vanity_V0compiler_V0library_V20" };
...
VWEAK VWORD _V0read__all;VWEAK struct { VBlob sym; char bytes[9]; } _VW_V0read__all = { { .base = { .tag = VSYMBOL }, 9 }, "read-all" };
VWEAK VWORD _V0search__open__input__file;VWEAK struct { VBlob sym; char bytes[23]; } _VW_V0search__open__input__file = { { .base = { .tag = VSYMBOL }, 23 }, "search-open-input-file" };
static struct { VBlob sym; char bytes[44]; } _V10string_D211 = { { .base = { .tag = VSTRING }, 44 }, "library header must only have one statement" };
static struct { VBlob sym; char bytes[23]; } _V10string_D210 = { { .base = { .tag = VSTRING }, 23 }, "unable to find library" };
static struct { VBlob sym; char bytes[27]; } _V10string_D209 = { { .base = { .tag = VSTRING }, 27 }, "library already registered" };
static struct { VBlob sym; char bytes[8]; } _V10string_D208 = { { .base = { .tag = VSTRING }, 8 }, "~A.scmh" };
static struct { VBlob sym; char bytes[6]; } _V10string_D207 = { { .base = { .tag = VSTRING }, 6 }, "~A/~A" };
static struct { VBlob sym; char bytes[2]; } _V10string_D206 = { { .base = { .tag = VSTRING }, 2 }, "." };
VWEAK VWORD _V0inline__export;VWEAK struct { VBlob sym; char bytes[14]; } _VW_V0inline__export = { { .base = { .tag = VSYMBOL }, 14 }, "inline-export" };
VWEAK VWORD _V0inline__import;VWEAK struct { VBlob sym; char bytes[14]; } _VW_V0inline__import = { { .base = { .tag = VSYMBOL }, 14 }, "inline-import" };
VWEAK VWORD _V0export;VWEAK struct { VBlob sym; char bytes[7]; } _VW_V0export = { { .base = { .tag = VSYMBOL }, 7 }, "export" };
VWEAK VWORD _V0define__library__interface;VWEAK struct { VBlob sym; char bytes[25]; } _VW_V0define__library__interface = { { .base = { .tag = VSYMBOL }, 25 }, "define-library-interface" };
static struct { VBlob sym; char bytes[20]; } _V10string_D205 = { { .base = { .tag = VSTRING }, 20 }, "not a valid library" };
...
VWEAK VWORD _V0gather__dependencies;VWEAK struct { VBlob sym; char bytes[20]; } _VW_V0gather__dependencies = { { .base = { .tag = VSYMBOL }, 20 }, "gather-dependencies" };
VWEAK VWORD _V0import___Gpath;VWEAK struct { VBlob sym; char bytes[13]; } _VW_V0import___Gpath = { { .base = { .tag = VSYMBOL }, 13 }, "import->path" };
VWEAK VWORD _V0import__basepath;VWEAK struct { VBlob sym; char bytes[16]; } _VW_V0import__basepath = { { .base = { .tag = VSYMBOL }, 16 }, "import-basepath" };
VWEAK VWORD _V0valid__import_Q;VWEAK struct { VBlob sym; char bytes[14]; } _VW_V0valid__import_Q = { { .base = { .tag = VSYMBOL }, 14 }, "valid-import\?" };
