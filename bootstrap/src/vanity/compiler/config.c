...
#include <stdarg.h>
static struct { VBlob sym; char bytes[34]; } _V10_Dstring_D11 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 34 }, "_V0vanity_V0compiler_V0config_V20" };
...
static struct { VBlob sym; char bytes[12]; } _V10_Dstring_D10 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 12 }, "/usr/local/" };
...
static void _V0vanity_V0compiler_V0config_V20_k1(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0config_V20_k1, runtime, upenv, 1, argc, _var0) {
  ...
  env->vars[0] = _var0;
  // (letrec 2 ((##inline ##vcore.qcons '0 (##inline ##vcore.qcons '0 '())) (##string ##.string.10)) ((bruijn ##.k.4 2 0) (##inline ##vcore.cons (##inline ##vcore.cons 'install-root (bruijn ##.install-root.2 0 1)) (##inline ##vcore.cons (##inline ##vcore.cons 'version (bruijn ##.version.1 0 0)) '()))))
    // OH NO A LETREC!
    {
    VEnv * upenv = env;
    ...
    env->vars[0] = VInlineCons2(runtime,
        ...
        VEncodeInt(0l),
        VNULL));
    env->vars[1] = VEncodePointer(&_V10_Dstring_D10.sym, VPOINTER_OTHER);
...
static void _V0vanity_V0compiler_V0config_V20_lambda1(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0config_V20_lambda1, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (##vcore.make-import (close _V0vanity_V0compiler_V0config_V20_k1) (##string ##.string.11))
    V_CALL_FUNC(VMakeImport2, NULL, runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0vanity_V0compiler_V0config_V20_k1, env)}),
      VEncodePointer(&_V10_Dstring_D11.sym, VPOINTER_OTHER));
 }
}
