...
static struct { VBlob sym; char bytes[21]; } _V10_Dstring_D1463 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 21 }, "_V0vanity_V0core_V20" };
static struct { VBlob sym; char bytes[21]; } _V10_Dstring_D1462 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 21 }, "_V0vanity_V0list_V20" };
static struct { VBlob sym; char bytes[33]; } _V10_Dstring_D1461 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 33 }, "_V0vanity_V0compiler_V0utils_V20" };
static struct { VBlob sym; char bytes[35]; } _V10_Dstring_D1460 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 35 }, "_V0vanity_V0compiler_V0library_V20" };
static VPair _V10_Dpair_D1459 = { .base = { .tag = VPAIR, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, };
static struct { VBlob sym; char bytes[44]; } _V10_Dstring_D1458 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 44 }, "library header must only have one statement" };
...
static struct { VBlob sym; char bytes[23]; } _V10_Dstring_D1445 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 23 }, "unable to find library" };
...
static struct { VBlob sym; char bytes[26]; } _V10_Dstring_D1099 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 26 }, "match statement exhausted" };
...
static struct { VBlob sym; char bytes[15]; } _V10_Dstring_D1038 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 15 }, "invalid export" };
...
static struct { VBlob sym; char bytes[8]; } _V10_Dstring_D862 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 8 }, "~A.scmh" };
...
static struct { VBlob sym; char bytes[6]; } _V10_Dstring_D855 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 6 }, "~A/~A" };
...
static struct { VBlob sym; char bytes[2]; } _V10_Dstring_D847 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 2 }, "." };
...
void _V50_V0vanity_V0compiler_V0library_V0gather__dependencies_V0lambda3(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0, VWORD _var1) {
 static VDebugInfo dbg = { "_V50_V0vanity_V0compiler_V0library_V0gather__dependencies_V0lambda3" };
 VRecordCall2(runtime, &dbg);
 if(argc != 2) {
...
void _V50_V0vanity_V0compiler_V0library_V0import__basepath_V0k17(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 ...
 if(argc != 1) {
  ...
  // ((bruijn ##.sprintf.63 5 3) (bruijn ##.%k.276 3 0) (##string ##.string.855) (bruijn ##.%x.533 1 0) (bruijn ##.%x.279 0 0))
...
void _V50_V0vanity_V0compiler_V0library_V0import__basepath(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0, VWORD _var1) {
 ...
 if(argc != 2) {
  ...
  self->vars[0] = _var0;
  self->vars[1] = _var1;
  // (basic-block 2 2 (##.%x.531 ##.%p.532) ((##vcore.cdr (bruijn ##.import.122 1 1)) (##vcore.null? (bruijn ##.%x.531 0 0))) (if (bruijn ##.%p.532 0 1) ((bruijn ##.%k.276 1 0) (##string ##.string.847)) (basic-block 2 2 (##.%x.533 ##.%x.534) ((##vcore.car (bruijn ##.import.122 2 1)) (##vcore.cdr (bruijn ##.import.122 2 1))) (##qualified-call (vanity compiler library import-basepath) #t (bruijn ##.import-basepath.97 3 1) (close _V50_V0vanity_V0compiler_V0library_V0import__basepath_V0k17) (bruijn ##.%x.534 0 1)))))
    {
    VEnv * statics = self;
    struct { VEnv self; VWORD argv[2]; } container;
    self = &container.self;
...
void _V50_V0vanity_V0compiler_V0library_V0import___Gpath_V0k18(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 ...
 if(argc != 1) {
  ...
  // ((bruijn ##.sprintf.63 5 3) (bruijn ##.%k.282 3 0) (##string ##.string.855) (bruijn ##.%x.538 1 0) (bruijn ##.%x.286 0 0))
    VCallDecodedWithGC(runtime, VDecodeClosureApply2(runtime, VGetArg(statics, 5-1, 3)), 4,
      statics->up->up->vars[0],
      VEncodePointer(&_V10_Dstring_D855.sym, VPOINTER_OTHER),
      statics->vars[0],
...
void _V50_V0vanity_V0compiler_V0library_V0import___Gpath(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0, VWORD _var1) {
 ...
 if(argc != 2) {
  ...
  self->vars[0] = _var0;
  self->vars[1] = _var1;
  // (basic-block 2 2 (##.%x.535 ##.%p.536) ((##vcore.cdr (bruijn ##.import.123 1 1)) (##vcore.null? (bruijn ##.%x.535 0 0))) (if (bruijn ##.%p.536 0 1) (basic-block 1 1 (##.%x.537) ((##vcore.car (bruijn ##.import.123 2 1))) ((bruijn ##.sprintf.63 4 3) (bruijn ##.%k.282 2 0) (##string ##.string.862) (bruijn ##.%x.537 0 0))) (basic-block 2 2 (##.%x.538 ##.%x.539) ((##vcore.car (bruijn ##.import.123 2 1)) (##vcore.cdr (bruijn ##.import.123 2 1))) (##qualified-call (vanity compiler library import->path) #t (bruijn ##.import->path.98 3 2) (close _V50_V0vanity_V0compiler_V0library_V0import___Gpath_V0k18) (bruijn ##.%x.539 0 1)))))
    {
    VEnv * statics = self;
    struct { VEnv self; VWORD argv[2]; } container;
    self = &container.self;
...
self->vars[2])) {
    ...
    VCallDecodedWithGC(runtime, VDecodeClosureApply2(runtime, VGetArg(statics, 5-1, 5)), 3,
      statics->up->up->vars[0],
      statics->up->up->vars[1],
      VEncodePointer(&_V10_Dpair_D939, VPOINTER_PAIR));
}
    }
}
    }
...
void _V50_V0vanity_V0compiler_V0library_V0process__import_B_V10_Dprocess__export_D138_V0k33(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 ...
 if(argc != 1) {
  ...
  // (if (bruijn ##.%p.566 1 0) ((bruijn ##.%k.331 0 0) #void) ((bruijn ##.compiler-error.70 9 10) (bruijn ##.%k.331 0 0) (##string ##.string.1038) (bruijn ##.e.144 5 1)))
if(VDecodeBool(
statics->vars[0])) {
    VCallDecodedWithGC(runtime, VDecodeClosureApply2(runtime, _var0), 1,
      VVOID);
...
void _V50_V0vanity_V0compiler_V0library_V0process__import_B_V10_Dprocess__export_D138_V0lambda7(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0, VWORD _var1) {
 static VDebugInfo dbg = { "_V50_V0vanity_V0compiler_V0library_V0process__import_B_V10_Dprocess__export_D138_V0lambda7" };
 VRecordCall2(runtime, &dbg);
 if(argc != 2) {
...
static void _V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k43(VRuntime * runtime, VEnv * statics, int argc) {
  VEnv * self = statics;
  statics = self ? self->up : NULL;
  // ((bruijn ##.error.68 14 8) (bruijn ##.%k.424 1 0) (##string ##.string.1099))
...
static void _V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k55(VRuntime * runtime, VEnv * statics, int argc) {
  VEnv * self = statics;
  statics = self ? self->up : NULL;
  // ((bruijn ##.error.68 15 8) (bruijn ##.%k.400 1 0) (##string ##.string.1099))
...
static void _V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k66(VRuntime * runtime, VEnv * statics, int argc) {
  VEnv * self = statics;
  statics = self ? self->up : NULL;
  // ((bruijn ##.error.68 17 8) (bruijn ##.%k.379 1 0) (##string ##.string.1099))
...
static void _V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k76(VRuntime * runtime, VEnv * statics, int argc) {
  VEnv * self = statics;
  statics = self ? self->up : NULL;
  // ((bruijn ##.error.68 17 8) (bruijn ##.%k.357 1 0) (##string ##.string.1099))
    VCallDecodedWithGC(runtime, VDecodeClosureApply2(runtime, VGetArg(statics, 17-1, 8)), 2,
      statics->vars[0],
      VEncodePointer(&_V10_Dstring_D1099.sym, VPOINTER_OTHER));
}
...
void _V50_V0vanity_V0compiler_V0library_V0process__import_B_V0lambda10(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0, VWORD _var1) {
 static VDebugInfo dbg = { "_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0lambda10" };
 VRecordCall2(runtime, &dbg);
 if(argc != 2) {
...
void _V50_V0vanity_V0compiler_V0library_V0import__path_V0lambda33(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0, VWORD _var1) {
 static VDebugInfo dbg = { "_V50_V0vanity_V0compiler_V0library_V0import__path_V0lambda33" };
 VRecordCall2(runtime, &dbg);
 if(argc != 2) {
...
void _V50_V0vanity_V0compiler_V0library_V0load__library__interface_V0k114(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 ...
 if(argc != 1) {
  ...
  // (if (bruijn ##.fd.247 1 0) ((bruijn ##.read-all.77 5 17) (bruijn ##.%k.496 0 0) (bruijn ##.fd.247 1 0)) ((bruijn ##.compiler-error.70 5 10) (bruijn ##.%k.496 0 0) (##string ##.string.1445) (bruijn ##.import.245 3 1)))
if(VDecodeBool(
statics->vars[0])) {
...
void _V50_V0vanity_V0compiler_V0library_V0load__library__interface_V0k118(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 ...
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // (if (bruijn ##.%p.491 1 0) (basic-block 1 1 (##.%r.685) ((##vcore.car (bruijn ##.parse.248 4 0))) ((bruijn ##.%k.492 1 0) (bruijn ##.%r.685 0 0))) ((bruijn ##.compiler-error.70 8 10) (bruijn ##.%k.492 0 0) (##string ##.string.1458)))
if(VDecodeBool(
statics->vars[0])) {
    {
    VEnv * statics = self;
...
static void _V0vanity_V0compiler_V0library_V20_V0k4(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 ...
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // ((##intrinsic "VMultiImport") (close _V0vanity_V0compiler_V0library_V20_V0lambda2) (##string ##.string.1460) (bruijn ##.%x.513 0 0) 'equal? 'append 'map 'sprintf 'fold 'memv 'list 'cadr 'error 'filter 'compiler-error 'assv 'string-append 'cddr 'assoc 'resolve-file-path 'close-port 'read-all 'search-open-input-file)
...
static void _V0vanity_V0compiler_V0library_V20_V0k2(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 ...
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // (##vcore.load-library (close _V0vanity_V0compiler_V0library_V20_V0k3) (##string ##.string.1461))
...
static void _V0vanity_V0compiler_V0library_V20_V0k1(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 ...
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // (##vcore.load-library (close _V0vanity_V0compiler_V0library_V20_V0k2) (##string ##.string.1462))
    VCallFuncWithGC(runtime, (VFunc)VLoadLibrary2, 2,
...
static void _V0vanity_V0compiler_V0library_V20_V0lambda1(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 ...
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // (##vcore.load-library (close _V0vanity_V0compiler_V0library_V20_V0k1) (##string ##.string.1463))
    VCallFuncWithGC(runtime, (VFunc)VLoadLibrary2, 2,
...
static __attribute__((constructor)) void VDllMain1() {
  ...
  _V10_Dpair_D1459.first = VEncodePointer(&_V10_Dpair_D1448, VPOINTER_PAIR);
  _V10_Dpair_D1459.rest = VEncodePointer(&_V10_Dpair_D1456, VPOINTER_PAIR);
  _V10_Dpair_D1457.first = VEncodePointer(&_V10_Dpair_D706, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1455.first = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D1455.rest = VEncodePointer(&_V10_Dpair_D1451, VPOINTER_PAIR);
  _V10_Dpair_D1454.first = VEncodePointer(&_V10_Dpair_D791, VPOINTER_PAIR);
  _V10_Dpair_D1454.rest = VEncodePointer(&_V10_Dpair_D1452, VPOINTER_PAIR);
  _V10_Dpair_D1453.first = VEncodePointer(&_V10_Dpair_D706, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1451.first = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1450.rest = VEncodePointer(&_V10_Dpair_D1442, VPOINTER_PAIR);
  _V10_Dpair_D1449.first = VEncodePointer(&_V10_Dpair_D1448, VPOINTER_PAIR);
  _V10_Dpair_D1449.rest = VEncodePointer(&_V10_Dpair_D1443, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1446.first = _V0parse;
  _V10_Dpair_D1446.rest = VNULL;
  _V10_Dpair_D1444.first = VEncodePointer(&_V10_Dpair_D706, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1442.first = VEncodePointer(&_V10_Dpair_D1436, VPOINTER_PAIR);
  _V10_Dpair_D1442.rest = VEncodePointer(&_V10_Dpair_D1439, VPOINTER_PAIR);
  _V10_Dpair_D1441.first = VEncodePointer(&_V10_Dpair_D1438, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1439.first = VEncodePointer(&_V10_Dpair_D709, VPOINTER_PAIR);
  _V10_Dpair_D1439.rest = VEncodePointer(&_V10_Dpair_D963, VPOINTER_PAIR);
  _V10_Dpair_D1438.first = VEncodeBool(false);
  ...
  _V10_Dpair_D1436.first = _V0fd;
  _V10_Dpair_D1436.rest = VNULL;
  _V10_Dpair_D1435.first = VEncodePointer(&_V10_Dpair_D711, VPOINTER_PAIR);
  _V10_Dpair_D1435.rest = VEncodePointer(&_V10_Dpair_D1332, VPOINTER_PAIR);
  _V10_Dpair_D1434.first = VEncodePointer(&_V10_Dpair_D1433, VPOINTER_PAIR);
  _V10_Dpair_D1434.rest = VEncodePointer(&_V10_Dpair_D774, VPOINTER_PAIR);
  _V10_Dpair_D1433.first = VEncodePointer(&_V10_Dpair_D1432, VPOINTER_PAIR);
  _V10_Dpair_D1433.rest = VEncodePointer(&_V10_Dpair_D947, VPOINTER_PAIR);
  _V10_Dpair_D1432.first = _V0vanity;
  _V10_Dpair_D1432.rest = VEncodePointer(&_V10_Dpair_D1431, VPOINTER_PAIR);
  _V10_Dpair_D1431.first = _V0compiler;
  _V10_Dpair_D1431.rest = VEncodePointer(&_V10_Dpair_D1430, VPOINTER_PAIR);
  _V10_Dpair_D1430.first = _V0library;
  _V10_Dpair_D1430.rest = VEncodePointer(&_V10_Dpair_D1429, VPOINTER_PAIR);
  _V10_Dpair_D1429.first = _V0load__library__interface;
  _V10_Dpair_D1429.rest = VNULL;
  _V10_Dpair_D1428.first = VEncodePointer(&_V10_Dpair_D711, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1426.first = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D1426.rest = VEncodePointer(&_V10_Dpair_D963, VPOINTER_PAIR);
  _V10_Dpair_D1425.first = VEncodePointer(&_V10_Dpair_D791, VPOINTER_PAIR);
  _V10_Dpair_D1425.rest = VEncodePointer(&_V10_Dpair_D1332, VPOINTER_PAIR);
  _V10_Dpair_D1424.first = VEncodePointer(&_V10_Dpair_D1423, VPOINTER_PAIR);
  _V10_Dpair_D1424.rest = VEncodePointer(&_V10_Dpair_D774, VPOINTER_PAIR);
  _V10_Dpair_D1423.first = VEncodePointer(&_V10_Dpair_D1422, VPOINTER_PAIR);
  _V10_Dpair_D1423.rest = VEncodePointer(&_V10_Dpair_D947, VPOINTER_PAIR);
  _V10_Dpair_D1422.first = _V0vanity;
  _V10_Dpair_D1422.rest = VEncodePointer(&_V10_Dpair_D1421, VPOINTER_PAIR);
  _V10_Dpair_D1421.first = _V0compiler;
  _V10_Dpair_D1421.rest = VEncodePointer(&_V10_Dpair_D1420, VPOINTER_PAIR);
  _V10_Dpair_D1420.first = _V0library;
  _V10_Dpair_D1420.rest = VEncodePointer(&_V10_Dpair_D1419, VPOINTER_PAIR);
  _V10_Dpair_D1419.first = _V0library__exists_Q;
  _V10_Dpair_D1419.rest = VNULL;
  _V10_Dpair_D1418.first = VEncodePointer(&_V10_Dpair_D711, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1416.first = VEncodePointer(&_V10_Dpair_D709, VPOINTER_PAIR);
  _V10_Dpair_D1416.rest = VEncodePointer(&_V10_Dpair_D1413, VPOINTER_PAIR);
  _V10_Dpair_D1415.first = VEncodePointer(&_V10_Dpair_D711, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1413.first = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D1413.rest = VEncodePointer(&_V10_Dpair_D1310, VPOINTER_PAIR);
  _V10_Dpair_D1412.first = VEncodePointer(&_V10_Dpair_D791, VPOINTER_PAIR);
  _V10_Dpair_D1412.rest = VEncodePointer(&_V10_Dpair_D1311, VPOINTER_PAIR);
  _V10_Dpair_D1411.first = VEncodePointer(&_V10_Dpair_D1410, VPOINTER_PAIR);
  _V10_Dpair_D1411.rest = VEncodePointer(&_V10_Dpair_D774, VPOINTER_PAIR);
  _V10_Dpair_D1410.first = VEncodePointer(&_V10_Dpair_D1409, VPOINTER_PAIR);
  _V10_Dpair_D1410.rest = VEncodePointer(&_V10_Dpair_D1301, VPOINTER_PAIR);
  _V10_Dpair_D1409.first = _V0vanity;
  _V10_Dpair_D1409.rest = VEncodePointer(&_V10_Dpair_D1408, VPOINTER_PAIR);
  _V10_Dpair_D1408.first = _V0compiler;
  _V10_Dpair_D1408.rest = VEncodePointer(&_V10_Dpair_D1407, VPOINTER_PAIR);
  _V10_Dpair_D1407.first = _V0library;
  _V10_Dpair_D1407.rest = VEncodePointer(&_V10_Dpair_D1406, VPOINTER_PAIR);
  _V10_Dpair_D1406.first = _V0register__library__interface_B;
  _V10_Dpair_D1406.rest = VNULL;
  _V10_Dpair_D1405.first = VEncodePointer(&_V10_Dpair_D706, VPOINTER_PAIR);
  _V10_Dpair_D1405.rest = VEncodePointer(&_V10_Dpair_D1403, VPOINTER_PAIR);
  _V10_Dpair_D1404.first = VEncodePointer(&_V10_Dpair_D711, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1402.first = VEncodePointer(&_V10_Dpair_D842, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1400.first = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D1400.rest = VEncodePointer(&_V10_Dpair_D1396, VPOINTER_PAIR);
  _V10_Dpair_D1399.first = _V0expr_D11;
  _V10_Dpair_D1399.rest = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D1398.first = VEncodePointer(&_V10_Dpair_D791, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1396.first = VEncodePointer(&_V10_Dpair_D709, VPOINTER_PAIR);
  _V10_Dpair_D1396.rest = VEncodePointer(&_V10_Dpair_D1395, VPOINTER_PAIR);
  _V10_Dpair_D1395.first = VEncodePointer(&_V10_Dpair_D704, VPOINTER_PAIR);
  _V10_Dpair_D1395.rest = VEncodePointer(&_V10_Dpair_D1392, VPOINTER_PAIR);
  _V10_Dpair_D1394.first = VEncodePointer(&_V10_Dpair_D706, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1392.first = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D1392.rest = VEncodePointer(&_V10_Dpair_D1375, VPOINTER_PAIR);
  _V10_Dpair_D1391.first = VEncodePointer(&_V10_Dpair_D706, VPOINTER_PAIR);
  _V10_Dpair_D1391.rest = VEncodePointer(&_V10_Dpair_D1389, VPOINTER_PAIR);
  _V10_Dpair_D1390.first = VEncodePointer(&_V10_Dpair_D711, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1388.first = VEncodePointer(&_V10_Dpair_D1162, VPOINTER_PAIR);
  _V10_Dpair_D1388.rest = VEncodePointer(&_V10_Dpair_D1387, VPOINTER_PAIR);
  _V10_Dpair_D1387.first = VEncodePointer(&_V10_Dpair_D1383, VPOINTER_PAIR);
  _V10_Dpair_D1387.rest = VEncodePointer(&_V10_Dpair_D1386, VPOINTER_PAIR);
  _V10_Dpair_D1386.first = VEncodePointer(&_V10_Dpair_D1384, VPOINTER_PAIR);
  _V10_Dpair_D1386.rest = VEncodePointer(&_V10_Dpair_D1385, VPOINTER_PAIR);
  _V10_Dpair_D1385.first = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D1385.rest = VEncodePointer(&_V10_Dpair_D1379, VPOINTER_PAIR);
  _V10_Dpair_D1384.first = _V0expr_D8;
  _V10_Dpair_D1384.rest = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D1383.first = _V0import;
  _V10_Dpair_D1383.rest = VEncodePointer(&_V10_Dpair_D1382, VPOINTER_PAIR);
  _V10_Dpair_D1382.first = _V0expr_D9;
  _V10_Dpair_D1382.rest = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D1381.first = VEncodePointer(&_V10_Dpair_D791, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1379.first = VEncodePointer(&_V10_Dpair_D709, VPOINTER_PAIR);
  _V10_Dpair_D1379.rest = VEncodePointer(&_V10_Dpair_D1378, VPOINTER_PAIR);
  _V10_Dpair_D1378.first = VEncodePointer(&_V10_Dpair_D704, VPOINTER_PAIR);
  _V10_Dpair_D1378.rest = VEncodePointer(&_V10_Dpair_D1375, VPOINTER_PAIR);
  _V10_Dpair_D1377.first = VEncodePointer(&_V10_Dpair_D706, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1375.first = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D1375.rest = VEncodePointer(&_V10_Dpair_D1361, VPOINTER_PAIR);
  _V10_Dpair_D1374.first = VEncodePointer(&_V10_Dpair_D706, VPOINTER_PAIR);
  _V10_Dpair_D1374.rest = VEncodePointer(&_V10_Dpair_D1372, VPOINTER_PAIR);
  _V10_Dpair_D1373.first = VEncodePointer(&_V10_Dpair_D711, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1371.first = VEncodePointer(&_V10_Dpair_D842, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1369.first = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D1369.rest = VEncodePointer(&_V10_Dpair_D1365, VPOINTER_PAIR);
  _V10_Dpair_D1368.first = _V0expr_D6;
  _V10_Dpair_D1368.rest = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D1367.first = VEncodePointer(&_V10_Dpair_D791, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1365.first = VEncodePointer(&_V10_Dpair_D709, VPOINTER_PAIR);
  _V10_Dpair_D1365.rest = VEncodePointer(&_V10_Dpair_D1364, VPOINTER_PAIR);
  _V10_Dpair_D1364.first = VEncodePointer(&_V10_Dpair_D704, VPOINTER_PAIR);
  _V10_Dpair_D1364.rest = VEncodePointer(&_V10_Dpair_D1361, VPOINTER_PAIR);
  _V10_Dpair_D1363.first = VEncodePointer(&_V10_Dpair_D706, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1361.first = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D1361.rest = VEncodePointer(&_V10_Dpair_D1347, VPOINTER_PAIR);
  _V10_Dpair_D1360.first = VEncodePointer(&_V10_Dpair_D706, VPOINTER_PAIR);
  _V10_Dpair_D1360.rest = VEncodePointer(&_V10_Dpair_D1358, VPOINTER_PAIR);
  _V10_Dpair_D1359.first = VEncodePointer(&_V10_Dpair_D711, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1357.first = VEncodePointer(&_V10_Dpair_D842, VPOINTER_PAIR);
  _V10_Dpair_D1357.rest = VEncodePointer(&_V10_Dpair_D1356, VPOINTER_PAIR);
  _V10_Dpair_D1356.first = VEncodePointer(&_V10_Dpair_D1354, VPOINTER_PAIR);
  _V10_Dpair_D1356.rest = VEncodePointer(&_V10_Dpair_D1355, VPOINTER_PAIR);
  _V10_Dpair_D1355.first = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D1355.rest = VEncodePointer(&_V10_Dpair_D1351, VPOINTER_PAIR);
  _V10_Dpair_D1354.first = _V0expr_D4;
  _V10_Dpair_D1354.rest = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D1353.first = VEncodePointer(&_V10_Dpair_D791, VPOINTER_PAIR);
  _V10_Dpair_D1353.rest = VEncodePointer(&_V10_Dpair_D1352, VPOINTER_PAIR);
  _V10_Dpair_D1352.first = VEncodePointer(&_V10_Dpair_D1351, VPOINTER_PAIR);
  _V10_Dpair_D1352.rest = VNULL;
  _V10_Dpair_D1351.first = VEncodePointer(&_V10_Dpair_D709, VPOINTER_PAIR);
  _V10_Dpair_D1351.rest = VEncodePointer(&_V10_Dpair_D1350, VPOINTER_PAIR);
  _V10_Dpair_D1350.first = VEncodePointer(&_V10_Dpair_D704, VPOINTER_PAIR);
  _V10_Dpair_D1350.rest = VEncodePointer(&_V10_Dpair_D1347, VPOINTER_PAIR);
  _V10_Dpair_D1349.first = VEncodePointer(&_V10_Dpair_D706, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1347.first = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D1347.rest = VEncodePointer(&_V10_Dpair_D1346, VPOINTER_PAIR);
  _V10_Dpair_D1346.first = VEncodePointer(&_V10_Dpair_D1341, VPOINTER_PAIR);
  _V10_Dpair_D1346.rest = VEncodePointer(&_V10_Dpair_D850, VPOINTER_PAIR);
  _V10_Dpair_D1345.first = VEncodePointer(&_V10_Dpair_D1343, VPOINTER_PAIR);
  _V10_Dpair_D1345.rest = VEncodePointer(&_V10_Dpair_D1344, VPOINTER_PAIR);
  _V10_Dpair_D1344.first = VEncodePointer(&_V10_Dpair_D850, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1332.first = VEncodePointer(&_V10_Dpair_D963, VPOINTER_PAIR);
  _V10_Dpair_D1332.rest = VNULL;
  _V10_Dpair_D1331.first = VEncodeBool(false);
  ...
  _V10_Dpair_D1310.first = VEncodePointer(&_V10_Dpair_D709, VPOINTER_PAIR);
  _V10_Dpair_D1310.rest = VEncodePointer(&_V10_Dpair_D1304, VPOINTER_PAIR);
  _V10_Dpair_D1309.first = VEncodeBool(false);
  ...
  _V10_Dpair_D1307.first = _V0x_D13;
  _V10_Dpair_D1307.rest = VNULL;
  _V10_Dpair_D1306.first = VEncodePointer(&_V10_Dpair_D711, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1304.first = VEncodePointer(&_V10_Dpair_D1300, VPOINTER_PAIR);
  _V10_Dpair_D1304.rest = VEncodePointer(&_V10_Dpair_D773, VPOINTER_PAIR);
  _V10_Dpair_D1303.first = VEncodePointer(&_V10_Dpair_D1302, VPOINTER_PAIR);
  _V10_Dpair_D1303.rest = VEncodePointer(&_V10_Dpair_D774, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1300.rest = VEncodePointer(&_V10_Dpair_D1275, VPOINTER_PAIR);
  _V10_Dpair_D1299.first = _V0vanity;
  _V10_Dpair_D1299.rest = VEncodePointer(&_V10_Dpair_D1298, VPOINTER_PAIR);
  _V10_Dpair_D1298.first = _V0compiler;
  _V10_Dpair_D1298.rest = VEncodePointer(&_V10_Dpair_D1297, VPOINTER_PAIR);
  _V10_Dpair_D1297.first = _V0library;
  _V10_Dpair_D1297.rest = VEncodePointer(&_V10_Dpair_D1296, VPOINTER_PAIR);
  _V10_Dpair_D1296.first = _V0extract__constants;
  _V10_Dpair_D1296.rest = VNULL;
  _V10_Dpair_D1295.first = VEncodePointer(&_V10_Dpair_D711, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1293.first = VEncodePointer(&_V10_Dpair_D1005, VPOINTER_PAIR);
  _V10_Dpair_D1293.rest = VEncodePointer(&_V10_Dpair_D1289, VPOINTER_PAIR);
  _V10_Dpair_D1292.first = VEncodePointer(&_V10_Dpair_D1096, VPOINTER_PAIR);
  _V10_Dpair_D1292.rest = VEncodePointer(&_V10_Dpair_D1290, VPOINTER_PAIR);
  _V10_Dpair_D1291.first = VEncodePointer(&_V10_Dpair_D711, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1289.first = VEncodePointer(&_V10_Dpair_D709, VPOINTER_PAIR);
  _V10_Dpair_D1289.rest = VEncodePointer(&_V10_Dpair_D1286, VPOINTER_PAIR);
  _V10_Dpair_D1288.first = VEncodePointer(&_V10_Dpair_D711, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1286.first = VEncodePointer(&_V10_Dpair_D709, VPOINTER_PAIR);
  _V10_Dpair_D1286.rest = VEncodePointer(&_V10_Dpair_D1283, VPOINTER_PAIR);
  _V10_Dpair_D1285.first = VEncodePointer(&_V10_Dpair_D711, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1283.first = VEncodePointer(&_V10_Dpair_D709, VPOINTER_PAIR);
  _V10_Dpair_D1283.rest = VEncodePointer(&_V10_Dpair_D1280, VPOINTER_PAIR);
  _V10_Dpair_D1282.first = VEncodePointer(&_V10_Dpair_D711, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1280.first = VEncodePointer(&_V10_Dpair_D1275, VPOINTER_PAIR);
  _V10_Dpair_D1280.rest = VEncodePointer(&_V10_Dpair_D1223, VPOINTER_PAIR);
  _V10_Dpair_D1279.first = VEncodePointer(&_V10_Dpair_D1277, VPOINTER_PAIR);
  _V10_Dpair_D1279.rest = VEncodePointer(&_V10_Dpair_D1278, VPOINTER_PAIR);
  _V10_Dpair_D1278.first = VEncodePointer(&_V10_Dpair_D1223, VPOINTER_PAIR);
  _V10_Dpair_D1278.rest = VNULL;
  _V10_Dpair_D1277.first = VEncodeBool(false);
  ...
  _V10_Dpair_D1275.first = _V0lib;
  _V10_Dpair_D1275.rest = VNULL;
  _V10_Dpair_D1274.first = VEncodePointer(&_V10_Dpair_D1273, VPOINTER_PAIR);
  _V10_Dpair_D1274.rest = VEncodePointer(&_V10_Dpair_D1260, VPOINTER_PAIR);
  _V10_Dpair_D1273.first = VEncodeBool(false);
  ...
  _V10_Dpair_D1265.first = _V0x_D48;
  _V10_Dpair_D1265.rest = VNULL;
  _V10_Dpair_D1264.first = VEncodePointer(&_V10_Dpair_D711, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1262.first = VEncodePointer(&_V10_Dpair_D709, VPOINTER_PAIR);
  _V10_Dpair_D1262.rest = VEncodePointer(&_V10_Dpair_D1259, VPOINTER_PAIR);
  _V10_Dpair_D1261.first = VEncodePointer(&_V10_Dpair_D711, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1259.first = VEncodePointer(&_V10_Dpair_D704, VPOINTER_PAIR);
  _V10_Dpair_D1259.rest = VEncodePointer(&_V10_Dpair_D1255, VPOINTER_PAIR);
  _V10_Dpair_D1258.first = VEncodePointer(&_V10_Dpair_D706, VPOINTER_PAIR);
  _V10_Dpair_D1258.rest = VEncodePointer(&_V10_Dpair_D1256, VPOINTER_PAIR);
  _V10_Dpair_D1257.first = VEncodePointer(&_V10_Dpair_D711, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1255.first = VEncodePointer(&_V10_Dpair_D1078, VPOINTER_PAIR);
  _V10_Dpair_D1255.rest = VEncodePointer(&_V10_Dpair_D1254, VPOINTER_PAIR);
  _V10_Dpair_D1254.first = VEncodePointer(&_V10_Dpair_D1249, VPOINTER_PAIR);
  _V10_Dpair_D1254.rest = VEncodePointer(&_V10_Dpair_D1253, VPOINTER_PAIR);
  _V10_Dpair_D1253.first = VEncodePointer(&_V10_Dpair_D1251, VPOINTER_PAIR);
  _V10_Dpair_D1253.rest = VEncodePointer(&_V10_Dpair_D1252, VPOINTER_PAIR);
  _V10_Dpair_D1252.first = VEncodePointer(&_V10_Dpair_D704, VPOINTER_PAIR);
  _V10_Dpair_D1252.rest = VEncodePointer(&_V10_Dpair_D1245, VPOINTER_PAIR);
  _V10_Dpair_D1251.first = _V0path;
  _V10_Dpair_D1251.rest = VEncodePointer(&_V10_Dpair_D1250, VPOINTER_PAIR);
  _V10_Dpair_D1250.first = _V0expr_D45;
  _V10_Dpair_D1250.rest = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D1249.first = _V0imports;
  _V10_Dpair_D1249.rest = VEncodePointer(&_V10_Dpair_D1248, VPOINTER_PAIR);
  _V10_Dpair_D1248.first = _V0expr_D46;
  _V10_Dpair_D1248.rest = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D1247.first = VEncodePointer(&_V10_Dpair_D706, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1245.first = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D1245.rest = VEncodePointer(&_V10_Dpair_D1244, VPOINTER_PAIR);
  _V10_Dpair_D1244.first = VEncodePointer(&_V10_Dpair_D1238, VPOINTER_PAIR);
  _V10_Dpair_D1244.rest = VEncodePointer(&_V10_Dpair_D1241, VPOINTER_PAIR);
  _V10_Dpair_D1243.first = VEncodePointer(&_V10_Dpair_D1240, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1241.first = VEncodePointer(&_V10_Dpair_D1061, VPOINTER_PAIR);
  _V10_Dpair_D1241.rest = VEncodePointer(&_V10_Dpair_D1234, VPOINTER_PAIR);
  _V10_Dpair_D1240.first = VEncodeBool(false);
  ...
  _V10_Dpair_D1238.first = _V0_Mk;
  _V10_Dpair_D1238.rest = VEncodePointer(&_V10_Dpair_D1237, VPOINTER_PAIR);
  _V10_Dpair_D1237.first = _V0kk_D42;
  _V10_Dpair_D1237.rest = VNULL;
  _V10_Dpair_D1236.first = VEncodePointer(&_V10_Dpair_D1063, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1234.first = VEncodePointer(&_V10_Dpair_D704, VPOINTER_PAIR);
  _V10_Dpair_D1234.rest = VEncodePointer(&_V10_Dpair_D1230, VPOINTER_PAIR);
  _V10_Dpair_D1233.first = VEncodePointer(&_V10_Dpair_D706, VPOINTER_PAIR);
  _V10_Dpair_D1233.rest = VEncodePointer(&_V10_Dpair_D1231, VPOINTER_PAIR);
  _V10_Dpair_D1232.first = VEncodePointer(&_V10_Dpair_D711, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1230.first = VEncodePointer(&_V10_Dpair_D983, VPOINTER_PAIR);
  _V10_Dpair_D1230.rest = VEncodePointer(&_V10_Dpair_D1229, VPOINTER_PAIR);
  _V10_Dpair_D1229.first = VEncodePointer(&_V10_Dpair_D1227, VPOINTER_PAIR);
  _V10_Dpair_D1229.rest = VEncodePointer(&_V10_Dpair_D1228, VPOINTER_PAIR);
  _V10_Dpair_D1228.first = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D1228.rest = VEncodePointer(&_V10_Dpair_D1224, VPOINTER_PAIR);
  _V10_Dpair_D1227.first = _V0expr_D24;
  _V10_Dpair_D1227.rest = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D1226.first = VEncodePointer(&_V10_Dpair_D791, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1224.first = VEncodePointer(&_V10_Dpair_D709, VPOINTER_PAIR);
  _V10_Dpair_D1224.rest = VEncodePointer(&_V10_Dpair_D1223, VPOINTER_PAIR);
  _V10_Dpair_D1223.first = VEncodePointer(&_V10_Dpair_D704, VPOINTER_PAIR);
  _V10_Dpair_D1223.rest = VEncodePointer(&_V10_Dpair_D1220, VPOINTER_PAIR);
  _V10_Dpair_D1222.first = VEncodePointer(&_V10_Dpair_D706, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1220.first = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D1220.rest = VEncodePointer(&_V10_Dpair_D1155, VPOINTER_PAIR);
  _V10_Dpair_D1219.first = VEncodePointer(&_V10_Dpair_D1218, VPOINTER_PAIR);
  _V10_Dpair_D1219.rest = VEncodePointer(&_V10_Dpair_D1205, VPOINTER_PAIR);
  _V10_Dpair_D1218.first = VEncodeBool(false);
  ...
  _V10_Dpair_D1215.first = _V0x_D40;
  _V10_Dpair_D1215.rest = VNULL;
  _V10_Dpair_D1214.first = VEncodePointer(&_V10_Dpair_D1213, VPOINTER_PAIR);
  _V10_Dpair_D1214.rest = VEncodePointer(&_V10_Dpair_D1208, VPOINTER_PAIR);
  _V10_Dpair_D1213.first = VEncodeBool(false);
  ...
  _V10_Dpair_D1210.first = _V0x_D41;
  _V10_Dpair_D1210.rest = VNULL;
  _V10_Dpair_D1209.first = VEncodePointer(&_V10_Dpair_D711, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1207.first = VEncodePointer(&_V10_Dpair_D709, VPOINTER_PAIR);
  _V10_Dpair_D1207.rest = VEncodePointer(&_V10_Dpair_D1204, VPOINTER_PAIR);
  _V10_Dpair_D1206.first = VEncodePointer(&_V10_Dpair_D711, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1204.first = VEncodePointer(&_V10_Dpair_D1198, VPOINTER_PAIR);
  _V10_Dpair_D1204.rest = VEncodePointer(&_V10_Dpair_D1201, VPOINTER_PAIR);
  _V10_Dpair_D1203.first = VEncodePointer(&_V10_Dpair_D1200, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1201.first = VEncodePointer(&_V10_Dpair_D704, VPOINTER_PAIR);
  _V10_Dpair_D1201.rest = VEncodePointer(&_V10_Dpair_D1194, VPOINTER_PAIR);
  _V10_Dpair_D1200.first = VEncodeBool(false);
  ...
  _V10_Dpair_D1198.first = _V0stringfix;
  _V10_Dpair_D1198.rest = VNULL;
  _V10_Dpair_D1197.first = VEncodePointer(&_V10_Dpair_D706, VPOINTER_PAIR);
  _V10_Dpair_D1197.rest = VEncodePointer(&_V10_Dpair_D1195, VPOINTER_PAIR);
  _V10_Dpair_D1196.first = VEncodePointer(&_V10_Dpair_D711, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1194.first = VEncodePointer(&_V10_Dpair_D1078, VPOINTER_PAIR);
  _V10_Dpair_D1194.rest = VEncodePointer(&_V10_Dpair_D1193, VPOINTER_PAIR);
  _V10_Dpair_D1193.first = VEncodePointer(&_V10_Dpair_D1188, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1191.first = VEncodePointer(&_V10_Dpair_D704, VPOINTER_PAIR);
  _V10_Dpair_D1191.rest = VEncodePointer(&_V10_Dpair_D1184, VPOINTER_PAIR);
  _V10_Dpair_D1190.first = _V0path;
  _V10_Dpair_D1190.rest = VEncodePointer(&_V10_Dpair_D1189, VPOINTER_PAIR);
  _V10_Dpair_D1189.first = _V0expr_D38;
  _V10_Dpair_D1189.rest = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D1188.first = _V0imports;
  _V10_Dpair_D1188.rest = VEncodePointer(&_V10_Dpair_D1187, VPOINTER_PAIR);
  _V10_Dpair_D1187.first = _V0expr_D39;
  _V10_Dpair_D1187.rest = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D1186.first = VEncodePointer(&_V10_Dpair_D706, VPOINTER_PAIR);
  _V10_Dpair_D1186.rest = VEncodePointer(&_V10_Dpair_D1185, VPOINTER_PAIR);
  _V10_Dpair_D1185.first = VEncodePointer(&_V10_Dpair_D1184, VPOINTER_PAIR);
  _V10_Dpair_D1185.rest = VNULL;
  _V10_Dpair_D1184.first = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D1184.rest = VEncodePointer(&_V10_Dpair_D1183, VPOINTER_PAIR);
  _V10_Dpair_D1183.first = VEncodePointer(&_V10_Dpair_D1177, VPOINTER_PAIR);
  _V10_Dpair_D1183.rest = VEncodePointer(&_V10_Dpair_D1180, VPOINTER_PAIR);
  _V10_Dpair_D1182.first = VEncodePointer(&_V10_Dpair_D1179, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1180.first = VEncodePointer(&_V10_Dpair_D1061, VPOINTER_PAIR);
  _V10_Dpair_D1180.rest = VEncodePointer(&_V10_Dpair_D1173, VPOINTER_PAIR);
  _V10_Dpair_D1179.first = VEncodeBool(false);
  ...
  _V10_Dpair_D1177.first = _V0_Mk;
  _V10_Dpair_D1177.rest = VEncodePointer(&_V10_Dpair_D1176, VPOINTER_PAIR);
  _V10_Dpair_D1176.first = _V0kk_D35;
  _V10_Dpair_D1176.rest = VNULL;
  _V10_Dpair_D1175.first = VEncodePointer(&_V10_Dpair_D1063, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1173.first = VEncodePointer(&_V10_Dpair_D704, VPOINTER_PAIR);
  _V10_Dpair_D1173.rest = VEncodePointer(&_V10_Dpair_D1169, VPOINTER_PAIR);
  _V10_Dpair_D1172.first = VEncodePointer(&_V10_Dpair_D706, VPOINTER_PAIR);
  _V10_Dpair_D1172.rest = VEncodePointer(&_V10_Dpair_D1170, VPOINTER_PAIR);
  _V10_Dpair_D1171.first = VEncodePointer(&_V10_Dpair_D711, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1169.first = VEncodePointer(&_V10_Dpair_D1162, VPOINTER_PAIR);
  _V10_Dpair_D1169.rest = VEncodePointer(&_V10_Dpair_D1168, VPOINTER_PAIR);
  _V10_Dpair_D1168.first = VEncodePointer(&_V10_Dpair_D1164, VPOINTER_PAIR);
  _V10_Dpair_D1168.rest = VEncodePointer(&_V10_Dpair_D1167, VPOINTER_PAIR);
  _V10_Dpair_D1167.first = VEncodePointer(&_V10_Dpair_D1165, VPOINTER_PAIR);
  _V10_Dpair_D1167.rest = VEncodePointer(&_V10_Dpair_D1166, VPOINTER_PAIR);
  _V10_Dpair_D1166.first = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D1166.rest = VEncodePointer(&_V10_Dpair_D1159, VPOINTER_PAIR);
  _V10_Dpair_D1165.first = _V0expr_D21;
  _V10_Dpair_D1165.rest = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D1164.first = _V0import;
  _V10_Dpair_D1164.rest = VEncodePointer(&_V10_Dpair_D1163, VPOINTER_PAIR);
  _V10_Dpair_D1163.first = _V0expr_D22;
  _V10_Dpair_D1163.rest = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D1162.first = _V0prefix;
  _V10_Dpair_D1162.rest = VEncodePointer(&_V10_Dpair_D849, VPOINTER_PAIR);
  _V10_Dpair_D1161.first = VEncodePointer(&_V10_Dpair_D791, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1159.first = VEncodePointer(&_V10_Dpair_D709, VPOINTER_PAIR);
  _V10_Dpair_D1159.rest = VEncodePointer(&_V10_Dpair_D1158, VPOINTER_PAIR);
  _V10_Dpair_D1158.first = VEncodePointer(&_V10_Dpair_D704, VPOINTER_PAIR);
  _V10_Dpair_D1158.rest = VEncodePointer(&_V10_Dpair_D1155, VPOINTER_PAIR);
  _V10_Dpair_D1157.first = VEncodePointer(&_V10_Dpair_D706, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1155.first = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D1155.rest = VEncodePointer(&_V10_Dpair_D1100, VPOINTER_PAIR);
  _V10_Dpair_D1154.first = VEncodePointer(&_V10_Dpair_D711, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1152.first = VEncodePointer(&_V10_Dpair_D709, VPOINTER_PAIR);
  _V10_Dpair_D1152.rest = VEncodePointer(&_V10_Dpair_D1151, VPOINTER_PAIR);
  _V10_Dpair_D1151.first = VEncodePointer(&_V10_Dpair_D1005, VPOINTER_PAIR);
  _V10_Dpair_D1151.rest = VEncodePointer(&_V10_Dpair_D1139, VPOINTER_PAIR);
  _V10_Dpair_D1150.first = VEncodePointer(&_V10_Dpair_D1096, VPOINTER_PAIR);
  _V10_Dpair_D1150.rest = VEncodePointer(&_V10_Dpair_D1140, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1147.first = VEncodePointer(&_V10_Dpair_D709, VPOINTER_PAIR);
  _V10_Dpair_D1147.rest = VEncodePointer(&_V10_Dpair_D1146, VPOINTER_PAIR);
  _V10_Dpair_D1146.first = VEncodePointer(&_V10_Dpair_D1005, VPOINTER_PAIR);
  _V10_Dpair_D1146.rest = VEncodePointer(&_V10_Dpair_D1142, VPOINTER_PAIR);
  _V10_Dpair_D1145.first = VEncodePointer(&_V10_Dpair_D1096, VPOINTER_PAIR);
  _V10_Dpair_D1145.rest = VEncodePointer(&_V10_Dpair_D1143, VPOINTER_PAIR);
  _V10_Dpair_D1144.first = VEncodePointer(&_V10_Dpair_D711, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1142.first = VEncodePointer(&_V10_Dpair_D709, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1139.first = VEncodePointer(&_V10_Dpair_D704, VPOINTER_PAIR);
  _V10_Dpair_D1139.rest = VEncodePointer(&_V10_Dpair_D1135, VPOINTER_PAIR);
  _V10_Dpair_D1138.first = VEncodePointer(&_V10_Dpair_D706, VPOINTER_PAIR);
  _V10_Dpair_D1138.rest = VEncodePointer(&_V10_Dpair_D1136, VPOINTER_PAIR);
  _V10_Dpair_D1137.first = VEncodePointer(&_V10_Dpair_D711, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1135.first = VEncodePointer(&_V10_Dpair_D1078, VPOINTER_PAIR);
  _V10_Dpair_D1135.rest = VEncodePointer(&_V10_Dpair_D1134, VPOINTER_PAIR);
  _V10_Dpair_D1134.first = VEncodePointer(&_V10_Dpair_D1129, VPOINTER_PAIR);
  _V10_Dpair_D1134.rest = VEncodePointer(&_V10_Dpair_D1133, VPOINTER_PAIR);
  _V10_Dpair_D1133.first = VEncodePointer(&_V10_Dpair_D1131, VPOINTER_PAIR);
  _V10_Dpair_D1133.rest = VEncodePointer(&_V10_Dpair_D1132, VPOINTER_PAIR);
  _V10_Dpair_D1132.first = VEncodePointer(&_V10_Dpair_D704, VPOINTER_PAIR);
  _V10_Dpair_D1132.rest = VEncodePointer(&_V10_Dpair_D1125, VPOINTER_PAIR);
  _V10_Dpair_D1131.first = _V0path;
  _V10_Dpair_D1131.rest = VEncodePointer(&_V10_Dpair_D1130, VPOINTER_PAIR);
  _V10_Dpair_D1130.first = _V0expr_D33;
  _V10_Dpair_D1130.rest = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D1129.first = _V0imports;
  _V10_Dpair_D1129.rest = VEncodePointer(&_V10_Dpair_D1128, VPOINTER_PAIR);
  _V10_Dpair_D1128.first = _V0expr_D34;
  _V10_Dpair_D1128.rest = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D1127.first = VEncodePointer(&_V10_Dpair_D706, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1125.first = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1121.first = VEncodePointer(&_V10_Dpair_D1061, VPOINTER_PAIR);
  _V10_Dpair_D1121.rest = VEncodePointer(&_V10_Dpair_D1114, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1117.first = _V0kk_D30;
  _V10_Dpair_D1117.rest = VNULL;
  _V10_Dpair_D1116.first = VEncodePointer(&_V10_Dpair_D1063, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1114.first = VEncodePointer(&_V10_Dpair_D704, VPOINTER_PAIR);
  _V10_Dpair_D1114.rest = VEncodePointer(&_V10_Dpair_D1110, VPOINTER_PAIR);
  _V10_Dpair_D1113.first = VEncodePointer(&_V10_Dpair_D706, VPOINTER_PAIR);
  _V10_Dpair_D1113.rest = VEncodePointer(&_V10_Dpair_D1111, VPOINTER_PAIR);
  _V10_Dpair_D1112.first = VEncodePointer(&_V10_Dpair_D711, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1110.first = VEncodePointer(&_V10_Dpair_D1053, VPOINTER_PAIR);
  _V10_Dpair_D1110.rest = VEncodePointer(&_V10_Dpair_D1109, VPOINTER_PAIR);
  _V10_Dpair_D1109.first = VEncodePointer(&_V10_Dpair_D1107, VPOINTER_PAIR);
  _V10_Dpair_D1109.rest = VEncodePointer(&_V10_Dpair_D1108, VPOINTER_PAIR);
  _V10_Dpair_D1108.first = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D1108.rest = VEncodePointer(&_V10_Dpair_D1104, VPOINTER_PAIR);
  _V10_Dpair_D1107.first = _V0expr_D19;
  _V10_Dpair_D1107.rest = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D1106.first = VEncodePointer(&_V10_Dpair_D791, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1104.first = VEncodePointer(&_V10_Dpair_D709, VPOINTER_PAIR);
  _V10_Dpair_D1104.rest = VEncodePointer(&_V10_Dpair_D1103, VPOINTER_PAIR);
  _V10_Dpair_D1103.first = VEncodePointer(&_V10_Dpair_D704, VPOINTER_PAIR);
  _V10_Dpair_D1103.rest = VEncodePointer(&_V10_Dpair_D1100, VPOINTER_PAIR);
  _V10_Dpair_D1102.first = VEncodePointer(&_V10_Dpair_D706, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1100.first = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D1100.rest = VEncodePointer(&_V10_Dpair_D1045, VPOINTER_PAIR);
  _V10_Dpair_D1098.first = VEncodePointer(&_V10_Dpair_D1096, VPOINTER_PAIR);
  _V10_Dpair_D1098.rest = VEncodePointer(&_V10_Dpair_D1091, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1096.first = VEncodeBool(false);
  _V10_Dpair_D1096.rest = VEncodePointer(&_V10_Dpair_D1006, VPOINTER_PAIR);
  _V10_Dpair_D1095.first = VEncodePointer(&_V10_Dpair_D711, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1093.first = VEncodePointer(&_V10_Dpair_D709, VPOINTER_PAIR);
  _V10_Dpair_D1093.rest = VEncodePointer(&_V10_Dpair_D1090, VPOINTER_PAIR);
  _V10_Dpair_D1092.first = VEncodePointer(&_V10_Dpair_D711, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1090.first = VEncodePointer(&_V10_Dpair_D704, VPOINTER_PAIR);
  _V10_Dpair_D1090.rest = VEncodePointer(&_V10_Dpair_D1086, VPOINTER_PAIR);
  _V10_Dpair_D1089.first = VEncodePointer(&_V10_Dpair_D706, VPOINTER_PAIR);
  _V10_Dpair_D1089.rest = VEncodePointer(&_V10_Dpair_D1087, VPOINTER_PAIR);
  _V10_Dpair_D1088.first = VEncodePointer(&_V10_Dpair_D711, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1086.first = VEncodePointer(&_V10_Dpair_D1078, VPOINTER_PAIR);
  _V10_Dpair_D1086.rest = VEncodePointer(&_V10_Dpair_D1085, VPOINTER_PAIR);
  _V10_Dpair_D1085.first = VEncodePointer(&_V10_Dpair_D1080, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1083.first = VEncodePointer(&_V10_Dpair_D704, VPOINTER_PAIR);
  _V10_Dpair_D1083.rest = VEncodePointer(&_V10_Dpair_D1075, VPOINTER_PAIR);
  _V10_Dpair_D1082.first = _V0path;
  _V10_Dpair_D1082.rest = VEncodePointer(&_V10_Dpair_D1081, VPOINTER_PAIR);
  _V10_Dpair_D1081.first = _V0expr_D28;
  _V10_Dpair_D1081.rest = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D1080.first = _V0imports;
  _V10_Dpair_D1080.rest = VEncodePointer(&_V10_Dpair_D1079, VPOINTER_PAIR);
  _V10_Dpair_D1079.first = _V0expr_D29;
  _V10_Dpair_D1079.rest = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D1078.first = _V0constant__imports;
  _V10_Dpair_D1078.rest = VEncodePointer(&_V10_Dpair_D849, VPOINTER_PAIR);
  _V10_Dpair_D1077.first = VEncodePointer(&_V10_Dpair_D706, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1075.first = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D1075.rest = VEncodePointer(&_V10_Dpair_D1074, VPOINTER_PAIR);
  _V10_Dpair_D1074.first = VEncodePointer(&_V10_Dpair_D1068, VPOINTER_PAIR);
  _V10_Dpair_D1074.rest = VEncodePointer(&_V10_Dpair_D1071, VPOINTER_PAIR);
  _V10_Dpair_D1073.first = VEncodePointer(&_V10_Dpair_D1070, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1071.first = VEncodePointer(&_V10_Dpair_D1061, VPOINTER_PAIR);
  _V10_Dpair_D1071.rest = VEncodePointer(&_V10_Dpair_D1064, VPOINTER_PAIR);
  _V10_Dpair_D1070.first = VEncodeBool(false);
  _V10_Dpair_D1070.rest = VEncodePointer(&_V10_Dpair_D1069, VPOINTER_PAIR);
  _V10_Dpair_D1069.first = VEncodePointer(&_V10_Dpair_D1068, VPOINTER_PAIR);
  _V10_Dpair_D1069.rest = VNULL;
  _V10_Dpair_D1068.first = _V0_Mk;
  _V10_Dpair_D1068.rest = VEncodePointer(&_V10_Dpair_D1067, VPOINTER_PAIR);
  _V10_Dpair_D1067.first = _V0kk_D25;
  _V10_Dpair_D1067.rest = VNULL;
  _V10_Dpair_D1066.first = VEncodePointer(&_V10_Dpair_D1063, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1064.first = VEncodePointer(&_V10_Dpair_D704, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1061.first = _V0resolved__import;
  _V10_Dpair_D1061.rest = VNULL;
  _V10_Dpair_D1060.first = VEncodePointer(&_V10_Dpair_D706, VPOINTER_PAIR);
  _V10_Dpair_D1060.rest = VEncodePointer(&_V10_Dpair_D1058, VPOINTER_PAIR);
  _V10_Dpair_D1059.first = VEncodePointer(&_V10_Dpair_D711, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1055.first = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D1055.rest = VEncodePointer(&_V10_Dpair_D1049, VPOINTER_PAIR);
  _V10_Dpair_D1054.first = _V0expr_D17;
  _V10_Dpair_D1054.rest = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D1053.first = _V0import;
  _V10_Dpair_D1053.rest = VEncodePointer(&_V10_Dpair_D1052, VPOINTER_PAIR);
  _V10_Dpair_D1052.first = _V0names;
  _V10_Dpair_D1052.rest = VNULL;
  _V10_Dpair_D1051.first = VEncodePointer(&_V10_Dpair_D791, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1049.first = VEncodePointer(&_V10_Dpair_D709, VPOINTER_PAIR);
  _V10_Dpair_D1049.rest = VEncodePointer(&_V10_Dpair_D1048, VPOINTER_PAIR);
  _V10_Dpair_D1048.first = VEncodePointer(&_V10_Dpair_D704, VPOINTER_PAIR);
  _V10_Dpair_D1048.rest = VEncodePointer(&_V10_Dpair_D1045, VPOINTER_PAIR);
  _V10_Dpair_D1047.first = VEncodePointer(&_V10_Dpair_D706, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1045.first = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D1045.rest = VEncodePointer(&_V10_Dpair_D1044, VPOINTER_PAIR);
  _V10_Dpair_D1044.first = VEncodePointer(&_V10_Dpair_D1040, VPOINTER_PAIR);
  _V10_Dpair_D1044.rest = VEncodePointer(&_V10_Dpair_D964, VPOINTER_PAIR);
  _V10_Dpair_D1043.first = VEncodePointer(&_V10_Dpair_D1042, VPOINTER_PAIR);
  _V10_Dpair_D1043.rest = VEncodePointer(&_V10_Dpair_D965, VPOINTER_PAIR);
  _V10_Dpair_D1042.first = VEncodeBool(false);
  ...
  _V10_Dpair_D1040.first = _V0_Mk;
  _V10_Dpair_D1040.rest = VEncodePointer(&_V10_Dpair_D1039, VPOINTER_PAIR);
  _V10_Dpair_D1039.first = _V0kk_D14;
  _V10_Dpair_D1039.rest = VNULL;
  _V10_Dpair_D1037.first = VEncodePointer(&_V10_Dpair_D706, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1035.first = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D1035.rest = VEncodePointer(&_V10_Dpair_D1020, VPOINTER_PAIR);
  _V10_Dpair_D1034.first = VEncodePointer(&_V10_Dpair_D706, VPOINTER_PAIR);
  _V10_Dpair_D1034.rest = VEncodePointer(&_V10_Dpair_D1032, VPOINTER_PAIR);
  _V10_Dpair_D1033.first = VEncodePointer(&_V10_Dpair_D711, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1031.first = VEncodePointer(&_V10_Dpair_D1024, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1029.first = VEncodePointer(&_V10_Dpair_D1027, VPOINTER_PAIR);
  _V10_Dpair_D1029.rest = VEncodePointer(&_V10_Dpair_D1028, VPOINTER_PAIR);
  _V10_Dpair_D1028.first = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D1028.rest = VEncodePointer(&_V10_Dpair_D1021, VPOINTER_PAIR);
  _V10_Dpair_D1027.first = _V0expr_D53;
  _V10_Dpair_D1027.rest = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D1026.first = _V0a;
  _V10_Dpair_D1026.rest = VEncodePointer(&_V10_Dpair_D1025, VPOINTER_PAIR);
  _V10_Dpair_D1025.first = _V0expr_D54;
  _V10_Dpair_D1025.rest = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D1024.first = _V0b;
  _V10_Dpair_D1024.rest = VEncodePointer(&_V10_Dpair_D849, VPOINTER_PAIR);
  _V10_Dpair_D1023.first = VEncodePointer(&_V10_Dpair_D791, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1021.first = VEncodePointer(&_V10_Dpair_D709, VPOINTER_PAIR);
  _V10_Dpair_D1021.rest = VEncodePointer(&_V10_Dpair_D1020, VPOINTER_PAIR);
  _V10_Dpair_D1020.first = VEncodePointer(&_V10_Dpair_D704, VPOINTER_PAIR);
  _V10_Dpair_D1020.rest = VEncodePointer(&_V10_Dpair_D1017, VPOINTER_PAIR);
  _V10_Dpair_D1019.first = VEncodePointer(&_V10_Dpair_D706, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1017.first = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D1017.rest = VEncodePointer(&_V10_Dpair_D1016, VPOINTER_PAIR);
  _V10_Dpair_D1016.first = VEncodePointer(&_V10_Dpair_D1010, VPOINTER_PAIR);
  _V10_Dpair_D1016.rest = VEncodePointer(&_V10_Dpair_D1013, VPOINTER_PAIR);
  _V10_Dpair_D1015.first = VEncodePointer(&_V10_Dpair_D1012, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1013.rest = VEncodePointer(&_V10_Dpair_D964, VPOINTER_PAIR);
  ...
  _V10_Dpair_D1010.first = _V0_Mk;
  _V10_Dpair_D1010.rest = VEncodePointer(&_V10_Dpair_D1009, VPOINTER_PAIR);
  _V10_Dpair_D1009.first = _V0kk_D50;
  _V10_Dpair_D1009.rest = VNULL;
  _V10_Dpair_D1008.first = VEncodePointer(&_V10_Dpair_D1007, VPOINTER_PAIR);
  _V10_Dpair_D1008.rest = VEncodePointer(&_V10_Dpair_D965, VPOINTER_PAIR);
  _V10_Dpair_D1007.first = VEncodePointer(&_V10_Dpair_D1003, VPOINTER_PAIR);
  ...
  _V10_Dpair_D995.first = VEncodePointer(&_V10_Dpair_D988, VPOINTER_PAIR);
  _V10_Dpair_D995.rest = VEncodePointer(&_V10_Dpair_D992, VPOINTER_PAIR);
  ...
  _V10_Dpair_D992.first = VEncodePointer(&_V10_Dpair_D848, VPOINTER_PAIR);
  _V10_Dpair_D992.rest = VEncodePointer(&_V10_Dpair_D991, VPOINTER_PAIR);
  _V10_Dpair_D991.first = VEncodePointer(&_V10_Dpair_D984, VPOINTER_PAIR);
  _V10_Dpair_D991.rest = VEncodePointer(&_V10_Dpair_D964, VPOINTER_PAIR);
  _V10_Dpair_D990.first = VEncodeBool(false);
  ...
  _V10_Dpair_D988.first = _V0x_D49;
  _V10_Dpair_D988.rest = VNULL;
  _V10_Dpair_D987.first = VEncodePointer(&_V10_Dpair_D986, VPOINTER_PAIR);
  _V10_Dpair_D987.rest = VEncodePointer(&_V10_Dpair_D965, VPOINTER_PAIR);
  _V10_Dpair_D986.first = VEncodePointer(&_V10_Dpair_D981, VPOINTER_PAIR);
  ...
  _V10_Dpair_D974.first = VEncodePointer(&_V10_Dpair_D709, VPOINTER_PAIR);
  _V10_Dpair_D974.rest = VEncodePointer(&_V10_Dpair_D971, VPOINTER_PAIR);
  _V10_Dpair_D973.first = VEncodePointer(&_V10_Dpair_D711, VPOINTER_PAIR);
  ...
  _V10_Dpair_D971.first = VEncodePointer(&_V10_Dpair_D709, VPOINTER_PAIR);
  _V10_Dpair_D971.rest = VEncodePointer(&_V10_Dpair_D968, VPOINTER_PAIR);
  _V10_Dpair_D970.first = VEncodePointer(&_V10_Dpair_D711, VPOINTER_PAIR);
  ...
  _V10_Dpair_D968.first = VEncodePointer(&_V10_Dpair_D848, VPOINTER_PAIR);
  _V10_Dpair_D968.rest = VEncodePointer(&_V10_Dpair_D967, VPOINTER_PAIR);
  _V10_Dpair_D967.first = VEncodePointer(&_V10_Dpair_D957, VPOINTER_PAIR);
  _V10_Dpair_D967.rest = VEncodePointer(&_V10_Dpair_D964, VPOINTER_PAIR);
  _V10_Dpair_D966.first = VEncodePointer(&_V10_Dpair_D959, VPOINTER_PAIR);
  ...
  _V10_Dpair_D964.first = VEncodePointer(&_V10_Dpair_D962, VPOINTER_PAIR);
  _V10_Dpair_D964.rest = VEncodePointer(&_V10_Dpair_D963, VPOINTER_PAIR);
  _V10_Dpair_D963.first = VEncodePointer(&_V10_Dpair_D946, VPOINTER_PAIR);
  _V10_Dpair_D963.rest = VEncodePointer(&_V10_Dpair_D773, VPOINTER_PAIR);
  _V10_Dpair_D962.first = _V0prefix__import;
  _V10_Dpair_D962.rest = VEncodePointer(&_V10_Dpair_D961, VPOINTER_PAIR);
  _V10_Dpair_D961.first = _V0rename__import;
  _V10_Dpair_D961.rest = VEncodePointer(&_V10_Dpair_D960, VPOINTER_PAIR);
  _V10_Dpair_D960.first = _V0process__export;
  _V10_Dpair_D960.rest = VNULL;
  _V10_Dpair_D959.first = VEncodePointer(&_V10_Dpair_D954, VPOINTER_PAIR);
  ...
  _V10_Dpair_D926.first = VEncodePointer(&_V10_Dpair_D709, VPOINTER_PAIR);
  _V10_Dpair_D926.rest = VEncodePointer(&_V10_Dpair_D925, VPOINTER_PAIR);
  _V10_Dpair_D925.first = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D925.rest = VEncodePointer(&_V10_Dpair_D924, VPOINTER_PAIR);
  _V10_Dpair_D924.first = VEncodePointer(&_V10_Dpair_D914, VPOINTER_PAIR);
  _V10_Dpair_D924.rest = VEncodePointer(&_V10_Dpair_D921, VPOINTER_PAIR);
  _V10_Dpair_D923.first = VEncodePointer(&_V10_Dpair_D916, VPOINTER_PAIR);
  ...
  _V10_Dpair_D921.first = VEncodePointer(&_V10_Dpair_D917, VPOINTER_PAIR);
  _V10_Dpair_D921.rest = VEncodePointer(&_V10_Dpair_D920, VPOINTER_PAIR);
  _V10_Dpair_D920.first = VEncodePointer(&_V10_Dpair_D918, VPOINTER_PAIR);
  _V10_Dpair_D920.rest = VEncodePointer(&_V10_Dpair_D919, VPOINTER_PAIR);
  _V10_Dpair_D919.first = VEncodePointer(&_V10_Dpair_D904, VPOINTER_PAIR);
  _V10_Dpair_D919.rest = VEncodePointer(&_V10_Dpair_D773, VPOINTER_PAIR);
  _V10_Dpair_D918.first = _V0len;
  _V10_Dpair_D918.rest = VNULL;
  _V10_Dpair_D917.first = _V0loop;
  _V10_Dpair_D917.rest = VNULL;
  _V10_Dpair_D916.first = VEncodePointer(&_V10_Dpair_D912, VPOINTER_PAIR);
  ...
  _V10_Dpair_D901.first = _V0compiler;
  _V10_Dpair_D901.rest = VEncodePointer(&_V10_Dpair_D900, VPOINTER_PAIR);
  _V10_Dpair_D900.first = _V0library;
  _V10_Dpair_D900.rest = VEncodePointer(&_V10_Dpair_D899, VPOINTER_PAIR);
  _V10_Dpair_D899.first = _V0acceptable__characters_Q;
  _V10_Dpair_D899.rest = VNULL;
  _V10_Dpair_D898.first = VEncodePointer(&_V10_Dpair_D897, VPOINTER_PAIR);
  _V10_Dpair_D898.rest = VEncodePointer(&_V10_Dpair_D774, VPOINTER_PAIR);
  _V10_Dpair_D897.first = VEncodePointer(&_V10_Dpair_D892, VPOINTER_PAIR);
  ...
  _V10_Dpair_D894.first = _V0a;
  _V10_Dpair_D894.rest = VEncodePointer(&_V10_Dpair_D893, VPOINTER_PAIR);
  _V10_Dpair_D893.first = _V0b;
  _V10_Dpair_D893.rest = VNULL;
  _V10_Dpair_D892.first = _V0vanity;
  _V10_Dpair_D892.rest = VEncodePointer(&_V10_Dpair_D891, VPOINTER_PAIR);
  _V10_Dpair_D891.first = _V0compiler;
  _V10_Dpair_D891.rest = VEncodePointer(&_V10_Dpair_D890, VPOINTER_PAIR);
  _V10_Dpair_D890.first = _V0library;
  _V10_Dpair_D890.rest = VEncodePointer(&_V10_Dpair_D889, VPOINTER_PAIR);
  _V10_Dpair_D889.first = _V0andf;
  _V10_Dpair_D889.rest = VNULL;
  _V10_Dpair_D888.first = VEncodePointer(&_V10_Dpair_D711, VPOINTER_PAIR);
  _V10_Dpair_D888.rest = VEncodePointer(&_V10_Dpair_D887, VPOINTER_PAIR);
  _V10_Dpair_D887.first = VEncodePointer(&_V10_Dpair_D886, VPOINTER_PAIR);
  _V10_Dpair_D887.rest = VNULL;
  _V10_Dpair_D886.first = VEncodePointer(&_V10_Dpair_D849, VPOINTER_PAIR);
  _V10_Dpair_D886.rest = VEncodePointer(&_V10_Dpair_D885, VPOINTER_PAIR);
  _V10_Dpair_D885.first = VEncodePointer(&_V10_Dpair_D709, VPOINTER_PAIR);
  _V10_Dpair_D885.rest = VEncodePointer(&_V10_Dpair_D882, VPOINTER_PAIR);
  _V10_Dpair_D884.first = VEncodePointer(&_V10_Dpair_D711, VPOINTER_PAIR);
  ...
  _V10_Dpair_D882.first = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D882.rest = VEncodePointer(&_V10_Dpair_D881, VPOINTER_PAIR);
  _V10_Dpair_D881.first = VEncodePointer(&_V10_Dpair_D877, VPOINTER_PAIR);
  _V10_Dpair_D881.rest = VEncodePointer(&_V10_Dpair_D773, VPOINTER_PAIR);
  _V10_Dpair_D880.first = VEncodePointer(&_V10_Dpair_D879, VPOINTER_PAIR);
  _V10_Dpair_D880.rest = VEncodePointer(&_V10_Dpair_D774, VPOINTER_PAIR);
  ...
  _V10_Dpair_D869.first = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D869.rest = VEncodePointer(&_V10_Dpair_D850, VPOINTER_PAIR);
  _V10_Dpair_D868.first = VEncodePointer(&_V10_Dpair_D867, VPOINTER_PAIR);
  _V10_Dpair_D868.rest = VEncodePointer(&_V10_Dpair_D774, VPOINTER_PAIR);
  _V10_Dpair_D867.first = VEncodePointer(&_V10_Dpair_D866, VPOINTER_PAIR);
  _V10_Dpair_D867.rest = VEncodePointer(&_V10_Dpair_D844, VPOINTER_PAIR);
  _V10_Dpair_D866.first = _V0vanity;
  _V10_Dpair_D866.rest = VEncodePointer(&_V10_Dpair_D865, VPOINTER_PAIR);
  _V10_Dpair_D865.first = _V0compiler;
  _V10_Dpair_D865.rest = VEncodePointer(&_V10_Dpair_D864, VPOINTER_PAIR);
  _V10_Dpair_D864.first = _V0library;
  _V10_Dpair_D864.rest = VEncodePointer(&_V10_Dpair_D863, VPOINTER_PAIR);
  _V10_Dpair_D863.first = _V0valid__import_Q;
  _V10_Dpair_D863.rest = VNULL;
  _V10_Dpair_D861.first = VEncodePointer(&_V10_Dpair_D860, VPOINTER_PAIR);
  _V10_Dpair_D861.rest = VEncodePointer(&_V10_Dpair_D774, VPOINTER_PAIR);
  _V10_Dpair_D860.first = VEncodePointer(&_V10_Dpair_D859, VPOINTER_PAIR);
  _V10_Dpair_D860.rest = VEncodePointer(&_V10_Dpair_D844, VPOINTER_PAIR);
  _V10_Dpair_D859.first = _V0vanity;
  _V10_Dpair_D859.rest = VEncodePointer(&_V10_Dpair_D858, VPOINTER_PAIR);
  _V10_Dpair_D858.first = _V0compiler;
  _V10_Dpair_D858.rest = VEncodePointer(&_V10_Dpair_D857, VPOINTER_PAIR);
  _V10_Dpair_D857.first = _V0library;
  _V10_Dpair_D857.rest = VEncodePointer(&_V10_Dpair_D856, VPOINTER_PAIR);
  _V10_Dpair_D856.first = _V0import___Gpath;
  _V10_Dpair_D856.rest = VNULL;
  _V10_Dpair_D854.first = VEncodePointer(&_V10_Dpair_D711, VPOINTER_PAIR);
  ...
  _V10_Dpair_D851.first = VEncodePointer(&_V10_Dpair_D849, VPOINTER_PAIR);
  _V10_Dpair_D851.rest = VEncodePointer(&_V10_Dpair_D850, VPOINTER_PAIR);
  _V10_Dpair_D850.first = VEncodePointer(&_V10_Dpair_D843, VPOINTER_PAIR);
  _V10_Dpair_D850.rest = VEncodePointer(&_V10_Dpair_D773, VPOINTER_PAIR);
  _V10_Dpair_D849.first = _V0_Mx;
  _V10_Dpair_D849.rest = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D848.first = _V0_Mx;
  _V10_Dpair_D848.rest = VEncodePointer(&_V10_Dpair_D709, VPOINTER_PAIR);
  _V10_Dpair_D846.first = VEncodePointer(&_V10_Dpair_D845, VPOINTER_PAIR);
  _V10_Dpair_D846.rest = VEncodePointer(&_V10_Dpair_D774, VPOINTER_PAIR);
  _V10_Dpair_D845.first = VEncodePointer(&_V10_Dpair_D841, VPOINTER_PAIR);
  ...
  _V10_Dpair_D835.first = VEncodePointer(&_V10_Dpair_D709, VPOINTER_PAIR);
  _V10_Dpair_D835.rest = VEncodePointer(&_V10_Dpair_D834, VPOINTER_PAIR);
  _V10_Dpair_D834.first = VEncodePointer(&_V10_Dpair_D709, VPOINTER_PAIR);
  _V10_Dpair_D834.rest = VEncodePointer(&_V10_Dpair_D831, VPOINTER_PAIR);
  _V10_Dpair_D833.first = VEncodePointer(&_V10_Dpair_D711, VPOINTER_PAIR);
  ...
  _V10_Dpair_D831.first = VEncodePointer(&_V10_Dpair_D704, VPOINTER_PAIR);
  _V10_Dpair_D831.rest = VEncodePointer(&_V10_Dpair_D827, VPOINTER_PAIR);
  _V10_Dpair_D830.first = VEncodePointer(&_V10_Dpair_D706, VPOINTER_PAIR);
  _V10_Dpair_D830.rest = VEncodePointer(&_V10_Dpair_D828, VPOINTER_PAIR);
  _V10_Dpair_D829.first = VEncodePointer(&_V10_Dpair_D711, VPOINTER_PAIR);
  ...
  _V10_Dpair_D827.first = VEncodePointer(&_V10_Dpair_D823, VPOINTER_PAIR);
  _V10_Dpair_D827.rest = VEncodePointer(&_V10_Dpair_D826, VPOINTER_PAIR);
  _V10_Dpair_D826.first = VEncodePointer(&_V10_Dpair_D824, VPOINTER_PAIR);
  _V10_Dpair_D826.rest = VEncodePointer(&_V10_Dpair_D825, VPOINTER_PAIR);
  _V10_Dpair_D825.first = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D825.rest = VEncodePointer(&_V10_Dpair_D819, VPOINTER_PAIR);
  _V10_Dpair_D824.first = _V0expr_D59;
  _V10_Dpair_D824.rest = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D823.first = _V0name;
  _V10_Dpair_D823.rest = VEncodePointer(&_V10_Dpair_D822, VPOINTER_PAIR);
  _V10_Dpair_D822.first = _V0body;
  _V10_Dpair_D822.rest = VNULL;
  _V10_Dpair_D821.first = VEncodePointer(&_V10_Dpair_D791, VPOINTER_PAIR);
  ...
  _V10_Dpair_D819.first = VEncodePointer(&_V10_Dpair_D709, VPOINTER_PAIR);
  _V10_Dpair_D819.rest = VEncodePointer(&_V10_Dpair_D818, VPOINTER_PAIR);
  _V10_Dpair_D818.first = VEncodePointer(&_V10_Dpair_D704, VPOINTER_PAIR);
  _V10_Dpair_D818.rest = VEncodePointer(&_V10_Dpair_D815, VPOINTER_PAIR);
  _V10_Dpair_D817.first = VEncodePointer(&_V10_Dpair_D706, VPOINTER_PAIR);
  _V10_Dpair_D817.rest = VEncodePointer(&_V10_Dpair_D816, VPOINTER_PAIR);
  _V10_Dpair_D816.first = VEncodePointer(&_V10_Dpair_D815, VPOINTER_PAIR);
  _V10_Dpair_D816.rest = VNULL;
  _V10_Dpair_D815.first = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D815.rest = VEncodePointer(&_V10_Dpair_D787, VPOINTER_PAIR);
  _V10_Dpair_D814.first = VEncodePointer(&_V10_Dpair_D810, VPOINTER_PAIR);
  ...
  _V10_Dpair_D812.first = _V0unquote;
  _V10_Dpair_D812.rest = VEncodePointer(&_V10_Dpair_D811, VPOINTER_PAIR);
  _V10_Dpair_D811.first = _V0unmangled__env;
  _V10_Dpair_D811.rest = VNULL;
  _V10_Dpair_D810.first = VEncodeBool(false);
  _V10_Dpair_D810.rest = VEncodePointer(&_V10_Dpair_D809, VPOINTER_PAIR);
  _V10_Dpair_D809.first = _V0_U;
  _V10_Dpair_D809.rest = VNULL;
  _V10_Dpair_D808.first = VEncodePointer(&_V10_Dpair_D711, VPOINTER_PAIR);
  ...
  _V10_Dpair_D806.first = VEncodePointer(&_V10_Dpair_D709, VPOINTER_PAIR);
  _V10_Dpair_D806.rest = VEncodePointer(&_V10_Dpair_D805, VPOINTER_PAIR);
  _V10_Dpair_D805.first = VEncodePointer(&_V10_Dpair_D709, VPOINTER_PAIR);
  _V10_Dpair_D805.rest = VEncodePointer(&_V10_Dpair_D802, VPOINTER_PAIR);
  _V10_Dpair_D804.first = VEncodePointer(&_V10_Dpair_D711, VPOINTER_PAIR);
  ...
  _V10_Dpair_D802.first = VEncodePointer(&_V10_Dpair_D704, VPOINTER_PAIR);
  _V10_Dpair_D802.rest = VEncodePointer(&_V10_Dpair_D798, VPOINTER_PAIR);
  _V10_Dpair_D801.first = VEncodePointer(&_V10_Dpair_D706, VPOINTER_PAIR);
  _V10_Dpair_D801.rest = VEncodePointer(&_V10_Dpair_D799, VPOINTER_PAIR);
  _V10_Dpair_D800.first = VEncodePointer(&_V10_Dpair_D711, VPOINTER_PAIR);
  ...
  _V10_Dpair_D797.first = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D797.rest = VEncodePointer(&_V10_Dpair_D793, VPOINTER_PAIR);
  _V10_Dpair_D796.first = _V0libs;
  _V10_Dpair_D796.rest = VNULL;
  _V10_Dpair_D795.first = VEncodePointer(&_V10_Dpair_D791, VPOINTER_PAIR);
  ...
  _V10_Dpair_D793.first = VEncodePointer(&_V10_Dpair_D709, VPOINTER_PAIR);
  _V10_Dpair_D793.rest = VEncodePointer(&_V10_Dpair_D792, VPOINTER_PAIR);
  _V10_Dpair_D792.first = VEncodePointer(&_V10_Dpair_D704, VPOINTER_PAIR);
  _V10_Dpair_D792.rest = VEncodePointer(&_V10_Dpair_D787, VPOINTER_PAIR);
  _V10_Dpair_D791.first = VEncodeBool(false);
  _V10_Dpair_D791.rest = VEncodePointer(&_V10_Dpair_D790, VPOINTER_PAIR);
  _V10_Dpair_D790.first = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D790.rest = VNULL;
  _V10_Dpair_D789.first = VEncodePointer(&_V10_Dpair_D706, VPOINTER_PAIR);
  ...
  _V10_Dpair_D787.first = VEncodePointer(&_V10_Dpair_D785, VPOINTER_PAIR);
  _V10_Dpair_D787.rest = VEncodePointer(&_V10_Dpair_D786, VPOINTER_PAIR);
  _V10_Dpair_D786.first = VEncodePointer(&_V10_Dpair_D777, VPOINTER_PAIR);
  _V10_Dpair_D786.rest = VEncodePointer(&_V10_Dpair_D782, VPOINTER_PAIR);
  _V10_Dpair_D785.first = _V0input_D56;
  _V10_Dpair_D785.rest = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D784.first = VEncodePointer(&_V10_Dpair_D779, VPOINTER_PAIR);
  ...
  _V10_Dpair_D782.first = VEncodePointer(&_V10_Dpair_D780, VPOINTER_PAIR);
  _V10_Dpair_D782.rest = VEncodePointer(&_V10_Dpair_D781, VPOINTER_PAIR);
  _V10_Dpair_D781.first = VEncodePointer(&_V10_Dpair_D752, VPOINTER_PAIR);
  _V10_Dpair_D781.rest = VEncodePointer(&_V10_Dpair_D773, VPOINTER_PAIR);
  _V10_Dpair_D780.first = _V0_Mp;
  ...
  _V10_Dpair_D777.first = _V0_Mk;
  _V10_Dpair_D777.rest = VEncodePointer(&_V10_Dpair_D776, VPOINTER_PAIR);
  _V10_Dpair_D776.first = _V0kk_D55;
  _V10_Dpair_D776.rest = VNULL;
  _V10_Dpair_D775.first = VEncodePointer(&_V10_Dpair_D754, VPOINTER_PAIR);
  ...
  _V10_Dpair_D744.first = VEncodePointer(&_V10_Dpair_D709, VPOINTER_PAIR);
  _V10_Dpair_D744.rest = VEncodePointer(&_V10_Dpair_D720, VPOINTER_PAIR);
  ...
  _V10_Dpair_D720.first = VEncodePointer(&_V10_Dpair_D709, VPOINTER_PAIR);
  _V10_Dpair_D720.rest = VEncodePointer(&_V10_Dpair_D717, VPOINTER_PAIR);
  _V10_Dpair_D719.first = VEncodePointer(&_V10_Dpair_D711, VPOINTER_PAIR);
  _V10_Dpair_D719.rest = VEncodePointer(&_V10_Dpair_D718, VPOINTER_PAIR);
  _V10_Dpair_D718.first = VEncodePointer(&_V10_Dpair_D717, VPOINTER_PAIR);
  _V10_Dpair_D718.rest = VNULL;
  _V10_Dpair_D717.first = VEncodePointer(&_V10_Dpair_D709, VPOINTER_PAIR);
  _V10_Dpair_D717.rest = VEncodePointer(&_V10_Dpair_D714, VPOINTER_PAIR);
  _V10_Dpair_D716.first = VEncodePointer(&_V10_Dpair_D711, VPOINTER_PAIR);
  _V10_Dpair_D716.rest = VEncodePointer(&_V10_Dpair_D715, VPOINTER_PAIR);
  _V10_Dpair_D715.first = VEncodePointer(&_V10_Dpair_D714, VPOINTER_PAIR);
  _V10_Dpair_D715.rest = VNULL;
  _V10_Dpair_D714.first = VEncodePointer(&_V10_Dpair_D709, VPOINTER_PAIR);
  _V10_Dpair_D714.rest = VEncodePointer(&_V10_Dpair_D705, VPOINTER_PAIR);
  _V10_Dpair_D713.first = VEncodePointer(&_V10_Dpair_D711, VPOINTER_PAIR);
  _V10_Dpair_D713.rest = VEncodePointer(&_V10_Dpair_D712, VPOINTER_PAIR);
  _V10_Dpair_D712.first = VEncodePointer(&_V10_Dpair_D705, VPOINTER_PAIR);
  ...
  _V10_Dpair_D708.first = VEncodePointer(&_V10_Dpair_D706, VPOINTER_PAIR);
  _V10_Dpair_D708.rest = VEncodePointer(&_V10_Dpair_D707, VPOINTER_PAIR);
  _V10_Dpair_D707.first = VNULL;
  _V10_Dpair_D707.rest = VNULL;
  _V10_Dpair_D706.first = VEncodeBool(false);
  ...
  _V10_Dpair_D704.first = _V0_Mk;
  _V10_Dpair_D704.rest = VNULL;
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0gather__dependencies_V0k7, VEncodePointer(&_V10_Dpair_D800, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0gather__dependencies_V0k9, VEncodePointer(&_V10_Dpair_D808, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0gather__dependencies_V0k8, VEncodePointer(&_V10_Dpair_D804, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0gather__dependencies_V0lambda4, VEncodePointer(&_V10_Dpair_D801, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0gather__dependencies_V0k6, VEncodePointer(&_V10_Dpair_D795, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0gather__dependencies_V0k5, VEncodePointer(&_V10_Dpair_D789, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0gather__dependencies_V0k13, VEncodePointer(&_V10_Dpair_D829, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0gather__dependencies_V0k15, VEncodePointer(&_V10_Dpair_D837, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0gather__dependencies_V0k14, VEncodePointer(&_V10_Dpair_D833, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0gather__dependencies_V0lambda5, VEncodePointer(&_V10_Dpair_D830, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0gather__dependencies_V0k12, VEncodePointer(&_V10_Dpair_D821, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0gather__dependencies_V0k11, VEncodePointer(&_V10_Dpair_D817, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0gather__dependencies_V0lambda6, VEncodePointer(&_V10_Dpair_D817, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0gather__dependencies_V0k16, VEncodePointer(&_V10_Dpair_D814, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0gather__dependencies_V0k10, VEncodePointer(&_V10_Dpair_D814, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0gather__dependencies_V0lambda3, VEncodePointer(&_V10_Dpair_D784, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0gather__dependencies, VEncodePointer(&_V10_Dpair_D775, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0import__basepath_V0k17, VEncodePointer(&_V10_Dpair_D854, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0import__basepath, VEncodePointer(&_V10_Dpair_D846, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0import___Gpath_V0k18, VEncodePointer(&_V10_Dpair_D854, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0import___Gpath, VEncodePointer(&_V10_Dpair_D861, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0valid__import_Q_V0k19, VEncodePointer(&_V10_Dpair_D871, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0valid__import_Q, VEncodePointer(&_V10_Dpair_D868, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0valid__import__element_Q_V0k21, VEncodePointer(&_V10_Dpair_D888, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0valid__import__element_Q_V0k20, VEncodePointer(&_V10_Dpair_D884, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0valid__import__element_Q, VEncodePointer(&_V10_Dpair_D880, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0andf, VEncodePointer(&_V10_Dpair_D898, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0acceptable__characters_Q_V10_Dloop_D130_V0k22, VEncodePointer(&_V10_Dpair_D928, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0acceptable__characters_Q_V10_Dloop_D130, VEncodePointer(&_V10_Dpair_D923, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0acceptable__characters_Q, VEncodePointer(&_V10_Dpair_D907, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0acceptable__char_Q, VEncodePointer(&_V10_Dpair_D937, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V10_Dprefix__import_D136_V0k25, VEncodePointer(&_V10_Dpair_D976, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V10_Dprefix__import_D136_V0k24, VEncodePointer(&_V10_Dpair_D973, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V10_Dprefix__import_D136_V0k23, VEncodePointer(&_V10_Dpair_D970, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V10_Dprefix__import_D136, VEncodePointer(&_V10_Dpair_D966, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V10_Drename__import_D137_V0k27, VEncodePointer(&_V10_Dpair_D997, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V10_Drename__import_D137_V0k28, VEncodePointer(&_V10_Dpair_D998, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V10_Drename__import_D137_V0k26, VEncodePointer(&_V10_Dpair_D994, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V10_Drename__import_D137, VEncodePointer(&_V10_Dpair_D987, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V10_Dprocess__export_D138_V0k31, VEncodePointer(&_V10_Dpair_D1033, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V10_Dprocess__export_D138_V0lambda8, VEncodePointer(&_V10_Dpair_D1034, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V10_Dprocess__export_D138_V0k30, VEncodePointer(&_V10_Dpair_D1023, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V10_Dprocess__export_D138_V0k29, VEncodePointer(&_V10_Dpair_D1019, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V10_Dprocess__export_D138_V0k33, VEncodePointer(&_V10_Dpair_D1037, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V10_Dprocess__export_D138_V0k34, VEncodePointer(&_V10_Dpair_D814, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V10_Dprocess__export_D138_V0lambda9, VEncodePointer(&_V10_Dpair_D1019, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V10_Dprocess__export_D138_V0k32, VEncodePointer(&_V10_Dpair_D814, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V10_Dprocess__export_D138_V0lambda7, VEncodePointer(&_V10_Dpair_D1015, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V10_Dprocess__export_D138, VEncodePointer(&_V10_Dpair_D1008, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k37, VEncodePointer(&_V10_Dpair_D1059, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k40, VEncodePointer(&_V10_Dpair_D1088, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k42, VEncodePointer(&_V10_Dpair_D1095, VPOINTER_PAIR));
  ...
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k41, VEncodePointer(&_V10_Dpair_D1092, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0lambda15, VEncodePointer(&_V10_Dpair_D1098, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0lambda13, VEncodePointer(&_V10_Dpair_D1089, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k39, VEncodePointer(&_V10_Dpair_D1077, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k43, VEncodePointer(&_V10_Dpair_D814, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0lambda12, VEncodePointer(&_V10_Dpair_D1073, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k38, VEncodePointer(&_V10_Dpair_D1066, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0lambda11, VEncodePointer(&_V10_Dpair_D1060, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k36, VEncodePointer(&_V10_Dpair_D1051, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k35, VEncodePointer(&_V10_Dpair_D1047, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k47, VEncodePointer(&_V10_Dpair_D1112, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k50, VEncodePointer(&_V10_Dpair_D1137, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k52, VEncodePointer(&_V10_Dpair_D1144, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k53, VEncodePointer(&_V10_Dpair_D1149, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0lambda19, VEncodePointer(&_V10_Dpair_D1145, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k51, VEncodePointer(&_V10_Dpair_D1141, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k54, VEncodePointer(&_V10_Dpair_D1154, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0lambda20, VEncodePointer(&_V10_Dpair_D1150, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0lambda18, VEncodePointer(&_V10_Dpair_D1138, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k49, VEncodePointer(&_V10_Dpair_D1127, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k55, VEncodePointer(&_V10_Dpair_D814, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0lambda17, VEncodePointer(&_V10_Dpair_D1123, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k48, VEncodePointer(&_V10_Dpair_D1116, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0lambda16, VEncodePointer(&_V10_Dpair_D1113, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k46, VEncodePointer(&_V10_Dpair_D1106, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k45, VEncodePointer(&_V10_Dpair_D1102, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k59, VEncodePointer(&_V10_Dpair_D1171, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k62, VEncodePointer(&_V10_Dpair_D1196, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k65, VEncodePointer(&_V10_Dpair_D1209, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0lambda24, VEncodePointer(&_V10_Dpair_D1214, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k64, VEncodePointer(&_V10_Dpair_D1206, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0lambda25, VEncodePointer(&_V10_Dpair_D1219, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k63, VEncodePointer(&_V10_Dpair_D1203, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0lambda23, VEncodePointer(&_V10_Dpair_D1197, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k61, VEncodePointer(&_V10_Dpair_D1186, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k66, VEncodePointer(&_V10_Dpair_D814, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0lambda22, VEncodePointer(&_V10_Dpair_D1182, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k60, VEncodePointer(&_V10_Dpair_D1175, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0lambda21, VEncodePointer(&_V10_Dpair_D1172, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k58, VEncodePointer(&_V10_Dpair_D1161, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k57, VEncodePointer(&_V10_Dpair_D1157, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k70, VEncodePointer(&_V10_Dpair_D1232, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k73, VEncodePointer(&_V10_Dpair_D1257, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k75, VEncodePointer(&_V10_Dpair_D1264, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0lambda29, VEncodePointer(&_V10_Dpair_D1269, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k74, VEncodePointer(&_V10_Dpair_D1261, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0lambda30, VEncodePointer(&_V10_Dpair_D1274, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0lambda28, VEncodePointer(&_V10_Dpair_D1258, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k72, VEncodePointer(&_V10_Dpair_D1247, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k76, VEncodePointer(&_V10_Dpair_D814, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0lambda27, VEncodePointer(&_V10_Dpair_D1243, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k71, VEncodePointer(&_V10_Dpair_D1236, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0lambda26, VEncodePointer(&_V10_Dpair_D1233, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k69, VEncodePointer(&_V10_Dpair_D1226, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k68, VEncodePointer(&_V10_Dpair_D1222, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k82, VEncodePointer(&_V10_Dpair_D1291, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k83, VEncodePointer(&_V10_Dpair_D1295, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0lambda32, VEncodePointer(&_V10_Dpair_D1292, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k81, VEncodePointer(&_V10_Dpair_D1288, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k80, VEncodePointer(&_V10_Dpair_D1285, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k79, VEncodePointer(&_V10_Dpair_D1282, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k78, VEncodePointer(&_V10_Dpair_D1279, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0lambda31, VEncodePointer(&_V10_Dpair_D1222, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k77, VEncodePointer(&_V10_Dpair_D814, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k67, VEncodePointer(&_V10_Dpair_D814, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k56, VEncodePointer(&_V10_Dpair_D814, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0k44, VEncodePointer(&_V10_Dpair_D814, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B_V0lambda10, VEncodePointer(&_V10_Dpair_D1043, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0process__import_B, VEncodePointer(&_V10_Dpair_D949, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0extract__constants_V0k85, VEncodePointer(&_V10_Dpair_D1312, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0extract__constants_V0k84, VEncodePointer(&_V10_Dpair_D1306, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0extract__constants, VEncodePointer(&_V10_Dpair_D1303, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0extract__exports_V0k87, VEncodePointer(&_V10_Dpair_D1322, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0extract__exports_V0k86, VEncodePointer(&_V10_Dpair_D1306, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0extract__exports, VEncodePointer(&_V10_Dpair_D1318, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0find__library__interface_B_V0k88, VEncodePointer(&_V10_Dpair_D1333, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0find__library__interface_B, VEncodePointer(&_V10_Dpair_D1328, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0import__path_V0k91, VEncodePointer(&_V10_Dpair_D1359, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0import__path_V0lambda34, VEncodePointer(&_V10_Dpair_D1360, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0import__path_V0k90, VEncodePointer(&_V10_Dpair_D1353, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0import__path_V0k89, VEncodePointer(&_V10_Dpair_D1349, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0import__path_V0k95, VEncodePointer(&_V10_Dpair_D1373, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0import__path_V0lambda35, VEncodePointer(&_V10_Dpair_D1374, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0import__path_V0k94, VEncodePointer(&_V10_Dpair_D1367, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0import__path_V0k93, VEncodePointer(&_V10_Dpair_D1363, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0import__path_V0k99, VEncodePointer(&_V10_Dpair_D1390, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0import__path_V0lambda36, VEncodePointer(&_V10_Dpair_D1391, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0import__path_V0k98, VEncodePointer(&_V10_Dpair_D1381, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0import__path_V0k97, VEncodePointer(&_V10_Dpair_D1377, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0import__path_V0k103, VEncodePointer(&_V10_Dpair_D1404, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0import__path_V0lambda37, VEncodePointer(&_V10_Dpair_D1405, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0import__path_V0k102, VEncodePointer(&_V10_Dpair_D1398, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0import__path_V0k101, VEncodePointer(&_V10_Dpair_D1394, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0import__path_V0lambda38, VEncodePointer(&_V10_Dpair_D1394, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0import__path_V0k104, VEncodePointer(&_V10_Dpair_D814, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0import__path_V0k100, VEncodePointer(&_V10_Dpair_D814, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0import__path_V0k96, VEncodePointer(&_V10_Dpair_D814, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0import__path_V0k92, VEncodePointer(&_V10_Dpair_D814, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0import__path_V0lambda33, VEncodePointer(&_V10_Dpair_D1345, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0import__path, VEncodePointer(&_V10_Dpair_D1339, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0register__library__interface_B_V0k108, VEncodePointer(&_V10_Dpair_D1418, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0register__library__interface_B_V0k107, VEncodePointer(&_V10_Dpair_D1415, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0register__library__interface_B_V0k109, VEncodePointer(&_V10_Dpair_D1415, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0register__library__interface_B_V0k106, VEncodePointer(&_V10_Dpair_D1412, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0register__library__interface_B_V0k105, VEncodePointer(&_V10_Dpair_D1306, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0register__library__interface_B, VEncodePointer(&_V10_Dpair_D1411, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0library__exists_Q_V0k111, VEncodePointer(&_V10_Dpair_D1428, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0library__exists_Q_V0k110, VEncodePointer(&_V10_Dpair_D1425, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0library__exists_Q, VEncodePointer(&_V10_Dpair_D1424, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0load__library__interface_V0k114, VEncodePointer(&_V10_Dpair_D1444, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0load__library__interface_V0k116, VEncodePointer(&_V10_Dpair_D1453, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0load__library__interface_V0k118, VEncodePointer(&_V10_Dpair_D1457, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0load__library__interface_V0k121, VEncodePointer(&_V10_Dpair_D814, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0load__library__interface_V0k120, VEncodePointer(&_V10_Dpair_D814, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0load__library__interface_V0k119, VEncodePointer(&_V10_Dpair_D1459, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0load__library__interface_V0k117, VEncodePointer(&_V10_Dpair_D1454, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0load__library__interface_V0k115, VEncodePointer(&_V10_Dpair_D1449, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0load__library__interface_V0k113, VEncodePointer(&_V10_Dpair_D1441, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0load__library__interface_V0k112, VEncodePointer(&_V10_Dpair_D1435, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0compiler_V0library_V0load__library__interface, VEncodePointer(&_V10_Dpair_D1434, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0compiler_V0library_V20_V0k122, VEncodePointer(&_V10_Dpair_D814, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0compiler_V0library_V20_V0lambda2, VEncodePointer(&_V10_Dpair_D746, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0compiler_V0library_V20_V0k4, VEncodePointer(&_V10_Dpair_D722, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0compiler_V0library_V20_V0k3, VEncodePointer(&_V10_Dpair_D719, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0compiler_V0library_V20_V0k2, VEncodePointer(&_V10_Dpair_D716, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0compiler_V0library_V20_V0k1, VEncodePointer(&_V10_Dpair_D713, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0compiler_V0library_V20_V0lambda1, VEncodePointer(&_V10_Dpair_D708, VPOINTER_PAIR));
}
