...
#include <stdarg.h>
static struct { VBlob sym; char bytes[21]; } _V10string_D79 = { { .base = { .tag = VSTRING }, 21 }, "_V0vanity_V0core_V20" };
static struct { VBlob sym; char bytes[33]; } _V10string_D78 = { { .base = { .tag = VSTRING }, 33 }, "_V0vanity_V0compiler_V0utils_V20" };
...
static struct { VBlob sym; char bytes[2]; } _V10string_D77 = { { .base = { .tag = VSTRING }, 2 }, "/" };
static struct { VBlob sym; char bytes[19]; } _V10string_D76 = { { .base = { .tag = VSTRING }, 19 }, "vsc: fatal error: " };
static struct { VBlob sym; char bytes[2]; } _V10string_D75 = { { .base = { .tag = VSTRING }, 2 }, ":" };
static struct { VBlob sym; char bytes[2]; } _V10string_D74 = { { .base = { .tag = VSTRING }, 2 }, " " };
...
static struct { VBlob sym; char bytes[8]; } _V10string_D73 = { { .base = { .tag = VSTRING }, 8 }, "##~A.~A" };
