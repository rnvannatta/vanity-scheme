...
static struct { VBlob sym; char bytes[21]; } _V10_Dstring_D507 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 21 }, "_V0vanity_V0core_V20" };
static struct { VBlob sym; char bytes[30]; } _V10_Dstring_D506 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 30 }, "_V0vanity_V0pretty__print_V20" };
...
static struct { VBlob sym; char bytes[3]; } _V10_Dstring_D401 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 3 }, ",@" };
static VPair _V10_Dpair_D400 = { .base = { .tag = VPAIR, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, };
static struct { VBlob sym; char bytes[2]; } _V10_Dstring_D399 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 2 }, "," };
static VPair _V10_Dpair_D398 = { .base = { .tag = VPAIR, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, };
static struct { VBlob sym; char bytes[2]; } _V10_Dstring_D397 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 2 }, "`" };
...
static struct { VBlob sym; char bytes[2]; } _V10_Dstring_D395 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 2 }, "'" };
...
static struct { VBlob sym; char bytes[2]; } _V10_Dstring_D345 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 2 }, "(" };
static struct { VBlob sym; char bytes[3]; } _V10_Dstring_D344 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 3 }, ". " };
...
static struct { VBlob sym; char bytes[2]; } _V10_Dstring_D324 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 2 }, " " };
...
static struct { VBlob sym; char bytes[2]; } _V10_Dstring_D314 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 2 }, ")" };
...
void _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D40_V0k21(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 ...
 if(argc != 1) {
  ...
  // (if (bruijn ##.%p.95 1 0) ((bruijn ##.display.5 16 3) (bruijn ##.%k.96 0 0) (##string ##.string.324)) ((bruijn ##.newline.4 16 2) (bruijn ##.%k.96 0 0)))
if(VDecodeBool(
statics->vars[0])) {
...
void _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D40_V0k25(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 ...
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // (if (bruijn ##.first-elem.42 5 2) (basic-block 1 1 (##.%x.164) ((##vcore.car (bruijn ##.expr.31 16 1))) ((bruijn ##.memv.2 18 0) (bruijn ##.%k.92 1 0) (bruijn ##.%x.164 0 0) '(##pair ##.pair.331))) ((bruijn ##.%k.92 0 0) #f))
if(VDecodeBool(
VGetArg(statics, 5-1, 2))) {
    ...
    VCallDecodedWithGC(runtime, VDecodeClosureApply2(runtime, VGetArg(statics, 18-1, 0)), 3,
      statics->vars[0],
      self->vars[0],
      VEncodePointer(&_V10_Dpair_D331, VPOINTER_PAIR));
    }
} else {
    VCallDecodedWithGC(runtime, VDecodeClosureApply2(runtime, _var0), 1,
      VEncodeBool(false));
...
static void _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D40_V0k35(VRuntime * runtime, VEnv * statics, int argc) {
  VEnv * self = statics;
  statics = self ? self->up : NULL;
  // ((bruijn ##.display.5 16 3) (bruijn ##.%k.77 4 0) (##string ##.string.314))
    VCallDecodedWithGC(runtime, VDecodeClosureApply2(runtime, VGetArg(statics, 16-1, 3)), 2,
...
static void _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D40_V0k33(VRuntime * runtime, VEnv * statics, int argc) {
  VEnv * self = statics;
  statics = self ? self->up : NULL;
  // ((bruijn ##.display.5 15 3) (close _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D40_V0k34) (##string ##.string.344))
...
void _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k6(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 ...
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // (if (bruijn ##.x.1.35 0 0) ((bruijn ##.display.5 5 3) (close _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k7) (bruijn ##.x.1.35 0 0)) ((bruijn ##.display.5 5 3) (close _V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k11) (##string ##.string.345)))
if(VDecodeBool(
_var0)) {
...
void _V50_V0vanity_V0pretty__print_V0join__line_Q(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0, VWORD _var1) {
 ...
 if(argc != 2) {
  ...
  self->vars[0] = _var0;
  self->vars[1] = _var1;
  // ((bruijn ##.assv.8 2 6) (close _V50_V0vanity_V0pretty__print_V0join__line_Q_V0k36) (bruijn ##.form.45 0 1) '(##pair ##.pair.377))
...
void _V50_V0vanity_V0pretty__print_V0quotation_Q(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0, VWORD _var1) {
 ...
 if(argc != 2) {
  ...
  self->vars[0] = _var0;
  self->vars[1] = _var1;
  // (basic-block 1 1 (##.%x.171) ((##vcore.car (bruijn ##.expr.48 1 1))) ((bruijn ##.assv.8 3 6) (close _V50_V0vanity_V0pretty__print_V0quotation_Q_V0k38) (bruijn ##.%x.171 0 0) '(##pair ##.pair.406)))
    {
    VEnv * statics = self;
    struct { VEnv self; VWORD argv[1]; } container;
    self = &container.self;
    ...
    VCallDecodedWithGC(runtime, VDecodeClosureApply2(runtime, statics->up->up->vars[6]), 3,
      ...
      self->vars[0],
      VEncodePointer(&_V10_Dpair_D406, VPOINTER_PAIR));
    }
}
...
void _V50_V0vanity_V0pretty__print_V0short_Q_V0lambda3(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0, VWORD _var1) {
 static VDebugInfo dbg = { "_V50_V0vanity_V0pretty__print_V0short_Q_V0lambda3" };
 VRecordCall2(runtime, &dbg);
 if(argc != 2) {
...
static void _V0vanity_V0pretty__print_V20_V0k2(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 ...
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // ((##intrinsic "VMultiImport") (close _V0vanity_V0pretty__print_V20_V0lambda2) (##string ##.string.506) (bruijn ##.%x.146 0 0) 'memv 'max 'newline 'display 'cadr 'write 'assv 'close-port 'get-output-string 'open-output-string)
...
static void _V0vanity_V0pretty__print_V20_V0lambda1(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 ...
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // (##vcore.load-library (close _V0vanity_V0pretty__print_V20_V0k1) (##string ##.string.507))
...
static __attribute__((constructor)) void VDllMain1() {
  ...
  _V10_Dpair_D505.first = VEncodePointer(&_V10_Dpair_D504, VPOINTER_PAIR);
  _V10_Dpair_D505.rest = VEncodePointer(&_V10_Dpair_D242, VPOINTER_PAIR);
  _V10_Dpair_D504.first = VEncodePointer(&_V10_Dpair_D500, VPOINTER_PAIR);
  ...
  _V10_Dpair_D502.first = _V0_Mk;
  _V10_Dpair_D502.rest = VEncodePointer(&_V10_Dpair_D501, VPOINTER_PAIR);
  _V10_Dpair_D501.first = _V0i;
  _V10_Dpair_D501.rest = VNULL;
  _V10_Dpair_D500.first = _V0vanity;
  _V10_Dpair_D500.rest = VEncodePointer(&_V10_Dpair_D499, VPOINTER_PAIR);
  _V10_Dpair_D499.first = _V0pretty__print;
  _V10_Dpair_D499.rest = VEncodePointer(&_V10_Dpair_D232, VPOINTER_PAIR);
  _V10_Dpair_D498.first = VEncodePointer(&_V10_Dpair_D497, VPOINTER_PAIR);
  _V10_Dpair_D498.rest = VEncodePointer(&_V10_Dpair_D242, VPOINTER_PAIR);
  _V10_Dpair_D497.first = VEncodePointer(&_V10_Dpair_D496, VPOINTER_PAIR);
  _V10_Dpair_D497.rest = VEncodePointer(&_V10_Dpair_D383, VPOINTER_PAIR);
  _V10_Dpair_D496.first = _V0vanity;
  _V10_Dpair_D496.rest = VEncodePointer(&_V10_Dpair_D495, VPOINTER_PAIR);
  _V10_Dpair_D495.first = _V0pretty__print;
  _V10_Dpair_D495.rest = VEncodePointer(&_V10_Dpair_D494, VPOINTER_PAIR);
  _V10_Dpair_D494.first = _V0atom_Q;
  _V10_Dpair_D494.rest = VNULL;
  _V10_Dpair_D493.first = VEncodePointer(&_V10_Dpair_D201, VPOINTER_PAIR);
  ...
  _V10_Dpair_D491.first = VEncodePointer(&_V10_Dpair_D486, VPOINTER_PAIR);
  _V10_Dpair_D491.rest = VEncodePointer(&_V10_Dpair_D391, VPOINTER_PAIR);
  _V10_Dpair_D490.first = VEncodePointer(&_V10_Dpair_D488, VPOINTER_PAIR);
  _V10_Dpair_D490.rest = VEncodePointer(&_V10_Dpair_D489, VPOINTER_PAIR);
  _V10_Dpair_D489.first = VEncodePointer(&_V10_Dpair_D391, VPOINTER_PAIR);
  _V10_Dpair_D489.rest = VNULL;
  _V10_Dpair_D488.first = VEncodeBool(false);
  ...
  _V10_Dpair_D477.first = _V0len;
  _V10_Dpair_D477.rest = VNULL;
  _V10_Dpair_D476.first = VEncodePointer(&_V10_Dpair_D201, VPOINTER_PAIR);
  ...
  _V10_Dpair_D474.first = VEncodePointer(&_V10_Dpair_D199, VPOINTER_PAIR);
  _V10_Dpair_D474.rest = VEncodePointer(&_V10_Dpair_D471, VPOINTER_PAIR);
  _V10_Dpair_D473.first = VEncodePointer(&_V10_Dpair_D201, VPOINTER_PAIR);
  ...
  _V10_Dpair_D472.rest = VNULL;
  _V10_Dpair_D471.first = VEncodePointer(&_V10_Dpair_D199, VPOINTER_PAIR);
  _V10_Dpair_D471.rest = VEncodePointer(&_V10_Dpair_D467, VPOINTER_PAIR);
  _V10_Dpair_D470.first = VEncodePointer(&_V10_Dpair_D201, VPOINTER_PAIR);
  _V10_Dpair_D470.rest = VEncodePointer(&_V10_Dpair_D468, VPOINTER_PAIR);
  _V10_Dpair_D469.first = VEncodePointer(&_V10_Dpair_D196, VPOINTER_PAIR);
  ...
  _V10_Dpair_D467.first = VEncodePointer(&_V10_Dpair_D256, VPOINTER_PAIR);
  _V10_Dpair_D467.rest = VEncodePointer(&_V10_Dpair_D466, VPOINTER_PAIR);
  _V10_Dpair_D466.first = VEncodePointer(&_V10_Dpair_D253, VPOINTER_PAIR);
  _V10_Dpair_D466.rest = VEncodePointer(&_V10_Dpair_D463, VPOINTER_PAIR);
  _V10_Dpair_D465.first = VEncodePointer(&_V10_Dpair_D255, VPOINTER_PAIR);
  ...
  _V10_Dpair_D463.first = VEncodePointer(&_V10_Dpair_D256, VPOINTER_PAIR);
  _V10_Dpair_D463.rest = VEncodePointer(&_V10_Dpair_D444, VPOINTER_PAIR);
  _V10_Dpair_D462.first = VEncodePointer(&_V10_Dpair_D461, VPOINTER_PAIR);
  _V10_Dpair_D462.rest = VEncodePointer(&_V10_Dpair_D432, VPOINTER_PAIR);
  _V10_Dpair_D461.first = VEncodePointer(&_V10_Dpair_D460, VPOINTER_PAIR);
  _V10_Dpair_D461.rest = VEncodePointer(&_V10_Dpair_D383, VPOINTER_PAIR);
  _V10_Dpair_D460.first = _V0vanity;
  _V10_Dpair_D460.rest = VEncodePointer(&_V10_Dpair_D459, VPOINTER_PAIR);
  _V10_Dpair_D459.first = _V0pretty__print;
  _V10_Dpair_D459.rest = VEncodePointer(&_V10_Dpair_D458, VPOINTER_PAIR);
  _V10_Dpair_D458.first = _V0short_Q;
  _V10_Dpair_D458.rest = VEncodePointer(&_V10_Dpair_D457, VPOINTER_PAIR);
  _V10_Dpair_D457.first = _V10_Dlengthof_D54;
  _V10_Dpair_D457.rest = VNULL;
  _V10_Dpair_D456.first = VEncodePointer(&_V10_Dpair_D201, VPOINTER_PAIR);
  ...
  _V10_Dpair_D454.first = VEncodePointer(&_V10_Dpair_D277, VPOINTER_PAIR);
  _V10_Dpair_D454.rest = VEncodePointer(&_V10_Dpair_D451, VPOINTER_PAIR);
  _V10_Dpair_D453.first = VEncodePointer(&_V10_Dpair_D201, VPOINTER_PAIR);
  ...
  _V10_Dpair_D451.first = VEncodePointer(&_V10_Dpair_D256, VPOINTER_PAIR);
  _V10_Dpair_D451.rest = VEncodePointer(&_V10_Dpair_D450, VPOINTER_PAIR);
  _V10_Dpair_D450.first = VEncodePointer(&_V10_Dpair_D253, VPOINTER_PAIR);
  _V10_Dpair_D450.rest = VEncodePointer(&_V10_Dpair_D449, VPOINTER_PAIR);
  _V10_Dpair_D449.first = VEncodePointer(&_V10_Dpair_D253, VPOINTER_PAIR);
  _V10_Dpair_D449.rest = VEncodePointer(&_V10_Dpair_D448, VPOINTER_PAIR);
  _V10_Dpair_D448.first = VEncodePointer(&_V10_Dpair_D441, VPOINTER_PAIR);
  _V10_Dpair_D448.rest = VEncodePointer(&_V10_Dpair_D445, VPOINTER_PAIR);
  _V10_Dpair_D447.first = VEncodePointer(&_V10_Dpair_D443, VPOINTER_PAIR);
  ...
  _V10_Dpair_D445.first = VEncodePointer(&_V10_Dpair_D309, VPOINTER_PAIR);
  _V10_Dpair_D445.rest = VEncodePointer(&_V10_Dpair_D444, VPOINTER_PAIR);
  _V10_Dpair_D444.first = VEncodePointer(&_V10_Dpair_D382, VPOINTER_PAIR);
  _V10_Dpair_D444.rest = VEncodePointer(&_V10_Dpair_D431, VPOINTER_PAIR);
  _V10_Dpair_D443.first = VEncodePointer(&_V10_Dpair_D438, VPOINTER_PAIR);
  _V10_Dpair_D443.rest = VEncodePointer(&_V10_Dpair_D442, VPOINTER_PAIR);
  _V10_Dpair_D442.first = VEncodePointer(&_V10_Dpair_D441, VPOINTER_PAIR);
  _V10_Dpair_D442.rest = VNULL;
  _V10_Dpair_D441.first = _V0_Mk;
  _V10_Dpair_D441.rest = VEncodePointer(&_V10_Dpair_D440, VPOINTER_PAIR);
  _V10_Dpair_D440.first = _V0expr;
  _V10_Dpair_D440.rest = VEncodePointer(&_V10_Dpair_D439, VPOINTER_PAIR);
  _V10_Dpair_D439.first = _V0n;
  _V10_Dpair_D439.rest = VNULL;
  _V10_Dpair_D438.first = _V0vanity;
  _V10_Dpair_D438.rest = VEncodePointer(&_V10_Dpair_D437, VPOINTER_PAIR);
  _V10_Dpair_D437.first = _V0pretty__print;
  _V10_Dpair_D437.rest = VEncodePointer(&_V10_Dpair_D436, VPOINTER_PAIR);
  _V10_Dpair_D436.first = _V0short_Q;
  _V10_Dpair_D436.rest = VEncodePointer(&_V10_Dpair_D435, VPOINTER_PAIR);
  _V10_Dpair_D435.first = _V10_Dlengthof__list_D53;
  _V10_Dpair_D435.rest = VEncodePointer(&_V10_Dpair_D434, VPOINTER_PAIR);
  _V10_Dpair_D434.first = _V10_Dloop_D56;
  _V10_Dpair_D434.rest = VNULL;
  _V10_Dpair_D433.first = VEncodePointer(&_V10_Dpair_D427, VPOINTER_PAIR);
  _V10_Dpair_D433.rest = VEncodePointer(&_V10_Dpair_D432, VPOINTER_PAIR);
  _V10_Dpair_D432.first = VEncodePointer(&_V10_Dpair_D431, VPOINTER_PAIR);
  _V10_Dpair_D432.rest = VNULL;
  _V10_Dpair_D431.first = VEncodePointer(&_V10_Dpair_D429, VPOINTER_PAIR);
  _V10_Dpair_D431.rest = VEncodePointer(&_V10_Dpair_D430, VPOINTER_PAIR);
  _V10_Dpair_D430.first = VEncodePointer(&_V10_Dpair_D417, VPOINTER_PAIR);
  _V10_Dpair_D430.rest = VEncodePointer(&_V10_Dpair_D420, VPOINTER_PAIR);
  _V10_Dpair_D429.first = _V0lengthof__list;
  _V10_Dpair_D429.rest = VEncodePointer(&_V10_Dpair_D428, VPOINTER_PAIR);
  _V10_Dpair_D428.first = _V0lengthof;
  _V10_Dpair_D428.rest = VNULL;
  _V10_Dpair_D427.first = VEncodePointer(&_V10_Dpair_D426, VPOINTER_PAIR);
  _V10_Dpair_D427.rest = VEncodePointer(&_V10_Dpair_D383, VPOINTER_PAIR);
  _V10_Dpair_D426.first = _V0vanity;
  _V10_Dpair_D426.rest = VEncodePointer(&_V10_Dpair_D425, VPOINTER_PAIR);
  _V10_Dpair_D425.first = _V0pretty__print;
  _V10_Dpair_D425.rest = VEncodePointer(&_V10_Dpair_D424, VPOINTER_PAIR);
  _V10_Dpair_D424.first = _V0short_Q;
  _V10_Dpair_D424.rest = VEncodePointer(&_V10_Dpair_D423, VPOINTER_PAIR);
  _V10_Dpair_D423.first = _V10_Dlengthof__list_D53;
  _V10_Dpair_D423.rest = VNULL;
  _V10_Dpair_D422.first = VEncodePointer(&_V10_Dpair_D419, VPOINTER_PAIR);
  ...
  _V10_Dpair_D420.first = VEncodePointer(&_V10_Dpair_D412, VPOINTER_PAIR);
  _V10_Dpair_D420.rest = VEncodePointer(&_V10_Dpair_D241, VPOINTER_PAIR);
  _V10_Dpair_D419.first = VEncodeBool(false);
  ...
  _V10_Dpair_D416.first = _V0return;
  _V10_Dpair_D416.rest = VNULL;
  _V10_Dpair_D415.first = VEncodePointer(&_V10_Dpair_D414, VPOINTER_PAIR);
  _V10_Dpair_D415.rest = VEncodePointer(&_V10_Dpair_D242, VPOINTER_PAIR);
  ...
  _V10_Dpair_D402.first = _V0unquote__splicing;
  _V10_Dpair_D402.rest = VEncodePointer(&_V10_Dstring_D401.sym, VPOINTER_OTHER);
  _V10_Dpair_D400.first = _V0unquote;
  _V10_Dpair_D400.rest = VEncodePointer(&_V10_Dstring_D399.sym, VPOINTER_OTHER);
  _V10_Dpair_D398.first = _V0quasiquote;
  _V10_Dpair_D398.rest = VEncodePointer(&_V10_Dstring_D397.sym, VPOINTER_OTHER);
  _V10_Dpair_D396.first = _V0quote;
  _V10_Dpair_D396.rest = VEncodePointer(&_V10_Dstring_D395.sym, VPOINTER_OTHER);
  _V10_Dpair_D394.first = VEncodePointer(&_V10_Dpair_D356, VPOINTER_PAIR);
  _V10_Dpair_D394.rest = VEncodePointer(&_V10_Dpair_D393, VPOINTER_PAIR);
  _V10_Dpair_D393.first = VEncodePointer(&_V10_Dpair_D392, VPOINTER_PAIR);
  _V10_Dpair_D393.rest = VNULL;
  _V10_Dpair_D392.first = VEncodePointer(&_V10_Dpair_D199, VPOINTER_PAIR);
  _V10_Dpair_D392.rest = VEncodePointer(&_V10_Dpair_D391, VPOINTER_PAIR);
  _V10_Dpair_D391.first = VEncodePointer(&_V10_Dpair_D382, VPOINTER_PAIR);
  _V10_Dpair_D391.rest = VEncodePointer(&_V10_Dpair_D241, VPOINTER_PAIR);
  _V10_Dpair_D390.first = VEncodePointer(&_V10_Dpair_D389, VPOINTER_PAIR);
  _V10_Dpair_D390.rest = VEncodePointer(&_V10_Dpair_D242, VPOINTER_PAIR);
  _V10_Dpair_D389.first = VEncodePointer(&_V10_Dpair_D388, VPOINTER_PAIR);
  _V10_Dpair_D389.rest = VEncodePointer(&_V10_Dpair_D383, VPOINTER_PAIR);
  _V10_Dpair_D388.first = _V0vanity;
  _V10_Dpair_D388.rest = VEncodePointer(&_V10_Dpair_D387, VPOINTER_PAIR);
  _V10_Dpair_D387.first = _V0pretty__print;
  _V10_Dpair_D387.rest = VEncodePointer(&_V10_Dpair_D386, VPOINTER_PAIR);
  _V10_Dpair_D386.first = _V0quotation_Q;
  _V10_Dpair_D386.rest = VNULL;
  _V10_Dpair_D385.first = VEncodePointer(&_V10_Dpair_D384, VPOINTER_PAIR);
  _V10_Dpair_D385.rest = VEncodePointer(&_V10_Dpair_D242, VPOINTER_PAIR);
  _V10_Dpair_D384.first = VEncodePointer(&_V10_Dpair_D380, VPOINTER_PAIR);
  ...
  _V10_Dpair_D369.first = VEncodePointer(&_V10_Dpair_D368, VPOINTER_PAIR);
  _V10_Dpair_D369.rest = VNULL;
  _V10_Dpair_D368.first = _V0letrec_S;
  _V10_Dpair_D368.rest = VEncodeInt(2l);
  _V10_Dpair_D367.first = _V0let_S;
  _V10_Dpair_D367.rest = VEncodeInt(2l);
  _V10_Dpair_D366.first = _V0letrec;
  _V10_Dpair_D366.rest = VEncodeInt(2l);
  _V10_Dpair_D365.first = _V0let;
  _V10_Dpair_D365.rest = VEncodeInt(2l);
  _V10_Dpair_D364.first = _V0if;
  _V10_Dpair_D364.rest = VEncodeInt(4l);
  _V10_Dpair_D363.first = _V0continuation;
  _V10_Dpair_D363.rest = VEncodeInt(2l);
  _V10_Dpair_D362.first = _V0lambda;
  _V10_Dpair_D362.rest = VEncodeInt(2l);
  _V10_Dpair_D361.first = _V0set_B;
  _V10_Dpair_D361.rest = VEncodeInt(2l);
  _V10_Dpair_D360.first = _V0define;
  _V10_Dpair_D360.rest = VEncodeInt(2l);
  _V10_Dpair_D359.first = VEncodePointer(&_V10_Dpair_D356, VPOINTER_PAIR);
  ...
  _V10_Dpair_D357.first = VEncodePointer(&_V10_Dpair_D350, VPOINTER_PAIR);
  _V10_Dpair_D357.rest = VEncodePointer(&_V10_Dpair_D241, VPOINTER_PAIR);
  _V10_Dpair_D356.first = VEncodeBool(false);
  ...
  _V10_Dpair_D354.first = _V0ret;
  _V10_Dpair_D354.rest = VNULL;
  _V10_Dpair_D353.first = VEncodePointer(&_V10_Dpair_D352, VPOINTER_PAIR);
  _V10_Dpair_D353.rest = VEncodePointer(&_V10_Dpair_D242, VPOINTER_PAIR);
  _V10_Dpair_D352.first = VEncodePointer(&_V10_Dpair_D348, VPOINTER_PAIR);
  ...
  _V10_Dpair_D350.first = _V0_Mk;
  _V10_Dpair_D350.rest = VEncodePointer(&_V10_Dpair_D349, VPOINTER_PAIR);
  _V10_Dpair_D349.first = _V0form;
  _V10_Dpair_D349.rest = VNULL;
  _V10_Dpair_D348.first = _V0vanity;
  _V10_Dpair_D348.rest = VEncodePointer(&_V10_Dpair_D347, VPOINTER_PAIR);
  _V10_Dpair_D347.first = _V0pretty__print;
  _V10_Dpair_D347.rest = VEncodePointer(&_V10_Dpair_D346, VPOINTER_PAIR);
  _V10_Dpair_D346.first = _V0join__line_Q;
  _V10_Dpair_D346.rest = VNULL;
  _V10_Dpair_D343.first = VEncodePointer(&_V10_Dpair_D201, VPOINTER_PAIR);
  _V10_Dpair_D343.rest = VEncodePointer(&_V10_Dpair_D341, VPOINTER_PAIR);
  _V10_Dpair_D342.first = VEncodePointer(&_V10_Dpair_D196, VPOINTER_PAIR);
  ...
  _V10_Dpair_D340.first = VEncodePointer(&_V10_Dpair_D277, VPOINTER_PAIR);
  _V10_Dpair_D340.rest = VEncodePointer(&_V10_Dpair_D339, VPOINTER_PAIR);
  _V10_Dpair_D339.first = VEncodePointer(&_V10_Dpair_D225, VPOINTER_PAIR);
  _V10_Dpair_D339.rest = VEncodePointer(&_V10_Dpair_D333, VPOINTER_PAIR);
  _V10_Dpair_D338.first = VEncodePointer(&_V10_Dpair_D337, VPOINTER_PAIR);
  _V10_Dpair_D338.rest = VEncodePointer(&_V10_Dpair_D334, VPOINTER_PAIR);
  _V10_Dpair_D337.first = VEncodeBool(false);
  _V10_Dpair_D337.rest = VEncodePointer(&_V10_Dpair_D336, VPOINTER_PAIR);
  _V10_Dpair_D336.first = VEncodePointer(&_V10_Dpair_D225, VPOINTER_PAIR);
  _V10_Dpair_D336.rest = VNULL;
  _V10_Dpair_D335.first = VEncodePointer(&_V10_Dpair_D196, VPOINTER_PAIR);
  _V10_Dpair_D335.rest = VEncodePointer(&_V10_Dpair_D334, VPOINTER_PAIR);
  _V10_Dpair_D334.first = VEncodePointer(&_V10_Dpair_D333, VPOINTER_PAIR);
  _V10_Dpair_D334.rest = VNULL;
  _V10_Dpair_D333.first = VEncodePointer(&_V10_Dpair_D253, VPOINTER_PAIR);
  _V10_Dpair_D333.rest = VEncodePointer(&_V10_Dpair_D326, VPOINTER_PAIR);
  _V10_Dpair_D332.first = VEncodePointer(&_V10_Dpair_D255, VPOINTER_PAIR);
  _V10_Dpair_D332.rest = VEncodePointer(&_V10_Dpair_D327, VPOINTER_PAIR);
  _V10_Dpair_D331.first = _V0define;
  _V10_Dpair_D331.rest = VEncodePointer(&_V10_Dpair_D330, VPOINTER_PAIR);
  _V10_Dpair_D330.first = _V0lambda;
  _V10_Dpair_D330.rest = VEncodePointer(&_V10_Dpair_D329, VPOINTER_PAIR);
  _V10_Dpair_D329.first = _V0continuation;
  _V10_Dpair_D329.rest = VNULL;
  _V10_Dpair_D328.first = VEncodePointer(&_V10_Dpair_D196, VPOINTER_PAIR);
  ...
  _V10_Dpair_D326.first = VEncodePointer(&_V10_Dpair_D296, VPOINTER_PAIR);
  _V10_Dpair_D326.rest = VEncodePointer(&_V10_Dpair_D321, VPOINTER_PAIR);
  _V10_Dpair_D325.first = VEncodePointer(&_V10_Dpair_D298, VPOINTER_PAIR);
  _V10_Dpair_D325.rest = VEncodePointer(&_V10_Dpair_D322, VPOINTER_PAIR);
  _V10_Dpair_D323.first = VEncodePointer(&_V10_Dpair_D196, VPOINTER_PAIR);
  ...
  _V10_Dpair_D321.first = VEncodePointer(&_V10_Dpair_D253, VPOINTER_PAIR);
  _V10_Dpair_D321.rest = VEncodePointer(&_V10_Dpair_D317, VPOINTER_PAIR);
  _V10_Dpair_D320.first = VEncodePointer(&_V10_Dpair_D255, VPOINTER_PAIR);
  _V10_Dpair_D320.rest = VEncodePointer(&_V10_Dpair_D318, VPOINTER_PAIR);
  _V10_Dpair_D319.first = VEncodePointer(&_V10_Dpair_D196, VPOINTER_PAIR);
  ...
  _V10_Dpair_D317.first = VEncodePointer(&_V10_Dpair_D253, VPOINTER_PAIR);
  _V10_Dpair_D317.rest = VEncodePointer(&_V10_Dpair_D316, VPOINTER_PAIR);
  _V10_Dpair_D316.first = VEncodePointer(&_V10_Dpair_D253, VPOINTER_PAIR);
  _V10_Dpair_D316.rest = VEncodePointer(&_V10_Dpair_D315, VPOINTER_PAIR);
  _V10_Dpair_D315.first = VEncodePointer(&_V10_Dpair_D306, VPOINTER_PAIR);
  _V10_Dpair_D315.rest = VEncodePointer(&_V10_Dpair_D311, VPOINTER_PAIR);
  _V10_Dpair_D313.first = VEncodePointer(&_V10_Dpair_D308, VPOINTER_PAIR);
  ...
  _V10_Dpair_D311.first = VEncodePointer(&_V10_Dpair_D309, VPOINTER_PAIR);
  _V10_Dpair_D311.rest = VEncodePointer(&_V10_Dpair_D310, VPOINTER_PAIR);
  _V10_Dpair_D310.first = VEncodePointer(&_V10_Dpair_D296, VPOINTER_PAIR);
  _V10_Dpair_D310.rest = VEncodePointer(&_V10_Dpair_D293, VPOINTER_PAIR);
  _V10_Dpair_D309.first = _V0loop;
  _V10_Dpair_D309.rest = VNULL;
  _V10_Dpair_D308.first = VEncodePointer(&_V10_Dpair_D303, VPOINTER_PAIR);
  ...
  _V10_Dpair_D296.first = _V0new__indent;
  _V10_Dpair_D296.rest = VNULL;
  _V10_Dpair_D295.first = VEncodePointer(&_V10_Dpair_D196, VPOINTER_PAIR);
  ...
  _V10_Dpair_D293.first = VEncodePointer(&_V10_Dpair_D289, VPOINTER_PAIR);
  _V10_Dpair_D293.rest = VEncodePointer(&_V10_Dpair_D282, VPOINTER_PAIR);
  _V10_Dpair_D292.first = VEncodePointer(&_V10_Dpair_D291, VPOINTER_PAIR);
  _V10_Dpair_D292.rest = VEncodePointer(&_V10_Dpair_D283, VPOINTER_PAIR);
  ...
  _V10_Dpair_D289.first = _V0first__indent;
  _V10_Dpair_D289.rest = VNULL;
  _V10_Dpair_D288.first = VEncodePointer(&_V10_Dpair_D201, VPOINTER_PAIR);
  ...
  _V10_Dpair_D286.first = VEncodePointer(&_V10_Dpair_D199, VPOINTER_PAIR);
  _V10_Dpair_D286.rest = VEncodePointer(&_V10_Dpair_D285, VPOINTER_PAIR);
  _V10_Dpair_D285.first = VEncodePointer(&_V10_Dpair_D194, VPOINTER_PAIR);
  _V10_Dpair_D285.rest = VEncodePointer(&_V10_Dpair_D282, VPOINTER_PAIR);
  _V10_Dpair_D284.first = VEncodePointer(&_V10_Dpair_D196, VPOINTER_PAIR);
  ...
  _V10_Dpair_D282.first = VEncodePointer(&_V10_Dpair_D274, VPOINTER_PAIR);
  _V10_Dpair_D282.rest = VEncodePointer(&_V10_Dpair_D279, VPOINTER_PAIR);
  ...
  _V10_Dpair_D279.first = VEncodePointer(&_V10_Dpair_D199, VPOINTER_PAIR);
  ...
  _V10_Dpair_D278.rest = VEncodePointer(&_V10_Dpair_D266, VPOINTER_PAIR);
  _V10_Dpair_D277.first = _V0_Mx;
  _V10_Dpair_D277.rest = VEncodePointer(&_V10_Dpair_D199, VPOINTER_PAIR);
  _V10_Dpair_D276.first = VEncodeBool(false);
  _V10_Dpair_D276.rest = VEncodePointer(&_V10_Dpair_D275, VPOINTER_PAIR);
  _V10_Dpair_D275.first = VEncodePointer(&_V10_Dpair_D274, VPOINTER_PAIR);
  _V10_Dpair_D275.rest = VNULL;
  _V10_Dpair_D274.first = _V0join__line;
  _V10_Dpair_D274.rest = VNULL;
  _V10_Dpair_D273.first = VEncodePointer(&_V10_Dpair_D201, VPOINTER_PAIR);
  _V10_Dpair_D273.rest = VEncodePointer(&_V10_Dpair_D271, VPOINTER_PAIR);
  _V10_Dpair_D272.first = VEncodePointer(&_V10_Dpair_D196, VPOINTER_PAIR);
  ...
  _V10_Dpair_D270.first = VEncodePointer(&_V10_Dpair_D256, VPOINTER_PAIR);
  _V10_Dpair_D270.rest = VEncodePointer(&_V10_Dpair_D269, VPOINTER_PAIR);
  _V10_Dpair_D269.first = VEncodePointer(&_V10_Dpair_D199, VPOINTER_PAIR);
  _V10_Dpair_D269.rest = VEncodePointer(&_V10_Dpair_D266, VPOINTER_PAIR);
  _V10_Dpair_D268.first = VEncodePointer(&_V10_Dpair_D201, VPOINTER_PAIR);
  ...
  _V10_Dpair_D266.first = VEncodePointer(&_V10_Dpair_D260, VPOINTER_PAIR);
  _V10_Dpair_D266.rest = VEncodePointer(&_V10_Dpair_D263, VPOINTER_PAIR);
  _V10_Dpair_D265.first = VEncodePointer(&_V10_Dpair_D262, VPOINTER_PAIR);
  ...
  _V10_Dpair_D263.first = VEncodePointer(&_V10_Dpair_D253, VPOINTER_PAIR);
  _V10_Dpair_D263.rest = VEncodePointer(&_V10_Dpair_D257, VPOINTER_PAIR);
  _V10_Dpair_D262.first = VEncodeBool(false);
  ...
  _V10_Dpair_D260.first = _V0x_D1;
  _V10_Dpair_D260.rest = VNULL;
  _V10_Dpair_D259.first = VEncodePointer(&_V10_Dpair_D255, VPOINTER_PAIR);
  ...
  _V10_Dpair_D258.rest = VNULL;
  _V10_Dpair_D257.first = VEncodePointer(&_V10_Dpair_D256, VPOINTER_PAIR);
  _V10_Dpair_D257.rest = VEncodePointer(&_V10_Dpair_D244, VPOINTER_PAIR);
  _V10_Dpair_D256.first = _V0_Mx;
  _V10_Dpair_D256.rest = VEncodePointer(&_V10_Dpair_D253, VPOINTER_PAIR);
  _V10_Dpair_D255.first = VEncodeBool(false);
  ...
  _V10_Dpair_D253.first = _V0_Mp;
  _V10_Dpair_D253.rest = VNULL;
  _V10_Dpair_D252.first = VEncodePointer(&_V10_Dpair_D248, VPOINTER_PAIR);
  ...
  _V10_Dpair_D250.first = _V0unquote;
  _V10_Dpair_D250.rest = VEncodePointer(&_V10_Dpair_D249, VPOINTER_PAIR);
  _V10_Dpair_D249.first = _V0unmangled__env;
  _V10_Dpair_D249.rest = VNULL;
  _V10_Dpair_D248.first = VEncodeBool(false);
  _V10_Dpair_D248.rest = VEncodePointer(&_V10_Dpair_D247, VPOINTER_PAIR);
  _V10_Dpair_D247.first = _V0_U;
  _V10_Dpair_D247.rest = VNULL;
  _V10_Dpair_D246.first = VEncodePointer(&_V10_Dpair_D196, VPOINTER_PAIR);
  ...
  _V10_Dpair_D244.first = VEncodePointer(&_V10_Dpair_D229, VPOINTER_PAIR);
  _V10_Dpair_D244.rest = VEncodePointer(&_V10_Dpair_D241, VPOINTER_PAIR);
  _V10_Dpair_D243.first = VEncodePointer(&_V10_Dpair_D231, VPOINTER_PAIR);
  _V10_Dpair_D243.rest = VEncodePointer(&_V10_Dpair_D242, VPOINTER_PAIR);
  _V10_Dpair_D242.first = VEncodePointer(&_V10_Dpair_D241, VPOINTER_PAIR);
  _V10_Dpair_D242.rest = VNULL;
  _V10_Dpair_D241.first = VEncodePointer(&_V10_Dpair_D239, VPOINTER_PAIR);
  _V10_Dpair_D241.rest = VEncodePointer(&_V10_Dpair_D240, VPOINTER_PAIR);
  _V10_Dpair_D240.first = VEncodePointer(&_V10_Dpair_D216, VPOINTER_PAIR);
  _V10_Dpair_D240.rest = VEncodePointer(&_V10_Dpair_D219, VPOINTER_PAIR);
  _V10_Dpair_D239.first = _V0pretty__print__impl;
  _V10_Dpair_D239.rest = VEncodePointer(&_V10_Dpair_D238, VPOINTER_PAIR);
  _V10_Dpair_D238.first = _V0join__line_Q;
  _V10_Dpair_D238.rest = VEncodePointer(&_V10_Dpair_D237, VPOINTER_PAIR);
  _V10_Dpair_D237.first = _V0pretty__print;
  _V10_Dpair_D237.rest = VEncodePointer(&_V10_Dpair_D236, VPOINTER_PAIR);
  _V10_Dpair_D236.first = _V0quotation_Q;
  _V10_Dpair_D236.rest = VEncodePointer(&_V10_Dpair_D235, VPOINTER_PAIR);
  _V10_Dpair_D235.first = _V0short_Q;
  _V10_Dpair_D235.rest = VEncodePointer(&_V10_Dpair_D234, VPOINTER_PAIR);
  _V10_Dpair_D234.first = _V0lengthof__atom;
  _V10_Dpair_D234.rest = VEncodePointer(&_V10_Dpair_D233, VPOINTER_PAIR);
  _V10_Dpair_D233.first = _V0atom_Q;
  _V10_Dpair_D233.rest = VEncodePointer(&_V10_Dpair_D232, VPOINTER_PAIR);
  _V10_Dpair_D232.first = _V0print__indent;
  _V10_Dpair_D232.rest = VNULL;
  _V10_Dpair_D231.first = VEncodePointer(&_V10_Dpair_D224, VPOINTER_PAIR);
  _V10_Dpair_D231.rest = VEncodePointer(&_V10_Dpair_D230, VPOINTER_PAIR);
  _V10_Dpair_D230.first = VEncodePointer(&_V10_Dpair_D229, VPOINTER_PAIR);
  _V10_Dpair_D230.rest = VNULL;
  _V10_Dpair_D229.first = _V0_Mk;
  _V10_Dpair_D229.rest = VEncodePointer(&_V10_Dpair_D228, VPOINTER_PAIR);
  _V10_Dpair_D228.first = _V0expr;
  _V10_Dpair_D228.rest = VEncodePointer(&_V10_Dpair_D227, VPOINTER_PAIR);
  _V10_Dpair_D227.first = _V0indent;
  _V10_Dpair_D227.rest = VEncodePointer(&_V10_Dpair_D226, VPOINTER_PAIR);
  _V10_Dpair_D226.first = _V0indent__this_Q;
  _V10_Dpair_D226.rest = VEncodePointer(&_V10_Dpair_D225, VPOINTER_PAIR);
  _V10_Dpair_D225.first = _V0short__threshold;
  _V10_Dpair_D225.rest = VNULL;
  _V10_Dpair_D224.first = _V0vanity;
  _V10_Dpair_D224.rest = VEncodePointer(&_V10_Dpair_D223, VPOINTER_PAIR);
  _V10_Dpair_D223.first = _V0pretty__print;
  _V10_Dpair_D223.rest = VEncodePointer(&_V10_Dpair_D222, VPOINTER_PAIR);
  _V10_Dpair_D222.first = _V0pretty__print__impl;
  _V10_Dpair_D222.rest = VNULL;
  _V10_Dpair_D221.first = VEncodePointer(&_V10_Dpair_D218, VPOINTER_PAIR);
  ...
  _V10_Dpair_D219.first = VEncodePointer(&_V10_Dpair_D199, VPOINTER_PAIR);
  _V10_Dpair_D219.rest = VEncodePointer(&_V10_Dpair_D204, VPOINTER_PAIR);
  _V10_Dpair_D218.first = VEncodeBool(false);
  ...
  _V10_Dpair_D204.first = VEncodePointer(&_V10_Dpair_D199, VPOINTER_PAIR);
  _V10_Dpair_D204.rest = VEncodePointer(&_V10_Dpair_D195, VPOINTER_PAIR);
  _V10_Dpair_D203.first = VEncodePointer(&_V10_Dpair_D201, VPOINTER_PAIR);
  ...
  _V10_Dpair_D201.first = VEncodeBool(false);
  ...
  _V10_Dpair_D194.first = _V0_Mk;
  _V10_Dpair_D194.rest = VNULL;
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k3, VEncodePointer(&_V10_Dpair_D246, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k9, VEncodePointer(&_V10_Dpair_D272, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k10, VEncodePointer(&_V10_Dpair_D273, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k8, VEncodePointer(&_V10_Dpair_D268, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k7, VEncodePointer(&_V10_Dpair_D252, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k15, VEncodePointer(&_V10_Dpair_D288, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k14, VEncodePointer(&_V10_Dpair_D284, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k17, VEncodePointer(&_V10_Dpair_D295, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D40_V0k19, VEncodePointer(&_V10_Dpair_D319, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D40_V0k21, VEncodePointer(&_V10_Dpair_D323, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D40_V0k23, VEncodePointer(&_V10_Dpair_D323, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D40_V0k25, VEncodePointer(&_V10_Dpair_D328, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D40_V0k27, VEncodePointer(&_V10_Dpair_D335, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D40_V0k29, VEncodePointer(&_V10_Dpair_D342, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D40_V0k31, VEncodePointer(&_V10_Dpair_D252, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D40_V0k30, VEncodePointer(&_V10_Dpair_D343, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D40_V0k28, VEncodePointer(&_V10_Dpair_D338, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D40_V0k26, VEncodePointer(&_V10_Dpair_D332, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D40_V0k24, VEncodePointer(&_V10_Dpair_D325, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D40_V0k22, VEncodePointer(&_V10_Dpair_D252, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D40_V0k20, VEncodePointer(&_V10_Dpair_D320, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D40_V0k35, VEncodePointer(&_V10_Dpair_D252, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D40_V0k34, VEncodePointer(&_V10_Dpair_D252, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D40_V0k33, VEncodePointer(&_V10_Dpair_D252, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D40_V0k32, VEncodePointer(&_V10_Dpair_D252, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V10_Dloop_D40, VEncodePointer(&_V10_Dpair_D313, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k18, VEncodePointer(&_V10_Dpair_D299, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k16, VEncodePointer(&_V10_Dpair_D292, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k13, VEncodePointer(&_V10_Dpair_D281, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k12, VEncodePointer(&_V10_Dpair_D252, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k11, VEncodePointer(&_V10_Dpair_D252, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k6, VEncodePointer(&_V10_Dpair_D265, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k5, VEncodePointer(&_V10_Dpair_D259, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl_V0k4, VEncodePointer(&_V10_Dpair_D252, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print__impl, VEncodePointer(&_V10_Dpair_D243, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0join__line_Q_V0k36, VEncodePointer(&_V10_Dpair_D359, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0join__line_Q, VEncodePointer(&_V10_Dpair_D353, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print_V0k37, VEncodePointer(&_V10_Dpair_D252, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0pretty__print, VEncodePointer(&_V10_Dpair_D385, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0quotation_Q_V0k38, VEncodePointer(&_V10_Dpair_D394, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0quotation_Q, VEncodePointer(&_V10_Dpair_D390, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0short_Q_V10_Dlengthof__list_D53_V10_Dloop_D56_V0k39, VEncodePointer(&_V10_Dpair_D453, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0short_Q_V10_Dlengthof__list_D53_V10_Dloop_D56_V0k40, VEncodePointer(&_V10_Dpair_D456, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0short_Q_V10_Dlengthof__list_D53_V10_Dloop_D56, VEncodePointer(&_V10_Dpair_D447, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0short_Q_V10_Dlengthof__list_D53, VEncodePointer(&_V10_Dpair_D433, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0short_Q_V10_Dlengthof_D54_V0k42, VEncodePointer(&_V10_Dpair_D469, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0short_Q_V10_Dlengthof_D54_V0k45, VEncodePointer(&_V10_Dpair_D476, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0short_Q_V10_Dlengthof_D54_V0k44, VEncodePointer(&_V10_Dpair_D473, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0short_Q_V10_Dlengthof_D54_V0k43, VEncodePointer(&_V10_Dpair_D470, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0short_Q_V10_Dlengthof_D54_V0k41, VEncodePointer(&_V10_Dpair_D465, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0short_Q_V10_Dlengthof_D54, VEncodePointer(&_V10_Dpair_D462, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0short_Q_V0k46, VEncodePointer(&_V10_Dpair_D480, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0short_Q_V0lambda3, VEncodePointer(&_V10_Dpair_D422, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0short_Q, VEncodePointer(&_V10_Dpair_D415, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0lengthof__atom_V0k50, VEncodePointer(&_V10_Dpair_D252, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0lengthof__atom_V0k49, VEncodePointer(&_V10_Dpair_D493, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0lengthof__atom_V0k48, VEncodePointer(&_V10_Dpair_D252, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0lengthof__atom_V0k47, VEncodePointer(&_V10_Dpair_D490, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0lengthof__atom, VEncodePointer(&_V10_Dpair_D485, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0atom_Q, VEncodePointer(&_V10_Dpair_D498, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0print__indent_V0k51, VEncodePointer(&_V10_Dpair_D252, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0pretty__print_V0print__indent, VEncodePointer(&_V10_Dpair_D505, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0pretty__print_V20_V0lambda2, VEncodePointer(&_V10_Dpair_D221, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0pretty__print_V20_V0k2, VEncodePointer(&_V10_Dpair_D206, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0pretty__print_V20_V0k1, VEncodePointer(&_V10_Dpair_D203, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0pretty__print_V20_V0lambda1, VEncodePointer(&_V10_Dpair_D198, VPOINTER_PAIR));
}
