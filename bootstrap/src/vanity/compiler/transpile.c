...
struct { VBlob sym; char bytes[12]; } _V10intrinsic __attribute__((weak)) = { { VSYMBOL, 12 }, "##intrinsic" };
...
struct { VBlob sym; char bytes[7]; } _V0bruijn __attribute__((weak)) = { { VSYMBOL, 7 }, "bruijn" };
...
struct { VBlob sym; char bytes[6]; } _V0close __attribute__((weak)) = { { VSYMBOL, 6 }, "close" };
static struct { VBlob sym; char bytes[60]; } _V10string_D1805 = { { VSTRING, 60 }, "VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)~A, env)})" };
struct { VBlob sym; char bytes[9]; } _V10string __attribute__((weak)) = { { VSYMBOL, 9 }, "##string" };
...
struct { VBlob sym; char bytes[10]; } _V0printout2 __attribute__((weak)) = { { VSYMBOL, 10 }, "printout2" };
struct { VBlob sym; char bytes[13]; } _V0to__functions __attribute__((weak)) = { { VSYMBOL, 13 }, "to-functions" };
struct { VBlob sym; char bytes[11]; } _V0bruijn__ify __attribute__((weak)) = { { VSYMBOL, 11 }, "bruijn-ify" };
