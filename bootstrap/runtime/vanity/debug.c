...
static struct { VBlob sym; char bytes[21]; } _V10_Dstring_D565 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 21 }, "_V0vanity_V0core_V20" };
static struct { VBlob sym; char bytes[22]; } _V10_Dstring_D564 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 22 }, "_V0vanity_V0debug_V20" };
...
static struct { VBlob sym; char bytes[14]; } _V10_Dstring_D431 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 14 }, "##closure~S~N" };
...
static struct { VBlob sym; char bytes[5]; } _V10_Dstring_D423 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 5 }, "~A: " };
...
__attribute__((used)) static void _V20CaseError__V50_V0vanity_V0debug_V0closure__bt(VRuntime * runtime, VEnv * statics, int argc, ...) {
 // ("_V50_V0vanity_V0debug_V0closure__bt" #t (##pair ##.pair.301) (2 ((bruijn ##.current-output-port.44 2 0) (close _V10_Dclosure__bt_D67_V0k3))) (3 (##qualified-call (vanity debug closure-bt-impl) #t (bruijn ##.closure-bt-impl.68 1 1) (bruijn ##.%k.122 0 0) (bruijn ##.proc.75 0 1) (bruijn ##.port.76 0 2))))
...
void _V50_V0vanity_V0debug_V0closure__bt__impl_V10_Dloop_D23_D81_V0lambda4(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V50_V0vanity_V0debug_V0closure__bt__impl_V10_Dloop_D23_D81_V0lambda4" };
 VRecordCall2(runtime, &dbg);
  struct { VEnv self; VWORD argv[1]; } container;
  VEnv * self = &container.self;
  VInitEnv(self, 1, 1, statics);
...
void _V50_V0vanity_V0debug_V0closure__bt__impl_V10_Dloop_D23_D81_V0k8(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 ...
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // ((bruijn ##.format.47 12 3) (close _V50_V0vanity_V0debug_V0closure__bt__impl_V10_Dloop_D23_D81_V0k9) (bruijn ##.port.78 10 2) (##string ##.string.423) (bruijn ##.i.82 3 1))
...
void _V50_V0vanity_V0debug_V0closure__bt__impl_V0lambda3(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V50_V0vanity_V0debug_V0closure__bt__impl_V0lambda3" };
 VRecordCall2(runtime, &dbg);
  struct { VEnv self; VWORD argv[1]; } container;
  VEnv * self = &container.self;
  VInitEnv(self, 1, 1, statics);
...
void _V50_V0vanity_V0debug_V0closure__bt__impl_V0k5(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 ...
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // (basic-block 1 1 (##.%x.197) ((##vcore.cons (bruijn ##.%x.150 2 0) (bruijn ##.%x.151 1 0))) ((bruijn ##.format.47 5 3) (close _V50_V0vanity_V0debug_V0closure__bt__impl_V0k6) (bruijn ##.port.78 3 2) (##string ##.string.431) (bruijn ##.%x.197 0 0)))
    {
    VEnv * statics = self;
    struct { VEnv self; VWORD argv[1]; } container;
    self = &container.self;
...
void _V50_V0vanity_V0debug_V0closure__env_V10_Dloop_D1_D99_V0lambda10(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V50_V0vanity_V0debug_V0closure__env_V10_Dloop_D1_D99_V0lambda10" };
 VRecordCall2(runtime, &dbg);
  struct { VEnv self; VWORD argv[1]; } container;
  VEnv * self = &container.self;
  VInitEnv(self, 1, 1, statics);
...
void _V50_V0vanity_V0debug_V0closure__env_V0lambda7(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V50_V0vanity_V0debug_V0closure__env_V0lambda7" };
 VRecordCall2(runtime, &dbg);
  struct { VEnv self; VWORD argv[1]; } container;
  VEnv * self = &container.self;
  VInitEnv(self, 1, 1, statics);
...
void _V50_V0vanity_V0debug_V0closure__formals(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0, VWORD _var1) {
 ...
 if(argc != 2) {
  ...
  self->vars[0] = _var0;
  self->vars[1] = _var1;
  // (basic-block 1 1 (##.ret.230) (((##basic-intrinsic "VGetProcDebugInfo") (bruijn ##.proc.113 1 1))) (if (bruijn ##.ret.230 0 0) ((bruijn ##.cdar.49 3 5) (bruijn ##.%k.171 1 0) (bruijn ##.ret.230 0 0)) ((bruijn ##.%k.171 1 0) '(##pair ##.pair.549))))
    {
    VEnv * statics = self;
    struct { VEnv self; VWORD argv[1]; } container;
    self = &container.self;
...
self->vars[0])) {
    ...
    VCallDecodedWithGC(runtime, VDecodeClosureApply2(runtime, statics->vars[0]), 1,
      VEncodePointer(&_V10_Dpair_D549, VPOINTER_PAIR));
}
    }
}
...
static void _V0vanity_V0debug_V20_V0k2(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 ...
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // ((##intrinsic "VMultiImport") (close _V0vanity_V0debug_V20_V0lambda2) (##string ##.string.564) (bruijn ##.%x.195 0 0) 'current-output-port 'newline 'write 'format 'cadr 'cdar 'caar 'vector->list)
...
static void _V0vanity_V0debug_V20_V0lambda1(VRuntime * runtime, VEnv * statics, int argc, VWORD _var0) {
 ...
 if(argc != 1) {
  ...
  VInitEnv(self, 1, 1, statics);
  self->vars[0] = _var0;
  // (##vcore.load-library (close _V0vanity_V0debug_V20_V0k1) (##string ##.string.565))
...
static __attribute__((constructor)) void VDllMain1() {
  ...
  _V10_Dpair_D561.first = VEncodePointer(&_V10_Dpair_D254, VPOINTER_PAIR);
  _V10_Dpair_D561.rest = VEncodePointer(&_V10_Dpair_D299, VPOINTER_PAIR);
  _V10_Dpair_D560.first = VEncodeBool(false);
  _V10_Dpair_D560.rest = VEncodePointer(&_V10_Dpair_D559, VPOINTER_PAIR);
  _V10_Dpair_D559.first = VEncodePointer(&_V10_Dpair_D537, VPOINTER_PAIR);
  ...
  _V10_Dpair_D558.rest = VEncodePointer(&_V10_Dpair_D300, VPOINTER_PAIR);
  _V10_Dpair_D557.first = VEncodePointer(&_V10_Dpair_D556, VPOINTER_PAIR);
  _V10_Dpair_D557.rest = VEncodePointer(&_V10_Dpair_D255, VPOINTER_PAIR);
  _V10_Dpair_D556.first = _V0vanity;
  _V10_Dpair_D556.rest = VEncodePointer(&_V10_Dpair_D555, VPOINTER_PAIR);
  _V10_Dpair_D555.first = _V0debug;
  _V10_Dpair_D555.rest = VEncodePointer(&_V10_Dpair_D291, VPOINTER_PAIR);
  _V10_Dpair_D554.first = VEncodePointer(&_V10_Dpair_D553, VPOINTER_PAIR);
  _V10_Dpair_D554.rest = VEncodePointer(&_V10_Dpair_D300, VPOINTER_PAIR);
  _V10_Dpair_D553.first = VEncodePointer(&_V10_Dpair_D552, VPOINTER_PAIR);
  _V10_Dpair_D553.rest = VEncodePointer(&_V10_Dpair_D435, VPOINTER_PAIR);
  ...
  _V10_Dpair_D550.first = _V0closure__name;
  _V10_Dpair_D550.rest = VNULL;
  _V10_Dpair_D549.first = _V0_Q;
  _V10_Dpair_D549.rest = VNULL;
  _V10_Dpair_D548.first = VEncodePointer(&_V10_Dpair_D547, VPOINTER_PAIR);
  _V10_Dpair_D548.rest = VEncodePointer(&_V10_Dpair_D300, VPOINTER_PAIR);
  _V10_Dpair_D547.first = VEncodePointer(&_V10_Dpair_D546, VPOINTER_PAIR);
  _V10_Dpair_D547.rest = VEncodePointer(&_V10_Dpair_D435, VPOINTER_PAIR);
  _V10_Dpair_D546.first = _V0vanity;
  _V10_Dpair_D546.rest = VEncodePointer(&_V10_Dpair_D545, VPOINTER_PAIR);
  _V10_Dpair_D545.first = _V0debug;
  _V10_Dpair_D545.rest = VEncodePointer(&_V10_Dpair_D544, VPOINTER_PAIR);
  _V10_Dpair_D544.first = _V0closure__formals;
  _V10_Dpair_D544.rest = VNULL;
  _V10_Dpair_D543.first = VEncodePointer(&_V10_Dpair_D542, VPOINTER_PAIR);
  _V10_Dpair_D543.rest = VEncodePointer(&_V10_Dpair_D539, VPOINTER_PAIR);
  _V10_Dpair_D542.first = VEncodeBool(false);
  _V10_Dpair_D542.rest = VEncodePointer(&_V10_Dpair_D541, VPOINTER_PAIR);
  _V10_Dpair_D541.first = VEncodePointer(&_V10_Dpair_D345, VPOINTER_PAIR);
  _V10_Dpair_D541.rest = VNULL;
  _V10_Dpair_D540.first = VEncodePointer(&_V10_Dpair_D256, VPOINTER_PAIR);
  _V10_Dpair_D540.rest = VEncodePointer(&_V10_Dpair_D539, VPOINTER_PAIR);
  _V10_Dpair_D539.first = VEncodePointer(&_V10_Dpair_D538, VPOINTER_PAIR);
  _V10_Dpair_D539.rest = VNULL;
  _V10_Dpair_D538.first = VEncodePointer(&_V10_Dpair_D537, VPOINTER_PAIR);
  _V10_Dpair_D538.rest = VEncodePointer(&_V10_Dpair_D302, VPOINTER_PAIR);
  _V10_Dpair_D537.first = _V0ret;
  ...
  _V10_Dpair_D536.rest = VEncodePointer(&_V10_Dpair_D300, VPOINTER_PAIR);
  _V10_Dpair_D535.first = VEncodePointer(&_V10_Dpair_D534, VPOINTER_PAIR);
  _V10_Dpair_D535.rest = VEncodePointer(&_V10_Dpair_D435, VPOINTER_PAIR);
  _V10_Dpair_D534.first = _V0vanity;
  _V10_Dpair_D534.rest = VEncodePointer(&_V10_Dpair_D533, VPOINTER_PAIR);
  _V10_Dpair_D533.first = _V0debug;
  _V10_Dpair_D533.rest = VEncodePointer(&_V10_Dpair_D532, VPOINTER_PAIR);
  _V10_Dpair_D532.first = _V0closure__env__names;
  _V10_Dpair_D532.rest = VNULL;
  _V10_Dpair_D531.first = VEncodePointer(&_V10_Dpair_D530, VPOINTER_PAIR);
  _V10_Dpair_D531.rest = VEncodePointer(&_V10_Dpair_D455, VPOINTER_PAIR);
  _V10_Dpair_D530.first = VEncodePointer(&_V10_Dpair_D527, VPOINTER_PAIR);
  ...
  _V10_Dpair_D528.first = _V0_Mk;
  _V10_Dpair_D528.rest = VEncodePointer(&_V10_Dpair_D445, VPOINTER_PAIR);
  _V10_Dpair_D527.first = _V0vanity;
  _V10_Dpair_D527.rest = VEncodePointer(&_V10_Dpair_D526, VPOINTER_PAIR);
  _V10_Dpair_D526.first = _V0debug;
  _V10_Dpair_D526.rest = VEncodePointer(&_V10_Dpair_D525, VPOINTER_PAIR);
  _V10_Dpair_D525.first = _V0closure__env;
  _V10_Dpair_D525.rest = VEncodePointer(&_V10_Dpair_D524, VPOINTER_PAIR);
  _V10_Dpair_D524.first = _V10_Dfinalize_D2_D98;
  _V10_Dpair_D524.rest = VNULL;
  _V10_Dpair_D523.first = VEncodePointer(&_V10_Dpair_D522, VPOINTER_PAIR);
  _V10_Dpair_D523.rest = VEncodePointer(&_V10_Dpair_D489, VPOINTER_PAIR);
  _V10_Dpair_D522.first = VEncodePointer(&_V10_Dpair_D519, VPOINTER_PAIR);
  ...
  _V10_Dpair_D512.first = VEncodePointer(&_V10_Dpair_D396, VPOINTER_PAIR);
  _V10_Dpair_D512.rest = VEncodePointer(&_V10_Dpair_D511, VPOINTER_PAIR);
  _V10_Dpair_D511.first = VEncodePointer(&_V10_Dpair_D259, VPOINTER_PAIR);
  _V10_Dpair_D511.rest = VEncodePointer(&_V10_Dpair_D502, VPOINTER_PAIR);
  _V10_Dpair_D510.first = VEncodePointer(&_V10_Dpair_D261, VPOINTER_PAIR);
  _V10_Dpair_D510.rest = VEncodePointer(&_V10_Dpair_D503, VPOINTER_PAIR);
  _V10_Dpair_D509.first = VEncodePointer(&_V10_Dpair_D256, VPOINTER_PAIR);
  _V10_Dpair_D509.rest = VEncodePointer(&_V10_Dpair_D508, VPOINTER_PAIR);
  _V10_Dpair_D508.first = VEncodePointer(&_V10_Dpair_D507, VPOINTER_PAIR);
  _V10_Dpair_D508.rest = VNULL;
  _V10_Dpair_D507.first = VEncodePointer(&_V10_Dpair_D397, VPOINTER_PAIR);
  _V10_Dpair_D507.rest = VEncodePointer(&_V10_Dpair_D506, VPOINTER_PAIR);
  _V10_Dpair_D506.first = VEncodePointer(&_V10_Dpair_D345, VPOINTER_PAIR);
  _V10_Dpair_D506.rest = VEncodePointer(&_V10_Dpair_D505, VPOINTER_PAIR);
  _V10_Dpair_D505.first = VEncodePointer(&_V10_Dpair_D497, VPOINTER_PAIR);
  _V10_Dpair_D505.rest = VEncodePointer(&_V10_Dpair_D502, VPOINTER_PAIR);
  _V10_Dpair_D504.first = VEncodePointer(&_V10_Dpair_D499, VPOINTER_PAIR);
  ...
  _V10_Dpair_D502.first = VEncodePointer(&_V10_Dpair_D500, VPOINTER_PAIR);
  _V10_Dpair_D502.rest = VEncodePointer(&_V10_Dpair_D501, VPOINTER_PAIR);
  _V10_Dpair_D501.first = VEncodePointer(&_V10_Dpair_D485, VPOINTER_PAIR);
  _V10_Dpair_D501.rest = VEncodePointer(&_V10_Dpair_D488, VPOINTER_PAIR);
  _V10_Dpair_D500.first = _V0loop_D12;
  ...
  _V10_Dpair_D488.first = VEncodePointer(&_V10_Dpair_D479, VPOINTER_PAIR);
  ...
  _V10_Dpair_D485.first = _V0finalize_D13;
  _V10_Dpair_D485.rest = VNULL;
  _V10_Dpair_D484.first = VEncodePointer(&_V10_Dpair_D481, VPOINTER_PAIR);
  ...
  _V10_Dpair_D482.first = VEncodePointer(&_V10_Dpair_D470, VPOINTER_PAIR);
  _V10_Dpair_D482.rest = VEncodePointer(&_V10_Dpair_D476, VPOINTER_PAIR);
  _V10_Dpair_D481.first = VEncodeBool(false);
  ...
  _V10_Dpair_D480.rest = VNULL;
  _V10_Dpair_D479.first = _V0collect__acc_D14;
  _V10_Dpair_D479.rest = VNULL;
  _V10_Dpair_D478.first = VEncodePointer(&_V10_Dpair_D472, VPOINTER_PAIR);
  ...
  _V10_Dpair_D476.first = VEncodePointer(&_V10_Dpair_D473, VPOINTER_PAIR);
  _V10_Dpair_D476.rest = VEncodePointer(&_V10_Dpair_D475, VPOINTER_PAIR);
  _V10_Dpair_D475.first = VEncodePointer(&_V10_Dpair_D345, VPOINTER_PAIR);
  _V10_Dpair_D475.rest = VEncodePointer(&_V10_Dpair_D474, VPOINTER_PAIR);
  _V10_Dpair_D474.first = VEncodePointer(&_V10_Dpair_D462, VPOINTER_PAIR);
  _V10_Dpair_D474.rest = VEncodePointer(&_V10_Dpair_D467, VPOINTER_PAIR);
  _V10_Dpair_D473.first = _V0y_D21;
  _V10_Dpair_D473.rest = VNULL;
  _V10_Dpair_D472.first = VEncodeBool(false);
  ...
  _V10_Dpair_D470.first = _V0collect__acc_D14__tail_D22;
  _V10_Dpair_D470.rest = VNULL;
  _V10_Dpair_D469.first = VEncodePointer(&_V10_Dpair_D464, VPOINTER_PAIR);
  ...
  _V10_Dpair_D467.first = VEncodePointer(&_V10_Dpair_D465, VPOINTER_PAIR);
  _V10_Dpair_D467.rest = VEncodePointer(&_V10_Dpair_D466, VPOINTER_PAIR);
  _V10_Dpair_D466.first = VEncodePointer(&_V10_Dpair_D451, VPOINTER_PAIR);
  _V10_Dpair_D466.rest = VEncodePointer(&_V10_Dpair_D454, VPOINTER_PAIR);
  _V10_Dpair_D465.first = _V0loop_D1;
  _V10_Dpair_D465.rest = VNULL;
  ...
  _V10_Dpair_D454.first = VEncodePointer(&_V10_Dpair_D445, VPOINTER_PAIR);
  ...
  _V10_Dpair_D451.first = _V0finalize_D2;
  _V10_Dpair_D451.rest = VNULL;
  _V10_Dpair_D450.first = VEncodePointer(&_V10_Dpair_D447, VPOINTER_PAIR);
  ...
  _V10_Dpair_D448.first = VEncodePointer(&_V10_Dpair_D438, VPOINTER_PAIR);
  _V10_Dpair_D448.rest = VEncodePointer(&_V10_Dpair_D442, VPOINTER_PAIR);
  ...
  _V10_Dpair_D445.first = _V0collect__acc_D3;
  _V10_Dpair_D445.rest = VNULL;
  _V10_Dpair_D444.first = VEncodePointer(&_V10_Dpair_D440, VPOINTER_PAIR);
  ...
  _V10_Dpair_D442.rest = VEncodePointer(&_V10_Dpair_D302, VPOINTER_PAIR);
  _V10_Dpair_D441.first = _V0y_D10;
  _V10_Dpair_D441.rest = VNULL;
  _V10_Dpair_D440.first = VEncodeBool(false);
  ...
  _V10_Dpair_D438.first = _V0collect__acc_D3__tail_D11;
  _V10_Dpair_D438.rest = VNULL;
  _V10_Dpair_D437.first = VEncodePointer(&_V10_Dpair_D436, VPOINTER_PAIR);
  _V10_Dpair_D437.rest = VEncodePointer(&_V10_Dpair_D300, VPOINTER_PAIR);
  _V10_Dpair_D436.first = VEncodePointer(&_V10_Dpair_D434, VPOINTER_PAIR);
  _V10_Dpair_D436.rest = VEncodePointer(&_V10_Dpair_D435, VPOINTER_PAIR);
  _V10_Dpair_D435.first = VEncodePointer(&_V10_Dpair_D284, VPOINTER_PAIR);
  _V10_Dpair_D435.rest = VNULL;
  ...
  _V10_Dpair_D432.first = _V0closure__env;
  _V10_Dpair_D432.rest = VNULL;
  _V10_Dpair_D430.first = VEncodePointer(&_V10_Dpair_D429, VPOINTER_PAIR);
  _V10_Dpair_D430.rest = VEncodePointer(&_V10_Dpair_D329, VPOINTER_PAIR);
  _V10_Dpair_D429.first = VEncodePointer(&_V10_Dpair_D428, VPOINTER_PAIR);
  _V10_Dpair_D429.rest = VEncodePointer(&_V10_Dpair_D255, VPOINTER_PAIR);
  _V10_Dpair_D428.first = _V0vanity;
  _V10_Dpair_D428.rest = VEncodePointer(&_V10_Dpair_D427, VPOINTER_PAIR);
  _V10_Dpair_D427.first = _V0debug;
  _V10_Dpair_D427.rest = VEncodePointer(&_V10_Dpair_D426, VPOINTER_PAIR);
  _V10_Dpair_D426.first = _V0closure__bt__impl;
  _V10_Dpair_D426.rest = VEncodePointer(&_V10_Dpair_D425, VPOINTER_PAIR);
  _V10_Dpair_D425.first = _V10_Dfinalize_D24_D80;
  _V10_Dpair_D425.rest = VNULL;
  _V10_Dpair_D424.first = VEncodePointer(&_V10_Dpair_D261, VPOINTER_PAIR);
  _V10_Dpair_D424.rest = VEncodePointer(&_V10_Dpair_D343, VPOINTER_PAIR);
  _V10_Dpair_D422.first = VEncodePointer(&_V10_Dpair_D421, VPOINTER_PAIR);
  _V10_Dpair_D422.rest = VEncodePointer(&_V10_Dpair_D373, VPOINTER_PAIR);
  _V10_Dpair_D421.first = VEncodePointer(&_V10_Dpair_D418, VPOINTER_PAIR);
  ...
  _V10_Dpair_D419.first = _V0_Mk;
  _V10_Dpair_D419.rest = VEncodePointer(&_V10_Dpair_D363, VPOINTER_PAIR);
  _V10_Dpair_D418.first = _V0vanity;
  _V10_Dpair_D418.rest = VEncodePointer(&_V10_Dpair_D417, VPOINTER_PAIR);
  _V10_Dpair_D417.first = _V0debug;
  _V10_Dpair_D417.rest = VEncodePointer(&_V10_Dpair_D416, VPOINTER_PAIR);
  _V10_Dpair_D416.first = _V0closure__bt__impl;
  _V10_Dpair_D416.rest = VEncodePointer(&_V10_Dpair_D415, VPOINTER_PAIR);
  _V10_Dpair_D415.first = _V10_Dloop_D23_D81;
  _V10_Dpair_D415.rest = VEncodePointer(&_V10_Dpair_D414, VPOINTER_PAIR);
  _V10_Dpair_D414.first = _V10_Dfinalize_D34_D88;
  _V10_Dpair_D414.rest = VNULL;
  _V10_Dpair_D413.first = VEncodePointer(&_V10_Dpair_D261, VPOINTER_PAIR);
  _V10_Dpair_D413.rest = VEncodePointer(&_V10_Dpair_D411, VPOINTER_PAIR);
  _V10_Dpair_D412.first = VEncodePointer(&_V10_Dpair_D256, VPOINTER_PAIR);
  ...
  _V10_Dpair_D410.first = VEncodePointer(&_V10_Dpair_D403, VPOINTER_PAIR);
  _V10_Dpair_D410.rest = VEncodePointer(&_V10_Dpair_D409, VPOINTER_PAIR);
  _V10_Dpair_D409.first = VEncodePointer(&_V10_Dpair_D259, VPOINTER_PAIR);
  _V10_Dpair_D409.rest = VEncodePointer(&_V10_Dpair_D387, VPOINTER_PAIR);
  _V10_Dpair_D408.first = VEncodePointer(&_V10_Dpair_D261, VPOINTER_PAIR);
  _V10_Dpair_D408.rest = VEncodePointer(&_V10_Dpair_D388, VPOINTER_PAIR);
  _V10_Dpair_D407.first = VEncodePointer(&_V10_Dpair_D261, VPOINTER_PAIR);
  _V10_Dpair_D407.rest = VEncodePointer(&_V10_Dpair_D405, VPOINTER_PAIR);
  _V10_Dpair_D406.first = VEncodePointer(&_V10_Dpair_D256, VPOINTER_PAIR);
  ...
  _V10_Dpair_D404.first = VEncodePointer(&_V10_Dpair_D403, VPOINTER_PAIR);
  _V10_Dpair_D404.rest = VEncodePointer(&_V10_Dpair_D400, VPOINTER_PAIR);
  _V10_Dpair_D403.first = _V0_Mx;
  _V10_Dpair_D403.rest = VEncodePointer(&_V10_Dpair_D345, VPOINTER_PAIR);
  _V10_Dpair_D402.first = VEncodePointer(&_V10_Dpair_D256, VPOINTER_PAIR);
  ...
  _V10_Dpair_D400.first = VEncodePointer(&_V10_Dpair_D398, VPOINTER_PAIR);
  _V10_Dpair_D400.rest = VEncodePointer(&_V10_Dpair_D399, VPOINTER_PAIR);
  _V10_Dpair_D399.first = VEncodePointer(&_V10_Dpair_D259, VPOINTER_PAIR);
  _V10_Dpair_D399.rest = VEncodePointer(&_V10_Dpair_D392, VPOINTER_PAIR);
  _V10_Dpair_D398.first = _V0_Mx;
  _V10_Dpair_D398.rest = VEncodePointer(&_V10_Dpair_D397, VPOINTER_PAIR);
  _V10_Dpair_D397.first = _V0_Mx;
  _V10_Dpair_D397.rest = VEncodePointer(&_V10_Dpair_D396, VPOINTER_PAIR);
  _V10_Dpair_D396.first = _V0_Snode_S;
  _V10_Dpair_D396.rest = VEncodePointer(&_V10_Dpair_D345, VPOINTER_PAIR);
  _V40VClosureRef = VEncodePointer(VLookupConstant("_V40VClosureRef", &_VW_V40VClosureRef), VPOINTER_CLOSURE);
  _V10_Dpair_D395.first = VEncodePointer(&_V10_Dpair_D261, VPOINTER_PAIR);
  _V10_Dpair_D395.rest = VEncodePointer(&_V10_Dpair_D393, VPOINTER_PAIR);
  _V10_Dpair_D394.first = VEncodePointer(&_V10_Dpair_D256, VPOINTER_PAIR);
  ...
  _V10_Dpair_D392.first = VEncodePointer(&_V10_Dpair_D345, VPOINTER_PAIR);
  _V10_Dpair_D392.rest = VEncodePointer(&_V10_Dpair_D391, VPOINTER_PAIR);
  _V10_Dpair_D391.first = VEncodePointer(&_V10_Dpair_D345, VPOINTER_PAIR);
  _V10_Dpair_D391.rest = VEncodePointer(&_V10_Dpair_D390, VPOINTER_PAIR);
  _V10_Dpair_D390.first = VEncodePointer(&_V10_Dpair_D382, VPOINTER_PAIR);
  _V10_Dpair_D390.rest = VEncodePointer(&_V10_Dpair_D387, VPOINTER_PAIR);
  ...
  _V10_Dpair_D386.first = VEncodePointer(&_V10_Dpair_D369, VPOINTER_PAIR);
  _V10_Dpair_D386.rest = VEncodePointer(&_V10_Dpair_D372, VPOINTER_PAIR);
  _V10_Dpair_D385.first = _V0loop_D33;
  _V10_Dpair_D385.rest = VNULL;
  _V10_Dpair_D384.first = VEncodePointer(&_V10_Dpair_D379, VPOINTER_PAIR);
  ...
  _V10_Dpair_D372.first = VEncodePointer(&_V10_Dpair_D363, VPOINTER_PAIR);
  ...
  _V10_Dpair_D369.first = _V0finalize_D34;
  _V10_Dpair_D369.rest = VNULL;
  _V10_Dpair_D368.first = VEncodePointer(&_V10_Dpair_D365, VPOINTER_PAIR);
  ...
  _V10_Dpair_D366.first = VEncodePointer(&_V10_Dpair_D355, VPOINTER_PAIR);
  _V10_Dpair_D366.rest = VEncodePointer(&_V10_Dpair_D360, VPOINTER_PAIR);
  _V10_Dpair_D365.first = VEncodeBool(false);
  ...
  _V10_Dpair_D363.first = _V0collect__acc_D35;
  _V10_Dpair_D363.rest = VNULL;
  _V10_Dpair_D362.first = VEncodePointer(&_V10_Dpair_D357, VPOINTER_PAIR);
  ...
  _V10_Dpair_D360.first = VEncodePointer(&_V10_Dpair_D358, VPOINTER_PAIR);
  _V10_Dpair_D360.rest = VEncodePointer(&_V10_Dpair_D359, VPOINTER_PAIR);
  _V10_Dpair_D359.first = VEncodePointer(&_V10_Dpair_D351, VPOINTER_PAIR);
  _V10_Dpair_D359.rest = VEncodePointer(&_V10_Dpair_D348, VPOINTER_PAIR);
  _V10_Dpair_D358.first = _V0y_D42;
  _V10_Dpair_D358.rest = VNULL;
  _V10_Dpair_D357.first = VEncodeBool(false);
  _V10_Dpair_D357.rest = VEncodePointer(&_V10_Dpair_D356, VPOINTER_PAIR);
  _V10_Dpair_D356.first = VEncodePointer(&_V10_Dpair_D355, VPOINTER_PAIR);
  _V10_Dpair_D356.rest = VNULL;
  _V10_Dpair_D355.first = _V0collect__acc_D35__tail_D43;
  ...
  _V10_Dpair_D354.rest = VEncodePointer(&_V10_Dpair_D349, VPOINTER_PAIR);
  _V10_Dpair_D353.first = VEncodeBool(false);
  ...
  _V10_Dpair_D351.first = _V0frame__names;
  _V10_Dpair_D351.rest = VNULL;
  _V10_Dpair_D350.first = VEncodePointer(&_V10_Dpair_D256, VPOINTER_PAIR);
  ...
  _V10_Dpair_D348.first = VEncodePointer(&_V10_Dpair_D345, VPOINTER_PAIR);
  _V10_Dpair_D348.rest = VEncodePointer(&_V10_Dpair_D347, VPOINTER_PAIR);
  _V10_Dpair_D347.first = VEncodePointer(&_V10_Dpair_D345, VPOINTER_PAIR);
  _V10_Dpair_D347.rest = VEncodePointer(&_V10_Dpair_D346, VPOINTER_PAIR);
  _V10_Dpair_D346.first = VEncodePointer(&_V10_Dpair_D337, VPOINTER_PAIR);
  _V10_Dpair_D346.rest = VEncodePointer(&_V10_Dpair_D342, VPOINTER_PAIR);
  _V10_Dpair_D345.first = _V0_Mp;
  _V10_Dpair_D345.rest = VNULL;
  _V10_Dpair_D344.first = VEncodePointer(&_V10_Dpair_D339, VPOINTER_PAIR);
  ...
  _V10_Dpair_D342.first = VEncodePointer(&_V10_Dpair_D340, VPOINTER_PAIR);
  _V10_Dpair_D342.rest = VEncodePointer(&_V10_Dpair_D341, VPOINTER_PAIR);
  _V10_Dpair_D341.first = VEncodePointer(&_V10_Dpair_D322, VPOINTER_PAIR);
  _V10_Dpair_D341.rest = VEncodePointer(&_V10_Dpair_D328, VPOINTER_PAIR);
  _V10_Dpair_D340.first = _V0loop_D23;
  _V10_Dpair_D340.rest = VNULL;
  _V10_Dpair_D339.first = VEncodePointer(&_V10_Dpair_D334, VPOINTER_PAIR);
  ...
  _V10_Dpair_D328.first = VEncodePointer(&_V10_Dpair_D325, VPOINTER_PAIR);
  ...
  _V10_Dpair_D326.first = VEncodePointer(&_V10_Dpair_D259, VPOINTER_PAIR);
  _V10_Dpair_D326.rest = VEncodePointer(&_V10_Dpair_D313, VPOINTER_PAIR);
  _V10_Dpair_D325.first = _V0y_D32;
  _V10_Dpair_D325.rest = VNULL;
  _V10_Dpair_D324.first = VEncodeBool(false);
  ...
  _V10_Dpair_D322.first = _V0finalize_D24;
  ...
  _V10_Dpair_D321.first = VEncodePointer(&_V10_Dpair_D317, VPOINTER_PAIR);
  ...
  _V10_Dpair_D319.first = _V0unquote;
  _V10_Dpair_D319.rest = VEncodePointer(&_V10_Dpair_D318, VPOINTER_PAIR);
  _V10_Dpair_D318.first = _V0unmangled__env;
  ...
  _V10_Dpair_D316.first = _V0_U;
  _V10_Dpair_D316.rest = VNULL;
  _V10_Dpair_D315.first = VEncodePointer(&_V10_Dpair_D261, VPOINTER_PAIR);
  ...
  _V10_Dpair_D314.rest = VNULL;
  _V10_Dpair_D313.first = VEncodePointer(&_V10_Dpair_D259, VPOINTER_PAIR);
  _V10_Dpair_D313.rest = VEncodePointer(&_V10_Dpair_D310, VPOINTER_PAIR);
  _V10_Dpair_D312.first = VEncodePointer(&_V10_Dpair_D261, VPOINTER_PAIR);
  ...
  _V10_Dpair_D310.first = VEncodePointer(&_V10_Dpair_D287, VPOINTER_PAIR);
  _V10_Dpair_D310.rest = VEncodePointer(&_V10_Dpair_D299, VPOINTER_PAIR);
  _V10_Dpair_D309.first = VEncodePointer(&_V10_Dpair_D308, VPOINTER_PAIR);
  _V10_Dpair_D309.rest = VEncodePointer(&_V10_Dpair_D300, VPOINTER_PAIR);
  _V10_Dpair_D308.first = VEncodePointer(&_V10_Dpair_D307, VPOINTER_PAIR);
  _V10_Dpair_D308.rest = VEncodePointer(&_V10_Dpair_D288, VPOINTER_PAIR);
  _V10_Dpair_D307.first = _V0vanity;
  _V10_Dpair_D307.rest = VEncodePointer(&_V10_Dpair_D306, VPOINTER_PAIR);
  _V10_Dpair_D306.first = _V0debug;
  _V10_Dpair_D306.rest = VEncodePointer(&_V10_Dpair_D305, VPOINTER_PAIR);
  _V10_Dpair_D305.first = _V0closure__bt__impl;
  _V10_Dpair_D305.rest = VNULL;
  _V10_Dpair_D304.first = VEncodePointer(&_V10_Dpair_D261, VPOINTER_PAIR);
  ...
  _V10_Dpair_D302.first = VEncodePointer(&_V10_Dpair_D284, VPOINTER_PAIR);
  _V10_Dpair_D302.rest = VEncodePointer(&_V10_Dpair_D299, VPOINTER_PAIR);
  _V10_Dpair_D301.first = VEncodePointer(&_V10_Dpair_D290, VPOINTER_PAIR);
  ...
  _V10_Dpair_D299.first = VEncodePointer(&_V10_Dpair_D297, VPOINTER_PAIR);
  _V10_Dpair_D299.rest = VEncodePointer(&_V10_Dpair_D298, VPOINTER_PAIR);
  _V10_Dpair_D298.first = VEncodePointer(&_V10_Dpair_D274, VPOINTER_PAIR);
  _V10_Dpair_D298.rest = VEncodePointer(&_V10_Dpair_D277, VPOINTER_PAIR);
  _V10_Dpair_D297.first = _V0closure__bt;
  _V10_Dpair_D297.rest = VEncodePointer(&_V10_Dpair_D296, VPOINTER_PAIR);
  _V10_Dpair_D296.first = _V0closure__bt__impl;
  _V10_Dpair_D296.rest = VEncodePointer(&_V10_Dpair_D295, VPOINTER_PAIR);
  _V10_Dpair_D295.first = _V0closure__env;
  _V10_Dpair_D295.rest = VEncodePointer(&_V10_Dpair_D294, VPOINTER_PAIR);
  _V10_Dpair_D294.first = _V0closure__env__names;
  _V10_Dpair_D294.rest = VEncodePointer(&_V10_Dpair_D293, VPOINTER_PAIR);
  _V10_Dpair_D293.first = _V0closure__formals;
  _V10_Dpair_D293.rest = VEncodePointer(&_V10_Dpair_D292, VPOINTER_PAIR);
  _V10_Dpair_D292.first = _V0closure__name;
  _V10_Dpair_D292.rest = VEncodePointer(&_V10_Dpair_D291, VPOINTER_PAIR);
  _V10_Dpair_D291.first = _V0current__signaling__arguments;
  _V10_Dpair_D291.rest = VNULL;
  _V10_Dpair_D290.first = VEncodePointer(&_V10_Dpair_D282, VPOINTER_PAIR);
  _V10_Dpair_D290.rest = VEncodePointer(&_V10_Dpair_D289, VPOINTER_PAIR);
  _V10_Dpair_D289.first = VEncodePointer(&_V10_Dpair_D284, VPOINTER_PAIR);
  ...
  _V10_Dpair_D277.first = VEncodePointer(&_V10_Dpair_D259, VPOINTER_PAIR);
  _V10_Dpair_D277.rest = VEncodePointer(&_V10_Dpair_D264, VPOINTER_PAIR);
  ...
  _V10_Dpair_D274.first = _V0current__output__port;
  _V10_Dpair_D274.rest = VEncodePointer(&_V10_Dpair_D273, VPOINTER_PAIR);
  _V10_Dpair_D273.first = _V0newline;
  ...
  _V10_Dpair_D264.first = VEncodePointer(&_V10_Dpair_D259, VPOINTER_PAIR);
  _V10_Dpair_D264.rest = VEncodePointer(&_V10_Dpair_D255, VPOINTER_PAIR);
  _V10_Dpair_D263.first = VEncodePointer(&_V10_Dpair_D261, VPOINTER_PAIR);
  _V10_Dpair_D263.rest = VEncodePointer(&_V10_Dpair_D262, VPOINTER_PAIR);
  _V10_Dpair_D262.first = VEncodePointer(&_V10_Dpair_D255, VPOINTER_PAIR);
  ...
  _V10_Dpair_D259.first = _V0_Mx;
  _V10_Dpair_D259.rest = VNULL;
  _V10_Dpair_D258.first = VEncodePointer(&_V10_Dpair_D256, VPOINTER_PAIR);
  _V10_Dpair_D258.rest = VEncodePointer(&_V10_Dpair_D257, VPOINTER_PAIR);
  _V10_Dpair_D257.first = VNULL;
  _V10_Dpair_D257.rest = VNULL;
  _V10_Dpair_D256.first = VEncodeBool(false);
  ...
  _V10_Dpair_D254.first = _V0_Mk;
  _V10_Dpair_D254.rest = VNULL;
  VRegisterProcDebugInfo((VFunc)_V10_Dclosure__bt_D67_V0k3, VEncodePointer(&_V10_Dpair_D304, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__bt, VEncodePointer(&_V10_Dpair_D301, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__bt__impl_V10_Dloop_D23_D81_V0k7, VEncodePointer(&_V10_Dpair_D350, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__bt__impl_V10_Dloop_D23_D81_V10_Dloop_D33_D89_V0k10, VEncodePointer(&_V10_Dpair_D394, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__bt__impl_V10_Dloop_D23_D81_V10_Dloop_D33_D89_V0k12, VEncodePointer(&_V10_Dpair_D402, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__bt__impl_V10_Dloop_D23_D81_V10_Dloop_D33_D89_V0k15, VEncodePointer(&_V10_Dpair_D406, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__bt__impl_V10_Dloop_D23_D81_V10_Dloop_D33_D89_V0k16, VEncodePointer(&_V10_Dpair_D407, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__bt__impl_V10_Dloop_D23_D81_V10_Dloop_D33_D89_V0k14, VEncodePointer(&_V10_Dpair_D321, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__bt__impl_V10_Dloop_D23_D81_V10_Dloop_D33_D89_V0k13, VEncodePointer(&_V10_Dpair_D321, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__bt__impl_V10_Dloop_D23_D81_V10_Dloop_D33_D89_V0k11, VEncodePointer(&_V10_Dpair_D395, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__bt__impl_V10_Dloop_D23_D81_V10_Dloop_D33_D89, VEncodePointer(&_V10_Dpair_D389, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__bt__impl_V10_Dloop_D23_D81_V0k20, VEncodePointer(&_V10_Dpair_D412, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__bt__impl_V10_Dloop_D23_D81_V0k21, VEncodePointer(&_V10_Dpair_D413, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__bt__impl_V10_Dloop_D23_D81_V0k19, VEncodePointer(&_V10_Dpair_D321, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__bt__impl_V10_Dloop_D23_D81_V0k18, VEncodePointer(&_V10_Dpair_D321, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__bt__impl_V10_Dloop_D23_D81_V0k17, VEncodePointer(&_V10_Dpair_D408, VPOINTER_PAIR));
  ...
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__bt__impl_V10_Dloop_D23_D81_V10_Dfinalize_D34_D88, VEncodePointer(&_V10_Dpair_D422, VPOINTER_PAIR));
  ...
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__bt__impl_V10_Dloop_D23_D81_V0lambda4, VEncodePointer(&_V10_Dpair_D362, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__bt__impl_V10_Dloop_D23_D81_V0k9, VEncodePointer(&_V10_Dpair_D321, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__bt__impl_V10_Dloop_D23_D81_V0k8, VEncodePointer(&_V10_Dpair_D354, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__bt__impl_V10_Dloop_D23_D81, VEncodePointer(&_V10_Dpair_D344, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__bt__impl_V0k22, VEncodePointer(&_V10_Dpair_D424, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__bt__impl_V0lambda3, VEncodePointer(&_V10_Dpair_D330, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__bt__impl_V10_Dfinalize_D24_D80, VEncodePointer(&_V10_Dpair_D430, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__bt__impl_V0k6, VEncodePointer(&_V10_Dpair_D321, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__bt__impl_V0k5, VEncodePointer(&_V10_Dpair_D315, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__bt__impl_V0k4, VEncodePointer(&_V10_Dpair_D312, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__bt__impl, VEncodePointer(&_V10_Dpair_D309, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__env_V10_Dloop_D1_D99_V10_Dloop_D12_D106_V0k23, VEncodePointer(&_V10_Dpair_D509, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__env_V10_Dloop_D1_D99_V10_Dloop_D12_D106_V0k25, VEncodePointer(&_V10_Dpair_D321, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__env_V10_Dloop_D1_D99_V10_Dloop_D12_D106_V0k24, VEncodePointer(&_V10_Dpair_D321, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__env_V10_Dloop_D1_D99_V10_Dloop_D12_D106, VEncodePointer(&_V10_Dpair_D504, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__env_V10_Dloop_D1_D99_V0k27, VEncodePointer(&_V10_Dpair_D514, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__env_V10_Dloop_D1_D99_V0k29, VEncodePointer(&_V10_Dpair_D321, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__env_V10_Dloop_D1_D99_V0k28, VEncodePointer(&_V10_Dpair_D321, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__env_V10_Dloop_D1_D99_V0k26, VEncodePointer(&_V10_Dpair_D510, VPOINTER_PAIR));
  ...
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__env_V10_Dloop_D1_D99_V10_Dfinalize_D13_D105, VEncodePointer(&_V10_Dpair_D523, VPOINTER_PAIR));
  ...
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__env_V10_Dloop_D1_D99_V0lambda10, VEncodePointer(&_V10_Dpair_D478, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__env_V10_Dloop_D1_D99, VEncodePointer(&_V10_Dpair_D469, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__env_V0lambda9, VEncodePointer(&_V10_Dpair_D456, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__env_V10_Dfinalize_D2_D98, VEncodePointer(&_V10_Dpair_D531, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__env_V0lambda8, VEncodePointer(&_V10_Dpair_D450, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__env_V0lambda7, VEncodePointer(&_V10_Dpair_D444, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__env, VEncodePointer(&_V10_Dpair_D437, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__env__names_V0k30, VEncodePointer(&_V10_Dpair_D540, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__env__names_V0k31, VEncodePointer(&_V10_Dpair_D543, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__env__names, VEncodePointer(&_V10_Dpair_D536, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__formals, VEncodePointer(&_V10_Dpair_D548, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0closure__name, VEncodePointer(&_V10_Dpair_D554, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0current__signaling__arguments_V0k32, VEncodePointer(&_V10_Dpair_D563, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V50_V0vanity_V0debug_V0current__signaling__arguments, VEncodePointer(&_V10_Dpair_D558, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0debug_V20_V0lambda2, VEncodePointer(&_V10_Dpair_D279, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0debug_V20_V0k2, VEncodePointer(&_V10_Dpair_D266, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0debug_V20_V0k1, VEncodePointer(&_V10_Dpair_D263, VPOINTER_PAIR));
  VRegisterProcDebugInfo((VFunc)_V0vanity_V0debug_V20_V0lambda1, VEncodePointer(&_V10_Dpair_D258, VPOINTER_PAIR));
}
