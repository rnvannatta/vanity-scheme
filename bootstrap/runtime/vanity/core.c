...
#include <stdarg.h>
static struct { VBlob sym; char bytes[21]; } _V10string_D1146 = { { .base = { .tag = VSTRING }, 21 }, "_V0vanity_V0seed_V20" };
static struct { VBlob sym; char bytes[21]; } _V10string_D1145 = { { .base = { .tag = VSTRING }, 21 }, "_V0vanity_V0core_V20" };
VWEAK VWORD _V40_V10sys_Dnull_Q;VWEAK VClosure _VW_V40_V10sys_Dnull_Q = { .base = { .tag = VCLOSURE }, (VFunc)VNullP2, NULL };
VWEAK VWORD _V40_V10sys_Deof__object_Q;VWEAK VClosure _VW_V40_V10sys_Deof__object_Q = { .base = { .tag = VCLOSURE }, (VFunc)VEofP2, NULL };
VWEAK VWORD _V40_V10sys_Dpair_Q;VWEAK VClosure _VW_V40_V10sys_Dpair_Q = { .base = { .tag = VCLOSURE }, (VFunc)VPairP2, NULL };
VWEAK VWORD _V40_V10sys_Dvector_Q;VWEAK VClosure _VW_V40_V10sys_Dvector_Q = { .base = { .tag = VCLOSURE }, (VFunc)VVectorP2, NULL };
VWEAK VWORD _V40_V10sys_Dprocedure_Q;VWEAK VClosure _VW_V40_V10sys_Dprocedure_Q = { .base = { .tag = VCLOSURE }, (VFunc)VProcedureP2, NULL };
VWEAK VWORD _V40_V10sys_Dsymbol_Q;VWEAK VClosure _VW_V40_V10sys_Dsymbol_Q = { .base = { .tag = VCLOSURE }, (VFunc)VSymbolP2, NULL };
VWEAK VWORD _V40_V10sys_Dstring_Q;VWEAK VClosure _VW_V40_V10sys_Dstring_Q = { .base = { .tag = VCLOSURE }, (VFunc)VStringP2, NULL };
VWEAK VWORD _V40_V10sys_Dchar_Q;VWEAK VClosure _VW_V40_V10sys_Dchar_Q = { .base = { .tag = VCLOSURE }, (VFunc)VCharP2, NULL };
VWEAK VWORD _V40_V10sys_Dint_Q;VWEAK VClosure _VW_V40_V10sys_Dint_Q = { .base = { .tag = VCLOSURE }, (VFunc)VIntP2, NULL };
VWEAK VWORD _V40_V10sys_Ddouble_Q;VWEAK VClosure _VW_V40_V10sys_Ddouble_Q = { .base = { .tag = VCLOSURE }, (VFunc)VDoubleP2, NULL };
VWEAK VWORD _V40_V10sys_Dsymbol_E_Q;VWEAK VClosure _VW_V40_V10sys_Dsymbol_E_Q = { .base = { .tag = VCLOSURE }, (VFunc)VSymbolEqv2, NULL };
VWEAK VWORD _V40_V10sys_Deqv_Q;VWEAK VClosure _VW_V40_V10sys_Deqv_Q = { .base = { .tag = VCLOSURE }, (VFunc)VEqv, NULL };
VWEAK VWORD _V40_V10sys_Dnot;VWEAK VClosure _VW_V40_V10sys_Dnot = { .base = { .tag = VCLOSURE }, (VFunc)VNot2, NULL };
VWEAK VWORD _V40_V10sys_D_P;VWEAK VClosure _VW_V40_V10sys_D_P = { .base = { .tag = VCLOSURE }, (VFunc)VAdd2, NULL };
VWEAK VWORD _V40_V10sys_D__;VWEAK VClosure _VW_V40_V10sys_D__ = { .base = { .tag = VCLOSURE }, (VFunc)VSub2, NULL };
VWEAK VWORD _V40_V10sys_D_S;VWEAK VClosure _VW_V40_V10sys_D_S = { .base = { .tag = VCLOSURE }, (VFunc)VMul2, NULL };
VWEAK VWORD _V40_V10sys_D_W;VWEAK VClosure _VW_V40_V10sys_D_W = { .base = { .tag = VCLOSURE }, (VFunc)VDiv2, NULL };
VWEAK VWORD _V40_V10sys_Dquotient;VWEAK VClosure _VW_V40_V10sys_Dquotient = { .base = { .tag = VCLOSURE }, (VFunc)VQuot2, NULL };
VWEAK VWORD _V40_V10sys_Dremainder;VWEAK VClosure _VW_V40_V10sys_Dremainder = { .base = { .tag = VCLOSURE }, (VFunc)VRem2, NULL };
VWEAK VWORD _V40_V10sys_Dcons;VWEAK VClosure _VW_V40_V10sys_Dcons = { .base = { .tag = VCLOSURE }, (VFunc)VCons2, NULL };
VWEAK VWORD _V40_V10sys_Dset__car_B;VWEAK VClosure _VW_V40_V10sys_Dset__car_B = { .base = { .tag = VCLOSURE }, (VFunc)VSetCar2, NULL };
VWEAK VWORD _V40_V10sys_Dset__cdr_B;VWEAK VClosure _VW_V40_V10sys_Dset__cdr_B = { .base = { .tag = VCLOSURE }, (VFunc)VSetCdr2, NULL };
VWEAK VWORD _V40_V10sys_Dcar;VWEAK VClosure _VW_V40_V10sys_Dcar = { .base = { .tag = VCLOSURE }, (VFunc)VCar2, NULL };
VWEAK VWORD _V40_V10sys_Dcdr;VWEAK VClosure _VW_V40_V10sys_Dcdr = { .base = { .tag = VCLOSURE }, (VFunc)VCdr2, NULL };
VWEAK VWORD _V40_V10sys_Dmake__string;VWEAK VClosure _VW_V40_V10sys_Dmake__string = { .base = { .tag = VCLOSURE }, (VFunc)VMakeString2, NULL };
VWEAK VWORD _V40_V10sys_Dsubstring;VWEAK VClosure _VW_V40_V10sys_Dsubstring = { .base = { .tag = VCLOSURE }, (VFunc)VSubstring2, NULL };
VWEAK VWORD _V40_V10sys_Dstring__copy_B;VWEAK VClosure _VW_V40_V10sys_Dstring__copy_B = { .base = { .tag = VCLOSURE }, (VFunc)VStringCopy2, NULL };
VWEAK VWORD _V40_V10sys_Dstring__ref;VWEAK VClosure _VW_V40_V10sys_Dstring__ref = { .base = { .tag = VCLOSURE }, (VFunc)VStringRef2, NULL };
VWEAK VWORD _V40_V10sys_Dstring__set_B;VWEAK VClosure _VW_V40_V10sys_Dstring__set_B = { .base = { .tag = VCLOSURE }, (VFunc)VStringSet2, NULL };
VWEAK VWORD _V40_V10sys_Dstring__length;VWEAK VClosure _VW_V40_V10sys_Dstring__length = { .base = { .tag = VCLOSURE }, (VFunc)VStringLength2, NULL };
VWEAK VWORD _V40_V10sys_Dstring___Gsymbol;VWEAK VClosure _VW_V40_V10sys_Dstring___Gsymbol = { .base = { .tag = VCLOSURE }, (VFunc)VStringSymbol2, NULL };
VWEAK VWORD _V40_V10sys_Dstring___Gnumber;VWEAK VClosure _VW_V40_V10sys_Dstring___Gnumber = { .base = { .tag = VCLOSURE }, (VFunc)VStringNumber2, NULL };
VWEAK VWORD _V40_V10sys_Dsymbol___Gstring;VWEAK VClosure _VW_V40_V10sys_Dsymbol___Gstring = { .base = { .tag = VCLOSURE }, (VFunc)VSymbolString2, NULL };
static struct { VBlob sym; char bytes[1]; } _V10string_D1144 = { { .base = { .tag = VSTRING }, 1 }, "" };
VWEAK VWORD _V40_V10sys_Dlist___Gvector;VWEAK VClosure _VW_V40_V10sys_Dlist___Gvector = { .base = { .tag = VCLOSURE }, (VFunc)VListVector2, NULL };
VWEAK VWORD _V40_V10sys_Dvector__ref;VWEAK VClosure _VW_V40_V10sys_Dvector__ref = { .base = { .tag = VCLOSURE }, (VFunc)VVectorRef2, NULL };
VWEAK VWORD _V40_V10sys_Dvector__set_B;VWEAK VClosure _VW_V40_V10sys_Dvector__set_B = { .base = { .tag = VCLOSURE }, (VFunc)VVectorSet2, NULL };
VWEAK VWORD _V40_V10sys_Dvector__length;VWEAK VClosure _VW_V40_V10sys_Dvector__length = { .base = { .tag = VCLOSURE }, (VFunc)VVectorLength2, NULL };
VWEAK VWORD _V40_V10sys_Deq_Q;VWEAK VClosure _VW_V40_V10sys_Deq_Q = { .base = { .tag = VCLOSURE }, (VFunc)VEq2, NULL };
VWEAK VWORD _V40_V10vcore_Dhash__table__equivalence__function;VWEAK VClosure _VW_V40_V10vcore_Dhash__table__equivalence__function = { .base = { .tag = VCLOSURE }, (VFunc)VHashTableEqvFunc, NULL };
VWEAK VWORD _V40_V10vcore_Dhash__table__hash__function;VWEAK VClosure _VW_V40_V10vcore_Dhash__table__hash__function = { .base = { .tag = VCLOSURE }, (VFunc)VHashTableHashFunc, NULL };
static struct { VBlob sym; char bytes[26]; } _V10string_D1143 = { { .base = { .tag = VSTRING }, 26 }, "No such key in hash table" };
VWEAK VWORD _V40_V10vcore_Dhash__table__set_B;VWEAK VClosure _VW_V40_V10vcore_Dhash__table__set_B = { .base = { .tag = VCLOSURE }, (VFunc)VHashTableSet, NULL };
VWEAK VWORD _V40_V10vcore_Dhash__table__delete_B;VWEAK VClosure _VW_V40_V10vcore_Dhash__table__delete_B = { .base = { .tag = VCLOSURE }, (VFunc)VHashTableDelete, NULL };
VWEAK VWORD _V40_V10sys_Dchar__integer;VWEAK VClosure _VW_V40_V10sys_Dchar__integer = { .base = { .tag = VCLOSURE }, (VFunc)VCharInt2, NULL };
VWEAK VWORD _V40_V10sys_Dclose__stream;VWEAK VClosure _VW_V40_V10sys_Dclose__stream = { .base = { .tag = VCLOSURE }, (VFunc)VCloseStream2, NULL };
VWEAK VWORD _V40_V10sys_Dopen__output__string;VWEAK VClosure _VW_V40_V10sys_Dopen__output__string = { .base = { .tag = VCLOSURE }, (VFunc)VOpenOutputString2, NULL };
static struct { VBlob sym; char bytes[24]; } _V10string_D1142 = { { .base = { .tag = VSTRING }, 24 }, "open-input-file: failed" };
static struct { VBlob sym; char bytes[25]; } _V10string_D1141 = { { .base = { .tag = VSTRING }, 25 }, "open-output-file: failed" };
static struct { VBlob sym; char bytes[27]; } _V10string_D1140 = { { .base = { .tag = VSTRING }, 27 }, "open-output-string: failed" };
VWEAK VWORD _V40_V10sys_Dget__output__string;VWEAK VClosure _VW_V40_V10sys_Dget__output__string = { .base = { .tag = VCLOSURE }, (VFunc)VGetOutputString2, NULL };
static struct { VBlob sym; char bytes[3]; } _V10string_D1139 = { { .base = { .tag = VSTRING }, 3 }, "#(" };
static struct { VBlob sym; char bytes[2]; } _V10string_D1138 = { { .base = { .tag = VSTRING }, 2 }, "(" };
static struct { VBlob sym; char bytes[2]; } _V10string_D1137 = { { .base = { .tag = VSTRING }, 2 }, ")" };
static struct { VBlob sym; char bytes[4]; } _V10string_D1136 = { { .base = { .tag = VSTRING }, 4 }, " . " };
VWEAK VWORD _V0ok;VWEAK struct { VBlob sym; char bytes[3]; } _VW_V0ok = { { .base = { .tag = VSYMBOL }, 3 }, "ok" };
VWEAK VWORD _V40_V10sys_Dcall_Wcc;VWEAK VClosure _VW_V40_V10sys_Dcall_Wcc = { .base = { .tag = VCLOSURE }, (VFunc)VCallCC2, NULL };
VWEAK VWORD _V40_V10sys_Dcall__with__values;VWEAK VClosure _VW_V40_V10sys_Dcall__with__values = { .base = { .tag = VCLOSURE }, (VFunc)VCallValues2, NULL };
VWEAK VWORD _V40_V10sys_Dapply;VWEAK VClosure _VW_V40_V10sys_Dapply = { .base = { .tag = VCLOSURE }, (VFunc)VApply2, NULL };
VWEAK VWORD _V40_V10sys_Dcommand__line;VWEAK VClosure _VW_V40_V10sys_Dcommand__line = { .base = { .tag = VCLOSURE }, (VFunc)VCommandLine2, NULL };
VWEAK VWORD _V40_V10sys_Dsystem;VWEAK VClosure _VW_V40_V10sys_Dsystem = { .base = { .tag = VCLOSURE }, (VFunc)VSystem2, NULL };
VWEAK VWORD _V40_V10sys_Dopen__input__process;VWEAK VClosure _VW_V40_V10sys_Dopen__input__process = { .base = { .tag = VCLOSURE }, (VFunc)VOpenInputProcess2, NULL };
VWEAK VWORD _V40_V10sys_Dopen__output__process;VWEAK VClosure _VW_V40_V10sys_Dopen__output__process = { .base = { .tag = VCLOSURE }, (VFunc)VOpenOutputProcess2, NULL };
VWEAK VWORD _V40_V10sys_Dmake__temporary__file;VWEAK VClosure _VW_V40_V10sys_Dmake__temporary__file = { .base = { .tag = VCLOSURE }, (VFunc)VMakeTemporaryFile2, NULL };
VWEAK VWORD _V40_V10sys_Dexit;VWEAK VClosure _VW_V40_V10sys_Dexit = { .base = { .tag = VCLOSURE }, (VFunc)VExit2, NULL };
static struct { VBlob sym; char bytes[23]; } _V10string_D1135 = { { .base = { .tag = VSTRING }, 23 }, "printf: unknown format" };
static struct { VBlob sym; char bytes[42]; } _V10string_D1134 = { { .base = { .tag = VSTRING }, 42 }, "printf: not enough args for format string" };
static struct { VBlob sym; char bytes[41]; } _V10string_D1133 = { { .base = { .tag = VSTRING }, 41 }, "printf: format string has trailing tilde" };
static struct { VBlob sym; char bytes[8]; } _V10string_D1132 = { { .base = { .tag = VSTRING }, 8 }, "error: " };
static struct { VBlob sym; char bytes[2]; } _V10string_D1131 = { { .base = { .tag = VSTRING }, 2 }, ":" };
static struct { VBlob sym; char bytes[2]; } _V10string_D1130 = { { .base = { .tag = VSTRING }, 2 }, " " };
...
VWEAK VWORD _V0writeln;VWEAK struct { VBlob sym; char bytes[8]; } _VW_V0writeln = { { .base = { .tag = VSYMBOL }, 8 }, "writeln" };
...
VWEAK VWORD _V0make__temporary__file;VWEAK struct { VBlob sym; char bytes[20]; } _VW_V0make__temporary__file = { { .base = { .tag = VSYMBOL }, 20 }, "make-temporary-file" };
VWEAK VWORD _V0open__output__process;VWEAK struct { VBlob sym; char bytes[20]; } _VW_V0open__output__process = { { .base = { .tag = VSYMBOL }, 20 }, "open-output-process" };
...
VWEAK VWORD _V0command__line;VWEAK struct { VBlob sym; char bytes[13]; } _VW_V0command__line = { { .base = { .tag = VSYMBOL }, 13 }, "command-line" };
...
VWEAK VWORD _V0mutator;VWEAK struct { VBlob sym; char bytes[8]; } _VW_V0mutator = { { .base = { .tag = VSYMBOL }, 8 }, "mutator" };
VWEAK VWORD _V0setter;VWEAK struct { VBlob sym; char bytes[7]; } _VW_V0setter = { { .base = { .tag = VSYMBOL }, 7 }, "setter" };
...
VWEAK VWORD _V0call__with__current__continuation;VWEAK struct { VBlob sym; char bytes[31]; } _VW_V0call__with__current__continuation = { { .base = { .tag = VSYMBOL }, 31 }, "call-with-current-continuation" };
VWEAK VWORD _V0call_Wcc;VWEAK struct { VBlob sym; char bytes[8]; } _VW_V0call_Wcc = { { .base = { .tag = VSYMBOL }, 8 }, "call/cc" };
VWEAK VWORD _V0write;VWEAK struct { VBlob sym; char bytes[6]; } _VW_V0write = { { .base = { .tag = VSYMBOL }, 6 }, "write" };
VWEAK VWORD _V0display;VWEAK struct { VBlob sym; char bytes[8]; } _VW_V0display = { { .base = { .tag = VSYMBOL }, 8 }, "display" };
VWEAK VWORD _V0newline;VWEAK struct { VBlob sym; char bytes[8]; } _VW_V0newline = { { .base = { .tag = VSYMBOL }, 8 }, "newline" };
VWEAK VWORD _V0read;VWEAK struct { VBlob sym; char bytes[5]; } _VW_V0read = { { .base = { .tag = VSYMBOL }, 5 }, "read" };
VWEAK VWORD _V0read__line;VWEAK struct { VBlob sym; char bytes[10]; } _VW_V0read__line = { { .base = { .tag = VSYMBOL }, 10 }, "read-line" };
VWEAK VWORD _V0read__char;VWEAK struct { VBlob sym; char bytes[10]; } _VW_V0read__char = { { .base = { .tag = VSYMBOL }, 10 }, "read-char" };
VWEAK VWORD _V0with__input__from__file;VWEAK struct { VBlob sym; char bytes[21]; } _VW_V0with__input__from__file = { { .base = { .tag = VSYMBOL }, 21 }, "with-input-from-file" };
VWEAK VWORD _V0with__output__to__file;VWEAK struct { VBlob sym; char bytes[20]; } _VW_V0with__output__to__file = { { .base = { .tag = VSYMBOL }, 20 }, "with-output-to-file" };
...
VWEAK VWORD _V0open__output__file;VWEAK struct { VBlob sym; char bytes[17]; } _VW_V0open__output__file = { { .base = { .tag = VSYMBOL }, 17 }, "open-output-file" };
VWEAK VWORD _V0open__input__file;VWEAK struct { VBlob sym; char bytes[16]; } _VW_V0open__input__file = { { .base = { .tag = VSYMBOL }, 16 }, "open-input-file" };
VWEAK VWORD _V0current__input__port;VWEAK struct { VBlob sym; char bytes[19]; } _VW_V0current__input__port = { { .base = { .tag = VSYMBOL }, 19 }, "current-input-port" };
...
VWEAK VWORD _V0current__output__port;VWEAK struct { VBlob sym; char bytes[20]; } _VW_V0current__output__port = { { .base = { .tag = VSYMBOL }, 20 }, "current-output-port" };
VWEAK VWORD _V0char___Ginteger;VWEAK struct { VBlob sym; char bytes[14]; } _VW_V0char___Ginteger = { { .base = { .tag = VSYMBOL }, 14 }, "char->integer" };
VWEAK VWORD _V0hash__table__delete_B;VWEAK struct { VBlob sym; char bytes[19]; } _VW_V0hash__table__delete_B = { { .base = { .tag = VSYMBOL }, 19 }, "hash-table-delete!" };
VWEAK VWORD _V0hash__table__set_B;VWEAK struct { VBlob sym; char bytes[16]; } _VW_V0hash__table__set_B = { { .base = { .tag = VSYMBOL }, 16 }, "hash-table-set!" };
VWEAK VWORD _V0hash__table__ref;VWEAK struct { VBlob sym; char bytes[15]; } _VW_V0hash__table__ref = { { .base = { .tag = VSYMBOL }, 15 }, "hash-table-ref" };
VWEAK VWORD _V0make__hash__table;VWEAK struct { VBlob sym; char bytes[16]; } _VW_V0make__hash__table = { { .base = { .tag = VSYMBOL }, 16 }, "make-hash-table" };
VWEAK VWORD _V0vector__for__each;VWEAK struct { VBlob sym; char bytes[16]; } _VW_V0vector__for__each = { { .base = { .tag = VSYMBOL }, 16 }, "vector-for-each" };
VWEAK VWORD _V0vector__length;VWEAK struct { VBlob sym; char bytes[14]; } _VW_V0vector__length = { { .base = { .tag = VSYMBOL }, 14 }, "vector-length" };
VWEAK VWORD _V0vector__set_B;VWEAK struct { VBlob sym; char bytes[12]; } _VW_V0vector__set_B = { { .base = { .tag = VSYMBOL }, 12 }, "vector-set!" };
VWEAK VWORD _V0vector__ref;VWEAK struct { VBlob sym; char bytes[11]; } _VW_V0vector__ref = { { .base = { .tag = VSYMBOL }, 11 }, "vector-ref" };
VWEAK VWORD _V0vector;VWEAK struct { VBlob sym; char bytes[7]; } _VW_V0vector = { { .base = { .tag = VSYMBOL }, 7 }, "vector" };
VWEAK VWORD _V0list___Gvector;VWEAK struct { VBlob sym; char bytes[13]; } _VW_V0list___Gvector = { { .base = { .tag = VSYMBOL }, 13 }, "list->vector" };
...
VWEAK VWORD _V0string___Gnumber;VWEAK struct { VBlob sym; char bytes[15]; } _VW_V0string___Gnumber = { { .base = { .tag = VSYMBOL }, 15 }, "string->number" };
...
VWEAK VWORD _V0string__set_B;VWEAK struct { VBlob sym; char bytes[12]; } _VW_V0string__set_B = { { .base = { .tag = VSYMBOL }, 12 }, "string-set!" };
VWEAK VWORD _V0string__ref;VWEAK struct { VBlob sym; char bytes[11]; } _VW_V0string__ref = { { .base = { .tag = VSYMBOL }, 11 }, "string-ref" };
VWEAK VWORD _V0string__copy_B;VWEAK struct { VBlob sym; char bytes[13]; } _VW_V0string__copy_B = { { .base = { .tag = VSYMBOL }, 13 }, "string-copy!" };
...
VWEAK VWORD _V0make__string;VWEAK struct { VBlob sym; char bytes[12]; } _VW_V0make__string = { { .base = { .tag = VSYMBOL }, 12 }, "make-string" };
VWEAK VWORD _V0list___Gstring;VWEAK struct { VBlob sym; char bytes[13]; } _VW_V0list___Gstring = { { .base = { .tag = VSYMBOL }, 13 }, "list->string" };
VWEAK VWORD _V0string___Glist;VWEAK struct { VBlob sym; char bytes[13]; } _VW_V0string___Glist = { { .base = { .tag = VSYMBOL }, 13 }, "string->list" };
...
VWEAK VWORD _V0assq;VWEAK struct { VBlob sym; char bytes[5]; } _VW_V0assq = { { .base = { .tag = VSYMBOL }, 5 }, "assq" };
...
VWEAK VWORD _V0memq;VWEAK struct { VBlob sym; char bytes[5]; } _VW_V0memq = { { .base = { .tag = VSYMBOL }, 5 }, "memq" };
...
VWEAK VWORD _V0cddddr;VWEAK struct { VBlob sym; char bytes[7]; } _VW_V0cddddr = { { .base = { .tag = VSYMBOL }, 7 }, "cddddr" };
VWEAK VWORD _V0cdddar;VWEAK struct { VBlob sym; char bytes[7]; } _VW_V0cdddar = { { .base = { .tag = VSYMBOL }, 7 }, "cdddar" };
VWEAK VWORD _V0cddadr;VWEAK struct { VBlob sym; char bytes[7]; } _VW_V0cddadr = { { .base = { .tag = VSYMBOL }, 7 }, "cddadr" };
VWEAK VWORD _V0cddaar;VWEAK struct { VBlob sym; char bytes[7]; } _VW_V0cddaar = { { .base = { .tag = VSYMBOL }, 7 }, "cddaar" };
VWEAK VWORD _V0cdaddr;VWEAK struct { VBlob sym; char bytes[7]; } _VW_V0cdaddr = { { .base = { .tag = VSYMBOL }, 7 }, "cdaddr" };
VWEAK VWORD _V0cdadar;VWEAK struct { VBlob sym; char bytes[7]; } _VW_V0cdadar = { { .base = { .tag = VSYMBOL }, 7 }, "cdadar" };
VWEAK VWORD _V0cdaadr;VWEAK struct { VBlob sym; char bytes[7]; } _VW_V0cdaadr = { { .base = { .tag = VSYMBOL }, 7 }, "cdaadr" };
VWEAK VWORD _V0cdaaar;VWEAK struct { VBlob sym; char bytes[7]; } _VW_V0cdaaar = { { .base = { .tag = VSYMBOL }, 7 }, "cdaaar" };
...
VWEAK VWORD _V0cadadr;VWEAK struct { VBlob sym; char bytes[7]; } _VW_V0cadadr = { { .base = { .tag = VSYMBOL }, 7 }, "cadadr" };
VWEAK VWORD _V0cadaar;VWEAK struct { VBlob sym; char bytes[7]; } _VW_V0cadaar = { { .base = { .tag = VSYMBOL }, 7 }, "cadaar" };
VWEAK VWORD _V0caaddr;VWEAK struct { VBlob sym; char bytes[7]; } _VW_V0caaddr = { { .base = { .tag = VSYMBOL }, 7 }, "caaddr" };
VWEAK VWORD _V0caadar;VWEAK struct { VBlob sym; char bytes[7]; } _VW_V0caadar = { { .base = { .tag = VSYMBOL }, 7 }, "caadar" };
VWEAK VWORD _V0caaadr;VWEAK struct { VBlob sym; char bytes[7]; } _VW_V0caaadr = { { .base = { .tag = VSYMBOL }, 7 }, "caaadr" };
VWEAK VWORD _V0caaaar;VWEAK struct { VBlob sym; char bytes[7]; } _VW_V0caaaar = { { .base = { .tag = VSYMBOL }, 7 }, "caaaar" };
VWEAK VWORD _V0cdddr;VWEAK struct { VBlob sym; char bytes[6]; } _VW_V0cdddr = { { .base = { .tag = VSYMBOL }, 6 }, "cdddr" };
VWEAK VWORD _V0cddar;VWEAK struct { VBlob sym; char bytes[6]; } _VW_V0cddar = { { .base = { .tag = VSYMBOL }, 6 }, "cddar" };
VWEAK VWORD _V0cdadr;VWEAK struct { VBlob sym; char bytes[6]; } _VW_V0cdadr = { { .base = { .tag = VSYMBOL }, 6 }, "cdadr" };
VWEAK VWORD _V0cdaar;VWEAK struct { VBlob sym; char bytes[6]; } _VW_V0cdaar = { { .base = { .tag = VSYMBOL }, 6 }, "cdaar" };
...
VWEAK VWORD _V0caadr;VWEAK struct { VBlob sym; char bytes[6]; } _VW_V0caadr = { { .base = { .tag = VSYMBOL }, 6 }, "caadr" };
VWEAK VWORD _V0caaar;VWEAK struct { VBlob sym; char bytes[6]; } _VW_V0caaar = { { .base = { .tag = VSYMBOL }, 6 }, "caaar" };
...
VWEAK VWORD _V0set__cdr_B;VWEAK struct { VBlob sym; char bytes[9]; } _VW_V0set__cdr_B = { { .base = { .tag = VSYMBOL }, 9 }, "set-cdr!" };
...
VWEAK VWORD _V0min;VWEAK struct { VBlob sym; char bytes[4]; } _VW_V0min = { { .base = { .tag = VSYMBOL }, 4 }, "min" };
VWEAK VWORD _V0max;VWEAK struct { VBlob sym; char bytes[4]; } _VW_V0max = { { .base = { .tag = VSYMBOL }, 4 }, "max" };
VWEAK VWORD _V0remainder;VWEAK struct { VBlob sym; char bytes[10]; } _VW_V0remainder = { { .base = { .tag = VSYMBOL }, 10 }, "remainder" };
VWEAK VWORD _V0quotient;VWEAK struct { VBlob sym; char bytes[9]; } _VW_V0quotient = { { .base = { .tag = VSYMBOL }, 9 }, "quotient" };
VWEAK VWORD _V0_W;VWEAK struct { VBlob sym; char bytes[2]; } _VW_V0_W = { { .base = { .tag = VSYMBOL }, 2 }, "/" };
VWEAK VWORD _V0_S;VWEAK struct { VBlob sym; char bytes[2]; } _VW_V0_S = { { .base = { .tag = VSYMBOL }, 2 }, "*" };
...
VWEAK VWORD _V0complex_Q;VWEAK struct { VBlob sym; char bytes[9]; } _VW_V0complex_Q = { { .base = { .tag = VSYMBOL }, 9 }, "complex\?" };
VWEAK VWORD _V0number_Q;VWEAK struct { VBlob sym; char bytes[8]; } _VW_V0number_Q = { { .base = { .tag = VSYMBOL }, 8 }, "number\?" };
VWEAK VWORD _V0exact___Ginexact;VWEAK struct { VBlob sym; char bytes[15]; } _VW_V0exact___Ginexact = { { .base = { .tag = VSYMBOL }, 15 }, "exact->inexact" };
VWEAK VWORD _V0inexact;VWEAK struct { VBlob sym; char bytes[8]; } _VW_V0inexact = { { .base = { .tag = VSYMBOL }, 8 }, "inexact" };
VWEAK VWORD _V0_G_E;VWEAK struct { VBlob sym; char bytes[3]; } _VW_V0_G_E = { { .base = { .tag = VSYMBOL }, 3 }, ">=" };
VWEAK VWORD _V0_L_E;VWEAK struct { VBlob sym; char bytes[3]; } _VW_V0_L_E = { { .base = { .tag = VSYMBOL }, 3 }, "<=" };
VWEAK VWORD _V0_G;VWEAK struct { VBlob sym; char bytes[2]; } _VW_V0_G = { { .base = { .tag = VSYMBOL }, 2 }, ">" };
...
VWEAK VWORD _V0symbol_E_Q;VWEAK struct { VBlob sym; char bytes[9]; } _VW_V0symbol_E_Q = { { .base = { .tag = VSYMBOL }, 9 }, "symbol=\?" };
...
VWEAK VWORD _V0real_Q;VWEAK struct { VBlob sym; char bytes[6]; } _VW_V0real_Q = { { .base = { .tag = VSYMBOL }, 6 }, "real\?" };
VWEAK VWORD _V0inexact_Q;VWEAK struct { VBlob sym; char bytes[9]; } _VW_V0inexact_Q = { { .base = { .tag = VSYMBOL }, 9 }, "inexact\?" };
VWEAK VWORD _V0exact_Q;VWEAK struct { VBlob sym; char bytes[7]; } _VW_V0exact_Q = { { .base = { .tag = VSYMBOL }, 7 }, "exact\?" };
...
VWEAK VWORD _V0procedure_Q;VWEAK struct { VBlob sym; char bytes[11]; } _VW_V0procedure_Q = { { .base = { .tag = VSYMBOL }, 11 }, "procedure\?" };
VWEAK VWORD _V0vector_Q;VWEAK struct { VBlob sym; char bytes[8]; } _VW_V0vector_Q = { { .base = { .tag = VSYMBOL }, 8 }, "vector\?" };
VWEAK VWORD _V0pair_Q;VWEAK struct { VBlob sym; char bytes[6]; } _VW_V0pair_Q = { { .base = { .tag = VSYMBOL }, 6 }, "pair\?" };
VWEAK VWORD _V0boolean_Q;VWEAK struct { VBlob sym; char bytes[9]; } _VW_V0boolean_Q = { { .base = { .tag = VSYMBOL }, 9 }, "boolean\?" };
VWEAK VWORD _V0eof__object_Q;VWEAK struct { VBlob sym; char bytes[12]; } _VW_V0eof__object_Q = { { .base = { .tag = VSYMBOL }, 12 }, "eof-object\?" };
