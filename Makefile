.PHONY : clean deps cleandeps compiler interpreter windows_interpreter runtime windows_runtime wasm_runtime install tests tests_linux tests_windows config lay_egg boot_dirs
