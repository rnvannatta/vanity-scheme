...
#include <stdarg.h>
static struct { VBlob sym; char bytes[21]; } _V10string_D381 = { { .base = { .tag = VSTRING }, 21 }, "_V0vanity_V0core_V20" };
static struct { VBlob sym; char bytes[21]; } _V10string_D380 = { { .base = { .tag = VSTRING }, 21 }, "_V0scheme_V0r7rs_V20" };
