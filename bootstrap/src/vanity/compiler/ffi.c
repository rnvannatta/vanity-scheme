...
#include <stdarg.h>
static struct { VBlob sym; char bytes[21]; } _V10string_D1204 = { { VSTRING, 21 }, "_V0vanity_V0core_V20" };
static struct { VBlob sym; char bytes[21]; } _V10string_D1203 = { { VSTRING, 21 }, "_V0vanity_V0list_V20" };
static struct { VBlob sym; char bytes[33]; } _V10string_D1202 = { { VSTRING, 33 }, "_V0vanity_V0compiler_V0utils_V20" };
static struct { VBlob sym; char bytes[34]; } _V10string_D1201 = { { VSTRING, 34 }, "_V0vanity_V0compiler_V0config_V20" };
static struct { VBlob sym; char bytes[31]; } _V10string_D1200 = { { VSTRING, 31 }, "_V0vanity_V0compiler_V0ffi_V20" };
...
static struct { VBlob sym; char bytes[8]; } _V10string_D1199 = { { VSTRING, 8 }, "pointer" };
static struct { VBlob sym; char bytes[15]; } _V10string_D1198 = { { VSTRING, 15 }, "parameter_list" };
static struct { VBlob sym; char bytes[9]; } _V10string_D1197 = { { VSTRING, 9 }, "function" };
static struct { VBlob sym; char bytes[17]; } _V10string_D1196 = { { VSTRING, 17 }, "unknown typename" };
VWEAK VWORD _V0longs;VWEAK struct { VBlob sym; char bytes[6]; } _VW_V0longs = { { VSYMBOL, 6 }, "longs" };
VWEAK VWORD _V0special;VWEAK struct { VBlob sym; char bytes[8]; } _VW_V0special = { { VSYMBOL, 8 }, "special" };
static struct { VBlob sym; char bytes[29]; } _V10string_D1195 = { { VSTRING, 29 }, "unsupported type combination" };
VWEAK VWORD _V0restrict;VWEAK struct { VBlob sym; char bytes[9]; } _VW_V0restrict = { { VSYMBOL, 9 }, "restrict" };
VWEAK VWORD _V0static;VWEAK struct { VBlob sym; char bytes[7]; } _VW_V0static = { { VSYMBOL, 7 }, "static" };
VWEAK VWORD _V0unsigned;VWEAK struct { VBlob sym; char bytes[9]; } _VW_V0unsigned = { { VSYMBOL, 9 }, "unsigned" };
VWEAK VWORD _V0signed;VWEAK struct { VBlob sym; char bytes[7]; } _VW_V0signed = { { VSYMBOL, 7 }, "signed" };
static struct { VBlob sym; char bytes[40]; } _V10string_D1194 = { { VSTRING, 40 }, "Can only have one type in a declaration" };
static struct { VBlob sym; char bytes[43]; } _V10string_D1193 = { { VSTRING, 43 }, "Multiple storage specifiers in declaration" };
static struct { VBlob sym; char bytes[44]; } _V10string_D1192 = { { VSTRING, 44 }, "Unexpected storage specifier in declaration" };
VWEAK VWORD _V0extern;VWEAK struct { VBlob sym; char bytes[7]; } _VW_V0extern = { { VSYMBOL, 7 }, "extern" };
VWEAK VWORD _V0register;VWEAK struct { VBlob sym; char bytes[9]; } _VW_V0register = { { VSYMBOL, 9 }, "register" };
VWEAK VWORD _V0auto;VWEAK struct { VBlob sym; char bytes[5]; } _VW_V0auto = { { VSYMBOL, 5 }, "auto" };
VWEAK VWORD _V0volatile;VWEAK struct { VBlob sym; char bytes[9]; } _VW_V0volatile = { { VSYMBOL, 9 }, "volatile" };
static struct { VBlob sym; char bytes[22]; } _V10string_D1191 = { { VSTRING, 22 }, "Unsupported C typedef" };
VWEAK VWORD _V0variable;VWEAK struct { VBlob sym; char bytes[9]; } _VW_V0variable = { { VSYMBOL, 9 }, "variable" };
static struct { VBlob sym; char bytes[21]; } _V10string_D1190 = { { VSTRING, 21 }, "Not a simple typedef" };
static struct { VBlob sym; char bytes[26]; } _V10string_D1189 = { { VSTRING, 26 }, "Unsupported C declaration" };
static struct { VBlob sym; char bytes[43]; } _V10string_D1188 = { { VSTRING, 43 }, "Unsupported arg type in C foreign-function" };
static struct { VBlob sym; char bytes[38]; } _V10string_D1187 = { { VSTRING, 38 }, "Not a simple function declaration: ~A" };
static struct { VBlob sym; char bytes[46]; } _V10string_D1186 = { { VSTRING, 46 }, "Unsupported return type in C foreign-function" };
static struct { VBlob sym; char bytes[5]; } _V10string_D1185 = { { VSTRING, 5 }, "enum" };
static struct { VBlob sym; char bytes[8]; } _V10string_D1184 = { { VSTRING, 8 }, "typedef" };
static struct { VBlob sym; char bytes[27]; } _V10string_D1183 = { { VSTRING, 27 }, "unknown entry in ffi table" };
VWEAK VWORD _V0typedef;VWEAK struct { VBlob sym; char bytes[8]; } _VW_V0typedef = { { VSYMBOL, 8 }, "typedef" };
VWEAK VWORD _V0enum;VWEAK struct { VBlob sym; char bytes[5]; } _VW_V0enum = { { VSYMBOL, 5 }, "enum" };
VWEAK VWORD _V0function;VWEAK struct { VBlob sym; char bytes[9]; } _VW_V0function = { { VSYMBOL, 9 }, "function" };
static struct { VBlob sym; char bytes[40]; } _V10string_D1182 = { { VSTRING, 40 }, "variable redeclared as different symbol" };
VWEAK VWORD _V0define;VWEAK struct { VBlob sym; char bytes[7]; } _VW_V0define = { { VSYMBOL, 7 }, "define" };
static struct { VBlob sym; char bytes[19]; } _V10string_D1181 = { { VSTRING, 19 }, "VForeignParseDeclC" };
static struct { VBlob sym; char bytes[37]; } _V10string_D1180 = { { VSTRING, 37 }, "Declaration is not a single function" };
static struct { VBlob sym; char bytes[18]; } _V10string_D1179 = { { VSTRING, 18 }, "naked_declaration" };
static struct { VBlob sym; char bytes[12]; } _V10string_D1178 = { { VSTRING, 12 }, "declaration" };
static struct { VBlob sym; char bytes[9]; } _V10string_D1177 = { { VSTRING, 9 }, "toplevel" };
static struct { VBlob sym; char bytes[32]; } _V10string_D1176 = { { VSTRING, 32 }, "Invalid foreign function syntax" };
static struct { VBlob sym; char bytes[6]; } _V10string_D1175 = { { VSTRING, 6 }, "~A/~A" };
static struct { VBlob sym; char bytes[7]; } _V10string_D1174 = { { VSTRING, 7 }, "[ ~A ]" };
static struct { VBlob sym; char bytes[27]; } _V10string_D1173 = { { VSTRING, 27 }, "Unable to open header file" };
static struct { VBlob sym; char bytes[33]; } _V10string_D1172 = { { VSTRING, 33 }, "include/vscheme/stdc/sysv_amd64/" };
static struct { VBlob sym; char bytes[63]; } _V10string_D1171 = { { VSTRING, 63 }, "gcc -E -P -undef -std=c11 -nostdinc -D__VANITY__ -w ~A -I~A/~A" };
static struct { VBlob sym; char bytes[21]; } _V10string_D1170 = { { VSTRING, 21 }, "VForeignParseHeaderC" };
static struct { VBlob sym; char bytes[21]; } _V10string_D1169 = { { VSTRING, 21 }, "VForeignReleaseParse" };
static struct { VBlob sym; char bytes[30]; } _V10string_D1168 = { { VSTRING, 30 }, "Invalid foreign import syntax" };
VWEAK VWORD _V10foreign_Dimport;VWEAK struct { VBlob sym; char bytes[17]; } _VW_V10foreign_Dimport = { { VSYMBOL, 17 }, "##foreign.import" };
static struct { VBlob sym; char bytes[2]; } _V10string_D1167 = { { VSTRING, 2 }, "C" };
static struct { VBlob sym; char bytes[15]; } _V10string_D1166 = { { VSTRING, 15 }, "#include <~A>\n" };
VWEAK VWORD _V10foreign_Ddeclare;VWEAK struct { VBlob sym; char bytes[18]; } _VW_V10foreign_Ddeclare = { { VSYMBOL, 18 }, "##foreign.declare" };
static struct { VBlob sym; char bytes[22]; } _V10string_D1165 = { { VSTRING, 22 }, "File must be a string" };
static struct { VBlob sym; char bytes[38]; } _V10string_D1164 = { { VSTRING, 38 }, "Unsupported foreign function language" };
static struct { VBlob sym; char bytes[12]; } _V10string_D1163 = { { VSTRING, 12 }, "_V30~A_shim" };
static struct { VBlob sym; char bytes[1]; } _V10string_D1162 = { { VSTRING, 1 }, "" };
static struct { VBlob sym; char bytes[14]; } _V10string_D1161 = { { VSTRING, 14 }, "VEncodeDouble" };
static struct { VBlob sym; char bytes[11]; } _V10string_D1160 = { { VSTRING, 11 }, "VEncodeInt" };
static struct { VBlob sym; char bytes[12]; } _V10string_D1159 = { { VSTRING, 12 }, "VEncodeChar" };
static struct { VBlob sym; char bytes[12]; } _V10string_D1158 = { { VSTRING, 12 }, "VEncodeBool" };
static struct { VBlob sym; char bytes[22]; } _V10string_D1157 = { { VSTRING, 22 }, "VEncodeForeignPointer" };
static struct { VBlob sym; char bytes[20]; } _V10string_D1156 = { { VSTRING, 20 }, "VCheckedDecodeVWORD" };
VWEAK VWORD _V0VWORD;VWEAK struct { VBlob sym; char bytes[6]; } _VW_V0VWORD = { { VSYMBOL, 6 }, "VWORD" };
VWEAK VWORD _V0float;VWEAK struct { VBlob sym; char bytes[6]; } _VW_V0float = { { VSYMBOL, 6 }, "float" };
static struct { VBlob sym; char bytes[21]; } _V10string_D1155 = { { VSTRING, 21 }, "VCheckedDecodeNumber" };
VWEAK VWORD _V0double;VWEAK struct { VBlob sym; char bytes[7]; } _VW_V0double = { { VSYMBOL, 7 }, "double" };
VWEAK VWORD _V0unsigned__long__long;VWEAK struct { VBlob sym; char bytes[19]; } _VW_V0unsigned__long__long = { { VSYMBOL, 19 }, "unsigned-long-long" };
VWEAK VWORD _V0long__long;VWEAK struct { VBlob sym; char bytes[10]; } _VW_V0long__long = { { VSYMBOL, 10 }, "long-long" };
VWEAK VWORD _V0unsigned__long;VWEAK struct { VBlob sym; char bytes[14]; } _VW_V0unsigned__long = { { VSYMBOL, 14 }, "unsigned-long" };
VWEAK VWORD _V0long;VWEAK struct { VBlob sym; char bytes[5]; } _VW_V0long = { { VSYMBOL, 5 }, "long" };
VWEAK VWORD _V0unsigned__int;VWEAK struct { VBlob sym; char bytes[13]; } _VW_V0unsigned__int = { { VSYMBOL, 13 }, "unsigned-int" };
static struct { VBlob sym; char bytes[18]; } _V10string_D1154 = { { VSTRING, 18 }, "VCheckedDecodeInt" };
VWEAK VWORD _V0int;VWEAK struct { VBlob sym; char bytes[4]; } _VW_V0int = { { VSYMBOL, 4 }, "int" };
static struct { VBlob sym; char bytes[28]; } _V10string_D1153 = { { VSTRING, 28 }, "VCheckedDecodeUnsignedShort" };
VWEAK VWORD _V0unsigned__short;VWEAK struct { VBlob sym; char bytes[15]; } _VW_V0unsigned__short = { { VSYMBOL, 15 }, "unsigned-short" };
static struct { VBlob sym; char bytes[20]; } _V10string_D1152 = { { VSTRING, 20 }, "VCheckedDecodeShort" };
VWEAK VWORD _V0short;VWEAK struct { VBlob sym; char bytes[6]; } _VW_V0short = { { VSYMBOL, 6 }, "short" };
static struct { VBlob sym; char bytes[27]; } _V10string_D1151 = { { VSTRING, 27 }, "VCheckedDecodeUnsignedChar" };
VWEAK VWORD _V0unsigned__char;VWEAK struct { VBlob sym; char bytes[14]; } _VW_V0unsigned__char = { { VSYMBOL, 14 }, "unsigned-char" };
static struct { VBlob sym; char bytes[25]; } _V10string_D1150 = { { VSTRING, 25 }, "VCheckedDecodeSignedChar" };
VWEAK VWORD _V0signed__char;VWEAK struct { VBlob sym; char bytes[12]; } _VW_V0signed__char = { { VSYMBOL, 12 }, "signed-char" };
static struct { VBlob sym; char bytes[19]; } _V10string_D1149 = { { VSTRING, 19 }, "VCheckedDecodeChar" };
static struct { VBlob sym; char bytes[19]; } _V10string_D1148 = { { VSTRING, 19 }, "VCheckedDecodeBool" };
VWEAK VWORD _V0_UBool;VWEAK struct { VBlob sym; char bytes[6]; } _VW_V0_UBool = { { VSYMBOL, 6 }, "_Bool" };
static struct { VBlob sym; char bytes[29]; } _V10string_D1147 = { { VSTRING, 29 }, "VCheckedDecodeForeignPointer" };
static struct { VBlob sym; char bytes[22]; } _V10string_D1146 = { { VSTRING, 22 }, "VCheckedDecodeVoidPtr" };
VWEAK VWORD _V0void__pointer;VWEAK struct { VBlob sym; char bytes[13]; } _VW_V0void__pointer = { { VSYMBOL, 13 }, "void-pointer" };
static struct { VBlob sym; char bytes[27]; } _V10string_D1145 = { { VSTRING, 27 }, "VCheckedDecodeConstVoidPtr" };
VWEAK VWORD _V0const__void__pointer;VWEAK struct { VBlob sym; char bytes[19]; } _VW_V0const__void__pointer = { { VSYMBOL, 19 }, "const-void-pointer" };
VWEAK VWORD _V0const;VWEAK struct { VBlob sym; char bytes[6]; } _VW_V0const = { { VSYMBOL, 6 }, "const" };
VWEAK VWORD _V0char;VWEAK struct { VBlob sym; char bytes[5]; } _VW_V0char = { { VSYMBOL, 5 }, "char" };
static struct { VBlob sym; char bytes[27]; } _V10string_D1144 = { { VSTRING, 27 }, "VCheckedDecodeConstCString" };
VWEAK VWORD _V0const__c__string;VWEAK struct { VBlob sym; char bytes[15]; } _VW_V0const__c__string = { { VSYMBOL, 15 }, "const-c-string" };
static struct { VBlob sym; char bytes[22]; } _V10string_D1143 = { { VSTRING, 22 }, "VCheckedDecodeCString" };
VWEAK VWORD _V0c__string;VWEAK struct { VBlob sym; char bytes[9]; } _VW_V0c__string = { { VSYMBOL, 9 }, "c-string" };
VWEAK VWORD _V0pointer;VWEAK struct { VBlob sym; char bytes[8]; } _VW_V0pointer = { { VSYMBOL, 8 }, "pointer" };
static struct { VBlob sym; char bytes[26]; } _V10string_D1142 = { { VSTRING, 26 }, "match statement exhausted" };
...
static struct { VBlob sym; char bytes[17]; } _V10string_D1141 = { { VSTRING, 17 }, "~A(_arg~A, \"~A\")" };
static struct { VBlob sym; char bytes[6]; } _V10string_D1140 = { { VSTRING, 6 }, "~A;~N" };
static struct { VBlob sym; char bytes[39]; } _V10string_D1139 = { { VSTRING, 39 }, "void _V30~A_shim(V_CORE_ARGS, VWORD _k" };
static struct { VBlob sym; char bytes[15]; } _V10string_D1138 = { { VSTRING, 15 }, ", VWORD _arg~A" };
static struct { VBlob sym; char bytes[34]; } _V10string_D1137 = { { VSTRING, 34 }, "  V_ARG_CHECK2(\"~A\", ~A, argc);~N" };
static struct { VBlob sym; char bytes[62]; } _V10string_D1136 = { { VSTRING, 62 }, "  V_GC_CHECK2_VARARGS((VFunc)~A, runtime, statics, ~A, ~A, _k" };
static struct { VBlob sym; char bytes[9]; } _V10string_D1135 = { { VSTRING, 9 }, ", _arg~A" };
static struct { VBlob sym; char bytes[6]; } _V10string_D1134 = { { VSTRING, 6 }, ") {~N" };
static struct { VBlob sym; char bytes[6]; } _V10string_D1133 = { { VSTRING, 6 }, "));~N" };
VWEAK VWORD _V0void;VWEAK struct { VBlob sym; char bytes[5]; } _VW_V0void = { { VSYMBOL, 5 }, "void" };
static struct { VBlob sym; char bytes[9]; } _V10string_D1132 = { { VSTRING, 9 }, "  }~N}~N" };
static struct { VBlob sym; char bytes[31]; } _V10string_D1131 = { { VSTRING, 31 }, "  V_CALL(_k, runtime, _ret);~N" };
static struct { VBlob sym; char bytes[32]; } _V10string_D1130 = { { VSTRING, 32 }, "  V_CALL(_k, runtime, VVOID);~N" };
static struct { VBlob sym; char bytes[3]; } _V10string_D1129 = { { VSTRING, 3 }, ", " };
static struct { VBlob sym; char bytes[24]; } _V10string_D1128 = { { VSTRING, 24 }, "    VWORD _ret = ~A(~A(" };
static struct { VBlob sym; char bytes[5]; } _V10string_D1127 = { { VSTRING, 5 }, "(~A(" };
