...
#include <stdarg.h>
static struct { VBlob sym; char bytes[21]; } _V10string_D343 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 21 }, "_V0vanity_V0core_V20" };
static struct { VBlob sym; char bytes[27]; } _V10string_D342 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 27 }, "_V0vanity_V0intrinsics_V20" };
...
static struct { VBlob sym; char bytes[7]; } _V10string_D341 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 7 }, "VAwait" };
static struct { VBlob sym; char bytes[7]; } _V10string_D340 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 7 }, "VAsync" };
static struct { VBlob sym; char bytes[15]; } _V10string_D339 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 15 }, "VFiberForkList" };
static struct { VBlob sym; char bytes[15]; } _V10string_D338 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 15 }, "VRandomAdvance" };
static struct { VBlob sym; char bytes[19]; } _V10string_D337 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 19 }, "VRandomSampleFloat" };
static struct { VBlob sym; char bytes[21]; } _V10string_D336 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 21 }, "VRandomSampleBounded" };
static struct { VBlob sym; char bytes[14]; } _V10string_D335 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 14 }, "VRandomSample" };
static struct { VBlob sym; char bytes[12]; } _V10string_D334 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 12 }, "VRandomCopy" };
static struct { VBlob sym; char bytes[12]; } _V10string_D333 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 12 }, "VMakeRandom" };
static struct { VBlob sym; char bytes[14]; } _V10string_D332 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 14 }, "VCommandLine2" };
static struct { VBlob sym; char bytes[20]; } _V10string_D331 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 20 }, "VMakeTemporaryFile2" };
static struct { VBlob sym; char bytes[20]; } _V10string_D330 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 20 }, "VOpenOutputProcess2" };
static struct { VBlob sym; char bytes[19]; } _V10string_D329 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 19 }, "VOpenInputProcess2" };
static struct { VBlob sym; char bytes[9]; } _V10string_D328 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 9 }, "VSystem2" };
static struct { VBlob sym; char bytes[16]; } _V10string_D327 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 16 }, "VGarbageCollect" };
static struct { VBlob sym; char bytes[10]; } _V10string_D326 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 10 }, "VFinalize" };
static struct { VBlob sym; char bytes[14]; } _V10string_D325 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 14 }, "VHasFinalizer" };
static struct { VBlob sym; char bytes[14]; } _V10string_D324 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 14 }, "VSetFinalizer" };
static struct { VBlob sym; char bytes[15]; } _V10string_D323 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 15 }, "VNewlineStdout" };
static struct { VBlob sym; char bytes[13]; } _V10string_D322 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 13 }, "VWriteStdout" };
static struct { VBlob sym; char bytes[15]; } _V10string_D321 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 15 }, "VDisplayStdout" };
static struct { VBlob sym; char bytes[10]; } _V10string_D320 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 10 }, "VNewline2" };
static struct { VBlob sym; char bytes[8]; } _V10string_D319 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 8 }, "VWrite2" };
static struct { VBlob sym; char bytes[10]; } _V10string_D318 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 10 }, "VDisplay2" };
static struct { VBlob sym; char bytes[7]; } _V10string_D317 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 7 }, "VRead2" };
static struct { VBlob sym; char bytes[11]; } _V10string_D316 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 11 }, "VReadLine2" };
static struct { VBlob sym; char bytes[11]; } _V10string_D315 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 11 }, "VReadChar2" };
static struct { VBlob sym; char bytes[7]; } _V10string_D314 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 7 }, "VEofP2" };
static struct { VBlob sym; char bytes[18]; } _V10string_D313 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 18 }, "VGetOutputString2" };
static struct { VBlob sym; char bytes[19]; } _V10string_D312 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 19 }, "VOpenOutputString2" };
static struct { VBlob sym; char bytes[10]; } _V10string_D311 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 10 }, "VTtyPortP" };
static struct { VBlob sym; char bytes[14]; } _V10string_D310 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 14 }, "VCloseStream2" };
static struct { VBlob sym; char bytes[19]; } _V10string_D309 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 19 }, "VOpenOutputStream2" };
static struct { VBlob sym; char bytes[18]; } _V10string_D308 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 18 }, "VOpenInputStream2" };
static struct { VBlob sym; char bytes[12]; } _V10string_D307 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 12 }, "VDupStderr2" };
static struct { VBlob sym; char bytes[12]; } _V10string_D306 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 12 }, "VDupStdout2" };
static struct { VBlob sym; char bytes[11]; } _V10string_D305 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 11 }, "VDupStdin2" };
static struct { VBlob sym; char bytes[12]; } _V10string_D304 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 12 }, "VStderrPort" };
static struct { VBlob sym; char bytes[12]; } _V10string_D303 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 12 }, "VStdoutPort" };
static struct { VBlob sym; char bytes[11]; } _V10string_D302 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 11 }, "VStdinPort" };
static struct { VBlob sym; char bytes[10]; } _V10string_D301 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 10 }, "VCharInt2" };
static struct { VBlob sym; char bytes[15]; } _V10string_D300 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 15 }, "VSymbolString2" };
static struct { VBlob sym; char bytes[15]; } _V10string_D299 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 15 }, "VStringNumber2" };
static struct { VBlob sym; char bytes[15]; } _V10string_D298 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 15 }, "VStringSymbol2" };
static struct { VBlob sym; char bytes[15]; } _V10string_D297 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 15 }, "VStringLength2" };
static struct { VBlob sym; char bytes[12]; } _V10string_D296 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 12 }, "VStringSet2" };
static struct { VBlob sym; char bytes[12]; } _V10string_D295 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 12 }, "VStringRef2" };
static struct { VBlob sym; char bytes[13]; } _V10string_D294 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 13 }, "VStringCopy2" };
static struct { VBlob sym; char bytes[12]; } _V10string_D293 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 12 }, "VSubstring2" };
static struct { VBlob sym; char bytes[13]; } _V10string_D292 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 13 }, "VMakeString2" };
static struct { VBlob sym; char bytes[17]; } _V10string_D291 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 17 }, "VHashTableDelete" };
static struct { VBlob sym; char bytes[14]; } _V10string_D290 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 14 }, "VHashTableSet" };
static struct { VBlob sym; char bytes[14]; } _V10string_D289 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 14 }, "VHashTableRef" };
static struct { VBlob sym; char bytes[19]; } _V10string_D288 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 19 }, "VHashTableHashFunc" };
static struct { VBlob sym; char bytes[18]; } _V10string_D287 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 18 }, "VHashTableEqvFunc" };
static struct { VBlob sym; char bytes[15]; } _V10string_D286 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 15 }, "VMakeHashTable" };
static struct { VBlob sym; char bytes[15]; } _V10string_D285 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 15 }, "VVectorLength2" };
static struct { VBlob sym; char bytes[12]; } _V10string_D284 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 12 }, "VVectorSet2" };
static struct { VBlob sym; char bytes[12]; } _V10string_D283 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 12 }, "VVectorRef2" };
static struct { VBlob sym; char bytes[13]; } _V10string_D282 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 13 }, "VListVector2" };
static struct { VBlob sym; char bytes[9]; } _V10string_D281 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 9 }, "VSetCdr2" };
static struct { VBlob sym; char bytes[9]; } _V10string_D280 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 9 }, "VSetCar2" };
static struct { VBlob sym; char bytes[6]; } _V10string_D279 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 6 }, "VCdr2" };
static struct { VBlob sym; char bytes[6]; } _V10string_D278 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 6 }, "VCar2" };
static struct { VBlob sym; char bytes[7]; } _V10string_D277 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 7 }, "VCons2" };
static struct { VBlob sym; char bytes[14]; } _V10string_D276 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 14 }, "VLoadLibrary2" };
static struct { VBlob sym; char bytes[13]; } _V10string_D275 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 13 }, "VMakeImport2" };
static struct { VBlob sym; char bytes[16]; } _V10string_D274 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 16 }, "VLookupLibrary2" };
static struct { VBlob sym; char bytes[14]; } _V10string_D273 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 14 }, "VMultiDefine2" };
static struct { VBlob sym; char bytes[11]; } _V10string_D272 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 11 }, "VFunction2" };
static struct { VBlob sym; char bytes[9]; } _V10string_D271 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 9 }, "VImport2" };
static struct { VBlob sym; char bytes[15]; } _V10string_D270 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 15 }, "VSetGlobalVar2" };
static struct { VBlob sym; char bytes[18]; } _V10string_D269 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 18 }, "VDefineGlobalVar2" };
static struct { VBlob sym; char bytes[7]; } _V10string_D268 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 7 }, "VExit2" };
static struct { VBlob sym; char bytes[8]; } _V10string_D267 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 8 }, "VAbort2" };
static struct { VBlob sym; char bytes[10]; } _V10string_D266 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 10 }, "VApplyCps" };
static struct { VBlob sym; char bytes[8]; } _V10string_D265 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 8 }, "VApply2" };
static struct { VBlob sym; char bytes[13]; } _V10string_D264 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 13 }, "VCallValues2" };
static struct { VBlob sym; char bytes[9]; } _V10string_D263 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 9 }, "VCallCC2" };
static struct { VBlob sym; char bytes[7]; } _V10string_D262 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 7 }, "VNext2" };
static struct { VBlob sym; char bytes[6]; } _V10string_D261 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 6 }, "VNot2" };
static struct { VBlob sym; char bytes[5]; } _V10string_D260 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 5 }, "VEqv" };
static struct { VBlob sym; char bytes[10]; } _V10string_D259 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 10 }, "VBlobEqv2" };
static struct { VBlob sym; char bytes[12]; } _V10string_D258 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 12 }, "VSymbolEqv2" };
static struct { VBlob sym; char bytes[5]; } _V10string_D257 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 5 }, "VEq2" };
static struct { VBlob sym; char bytes[8]; } _V10string_D256 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 8 }, "VCharP2" };
static struct { VBlob sym; char bytes[10]; } _V10string_D255 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 10 }, "VDoubleP2" };
static struct { VBlob sym; char bytes[7]; } _V10string_D254 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 7 }, "VIntP2" };
static struct { VBlob sym; char bytes[10]; } _V10string_D253 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 10 }, "VStringP2" };
static struct { VBlob sym; char bytes[10]; } _V10string_D252 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 10 }, "VSymbolP2" };
static struct { VBlob sym; char bytes[8]; } _V10string_D251 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 8 }, "VBlobP2" };
static struct { VBlob sym; char bytes[13]; } _V10string_D250 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 13 }, "VProcedureP2" };
static struct { VBlob sym; char bytes[10]; } _V10string_D249 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 10 }, "VVectorP2" };
static struct { VBlob sym; char bytes[8]; } _V10string_D248 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 8 }, "VPairP2" };
static struct { VBlob sym; char bytes[8]; } _V10string_D247 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 8 }, "VNullP2" };
static struct { VBlob sym; char bytes[6]; } _V10string_D246 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 6 }, "VRem2" };
static struct { VBlob sym; char bytes[7]; } _V10string_D245 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 7 }, "VQuot2" };
static struct { VBlob sym; char bytes[6]; } _V10string_D244 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 6 }, "VCmp2" };
static struct { VBlob sym; char bytes[6]; } _V10string_D243 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 6 }, "VDiv2" };
static struct { VBlob sym; char bytes[6]; } _V10string_D242 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 6 }, "VMul2" };
static struct { VBlob sym; char bytes[6]; } _V10string_D241 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 6 }, "VSub2" };
static struct { VBlob sym; char bytes[6]; } _V10string_D240 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 6 }, "VAdd2" };
...
static struct { VBlob sym; char bytes[12]; } _V10string_D239 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 12 }, "VInlineCdr2" };
static struct { VBlob sym; char bytes[12]; } _V10string_D238 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 12 }, "VInlineCar2" };
static struct { VBlob sym; char bytes[13]; } _V10string_D237 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 13 }, "VInlineCons2" };
...
static struct { VBlob sym; char bytes[11]; } _V10string_D236 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 11 }, "VInlineEq2" };
static struct { VBlob sym; char bytes[12]; } _V10string_D235 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 12 }, "VInlineNot2" };
static struct { VBlob sym; char bytes[14]; } _V10string_D234 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 14 }, "VInlinePairP2" };
static struct { VBlob sym; char bytes[14]; } _V10string_D233 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 14 }, "VInlineNullP2" };
...
static void _V0lookup__inline__name_k12(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__inline__name_k12, runtime, upenv, 1, argc, _var0) {
  // (if (bruijn ##p.13 0 0) ((bruijn ##k.6 9 0) (##string ##string.239)) ((bruijn ##k.6 9 0) #f))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 9-1, 0), runtime,
...
static void _V0lookup__inline__name_k11(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__inline__name_k11, runtime, upenv, 1, argc, _var0) {
  ...
  env->vars[0] = _var0;
  // (if (bruijn ##p.12 0 0) ((bruijn ##k.6 8 0) (##string ##string.238)) ((bruijn eqv? 10 0) (close _V0lookup__inline__name_k12) (bruijn ##x.1 7 0) '##vcore.cdr))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__inline__name_k10(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__inline__name_k10, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.11 0 0) ((bruijn ##k.6 7 0) (##string ##string.237)) ((bruijn eqv? 9 0) (close _V0lookup__inline__name_k11) (bruijn ##x.1 6 0) '##vcore.car))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__inline__name_k7(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__inline__name_k7, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.10 0 0) ((bruijn ##k.6 5 0) (##string ##string.236)) ((bruijn eqv? 7 0) (close _V0lookup__inline__name_k8) (bruijn ##x.1 4 0) '##vcore.cons))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__inline__name_k6(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__inline__name_k6, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.9 0 0) ((bruijn ##k.6 4 0) (##string ##string.235)) ((bruijn eqv? 6 0) (close _V0lookup__inline__name_k7) (bruijn ##x.1 3 0) '##vcore.eq?))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__inline__name_k5(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__inline__name_k5, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.8 0 0) ((bruijn ##k.6 3 0) (##string ##string.234)) ((bruijn eqv? 5 0) (close _V0lookup__inline__name_k6) (bruijn ##x.1 2 0) '##vcore.not))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__inline__name_k4(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__inline__name_k4, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.7 0 0) ((bruijn ##k.6 2 0) (##string ##string.233)) ((bruijn eqv? 4 0) (close _V0lookup__inline__name_k5) (bruijn ##x.1 1 0) '##vcore.pair?))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k52(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k52, runtime, upenv, 1, argc, _var0) {
  // (if (bruijn ##p.120 1 0) ((bruijn ##k.121 0 0) (bruijn ##p.120 1 0)) ((bruijn eqv? 43 0) (bruijn ##k.121 0 0) (bruijn ##x.2 40 0) '##vcore.qcons))
if(VDecodeBool(
upenv->vars[0])) {
    V_CALL(_var0, runtime,
      upenv->vars[0]);
...
static void _V0lookup__intrinsic__name_k117(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k117, runtime, upenv, 1, argc, _var0) {
  // (if (bruijn ##p.119 0 0) ((bruijn ##k.16 105 0) (##string ##string.341)) ((bruijn ##k.16 105 0) #f))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k116(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k116, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.118 0 0) ((bruijn ##k.16 104 0) (##string ##string.340)) ((bruijn eqv? 106 0) (close _V0lookup__intrinsic__name_k117) (bruijn ##x.2 103 0) '##vcore.await))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k115(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k115, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.117 0 0) ((bruijn ##k.16 103 0) (##string ##string.339)) ((bruijn eqv? 105 0) (close _V0lookup__intrinsic__name_k116) (bruijn ##x.2 102 0) '##vcore.async))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k114(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k114, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.116 0 0) ((bruijn ##k.16 102 0) (##string ##string.338)) ((bruijn eqv? 104 0) (close _V0lookup__intrinsic__name_k115) (bruijn ##x.2 101 0) '##vcore.fiber-fork-list))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k113(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k113, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.115 0 0) ((bruijn ##k.16 101 0) (##string ##string.337)) ((bruijn eqv? 103 0) (close _V0lookup__intrinsic__name_k114) (bruijn ##x.2 100 0) '##vcore.random-advance!))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k112(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k112, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.114 0 0) ((bruijn ##k.16 100 0) (##string ##string.336)) ((bruijn eqv? 102 0) (close _V0lookup__intrinsic__name_k113) (bruijn ##x.2 99 0) '##vcore.random-sample-float!))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k111(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k111, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.113 0 0) ((bruijn ##k.16 99 0) (##string ##string.335)) ((bruijn eqv? 101 0) (close _V0lookup__intrinsic__name_k112) (bruijn ##x.2 98 0) '##vcore.random-sample-bounded!))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k110(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k110, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.112 0 0) ((bruijn ##k.16 98 0) (##string ##string.334)) ((bruijn eqv? 100 0) (close _V0lookup__intrinsic__name_k111) (bruijn ##x.2 97 0) '##vcore.random-sample!))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k109(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k109, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.111 0 0) ((bruijn ##k.16 97 0) (##string ##string.333)) ((bruijn eqv? 99 0) (close _V0lookup__intrinsic__name_k110) (bruijn ##x.2 96 0) '##vcore.random-copy))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k108(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k108, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.110 0 0) ((bruijn ##k.16 96 0) (##string ##string.332)) ((bruijn eqv? 98 0) (close _V0lookup__intrinsic__name_k109) (bruijn ##x.2 95 0) '##vcore.make-random))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k107(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k107, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.109 0 0) ((bruijn ##k.16 95 0) (##string ##string.331)) ((bruijn eqv? 97 0) (close _V0lookup__intrinsic__name_k108) (bruijn ##x.2 94 0) '##vcore.command-line))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k106(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k106, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.108 0 0) ((bruijn ##k.16 94 0) (##string ##string.330)) ((bruijn eqv? 96 0) (close _V0lookup__intrinsic__name_k107) (bruijn ##x.2 93 0) '##vcore.make-temporary-file))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k105(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k105, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.107 0 0) ((bruijn ##k.16 93 0) (##string ##string.329)) ((bruijn eqv? 95 0) (close _V0lookup__intrinsic__name_k106) (bruijn ##x.2 92 0) '##vcore.open-output-process))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k104(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k104, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.106 0 0) ((bruijn ##k.16 92 0) (##string ##string.328)) ((bruijn eqv? 94 0) (close _V0lookup__intrinsic__name_k105) (bruijn ##x.2 91 0) '##vcore.open-input-process))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k103(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k103, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.105 0 0) ((bruijn ##k.16 91 0) (##string ##string.327)) ((bruijn eqv? 93 0) (close _V0lookup__intrinsic__name_k104) (bruijn ##x.2 90 0) '##vcore.system))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k102(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k102, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.104 0 0) ((bruijn ##k.16 90 0) (##string ##string.326)) ((bruijn eqv? 92 0) (close _V0lookup__intrinsic__name_k103) (bruijn ##x.2 89 0) '##vcore.garbage-collect))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k101(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k101, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.103 0 0) ((bruijn ##k.16 89 0) (##string ##string.325)) ((bruijn eqv? 91 0) (close _V0lookup__intrinsic__name_k102) (bruijn ##x.2 88 0) '##vcore.finalize!))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k100(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k100, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.102 0 0) ((bruijn ##k.16 88 0) (##string ##string.324)) ((bruijn eqv? 90 0) (close _V0lookup__intrinsic__name_k101) (bruijn ##x.2 87 0) '##vcore.has-finalizer?))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k99(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k99, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.101 0 0) ((bruijn ##k.16 87 0) (##string ##string.323)) ((bruijn eqv? 89 0) (close _V0lookup__intrinsic__name_k100) (bruijn ##x.2 86 0) '##vcore.set-finalizer!))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k98(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k98, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.100 0 0) ((bruijn ##k.16 86 0) (##string ##string.322)) ((bruijn eqv? 88 0) (close _V0lookup__intrinsic__name_k99) (bruijn ##x.2 85 0) '##vcore.newline-stdout))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k97(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k97, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.99 0 0) ((bruijn ##k.16 85 0) (##string ##string.321)) ((bruijn eqv? 87 0) (close _V0lookup__intrinsic__name_k98) (bruijn ##x.2 84 0) '##vcore.write-stdout))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k96(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k96, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.98 0 0) ((bruijn ##k.16 84 0) (##string ##string.320)) ((bruijn eqv? 86 0) (close _V0lookup__intrinsic__name_k97) (bruijn ##x.2 83 0) '##vcore.display-stdout))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k95(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k95, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.97 0 0) ((bruijn ##k.16 83 0) (##string ##string.319)) ((bruijn eqv? 85 0) (close _V0lookup__intrinsic__name_k96) (bruijn ##x.2 82 0) '##vcore.newline))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k94(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k94, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.96 0 0) ((bruijn ##k.16 82 0) (##string ##string.318)) ((bruijn eqv? 84 0) (close _V0lookup__intrinsic__name_k95) (bruijn ##x.2 81 0) '##vcore.write))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k93(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k93, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.95 0 0) ((bruijn ##k.16 81 0) (##string ##string.317)) ((bruijn eqv? 83 0) (close _V0lookup__intrinsic__name_k94) (bruijn ##x.2 80 0) '##vcore.display-word))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k92(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k92, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.94 0 0) ((bruijn ##k.16 80 0) (##string ##string.316)) ((bruijn eqv? 82 0) (close _V0lookup__intrinsic__name_k93) (bruijn ##x.2 79 0) '##vcore.read))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k91(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k91, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.93 0 0) ((bruijn ##k.16 79 0) (##string ##string.315)) ((bruijn eqv? 81 0) (close _V0lookup__intrinsic__name_k92) (bruijn ##x.2 78 0) '##vcore.read-line))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k90(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k90, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.92 0 0) ((bruijn ##k.16 78 0) (##string ##string.314)) ((bruijn eqv? 80 0) (close _V0lookup__intrinsic__name_k91) (bruijn ##x.2 77 0) '##vcore.read-char))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k89(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k89, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.91 0 0) ((bruijn ##k.16 77 0) (##string ##string.313)) ((bruijn eqv? 79 0) (close _V0lookup__intrinsic__name_k90) (bruijn ##x.2 76 0) '##vcore.eof-object?))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k88(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k88, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.90 0 0) ((bruijn ##k.16 76 0) (##string ##string.312)) ((bruijn eqv? 78 0) (close _V0lookup__intrinsic__name_k89) (bruijn ##x.2 75 0) '##vcore.get-output-string))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k87(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k87, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.89 0 0) ((bruijn ##k.16 75 0) (##string ##string.311)) ((bruijn eqv? 77 0) (close _V0lookup__intrinsic__name_k88) (bruijn ##x.2 74 0) '##vcore.open-output-string))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k86(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k86, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.88 0 0) ((bruijn ##k.16 74 0) (##string ##string.310)) ((bruijn eqv? 76 0) (close _V0lookup__intrinsic__name_k87) (bruijn ##x.2 73 0) '##vcore.tty-port?))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k85(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k85, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.87 0 0) ((bruijn ##k.16 73 0) (##string ##string.309)) ((bruijn eqv? 75 0) (close _V0lookup__intrinsic__name_k86) (bruijn ##x.2 72 0) '##vcore.close-stream))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k84(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k84, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.86 0 0) ((bruijn ##k.16 72 0) (##string ##string.308)) ((bruijn eqv? 74 0) (close _V0lookup__intrinsic__name_k85) (bruijn ##x.2 71 0) '##vcore.open-output-stream))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k83(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k83, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.85 0 0) ((bruijn ##k.16 71 0) (##string ##string.307)) ((bruijn eqv? 73 0) (close _V0lookup__intrinsic__name_k84) (bruijn ##x.2 70 0) '##vcore.open-input-stream))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k82(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k82, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.84 0 0) ((bruijn ##k.16 70 0) (##string ##string.306)) ((bruijn eqv? 72 0) (close _V0lookup__intrinsic__name_k83) (bruijn ##x.2 69 0) '##vcore.dup-stderr))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k81(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k81, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.83 0 0) ((bruijn ##k.16 69 0) (##string ##string.305)) ((bruijn eqv? 71 0) (close _V0lookup__intrinsic__name_k82) (bruijn ##x.2 68 0) '##vcore.dup-stdout))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k80(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k80, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.82 0 0) ((bruijn ##k.16 68 0) (##string ##string.304)) ((bruijn eqv? 70 0) (close _V0lookup__intrinsic__name_k81) (bruijn ##x.2 67 0) '##vcore.dup-stdin))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k79(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k79, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.81 0 0) ((bruijn ##k.16 67 0) (##string ##string.303)) ((bruijn eqv? 69 0) (close _V0lookup__intrinsic__name_k80) (bruijn ##x.2 66 0) '##vcore.stderr->port))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k78(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k78, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.80 0 0) ((bruijn ##k.16 66 0) (##string ##string.302)) ((bruijn eqv? 68 0) (close _V0lookup__intrinsic__name_k79) (bruijn ##x.2 65 0) '##vcore.stdout->port))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k77(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k77, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.79 0 0) ((bruijn ##k.16 65 0) (##string ##string.301)) ((bruijn eqv? 67 0) (close _V0lookup__intrinsic__name_k78) (bruijn ##x.2 64 0) '##vcore.stdin->port))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k76(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k76, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.78 0 0) ((bruijn ##k.16 64 0) (##string ##string.300)) ((bruijn eqv? 66 0) (close _V0lookup__intrinsic__name_k77) (bruijn ##x.2 63 0) '##vcore.char-integer))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k75(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k75, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.77 0 0) ((bruijn ##k.16 63 0) (##string ##string.299)) ((bruijn eqv? 65 0) (close _V0lookup__intrinsic__name_k76) (bruijn ##x.2 62 0) '##vcore.symbol->string))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k74(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k74, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.76 0 0) ((bruijn ##k.16 62 0) (##string ##string.298)) ((bruijn eqv? 64 0) (close _V0lookup__intrinsic__name_k75) (bruijn ##x.2 61 0) '##vcore.string->number))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k73(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k73, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.75 0 0) ((bruijn ##k.16 61 0) (##string ##string.297)) ((bruijn eqv? 63 0) (close _V0lookup__intrinsic__name_k74) (bruijn ##x.2 60 0) '##vcore.string->symbol))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k72(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k72, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.74 0 0) ((bruijn ##k.16 60 0) (##string ##string.296)) ((bruijn eqv? 62 0) (close _V0lookup__intrinsic__name_k73) (bruijn ##x.2 59 0) '##vcore.string-length))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k71(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k71, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.73 0 0) ((bruijn ##k.16 59 0) (##string ##string.295)) ((bruijn eqv? 61 0) (close _V0lookup__intrinsic__name_k72) (bruijn ##x.2 58 0) '##vcore.string-set!))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k70(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k70, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.72 0 0) ((bruijn ##k.16 58 0) (##string ##string.294)) ((bruijn eqv? 60 0) (close _V0lookup__intrinsic__name_k71) (bruijn ##x.2 57 0) '##vcore.string-ref))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k69(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k69, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.71 0 0) ((bruijn ##k.16 57 0) (##string ##string.293)) ((bruijn eqv? 59 0) (close _V0lookup__intrinsic__name_k70) (bruijn ##x.2 56 0) '##vcore.string-copy!))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k68(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k68, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.70 0 0) ((bruijn ##k.16 56 0) (##string ##string.292)) ((bruijn eqv? 58 0) (close _V0lookup__intrinsic__name_k69) (bruijn ##x.2 55 0) '##vcore.substring))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k67(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k67, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.69 0 0) ((bruijn ##k.16 55 0) (##string ##string.291)) ((bruijn eqv? 57 0) (close _V0lookup__intrinsic__name_k68) (bruijn ##x.2 54 0) '##vcore.make-string))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k66(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k66, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.68 0 0) ((bruijn ##k.16 54 0) (##string ##string.290)) ((bruijn eqv? 56 0) (close _V0lookup__intrinsic__name_k67) (bruijn ##x.2 53 0) '##vcore.hash-table-delete!))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k65(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k65, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.67 0 0) ((bruijn ##k.16 53 0) (##string ##string.289)) ((bruijn eqv? 55 0) (close _V0lookup__intrinsic__name_k66) (bruijn ##x.2 52 0) '##vcore.hash-table-set!))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k64(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k64, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.66 0 0) ((bruijn ##k.16 52 0) (##string ##string.288)) ((bruijn eqv? 54 0) (close _V0lookup__intrinsic__name_k65) (bruijn ##x.2 51 0) '##vcore.hash-table-ref))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k63(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k63, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.65 0 0) ((bruijn ##k.16 51 0) (##string ##string.287)) ((bruijn eqv? 53 0) (close _V0lookup__intrinsic__name_k64) (bruijn ##x.2 50 0) '##vcore.hash-table-hash-function))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k62(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k62, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.64 0 0) ((bruijn ##k.16 50 0) (##string ##string.286)) ((bruijn eqv? 52 0) (close _V0lookup__intrinsic__name_k63) (bruijn ##x.2 49 0) '##vcore.hash-table-equivalence-function))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k61(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k61, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.63 0 0) ((bruijn ##k.16 49 0) (##string ##string.285)) ((bruijn eqv? 51 0) (close _V0lookup__intrinsic__name_k62) (bruijn ##x.2 48 0) '##vcore.make-hash-table))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k60(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k60, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.62 0 0) ((bruijn ##k.16 48 0) (##string ##string.284)) ((bruijn eqv? 50 0) (close _V0lookup__intrinsic__name_k61) (bruijn ##x.2 47 0) '##vcore.vector-length))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k59(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k59, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.61 0 0) ((bruijn ##k.16 47 0) (##string ##string.283)) ((bruijn eqv? 49 0) (close _V0lookup__intrinsic__name_k60) (bruijn ##x.2 46 0) '##vcore.vector-set!))
if(VDecodeBool(
_var0)) {
    ...
    V_CALL(VGetArg(upenv, 49-1, 0), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0lookup__intrinsic__name_k60, env)}),
...
static void _V0lookup__intrinsic__name_k58(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k58, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.60 0 0) ((bruijn ##k.16 46 0) (##string ##string.282)) ((bruijn eqv? 48 0) (close _V0lookup__intrinsic__name_k59) (bruijn ##x.2 45 0) '##vcore.vector-ref))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k57(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k57, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.59 0 0) ((bruijn ##k.16 45 0) (##string ##string.281)) ((bruijn eqv? 47 0) (close _V0lookup__intrinsic__name_k58) (bruijn ##x.2 44 0) '##vcore.list->vector))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k56(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k56, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.58 0 0) ((bruijn ##k.16 44 0) (##string ##string.280)) ((bruijn eqv? 46 0) (close _V0lookup__intrinsic__name_k57) (bruijn ##x.2 43 0) '##vcore.set-cdr!))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k55(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k55, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.57 0 0) ((bruijn ##k.16 43 0) (##string ##string.279)) ((bruijn eqv? 45 0) (close _V0lookup__intrinsic__name_k56) (bruijn ##x.2 42 0) '##vcore.set-car!))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 43-1, 0), runtime,
...
static void _V0lookup__intrinsic__name_k54(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k54, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.56 0 0) ((bruijn ##k.16 42 0) (##string ##string.278)) ((bruijn eqv? 44 0) (close _V0lookup__intrinsic__name_k55) (bruijn ##x.2 41 0) '##vcore.cdr))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k53(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k53, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.55 0 0) ((bruijn ##k.16 41 0) (##string ##string.277)) ((bruijn eqv? 43 0) (close _V0lookup__intrinsic__name_k54) (bruijn ##x.2 40 0) '##vcore.car))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k51(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k51, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((close _V0lookup__intrinsic__name_k52) (close _V0lookup__intrinsic__name_k53))
    V_CALL_FUNC(_V0lookup__intrinsic__name_k52, env, runtime,
...
static void _V0lookup__intrinsic__name_k50(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k50, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.54 0 0) ((bruijn ##k.16 39 0) (##string ##string.276)) ((bruijn eqv? 41 0) (close _V0lookup__intrinsic__name_k51) (bruijn ##x.2 38 0) '##vcore.cons))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k49(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k49, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.53 0 0) ((bruijn ##k.16 38 0) (##string ##string.275)) ((bruijn eqv? 40 0) (close _V0lookup__intrinsic__name_k50) (bruijn ##x.2 37 0) '##vcore.load-library))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k48(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k48, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.52 0 0) ((bruijn ##k.16 37 0) (##string ##string.274)) ((bruijn eqv? 39 0) (close _V0lookup__intrinsic__name_k49) (bruijn ##x.2 36 0) '##vcore.make-import))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k47(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k47, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.51 0 0) ((bruijn ##k.16 36 0) (##string ##string.273)) ((bruijn eqv? 38 0) (close _V0lookup__intrinsic__name_k48) (bruijn ##x.2 35 0) '##vcore.lookup-library))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k46(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k46, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.50 0 0) ((bruijn ##k.16 35 0) (##string ##string.269)) ((bruijn eqv? 37 0) (close _V0lookup__intrinsic__name_k47) (bruijn ##x.2 34 0) '##vcore.multidefine))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k45(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k45, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.49 0 0) ((bruijn ##k.16 34 0) (##string ##string.272)) ((bruijn eqv? 36 0) (close _V0lookup__intrinsic__name_k46) (bruijn ##x.2 33 0) '##vcore.define))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k44(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k44, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.48 0 0) ((bruijn ##k.16 33 0) (##string ##string.271)) ((bruijn eqv? 35 0) (close _V0lookup__intrinsic__name_k45) (bruijn ##x.2 32 0) '##vcore.function))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k43(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k43, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.47 0 0) ((bruijn ##k.16 32 0) (##string ##string.270)) ((bruijn eqv? 34 0) (close _V0lookup__intrinsic__name_k44) (bruijn ##x.2 31 0) '##vcore.import))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k42(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k42, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.46 0 0) ((bruijn ##k.16 31 0) (##string ##string.269)) ((bruijn eqv? 33 0) (close _V0lookup__intrinsic__name_k43) (bruijn ##x.2 30 0) '##vcore.set-global!))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k41(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k41, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.45 0 0) ((bruijn ##k.16 30 0) (##string ##string.268)) ((bruijn eqv? 32 0) (close _V0lookup__intrinsic__name_k42) (bruijn ##x.2 29 0) '##vcore.define-global))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k40(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k40, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.44 0 0) ((bruijn ##k.16 29 0) (##string ##string.267)) ((bruijn eqv? 31 0) (close _V0lookup__intrinsic__name_k41) (bruijn ##x.2 28 0) '##vcore.exit))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k39(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k39, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.43 0 0) ((bruijn ##k.16 28 0) (##string ##string.266)) ((bruijn eqv? 30 0) (close _V0lookup__intrinsic__name_k40) (bruijn ##x.2 27 0) '##vcore.abort))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k38(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k38, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.42 0 0) ((bruijn ##k.16 27 0) (##string ##string.265)) ((bruijn eqv? 29 0) (close _V0lookup__intrinsic__name_k39) (bruijn ##x.2 26 0) '##vcore.apply-cps))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k37(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k37, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.41 0 0) ((bruijn ##k.16 26 0) (##string ##string.264)) ((bruijn eqv? 28 0) (close _V0lookup__intrinsic__name_k38) (bruijn ##x.2 25 0) '##vcore.apply))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k36(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k36, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.40 0 0) ((bruijn ##k.16 25 0) (##string ##string.263)) ((bruijn eqv? 27 0) (close _V0lookup__intrinsic__name_k37) (bruijn ##x.2 24 0) '##vcore.call-with-values))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k35(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k35, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.39 0 0) ((bruijn ##k.16 24 0) (##string ##string.262)) ((bruijn eqv? 26 0) (close _V0lookup__intrinsic__name_k36) (bruijn ##x.2 23 0) '##vcore.call/cc))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k34(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k34, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.38 0 0) ((bruijn ##k.16 23 0) (##string ##string.261)) ((bruijn eqv? 25 0) (close _V0lookup__intrinsic__name_k35) (bruijn ##x.2 22 0) '##vcore.next))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k33(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k33, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.37 0 0) ((bruijn ##k.16 22 0) (##string ##string.260)) ((bruijn eqv? 24 0) (close _V0lookup__intrinsic__name_k34) (bruijn ##x.2 21 0) '##vcore.not))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k32(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k32, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.36 0 0) ((bruijn ##k.16 21 0) (##string ##string.259)) ((bruijn eqv? 23 0) (close _V0lookup__intrinsic__name_k33) (bruijn ##x.2 20 0) '##vcore.eqv?))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k31(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k31, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.35 0 0) ((bruijn ##k.16 20 0) (##string ##string.258)) ((bruijn eqv? 22 0) (close _V0lookup__intrinsic__name_k32) (bruijn ##x.2 19 0) '##vcore.blob=?))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k30(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k30, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.34 0 0) ((bruijn ##k.16 19 0) (##string ##string.257)) ((bruijn eqv? 21 0) (close _V0lookup__intrinsic__name_k31) (bruijn ##x.2 18 0) '##vcore.symbol=?))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k29(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k29, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.33 0 0) ((bruijn ##k.16 18 0) (##string ##string.256)) ((bruijn eqv? 20 0) (close _V0lookup__intrinsic__name_k30) (bruijn ##x.2 17 0) '##vcore.eq?))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k28(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k28, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.32 0 0) ((bruijn ##k.16 17 0) (##string ##string.255)) ((bruijn eqv? 19 0) (close _V0lookup__intrinsic__name_k29) (bruijn ##x.2 16 0) '##vcore.char?))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k27(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k27, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.31 0 0) ((bruijn ##k.16 16 0) (##string ##string.254)) ((bruijn eqv? 18 0) (close _V0lookup__intrinsic__name_k28) (bruijn ##x.2 15 0) '##vcore.double?))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k26(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k26, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.30 0 0) ((bruijn ##k.16 15 0) (##string ##string.253)) ((bruijn eqv? 17 0) (close _V0lookup__intrinsic__name_k27) (bruijn ##x.2 14 0) '##vcore.int?))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k25(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k25, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.29 0 0) ((bruijn ##k.16 14 0) (##string ##string.252)) ((bruijn eqv? 16 0) (close _V0lookup__intrinsic__name_k26) (bruijn ##x.2 13 0) '##vcore.string?))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k24(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k24, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.28 0 0) ((bruijn ##k.16 13 0) (##string ##string.251)) ((bruijn eqv? 15 0) (close _V0lookup__intrinsic__name_k25) (bruijn ##x.2 12 0) '##vcore.symbol?))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k23(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k23, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.27 0 0) ((bruijn ##k.16 12 0) (##string ##string.250)) ((bruijn eqv? 14 0) (close _V0lookup__intrinsic__name_k24) (bruijn ##x.2 11 0) '##vcore.blob?))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k22(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k22, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.26 0 0) ((bruijn ##k.16 11 0) (##string ##string.249)) ((bruijn eqv? 13 0) (close _V0lookup__intrinsic__name_k23) (bruijn ##x.2 10 0) '##vcore.procedure?))
if(VDecodeBool(
_var0)) {
...
static void _V0lookup__intrinsic__name_k21(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k21, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.25 0 0) ((bruijn ##k.16 10 0) (##string ##string.248)) ((bruijn eqv? 12 0) (close _V0lookup__intrinsic__name_k22) (bruijn ##x.2 9 0) '##vcore.vector?))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 10-1, 0), runtime,
...
static void _V0lookup__intrinsic__name_k20(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k20, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.24 0 0) ((bruijn ##k.16 9 0) (##string ##string.247)) ((bruijn eqv? 11 0) (close _V0lookup__intrinsic__name_k21) (bruijn ##x.2 8 0) '##vcore.pair?))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 9-1, 0), runtime,
...
static void _V0lookup__intrinsic__name_k19(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k19, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.23 0 0) ((bruijn ##k.16 8 0) (##string ##string.246)) ((bruijn eqv? 10 0) (close _V0lookup__intrinsic__name_k20) (bruijn ##x.2 7 0) '##vcore.null?))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 8-1, 0), runtime,
...
static void _V0lookup__intrinsic__name_k18(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k18, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.22 0 0) ((bruijn ##k.16 7 0) (##string ##string.245)) ((bruijn eqv? 9 0) (close _V0lookup__intrinsic__name_k19) (bruijn ##x.2 6 0) '##vcore.remainder))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 7-1, 0), runtime,
...
static void _V0lookup__intrinsic__name_k17(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k17, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.21 0 0) ((bruijn ##k.16 6 0) (##string ##string.244)) ((bruijn eqv? 8 0) (close _V0lookup__intrinsic__name_k18) (bruijn ##x.2 5 0) '##vcore.quotient))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 6-1, 0), runtime,
...
static void _V0lookup__intrinsic__name_k16(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k16, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.20 0 0) ((bruijn ##k.16 5 0) (##string ##string.243)) ((bruijn eqv? 7 0) (close _V0lookup__intrinsic__name_k17) (bruijn ##x.2 4 0) '##vcore.cmp))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 5-1, 0), runtime,
...
static void _V0lookup__intrinsic__name_k15(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k15, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.19 0 0) ((bruijn ##k.16 4 0) (##string ##string.242)) ((bruijn eqv? 6 0) (close _V0lookup__intrinsic__name_k16) (bruijn ##x.2 3 0) '##vcore./))
if(VDecodeBool(
_var0)) {
    V_CALL(upenv->up->up->up->vars[0], runtime,
...
static void _V0lookup__intrinsic__name_k14(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k14, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.18 0 0) ((bruijn ##k.16 3 0) (##string ##string.241)) ((bruijn eqv? 5 0) (close _V0lookup__intrinsic__name_k15) (bruijn ##x.2 2 0) '##vcore.*))
if(VDecodeBool(
_var0)) {
    V_CALL(upenv->up->up->vars[0], runtime,
...
static void _V0lookup__intrinsic__name_k13(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic__name_k13, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.17 0 0) ((bruijn ##k.16 2 0) (##string ##string.240)) ((bruijn eqv? 4 0) (close _V0lookup__intrinsic__name_k14) (bruijn ##x.2 1 0) '##vcore.-))
if(VDecodeBool(
_var0)) {
    V_CALL(upenv->up->vars[0], runtime,
...
static void _V0lookup__intrinsic_k157(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k157, runtime, upenv, 1, argc, _var0) {
  // (if (bruijn ##p.225 1 0) ((bruijn ##k.226 0 0) (bruijn ##p.225 1 0)) ((bruijn eqv? 43 0) (bruijn ##k.226 0 0) (bruijn ##x.3 40 0) '##vcore.qcons))
if(VDecodeBool(
upenv->vars[0])) {
    V_CALL(_var0, runtime,
      upenv->vars[0]);
...
static void _V0lookup__intrinsic_k221(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k221, runtime, upenv, 1, argc, _var0) {
  // (if (bruijn ##p.224 0 0) ((bruijn ##k.122 104 0) (##intrinsic ##vcore.await)) ((bruijn ##k.122 104 0) #f))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 104-1, 0), runtime,
...
static void _V0lookup__intrinsic_k220(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k220, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.223 0 0) ((bruijn ##k.122 103 0) (##intrinsic ##vcore.async)) ((bruijn eqv? 105 0) (close _V0lookup__intrinsic_k221) (bruijn ##x.3 102 0) '##vcore.await))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 103-1, 0), runtime,
...
static void _V0lookup__intrinsic_k219(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k219, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.222 0 0) ((bruijn ##k.122 102 0) (##intrinsic ##vcore.fiber-fork-list)) ((bruijn eqv? 104 0) (close _V0lookup__intrinsic_k220) (bruijn ##x.3 101 0) '##vcore.async))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 102-1, 0), runtime,
...
static void _V0lookup__intrinsic_k218(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k218, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.221 0 0) ((bruijn ##k.122 101 0) (##intrinsic ##vcore.random-advance!)) ((bruijn eqv? 103 0) (close _V0lookup__intrinsic_k219) (bruijn ##x.3 100 0) '##vcore.fiber-fork-list))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 101-1, 0), runtime,
...
static void _V0lookup__intrinsic_k217(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k217, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.220 0 0) ((bruijn ##k.122 100 0) (##intrinsic ##vcore.random-sample-float!)) ((bruijn eqv? 102 0) (close _V0lookup__intrinsic_k218) (bruijn ##x.3 99 0) '##vcore.random-advance!))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 100-1, 0), runtime,
...
static void _V0lookup__intrinsic_k216(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k216, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.219 0 0) ((bruijn ##k.122 99 0) (##intrinsic ##vcore.random-sample-bounded!)) ((bruijn eqv? 101 0) (close _V0lookup__intrinsic_k217) (bruijn ##x.3 98 0) '##vcore.random-sample-float!))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 99-1, 0), runtime,
...
static void _V0lookup__intrinsic_k215(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k215, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.218 0 0) ((bruijn ##k.122 98 0) (##intrinsic ##vcore.random-sample!)) ((bruijn eqv? 100 0) (close _V0lookup__intrinsic_k216) (bruijn ##x.3 97 0) '##vcore.random-sample-bounded!))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 98-1, 0), runtime,
...
static void _V0lookup__intrinsic_k214(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k214, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.217 0 0) ((bruijn ##k.122 97 0) (##intrinsic ##vcore.random-copy)) ((bruijn eqv? 99 0) (close _V0lookup__intrinsic_k215) (bruijn ##x.3 96 0) '##vcore.random-sample!))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 97-1, 0), runtime,
...
static void _V0lookup__intrinsic_k213(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k213, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.216 0 0) ((bruijn ##k.122 96 0) (##intrinsic ##vcore.make-random)) ((bruijn eqv? 98 0) (close _V0lookup__intrinsic_k214) (bruijn ##x.3 95 0) '##vcore.random-copy))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 96-1, 0), runtime,
...
static void _V0lookup__intrinsic_k212(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k212, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.215 0 0) ((bruijn ##k.122 95 0) (##intrinsic ##vcore.command-line)) ((bruijn eqv? 97 0) (close _V0lookup__intrinsic_k213) (bruijn ##x.3 94 0) '##vcore.make-random))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 95-1, 0), runtime,
...
static void _V0lookup__intrinsic_k211(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k211, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.214 0 0) ((bruijn ##k.122 94 0) (##intrinsic ##vcore.make-temporary-file)) ((bruijn eqv? 96 0) (close _V0lookup__intrinsic_k212) (bruijn ##x.3 93 0) '##vcore.command-line))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 94-1, 0), runtime,
...
static void _V0lookup__intrinsic_k210(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k210, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.213 0 0) ((bruijn ##k.122 93 0) (##intrinsic ##vcore.open-output-process)) ((bruijn eqv? 95 0) (close _V0lookup__intrinsic_k211) (bruijn ##x.3 92 0) '##vcore.make-temporary-file))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 93-1, 0), runtime,
...
static void _V0lookup__intrinsic_k209(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k209, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.212 0 0) ((bruijn ##k.122 92 0) (##intrinsic ##vcore.open-input-process)) ((bruijn eqv? 94 0) (close _V0lookup__intrinsic_k210) (bruijn ##x.3 91 0) '##vcore.open-output-process))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 92-1, 0), runtime,
...
static void _V0lookup__intrinsic_k208(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k208, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.211 0 0) ((bruijn ##k.122 91 0) (##intrinsic ##vcore.system)) ((bruijn eqv? 93 0) (close _V0lookup__intrinsic_k209) (bruijn ##x.3 90 0) '##vcore.open-input-process))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 91-1, 0), runtime,
...
static void _V0lookup__intrinsic_k207(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k207, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.210 0 0) ((bruijn ##k.122 90 0) (##intrinsic ##vcore.garbage-collect)) ((bruijn eqv? 92 0) (close _V0lookup__intrinsic_k208) (bruijn ##x.3 89 0) '##vcore.system))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 90-1, 0), runtime,
...
static void _V0lookup__intrinsic_k206(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k206, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.209 0 0) ((bruijn ##k.122 89 0) (##intrinsic ##vcore.finalize!)) ((bruijn eqv? 91 0) (close _V0lookup__intrinsic_k207) (bruijn ##x.3 88 0) '##vcore.garbage-collect))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 89-1, 0), runtime,
...
static void _V0lookup__intrinsic_k205(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k205, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.208 0 0) ((bruijn ##k.122 88 0) (##intrinsic ##vcore.has-finalizer?)) ((bruijn eqv? 90 0) (close _V0lookup__intrinsic_k206) (bruijn ##x.3 87 0) '##vcore.finalize!))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 88-1, 0), runtime,
...
static void _V0lookup__intrinsic_k204(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k204, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.207 0 0) ((bruijn ##k.122 87 0) (##intrinsic ##vcore.set-finalizer!)) ((bruijn eqv? 89 0) (close _V0lookup__intrinsic_k205) (bruijn ##x.3 86 0) '##vcore.has-finalizer?))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 87-1, 0), runtime,
...
static void _V0lookup__intrinsic_k203(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k203, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.206 0 0) ((bruijn ##k.122 86 0) (##intrinsic ##vcore.newline-stdout)) ((bruijn eqv? 88 0) (close _V0lookup__intrinsic_k204) (bruijn ##x.3 85 0) '##vcore.set-finalizer!))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 86-1, 0), runtime,
...
static void _V0lookup__intrinsic_k202(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k202, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.205 0 0) ((bruijn ##k.122 85 0) (##intrinsic ##vcore.write-stdout)) ((bruijn eqv? 87 0) (close _V0lookup__intrinsic_k203) (bruijn ##x.3 84 0) '##vcore.newline-stdout))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 85-1, 0), runtime,
...
static void _V0lookup__intrinsic_k201(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k201, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.204 0 0) ((bruijn ##k.122 84 0) (##intrinsic ##vcore.display-stdout)) ((bruijn eqv? 86 0) (close _V0lookup__intrinsic_k202) (bruijn ##x.3 83 0) '##vcore.write-stdout))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 84-1, 0), runtime,
...
static void _V0lookup__intrinsic_k200(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k200, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.203 0 0) ((bruijn ##k.122 83 0) (##intrinsic ##vcore.newline)) ((bruijn eqv? 85 0) (close _V0lookup__intrinsic_k201) (bruijn ##x.3 82 0) '##vcore.display-stdout))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 83-1, 0), runtime,
...
static void _V0lookup__intrinsic_k199(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k199, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.202 0 0) ((bruijn ##k.122 82 0) (##intrinsic ##vcore.write)) ((bruijn eqv? 84 0) (close _V0lookup__intrinsic_k200) (bruijn ##x.3 81 0) '##vcore.newline))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 82-1, 0), runtime,
...
static void _V0lookup__intrinsic_k198(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k198, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.201 0 0) ((bruijn ##k.122 81 0) (##intrinsic ##vcore.display-word)) ((bruijn eqv? 83 0) (close _V0lookup__intrinsic_k199) (bruijn ##x.3 80 0) '##vcore.write))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 81-1, 0), runtime,
...
static void _V0lookup__intrinsic_k197(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k197, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.200 0 0) ((bruijn ##k.122 80 0) (##intrinsic ##vcore.read)) ((bruijn eqv? 82 0) (close _V0lookup__intrinsic_k198) (bruijn ##x.3 79 0) '##vcore.display-word))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 80-1, 0), runtime,
      _V40_V10vcore_Dread);
...
static void _V0lookup__intrinsic_k196(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k196, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.199 0 0) ((bruijn ##k.122 79 0) (##intrinsic ##vcore.read-line)) ((bruijn eqv? 81 0) (close _V0lookup__intrinsic_k197) (bruijn ##x.3 78 0) '##vcore.read))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 79-1, 0), runtime,
...
static void _V0lookup__intrinsic_k195(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k195, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.198 0 0) ((bruijn ##k.122 78 0) (##intrinsic ##vcore.read-char)) ((bruijn eqv? 80 0) (close _V0lookup__intrinsic_k196) (bruijn ##x.3 77 0) '##vcore.read-line))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 78-1, 0), runtime,
...
static void _V0lookup__intrinsic_k194(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k194, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.197 0 0) ((bruijn ##k.122 77 0) (##intrinsic ##vcore.eof-object?)) ((bruijn eqv? 79 0) (close _V0lookup__intrinsic_k195) (bruijn ##x.3 76 0) '##vcore.read-char))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 77-1, 0), runtime,
...
static void _V0lookup__intrinsic_k193(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k193, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.196 0 0) ((bruijn ##k.122 76 0) (##intrinsic ##vcore.get-output-string)) ((bruijn eqv? 78 0) (close _V0lookup__intrinsic_k194) (bruijn ##x.3 75 0) '##vcore.eof-object?))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 76-1, 0), runtime,
...
static void _V0lookup__intrinsic_k192(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k192, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.195 0 0) ((bruijn ##k.122 75 0) (##intrinsic ##vcore.open-output-string)) ((bruijn eqv? 77 0) (close _V0lookup__intrinsic_k193) (bruijn ##x.3 74 0) '##vcore.get-output-string))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 75-1, 0), runtime,
...
static void _V0lookup__intrinsic_k191(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k191, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.194 0 0) ((bruijn ##k.122 74 0) (##intrinsic ##vcore.close-stream)) ((bruijn eqv? 76 0) (close _V0lookup__intrinsic_k192) (bruijn ##x.3 73 0) '##vcore.open-output-string))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 74-1, 0), runtime,
...
static void _V0lookup__intrinsic_k190(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k190, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.193 0 0) ((bruijn ##k.122 73 0) (##intrinsic ##vcore.open-output-stream)) ((bruijn eqv? 75 0) (close _V0lookup__intrinsic_k191) (bruijn ##x.3 72 0) '##vcore.close-stream))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 73-1, 0), runtime,
...
static void _V0lookup__intrinsic_k189(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k189, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.192 0 0) ((bruijn ##k.122 72 0) (##intrinsic ##vcore.open-input-stream)) ((bruijn eqv? 74 0) (close _V0lookup__intrinsic_k190) (bruijn ##x.3 71 0) '##vcore.open-output-stream))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 72-1, 0), runtime,
...
static void _V0lookup__intrinsic_k188(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k188, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.191 0 0) ((bruijn ##k.122 71 0) (##intrinsic ##vcore.dup-stderr)) ((bruijn eqv? 73 0) (close _V0lookup__intrinsic_k189) (bruijn ##x.3 70 0) '##vcore.open-input-stream))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 71-1, 0), runtime,
...
static void _V0lookup__intrinsic_k187(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k187, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.190 0 0) ((bruijn ##k.122 70 0) (##intrinsic ##vcore.dup-stdout)) ((bruijn eqv? 72 0) (close _V0lookup__intrinsic_k188) (bruijn ##x.3 69 0) '##vcore.dup-stderr))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 70-1, 0), runtime,
...
static void _V0lookup__intrinsic_k186(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k186, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.189 0 0) ((bruijn ##k.122 69 0) (##intrinsic ##vcore.dup-stdin)) ((bruijn eqv? 71 0) (close _V0lookup__intrinsic_k187) (bruijn ##x.3 68 0) '##vcore.dup-stdout))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 69-1, 0), runtime,
...
static void _V0lookup__intrinsic_k185(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k185, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.188 0 0) ((bruijn ##k.122 68 0) (##intrinsic ##vcore.stderr->port)) ((bruijn eqv? 70 0) (close _V0lookup__intrinsic_k186) (bruijn ##x.3 67 0) '##vcore.dup-stdin))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 68-1, 0), runtime,
...
static void _V0lookup__intrinsic_k184(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k184, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.187 0 0) ((bruijn ##k.122 67 0) (##intrinsic ##vcore.stdout->port)) ((bruijn eqv? 69 0) (close _V0lookup__intrinsic_k185) (bruijn ##x.3 66 0) '##vcore.stderr->port))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 67-1, 0), runtime,
...
static void _V0lookup__intrinsic_k183(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k183, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.186 0 0) ((bruijn ##k.122 66 0) (##intrinsic ##vcore.stdin->port)) ((bruijn eqv? 68 0) (close _V0lookup__intrinsic_k184) (bruijn ##x.3 65 0) '##vcore.stdout->port))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 66-1, 0), runtime,
...
static void _V0lookup__intrinsic_k182(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k182, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.185 0 0) ((bruijn ##k.122 65 0) (##intrinsic ##vcore.char-integer)) ((bruijn eqv? 67 0) (close _V0lookup__intrinsic_k183) (bruijn ##x.3 64 0) '##vcore.stdin->port))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 65-1, 0), runtime,
...
static void _V0lookup__intrinsic_k181(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k181, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.184 0 0) ((bruijn ##k.122 64 0) (##intrinsic ##vcore.symbol->string)) ((bruijn eqv? 66 0) (close _V0lookup__intrinsic_k182) (bruijn ##x.3 63 0) '##vcore.char-integer))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 64-1, 0), runtime,
...
static void _V0lookup__intrinsic_k180(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k180, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.183 0 0) ((bruijn ##k.122 63 0) (##intrinsic ##vcore.string->number)) ((bruijn eqv? 65 0) (close _V0lookup__intrinsic_k181) (bruijn ##x.3 62 0) '##vcore.symbol->string))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 63-1, 0), runtime,
...
static void _V0lookup__intrinsic_k179(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k179, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.182 0 0) ((bruijn ##k.122 62 0) (##intrinsic ##vcore.string->symbol)) ((bruijn eqv? 64 0) (close _V0lookup__intrinsic_k180) (bruijn ##x.3 61 0) '##vcore.string->number))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 62-1, 0), runtime,
...
static void _V0lookup__intrinsic_k178(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k178, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.181 0 0) ((bruijn ##k.122 61 0) (##intrinsic ##vcore.string-length)) ((bruijn eqv? 63 0) (close _V0lookup__intrinsic_k179) (bruijn ##x.3 60 0) '##vcore.string->symbol))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 61-1, 0), runtime,
...
static void _V0lookup__intrinsic_k177(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k177, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.180 0 0) ((bruijn ##k.122 60 0) (##intrinsic ##vcore.string-set!)) ((bruijn eqv? 62 0) (close _V0lookup__intrinsic_k178) (bruijn ##x.3 59 0) '##vcore.string-length))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 60-1, 0), runtime,
...
static void _V0lookup__intrinsic_k176(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k176, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.179 0 0) ((bruijn ##k.122 59 0) (##intrinsic ##vcore.string-ref)) ((bruijn eqv? 61 0) (close _V0lookup__intrinsic_k177) (bruijn ##x.3 58 0) '##vcore.string-set!))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 59-1, 0), runtime,
...
static void _V0lookup__intrinsic_k175(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k175, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.178 0 0) ((bruijn ##k.122 58 0) (##intrinsic ##vcore.string-copy!)) ((bruijn eqv? 60 0) (close _V0lookup__intrinsic_k176) (bruijn ##x.3 57 0) '##vcore.string-ref))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 58-1, 0), runtime,
...
static void _V0lookup__intrinsic_k174(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k174, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.177 0 0) ((bruijn ##k.122 57 0) (##intrinsic ##vcore.substring)) ((bruijn eqv? 59 0) (close _V0lookup__intrinsic_k175) (bruijn ##x.3 56 0) '##vcore.string-copy!))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 57-1, 0), runtime,
...
static void _V0lookup__intrinsic_k173(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k173, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.176 0 0) ((bruijn ##k.122 56 0) (##intrinsic ##vcore.make-string)) ((bruijn eqv? 58 0) (close _V0lookup__intrinsic_k174) (bruijn ##x.3 55 0) '##vcore.substring))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 56-1, 0), runtime,
...
static void _V0lookup__intrinsic_k172(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k172, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.175 0 0) ((bruijn ##k.122 55 0) (##intrinsic ##vcore.hash-table-delete!)) ((bruijn eqv? 57 0) (close _V0lookup__intrinsic_k173) (bruijn ##x.3 54 0) '##vcore.make-string))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 55-1, 0), runtime,
...
static void _V0lookup__intrinsic_k171(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k171, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.174 0 0) ((bruijn ##k.122 54 0) (##intrinsic ##vcore.hash-table-set!)) ((bruijn eqv? 56 0) (close _V0lookup__intrinsic_k172) (bruijn ##x.3 53 0) '##vcore.hash-table-delete!))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 54-1, 0), runtime,
...
static void _V0lookup__intrinsic_k170(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k170, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.173 0 0) ((bruijn ##k.122 53 0) (##intrinsic ##vcore.hash-table-ref)) ((bruijn eqv? 55 0) (close _V0lookup__intrinsic_k171) (bruijn ##x.3 52 0) '##vcore.hash-table-set!))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 53-1, 0), runtime,
...
static void _V0lookup__intrinsic_k169(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k169, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.172 0 0) ((bruijn ##k.122 52 0) (##intrinsic ##vcore.hash-table-hash-function)) ((bruijn eqv? 54 0) (close _V0lookup__intrinsic_k170) (bruijn ##x.3 51 0) '##vcore.hash-table-ref))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 52-1, 0), runtime,
...
static void _V0lookup__intrinsic_k168(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k168, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.171 0 0) ((bruijn ##k.122 51 0) (##intrinsic ##vcore.hash-table-equivalence-function)) ((bruijn eqv? 53 0) (close _V0lookup__intrinsic_k169) (bruijn ##x.3 50 0) '##vcore.hash-table-hash-function))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 51-1, 0), runtime,
...
static void _V0lookup__intrinsic_k167(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k167, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.170 0 0) ((bruijn ##k.122 50 0) (##intrinsic ##vcore.make-hash-table)) ((bruijn eqv? 52 0) (close _V0lookup__intrinsic_k168) (bruijn ##x.3 49 0) '##vcore.hash-table-equivalence-function))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 50-1, 0), runtime,
...
static void _V0lookup__intrinsic_k166(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k166, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.169 0 0) ((bruijn ##k.122 49 0) (##intrinsic ##vcore.vector-length)) ((bruijn eqv? 51 0) (close _V0lookup__intrinsic_k167) (bruijn ##x.3 48 0) '##vcore.make-hash-table))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 49-1, 0), runtime,
...
static void _V0lookup__intrinsic_k165(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k165, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.168 0 0) ((bruijn ##k.122 48 0) (##intrinsic ##vcore.vector-set!)) ((bruijn eqv? 50 0) (close _V0lookup__intrinsic_k166) (bruijn ##x.3 47 0) '##vcore.vector-length))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 48-1, 0), runtime,
...
static void _V0lookup__intrinsic_k164(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k164, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.167 0 0) ((bruijn ##k.122 47 0) (##intrinsic ##vcore.vector-ref)) ((bruijn eqv? 49 0) (close _V0lookup__intrinsic_k165) (bruijn ##x.3 46 0) '##vcore.vector-set!))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 47-1, 0), runtime,
...
static void _V0lookup__intrinsic_k163(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k163, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.166 0 0) ((bruijn ##k.122 46 0) (##intrinsic ##vcore.list->vector)) ((bruijn eqv? 48 0) (close _V0lookup__intrinsic_k164) (bruijn ##x.3 45 0) '##vcore.vector-ref))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 46-1, 0), runtime,
...
static void _V0lookup__intrinsic_k162(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k162, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.165 0 0) ((bruijn ##k.122 45 0) (##intrinsic ##vcore.set-cdr!)) ((bruijn eqv? 47 0) (close _V0lookup__intrinsic_k163) (bruijn ##x.3 44 0) '##vcore.list->vector))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 45-1, 0), runtime,
...
static void _V0lookup__intrinsic_k161(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k161, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.164 0 0) ((bruijn ##k.122 44 0) (##intrinsic ##vcore.set-car!)) ((bruijn eqv? 46 0) (close _V0lookup__intrinsic_k162) (bruijn ##x.3 43 0) '##vcore.set-cdr!))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 44-1, 0), runtime,
...
static void _V0lookup__intrinsic_k160(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k160, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.163 0 0) ((bruijn ##k.122 43 0) (##intrinsic ##vcore.cdr)) ((bruijn eqv? 45 0) (close _V0lookup__intrinsic_k161) (bruijn ##x.3 42 0) '##vcore.set-car!))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 43-1, 0), runtime,
      _V40_V10vcore_Dcdr);
...
static void _V0lookup__intrinsic_k159(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k159, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.162 0 0) ((bruijn ##k.122 42 0) (##intrinsic ##vcore.car)) ((bruijn eqv? 44 0) (close _V0lookup__intrinsic_k160) (bruijn ##x.3 41 0) '##vcore.cdr))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 42-1, 0), runtime,
      _V40_V10vcore_Dcar);
...
static void _V0lookup__intrinsic_k158(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k158, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.161 0 0) ((bruijn ##k.122 41 0) (##intrinsic ##vcore.cons)) ((bruijn eqv? 43 0) (close _V0lookup__intrinsic_k159) (bruijn ##x.3 40 0) '##vcore.car))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 41-1, 0), runtime,
      _V40_V10vcore_Dcons);
...
static void _V0lookup__intrinsic_k156(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k156, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((close _V0lookup__intrinsic_k157) (close _V0lookup__intrinsic_k158))
    V_CALL_FUNC(_V0lookup__intrinsic_k157, env, runtime,
...
static void _V0lookup__intrinsic_k155(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k155, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.160 0 0) ((bruijn ##k.122 39 0) (##intrinsic ##vcore.load-library)) ((bruijn eqv? 41 0) (close _V0lookup__intrinsic_k156) (bruijn ##x.3 38 0) '##vcore.cons))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 39-1, 0), runtime,
...
static void _V0lookup__intrinsic_k154(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k154, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.159 0 0) ((bruijn ##k.122 38 0) (##intrinsic ##vcore.make-import)) ((bruijn eqv? 40 0) (close _V0lookup__intrinsic_k155) (bruijn ##x.3 37 0) '##vcore.load-library))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 38-1, 0), runtime,
...
static void _V0lookup__intrinsic_k153(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k153, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.158 0 0) ((bruijn ##k.122 37 0) (##intrinsic ##vcore.lookup-library)) ((bruijn eqv? 39 0) (close _V0lookup__intrinsic_k154) (bruijn ##x.3 36 0) '##vcore.make-import))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 37-1, 0), runtime,
...
static void _V0lookup__intrinsic_k152(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k152, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.157 0 0) ((bruijn ##k.122 36 0) (##intrinsic ##vcore.multidefine)) ((bruijn eqv? 38 0) (close _V0lookup__intrinsic_k153) (bruijn ##x.3 35 0) '##vcore.lookup-library))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 36-1, 0), runtime,
...
static void _V0lookup__intrinsic_k151(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k151, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.156 0 0) ((bruijn ##k.122 35 0) (##intrinsic ##vcore.define)) ((bruijn eqv? 37 0) (close _V0lookup__intrinsic_k152) (bruijn ##x.3 34 0) '##vcore.multidefine))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 35-1, 0), runtime,
...
static void _V0lookup__intrinsic_k150(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k150, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.155 0 0) ((bruijn ##k.122 34 0) (##intrinsic ##vcore.function)) ((bruijn eqv? 36 0) (close _V0lookup__intrinsic_k151) (bruijn ##x.3 33 0) '##vcore.define))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 34-1, 0), runtime,
...
static void _V0lookup__intrinsic_k149(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k149, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.154 0 0) ((bruijn ##k.122 33 0) (bruijn ##vcore.import 36 0)) ((bruijn eqv? 35 0) (close _V0lookup__intrinsic_k150) (bruijn ##x.3 32 0) '##vcore.function))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 33-1, 0), runtime,
      VGetArg(upenv, 36-1, 0));
...
static void _V0lookup__intrinsic_k148(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k148, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.153 0 0) ((bruijn ##k.122 32 0) (##intrinsic ##vcore.set-global!)) ((bruijn eqv? 34 0) (close _V0lookup__intrinsic_k149) (bruijn ##x.3 31 0) '##vcore.import))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 32-1, 0), runtime,
...
static void _V0lookup__intrinsic_k147(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k147, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.152 0 0) ((bruijn ##k.122 31 0) (##intrinsic ##vcore.define-global)) ((bruijn eqv? 33 0) (close _V0lookup__intrinsic_k148) (bruijn ##x.3 30 0) '##vcore.set-global!))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 31-1, 0), runtime,
...
static void _V0lookup__intrinsic_k146(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k146, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.151 0 0) ((bruijn ##k.122 30 0) (##intrinsic ##vcore.exit)) ((bruijn eqv? 32 0) (close _V0lookup__intrinsic_k147) (bruijn ##x.3 29 0) '##vcore.define-global))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 30-1, 0), runtime,
      _V40_V10vcore_Dexit);
...
static void _V0lookup__intrinsic_k145(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k145, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.150 0 0) ((bruijn ##k.122 29 0) (##intrinsic ##vcore.abort)) ((bruijn eqv? 31 0) (close _V0lookup__intrinsic_k146) (bruijn ##x.3 28 0) '##vcore.exit))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 29-1, 0), runtime,
...
static void _V0lookup__intrinsic_k144(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k144, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.149 0 0) ((bruijn ##k.122 28 0) (##intrinsic ##vcore.apply-cps)) ((bruijn eqv? 30 0) (close _V0lookup__intrinsic_k145) (bruijn ##x.3 27 0) '##vcore.abort))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 28-1, 0), runtime,
...
static void _V0lookup__intrinsic_k143(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k143, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.148 0 0) ((bruijn ##k.122 27 0) (##intrinsic ##vcore.apply)) ((bruijn eqv? 29 0) (close _V0lookup__intrinsic_k144) (bruijn ##x.3 26 0) '##vcore.apply-cps))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 27-1, 0), runtime,
...
static void _V0lookup__intrinsic_k142(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k142, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.147 0 0) ((bruijn ##k.122 26 0) (##intrinsic ##vcore.call-with-values)) ((bruijn eqv? 28 0) (close _V0lookup__intrinsic_k143) (bruijn ##x.3 25 0) '##vcore.apply))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 26-1, 0), runtime,
...
static void _V0lookup__intrinsic_k141(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k141, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.146 0 0) ((bruijn ##k.122 25 0) (##intrinsic ##vcore.call/cc)) ((bruijn eqv? 27 0) (close _V0lookup__intrinsic_k142) (bruijn ##x.3 24 0) '##vcore.call-with-values))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 25-1, 0), runtime,
...
static void _V0lookup__intrinsic_k140(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k140, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.145 0 0) ((bruijn ##k.122 24 0) (##intrinsic ##vcore.next)) ((bruijn eqv? 26 0) (close _V0lookup__intrinsic_k141) (bruijn ##x.3 23 0) '##vcore.call/cc))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 24-1, 0), runtime,
      _V40_V10vcore_Dnext);
...
static void _V0lookup__intrinsic_k139(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k139, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.144 0 0) ((bruijn ##k.122 23 0) (##intrinsic ##vcore.not)) ((bruijn eqv? 25 0) (close _V0lookup__intrinsic_k140) (bruijn ##x.3 22 0) '##vcore.next))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 23-1, 0), runtime,
      _V40_V10vcore_Dnot);
...
static void _V0lookup__intrinsic_k138(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k138, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.143 0 0) ((bruijn ##k.122 22 0) (##intrinsic ##vcore.eqv?)) ((bruijn eqv? 24 0) (close _V0lookup__intrinsic_k139) (bruijn ##x.3 21 0) '##vcore.not))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 22-1, 0), runtime,
...
static void _V0lookup__intrinsic_k137(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k137, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.142 0 0) ((bruijn ##k.122 21 0) (##intrinsic ##vcore.blob=?)) ((bruijn eqv? 23 0) (close _V0lookup__intrinsic_k138) (bruijn ##x.3 20 0) '##vcore.eqv?))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 21-1, 0), runtime,
...
static void _V0lookup__intrinsic_k136(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k136, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.141 0 0) ((bruijn ##k.122 20 0) (##intrinsic ##vcore.symbol=?)) ((bruijn eqv? 22 0) (close _V0lookup__intrinsic_k137) (bruijn ##x.3 19 0) '##vcore.blob=?))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 20-1, 0), runtime,
...
static void _V0lookup__intrinsic_k135(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k135, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.140 0 0) ((bruijn ##k.122 19 0) (##intrinsic ##vcore.eq?)) ((bruijn eqv? 21 0) (close _V0lookup__intrinsic_k136) (bruijn ##x.3 18 0) '##vcore.symbol=?))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 19-1, 0), runtime,
      _V40_V10vcore_Deq_Q);
...
static void _V0lookup__intrinsic_k134(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k134, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.139 0 0) ((bruijn ##k.122 18 0) (##intrinsic ##vcore.char?)) ((bruijn eqv? 20 0) (close _V0lookup__intrinsic_k135) (bruijn ##x.3 17 0) '##vcore.eq?))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 18-1, 0), runtime,
...
static void _V0lookup__intrinsic_k133(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k133, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.138 0 0) ((bruijn ##k.122 17 0) (##intrinsic ##vcore.double?)) ((bruijn eqv? 19 0) (close _V0lookup__intrinsic_k134) (bruijn ##x.3 16 0) '##vcore.char?))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 17-1, 0), runtime,
...
static void _V0lookup__intrinsic_k132(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k132, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.137 0 0) ((bruijn ##k.122 16 0) (##intrinsic ##vcore.int?)) ((bruijn eqv? 18 0) (close _V0lookup__intrinsic_k133) (bruijn ##x.3 15 0) '##vcore.double?))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 16-1, 0), runtime,
...
static void _V0lookup__intrinsic_k131(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k131, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.136 0 0) ((bruijn ##k.122 15 0) (##intrinsic ##vcore.string?)) ((bruijn eqv? 17 0) (close _V0lookup__intrinsic_k132) (bruijn ##x.3 14 0) '##vcore.int?))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 15-1, 0), runtime,
...
static void _V0lookup__intrinsic_k130(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k130, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.135 0 0) ((bruijn ##k.122 14 0) (##intrinsic ##vcore.symbol?)) ((bruijn eqv? 16 0) (close _V0lookup__intrinsic_k131) (bruijn ##x.3 13 0) '##vcore.string?))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 14-1, 0), runtime,
...
static void _V0lookup__intrinsic_k129(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k129, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.134 0 0) ((bruijn ##k.122 13 0) (##intrinsic ##vcore.blob?)) ((bruijn eqv? 15 0) (close _V0lookup__intrinsic_k130) (bruijn ##x.3 12 0) '##vcore.symbol?))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 13-1, 0), runtime,
...
static void _V0lookup__intrinsic_k128(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k128, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.133 0 0) ((bruijn ##k.122 12 0) (##intrinsic ##vcore.procedure?)) ((bruijn eqv? 14 0) (close _V0lookup__intrinsic_k129) (bruijn ##x.3 11 0) '##vcore.blob?))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 12-1, 0), runtime,
    ...
    V_CALL(VGetArg(upenv, 14-1, 0), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0lookup__intrinsic_k129, env)}),
      VGetArg(upenv, 11-1, 0),
      _V10vcore_Dblob_Q);
}
 }
}
static void _V0lookup__intrinsic_k127(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k127, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.132 0 0) ((bruijn ##k.122 11 0) (##intrinsic ##vcore.vector?)) ((bruijn eqv? 13 0) (close _V0lookup__intrinsic_k128) (bruijn ##x.3 10 0) '##vcore.procedure?))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 11-1, 0), runtime,
    ...
    V_CALL(VGetArg(upenv, 13-1, 0), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0lookup__intrinsic_k128, env)}),
      VGetArg(upenv, 10-1, 0),
      _V10vcore_Dprocedure_Q);
}
 }
}
static void _V0lookup__intrinsic_k126(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k126, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.131 0 0) ((bruijn ##k.122 10 0) (##intrinsic ##vcore.pair?)) ((bruijn eqv? 12 0) (close _V0lookup__intrinsic_k127) (bruijn ##x.3 9 0) '##vcore.vector?))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 10-1, 0), runtime,
    ...
    V_CALL(VGetArg(upenv, 12-1, 0), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0lookup__intrinsic_k127, env)}),
      VGetArg(upenv, 9-1, 0),
      _V10vcore_Dvector_Q);
}
 }
}
static void _V0lookup__intrinsic_k125(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k125, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.130 0 0) ((bruijn ##k.122 9 0) (##intrinsic ##vcore.null?)) ((bruijn eqv? 11 0) (close _V0lookup__intrinsic_k126) (bruijn ##x.3 8 0) '##vcore.pair?))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 9-1, 0), runtime,
    ...
    V_CALL(VGetArg(upenv, 11-1, 0), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0lookup__intrinsic_k126, env)}),
      VGetArg(upenv, 8-1, 0),
      _V10vcore_Dpair_Q);
}
 }
}
static void _V0lookup__intrinsic_k124(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k124, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.129 0 0) ((bruijn ##k.122 8 0) (##intrinsic ##vcore.remainder)) ((bruijn eqv? 10 0) (close _V0lookup__intrinsic_k125) (bruijn ##x.3 7 0) '##vcore.null?))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 8-1, 0), runtime,
    ...
    V_CALL(VGetArg(upenv, 10-1, 0), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0lookup__intrinsic_k125, env)}),
      VGetArg(upenv, 7-1, 0),
      _V10vcore_Dnull_Q);
}
 }
}
static void _V0lookup__intrinsic_k123(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k123, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.128 0 0) ((bruijn ##k.122 7 0) (##intrinsic ##vcore.quotient)) ((bruijn eqv? 9 0) (close _V0lookup__intrinsic_k124) (bruijn ##x.3 6 0) '##vcore.remainder))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 7-1, 0), runtime,
    ...
    V_CALL(VGetArg(upenv, 9-1, 0), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0lookup__intrinsic_k124, env)}),
      VGetArg(upenv, 6-1, 0),
      _V10vcore_Dremainder);
}
 }
}
static void _V0lookup__intrinsic_k122(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k122, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.127 0 0) ((bruijn ##k.122 6 0) (##intrinsic ##vcore.cmp)) ((bruijn eqv? 8 0) (close _V0lookup__intrinsic_k123) (bruijn ##x.3 5 0) '##vcore.quotient))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 6-1, 0), runtime,
      _V40_V10vcore_Dcmp);
    ...
    V_CALL(VGetArg(upenv, 8-1, 0), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0lookup__intrinsic_k123, env)}),
      VGetArg(upenv, 5-1, 0),
      _V10vcore_Dquotient);
}
 }
}
static void _V0lookup__intrinsic_k121(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k121, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.126 0 0) ((bruijn ##k.122 5 0) (##intrinsic ##vcore./)) ((bruijn eqv? 7 0) (close _V0lookup__intrinsic_k122) (bruijn ##x.3 4 0) '##vcore.cmp))
if(VDecodeBool(
_var0)) {
    V_CALL(VGetArg(upenv, 5-1, 0), runtime,
      _V40_V10vcore_D_W);
    ...
    V_CALL(VGetArg(upenv, 7-1, 0), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0lookup__intrinsic_k122, env)}),
      upenv->up->up->up->vars[0],
      _V10vcore_Dcmp);
}
 }
}
static void _V0lookup__intrinsic_k120(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k120, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.125 0 0) ((bruijn ##k.122 4 0) (##intrinsic ##vcore.*)) ((bruijn eqv? 6 0) (close _V0lookup__intrinsic_k121) (bruijn ##x.3 3 0) '##vcore./))
if(VDecodeBool(
_var0)) {
    V_CALL(upenv->up->up->up->vars[0], runtime,
      _V40_V10vcore_D_S);
    ...
    V_CALL(VGetArg(upenv, 6-1, 0), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0lookup__intrinsic_k121, env)}),
      upenv->up->up->vars[0],
      _V10vcore_D_W);
}
 }
}
static void _V0lookup__intrinsic_k119(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k119, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.124 0 0) ((bruijn ##k.122 3 0) (##intrinsic ##vcore.-)) ((bruijn eqv? 5 0) (close _V0lookup__intrinsic_k120) (bruijn ##x.3 2 0) '##vcore.*))
if(VDecodeBool(
_var0)) {
    V_CALL(upenv->up->up->vars[0], runtime,
      _V40_V10vcore_D__);
    ...
    V_CALL(VGetArg(upenv, 5-1, 0), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0lookup__intrinsic_k120, env)}),
      upenv->up->vars[0],
      _V10vcore_D_S);
}
 }
}
static void _V0lookup__intrinsic_k118(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_k118, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.123 0 0) ((bruijn ##k.122 2 0) (##intrinsic ##vcore.+)) ((bruijn eqv? 4 0) (close _V0lookup__intrinsic_k119) (bruijn ##x.3 1 0) '##vcore.-))
if(VDecodeBool(
_var0)) {
    V_CALL(upenv->up->vars[0], runtime,
      _V40_V10vcore_D_P);
    ...
    V_CALL(upenv->up->up->up->vars[0], runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0lookup__intrinsic_k119, env)}),
      upenv->vars[0],
      _V10vcore_D__);
}
 }
...
static void _V0lookup__intrinsic_lambda7(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0lookup__intrinsic_lambda7, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn eqv? 3 0) (close _V0lookup__intrinsic_k118) (bruijn ##x.3 0 0) '##vcore.+)
    V_CALL(upenv->up->up->vars[0], runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0lookup__intrinsic_k118, env)}),
      _var0,
      _V10vcore_D_P);
 }
}
...
static void _V0vanity_V0intrinsics_V20_k1(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0intrinsics_V20_k1, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (##vcore.make-import (close _V0vanity_V0intrinsics_V20_k2) (##string ##string.342) (bruijn ##x.232 0 0))
...
static void _V0vanity_V0intrinsics_V20_lambda1(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0intrinsics_V20_lambda1, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (##vcore.load-library (close _V0vanity_V0intrinsics_V20_k1) (##string ##string.343))
