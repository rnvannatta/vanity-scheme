...
#include <stdarg.h>
static struct { VBlob sym; char bytes[21]; } _V10string_D210 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 21 }, "_V0vanity_V0core_V20" };
static struct { VBlob sym; char bytes[21]; } _V10string_D209 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 21 }, "_V0vanity_V0list_V20" };
static struct { VBlob sym; char bytes[33]; } _V10string_D208 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 33 }, "_V0vanity_V0compiler_V0utils_V20" };
static struct { VBlob sym; char bytes[35]; } _V10string_D207 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 35 }, "_V0vanity_V0compiler_V0library_V20" };
...
static struct { VBlob sym; char bytes[44]; } _V10string_D206 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 44 }, "library header must only have one statement" };
static struct { VBlob sym; char bytes[23]; } _V10string_D205 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 23 }, "unable to find library" };
static struct { VBlob sym; char bytes[27]; } _V10string_D204 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 27 }, "library already registered" };
static struct { VBlob sym; char bytes[8]; } _V10string_D203 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 8 }, "~A.scmh" };
static struct { VBlob sym; char bytes[6]; } _V10string_D202 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 6 }, "~A/~A" };
static struct { VBlob sym; char bytes[2]; } _V10string_D201 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 2 }, "." };
...
static struct { VBlob sym; char bytes[20]; } _V10string_D200 = { { .base = { .tag = VSTRING, .flags = VFLAG_STATIC | VFLAG_IMMUTABLE }, 20 }, "not a valid library" };
...
static void _V0vanity_V0compiler_V0library_V20_k43(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0library_V20_k43, runtime, upenv, 1, argc, _var0) {
  // ((bruijn ##k.15 45 0) (##inline ##sys.cons (##inline ##sys.cons 'find-library-interface! (bruijn find-library-interface! 13 3)) (##inline ##sys.cons (##inline ##sys.cons 'register-library-interface! (bruijn register-library-interface! 13 2)) (##inline ##sys.cons (##inline ##sys.cons 'header-from-library (bruijn header-from-library 13 11)) (##inline ##sys.cons (##inline ##sys.cons 'valid-import? (bruijn valid-import? 13 8)) (##inline ##sys.cons (##inline ##sys.cons 'import-basepath (bruijn import-basepath 13 10)) (##inline ##sys.cons (##inline ##sys.cons 'import->path (bruijn import->path 13 9)) (##inline ##sys.cons (##inline ##sys.cons 'gather-dependencies (bruijn gather-dependencies 13 12)) '()))))))))
...
static void _V0gather__dependencies_k50(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0gather__dependencies_k50, runtime, upenv, 1, argc, _var0) {
  // ((bruijn ##kk.10 7 1) (bruijn ##k.85 4 0) (bruijn ##x.87 0 0))
...
static void _V0gather__dependencies_k49(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0gather__dependencies_k49, runtime, upenv, 1, argc, _var0) {
  ...
  env->vars[0] = _var0;
  // ((bruijn append 22 2) (close _V0gather__dependencies_k50) (##inline ##sys.cdr (bruijn ##expr.12 4 0)) (bruijn ##x.88 0 0))
...
static void _V0gather__dependencies_k48(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0gather__dependencies_k48, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn gather-dependencies 20 12) (close _V0gather__dependencies_k49) (bruijn ##x.89 0 0))
...
static void _V0gather__dependencies_k47(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0gather__dependencies_k47, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.86 0 0) ((bruijn cdr 20 4) (close _V0gather__dependencies_k48) (bruijn statements 6 1)) ((bruijn ##k.85 1 0) #f))
if(VDecodeBool(
_var0)) {
...
static void _V0gather__dependencies_k46(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0gather__dependencies_k46, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (##inline ##sys.pair? (bruijn ##expr.12 1 0)) ((bruijn equal? 19 3) (close _V0gather__dependencies_k47) 'import (##inline ##sys.car (bruijn ##expr.12 1 0))) ((bruijn ##k.85 0 0) #f))
if(VDecodeBool(
VInlinePairP(
        upenv->vars[0]))) {
...
static void _V0gather__dependencies_k58(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0gather__dependencies_k58, runtime, upenv, 1, argc, _var0) {
  // ((bruijn ##kk.10 11 1) (bruijn ##k.76 6 0) (bruijn ##x.79 0 0))
...
static void _V0gather__dependencies_k57(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0gather__dependencies_k57, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn append 26 2) (close _V0gather__dependencies_k58) (bruijn ##x.80 2 0) (bruijn ##x.81 0 0))
...
static void _V0gather__dependencies_k56(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0gather__dependencies_k56, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn gather-dependencies 24 12) (close _V0gather__dependencies_k57) (bruijn ##x.82 0 0))
...
static void _V0gather__dependencies_k55(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0gather__dependencies_k55, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn cdr 24 4) (close _V0gather__dependencies_k56) (bruijn statements 10 1))
...
static void _V0gather__dependencies_k54(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0gather__dependencies_k54, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (##inline ##sys.pair? (bruijn ##expr.14 0 0)) ((bruijn gather-dependencies 22 12) (close _V0gather__dependencies_k55) (##inline ##sys.cdr (bruijn ##expr.14 0 0))) ((bruijn ##k.76 2 0) #f))
if(VDecodeBool(
VInlinePairP(
        _var0))) {
...
static void _V0gather__dependencies_k53(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0gather__dependencies_k53, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.77 0 0) ((close _V0gather__dependencies_k54) (##inline ##sys.cdr (bruijn ##expr.13 2 0))) ((bruijn ##k.76 1 0) #f))
if(VDecodeBool(
_var0)) {
V_CALL_FUNC(_V0gather__dependencies_k54, env, runtime,
      VInlineCdr(
        upenv->up->vars[0]));
} else {
V_CALL(upenv->vars[0], runtime,
...
static void _V0gather__dependencies_k52(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0gather__dependencies_k52, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (##inline ##sys.pair? (bruijn ##expr.13 1 0)) ((bruijn equal? 21 3) (close _V0gather__dependencies_k53) 'define-library (##inline ##sys.car (bruijn ##expr.13 1 0))) ((bruijn ##k.76 0 0) #f))
if(VDecodeBool(
VInlinePairP(
        upenv->vars[0]))) {
...
static void _V0gather__dependencies_k61(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0gather__dependencies_k61" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
  VError("Not enough arguments to _V0gather__dependencies_k61, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
 V_GC_CHECK2_VARARGS((VFunc)_V0gather__dependencies_k61, runtime, upenv, 1, argc, _var0) {
  // ((bruijn ##kk.10 7 1) (bruijn ##k.70 7 0) (bruijn ##x.73 0 0))
V_CALL(VGetArg(upenv, 7-1, 1), runtime,
      VGetArg(upenv, 7-1, 0),
      _var0);
 }
}
static void _V0gather__dependencies_k60(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0gather__dependencies_k60" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
  VError("Not enough arguments to _V0gather__dependencies_k60, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
 V_GC_CHECK2_VARARGS((VFunc)_V0gather__dependencies_k60, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn gather-dependencies 21 12) (close _V0gather__dependencies_k61) (bruijn ##x.74 0 0))
V_CALL(VGetArg(upenv, 21-1, 12), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0gather__dependencies_k61, env)}),
      _var0);
 }
}
static void _V0gather__dependencies_k59(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0gather__dependencies_k59, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn cdr 21 4) (close _V0gather__dependencies_k60) (bruijn statements 7 1))
V_CALL(VGetArg(upenv, 21-1, 4), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0gather__dependencies_k60, env)}),
      VGetArg(upenv, 7-1, 1));
 }
}
static void _V0gather__dependencies_lambda7(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0gather__dependencies_lambda7" };
 VRecordCall2(runtime, &dbg);
 V_GC_CHECK2_VARARGS((VFunc)_V0gather__dependencies_lambda7, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((close _V0gather__dependencies_k52) (close _V0gather__dependencies_k59))
...
static void _V0gather__dependencies_k51(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0gather__dependencies_k51, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((close _V0gather__dependencies_lambda7) (bruijn ##input.11 2 0))
V_CALL_FUNC(_V0gather__dependencies_lambda7, env, runtime,
      upenv->up->vars[0]);
 }
}
static void _V0gather__dependencies_lambda6(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0gather__dependencies_lambda6" };
 VRecordCall2(runtime, &dbg);
 V_GC_CHECK2_VARARGS((VFunc)_V0gather__dependencies_lambda6, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((close _V0gather__dependencies_k46) (close _V0gather__dependencies_k51))
V_CALL_FUNC(_V0gather__dependencies_k46, env, runtime,
...
static void _V0gather__dependencies_k45(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0gather__dependencies_k45, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((close _V0gather__dependencies_lambda6) (bruijn ##input.11 0 0))
...
static void _V0gather__dependencies_lambda5(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0, VWORD _var1) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0gather__dependencies_lambda5, runtime, upenv, 2, argc, _var0, _var1) {
  ...
  env->vars[0] = _var0;
  env->vars[1] = _var1;
  // ((bruijn car 16 5) (close _V0gather__dependencies_k45) (bruijn statements 2 1))
...
static void _V0gather__dependencies_k44(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0gather__dependencies_k44, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.69 0 0) ((bruijn ##k.68 1 0) '()) ((bruijn call/cc 15 1) (bruijn ##k.68 1 0) (close _V0gather__dependencies_lambda5)))
if(VDecodeBool(
_var0)) {
V_CALL(upenv->vars[0], runtime,
      VNULL);
...
static void _V0gather__dependencies_lambda4(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0, VWORD _var1) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0gather__dependencies_lambda4, runtime, upenv, 2, argc, _var0, _var1) {
  ...
  env->vars[0] = _var0;
  env->vars[1] = _var1;
  // ((bruijn null? 14 0) (close _V0gather__dependencies_k44) (bruijn statements 0 1))
...
static void _V0vanity_V0compiler_V0library_V20_k42(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0library_V20_k42, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (set! (close _V0vanity_V0compiler_V0library_V20_k43) (bruijn gather-dependencies 12 12) (close _V0gather__dependencies_lambda4))
...
static void _V0header__from__library_k66(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0header__from__library_k66, runtime, upenv, 1, argc, _var0) {
  // ((bruijn ##kk.5 6 1) (bruijn ##k.102 3 0) (bruijn ##x.105 0 0))
...
static void _V0header__from__library_k65(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0header__from__library_k65, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (##inline ##sys.pair? (bruijn ##expr.8 0 0)) ((bruijn iter 7 0) (close _V0header__from__library_k66) '() '() (##inline ##sys.cdr (bruijn ##expr.8 0 0))) ((bruijn ##k.102 2 0) #f))
if(VDecodeBool(
VInlinePairP(
        _var0))) {
...
static void _V0header__from__library_k64(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0header__from__library_k64, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.103 0 0) ((close _V0header__from__library_k65) (##inline ##sys.cdr (bruijn ##expr.7 2 0))) ((bruijn ##k.102 1 0) #f))
if(VDecodeBool(
_var0)) {
V_CALL_FUNC(_V0header__from__library_k65, env, runtime,
      VInlineCdr(
        upenv->up->vars[0]));
} else {
V_CALL(upenv->vars[0], runtime,
...
static void _V0header__from__library_k63(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0header__from__library_k63, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (##inline ##sys.pair? (bruijn ##expr.7 1 0)) ((bruijn equal? 19 3) (close _V0header__from__library_k64) 'define-library (##inline ##sys.car (bruijn ##expr.7 1 0))) ((bruijn ##k.102 0 0) #f))
if(VDecodeBool(
VInlinePairP(
        upenv->vars[0]))) {
V_CALL(VGetArg(upenv, 19-1, 3), runtime,
...
static void _V0header__from__library_k70(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0header__from__library_k70" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
  VError("Not enough arguments to _V0header__from__library_k70, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
 V_GC_CHECK2_VARARGS((VFunc)_V0header__from__library_k70, runtime, upenv, 1, argc, _var0) {
  // ((bruijn ##kk.5 7 1) (bruijn ##k.97 2 0) (bruijn ##x.99 0 0))
V_CALL(VGetArg(upenv, 7-1, 1), runtime,
      upenv->up->vars[0],
      _var0);
 }
}
static void _V0header__from__library_k69(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0header__from__library_k69" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
  VError("Not enough arguments to _V0header__from__library_k69, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
 V_GC_CHECK2_VARARGS((VFunc)_V0header__from__library_k69, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.98 0 0) ((bruijn compiler-error 22 7) (close _V0header__from__library_k70) (##string ##string.200) (bruijn lib 9 1)) ((bruijn ##k.97 1 0) #f))
if(VDecodeBool(
_var0)) {
V_CALL(VGetArg(upenv, 22-1, 7), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0header__from__library_k70, env)}),
...
static void _V0header__from__library_k68(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0header__from__library_k68" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
  VError("Not enough arguments to _V0header__from__library_k68, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
 V_GC_CHECK2_VARARGS((VFunc)_V0header__from__library_k68, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (##inline ##sys.pair? (bruijn ##expr.9 1 0)) ((bruijn equal? 21 3) (close _V0header__from__library_k69) 'define-library (##inline ##sys.car (bruijn ##expr.9 1 0))) ((bruijn ##k.97 0 0) #f))
if(VDecodeBool(
VInlinePairP(
        upenv->vars[0]))) {
V_CALL(VGetArg(upenv, 21-1, 3), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0header__from__library_k69, env)}),
      _V0define__library,
      VInlineCar(
        upenv->vars[0]));
} else {
...
static void _V0header__from__library_k71(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0header__from__library_k71" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
  VError("Not enough arguments to _V0header__from__library_k71, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
 V_GC_CHECK2_VARARGS((VFunc)_V0header__from__library_k71, runtime, upenv, 1, argc, _var0) {
  // ((bruijn ##kk.5 5 1) (bruijn ##k.93 5 0) #f)
V_CALL(VGetArg(upenv, 5-1, 1), runtime,
      VGetArg(upenv, 5-1, 0),
      VEncodeBool(false));
 }
}
static void _V0header__from__library_lambda13(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0header__from__library_lambda13" };
 VRecordCall2(runtime, &dbg);
 V_GC_CHECK2_VARARGS((VFunc)_V0header__from__library_lambda13, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((close _V0header__from__library_k68) (close _V0header__from__library_k71))
V_CALL_FUNC(_V0header__from__library_k68, env, runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0header__from__library_k71, env)}));
 }
}
static void _V0header__from__library_k67(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0header__from__library_k67, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((close _V0header__from__library_lambda13) (bruijn ##input.6 2 0))
V_CALL_FUNC(_V0header__from__library_lambda13, env, runtime,
      upenv->up->vars[0]);
 }
}
static void _V0header__from__library_lambda12(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0header__from__library_lambda12" };
 VRecordCall2(runtime, &dbg);
 V_GC_CHECK2_VARARGS((VFunc)_V0header__from__library_lambda12, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((close _V0header__from__library_k63) (close _V0header__from__library_k67))
V_CALL_FUNC(_V0header__from__library_k63, env, runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0header__from__library_k67, env)}));
 }
}
static void _V0header__from__library_lambda11(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0header__from__library_lambda11" };
 VRecordCall2(runtime, &dbg);
 V_GC_CHECK2_VARARGS((VFunc)_V0header__from__library_lambda11, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((close _V0header__from__library_lambda12) (bruijn ##input.6 0 0))
...
static void _V0header__from__library_lambda10(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0, VWORD _var1) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0header__from__library_lambda10, runtime, upenv, 2, argc, _var0, _var1) {
  ...
  env->vars[0] = _var0;
  env->vars[1] = _var1;
  // ((close _V0header__from__library_lambda11) (bruijn lib 3 1))
...
static void _V0header__from__library_k62(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0header__from__library_k62, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn call/cc 15 1) (bruijn ##k.91 2 0) (close _V0header__from__library_lambda10))
V_CALL(VGetArg(upenv, 15-1, 1), runtime,
      upenv->up->vars[0],
...
static void _V0iter_k73(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0iter_k73, runtime, upenv, 1, argc, _var0) {
  // ((bruijn ##k.107 2 0) (##inline ##sys.cons 'define-library-interface (##inline ##sys.cons (bruijn ##x.110 0 0) (##inline ##sys.cons (##inline ##sys.cons 'import (bruijn imports 2 2)) (##inline ##sys.cons (##inline ##sys.cons 'export (bruijn exports 2 1)) (##inline ##sys.cons (##inline ##sys.cons 'inline-import '()) (##inline ##sys.cons (##inline ##sys.cons 'inline-export '()) '())))))))
V_CALL(upenv->up->vars[0], runtime,
      VInlineCons(
...
static void _V0iter_k79(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0iter_k79, runtime, upenv, 1, argc, _var0) {
  // ((bruijn ##kk.1 7 1) (bruijn ##k.132 4 0) (bruijn ##x.134 0 0))
V_CALL(VGetArg(upenv, 7-1, 1), runtime,
      upenv->up->up->up->vars[0],
      _var0);
 }
...
static void _V0iter_k78(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0iter_k78, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn iter 9 0) (close _V0iter_k79) (bruijn ##x.135 1 0) (bruijn imports 8 2) (bruijn ##x.136 0 0))
...
static void _V0iter_k77(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0iter_k77, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn cdr 22 4) (close _V0iter_k78) (bruijn rest 7 3))
...
static void _V0iter_k76(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0iter_k76, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.133 0 0) ((bruijn append 21 2) (close _V0iter_k77) (bruijn exports 6 1) (##inline ##sys.cdr (bruijn ##expr.3 2 0))) ((bruijn ##k.132 1 0) #f))
if(VDecodeBool(
_var0)) {
...
static void _V0iter_k75(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0iter_k75, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (##inline ##sys.pair? (bruijn ##expr.3 1 0)) ((bruijn equal? 20 3) (close _V0iter_k76) 'export (##inline ##sys.car (bruijn ##expr.3 1 0))) ((bruijn ##k.132 0 0) #f))
if(VDecodeBool(
VInlinePairP(
        upenv->vars[0]))) {
...
static void _V0iter_k85(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0iter_k85, runtime, upenv, 1, argc, _var0) {
  // ((bruijn ##kk.1 9 1) (bruijn ##k.125 4 0) (bruijn ##x.127 0 0))
...
static void _V0iter_k84(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0iter_k84, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn iter 11 0) (close _V0iter_k85) (bruijn exports 10 1) (bruijn ##x.128 1 0) (bruijn ##x.129 0 0))
V_CALL(VGetArg(upenv, 11-1, 0), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0iter_k85, env)}),
      VGetArg(upenv, 10-1, 1),
      upenv->vars[0],
      _var0);
 }
...
static void _V0iter_k83(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0iter_k83, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn cdr 24 4) (close _V0iter_k84) (bruijn rest 9 3))
V_CALL(VGetArg(upenv, 24-1, 4), runtime,
...
static void _V0iter_k82(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0iter_k82, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.126 0 0) ((bruijn append 23 2) (close _V0iter_k83) (bruijn imports 8 2) (##inline ##sys.cdr (bruijn ##expr.4 2 0))) ((bruijn ##k.125 1 0) #f))
if(VDecodeBool(
_var0)) {
V_CALL(VGetArg(upenv, 23-1, 2), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0iter_k83, env)}),
      VGetArg(upenv, 8-1, 2),
      VInlineCdr(
        upenv->up->vars[0]));
} else {
...
static void _V0iter_k81(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0iter_k81, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (##inline ##sys.pair? (bruijn ##expr.4 1 0)) ((bruijn equal? 22 3) (close _V0iter_k82) 'import (##inline ##sys.car (bruijn ##expr.4 1 0))) ((bruijn ##k.125 0 0) #f))
if(VDecodeBool(
VInlinePairP(
        upenv->vars[0]))) {
...
static void _V0iter_k88(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0iter_k88, runtime, upenv, 1, argc, _var0) {
  // ((bruijn ##kk.1 7 1) (bruijn ##k.119 7 0) (bruijn ##x.122 0 0))
V_CALL(VGetArg(upenv, 7-1, 1), runtime,
      VGetArg(upenv, 7-1, 0),
      _var0);
 }
...
static void _V0iter_k87(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0iter_k87, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn iter 9 0) (close _V0iter_k88) (bruijn exports 8 1) (bruijn imports 8 2) (bruijn ##x.123 0 0))
V_CALL(VGetArg(upenv, 9-1, 0), runtime,
...
static void _V0iter_k86(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0iter_k86, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn cdr 22 4) (close _V0iter_k87) (bruijn rest 7 3))
V_CALL(VGetArg(upenv, 22-1, 4), runtime,
...
static void _V0iter_lambda17(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0iter_lambda17, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((close _V0iter_k81) (close _V0iter_k86))
V_CALL_FUNC(_V0iter_k81, env, runtime,
...
static void _V0iter_k80(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0iter_k80, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((close _V0iter_lambda17) (bruijn ##input.2 2 0))
V_CALL_FUNC(_V0iter_lambda17, env, runtime,
      upenv->up->vars[0]);
 }
}
static void _V0iter_lambda16(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0iter_lambda16" };
 VRecordCall2(runtime, &dbg);
 V_GC_CHECK2_VARARGS((VFunc)_V0iter_lambda16, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((close _V0iter_k75) (close _V0iter_k80))
V_CALL_FUNC(_V0iter_k75, env, runtime,
...
static void _V0iter_k74(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0iter_k74, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((close _V0iter_lambda16) (bruijn ##input.2 0 0))
...
static void _V0iter_lambda15(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0, VWORD _var1) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0iter_lambda15, runtime, upenv, 2, argc, _var0, _var1) {
  ...
  env->vars[0] = _var0;
  env->vars[1] = _var1;
  // ((bruijn car 17 5) (close _V0iter_k74) (bruijn rest 2 3))
...
static void _V0iter_k72(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0iter_k72, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.108 0 0) ((bruijn cadr 16 6) (close _V0iter_k73) (bruijn lib 3 1)) ((bruijn call/cc 16 1) (bruijn ##k.107 1 0) (close _V0iter_lambda15)))
if(VDecodeBool(
_var0)) {
...
static void _V0iter_lambda14(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0, VWORD _var1, VWORD _var2, VWORD _var3) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0iter_lambda14, runtime, upenv, 4, argc, _var0, _var1, _var2, _var3) {
  ...
  env->vars[2] = _var2;
  env->vars[3] = _var3;
  // ((bruijn null? 15 0) (close _V0iter_k72) (bruijn rest 0 3))
V_CALL(VGetArg(upenv, 15-1, 0), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0iter_k72, env)}),
      _var3);
 }
}
static void _V0header__from__library_lambda9(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0header__from__library_lambda9" };
 VRecordCall2(runtime, &dbg);
 V_GC_CHECK2_VARARGS((VFunc)_V0header__from__library_lambda9, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (set! (close _V0header__from__library_k62) (bruijn iter 0 0) (close _V0iter_lambda14))
    V_CALL_FUNC(VSetEnvVar2, env, runtime,
...
static void _V0header__from__library_lambda8(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0, VWORD _var1) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0header__from__library_lambda8, runtime, upenv, 2, argc, _var0, _var1) {
  ...
  env->vars[0] = _var0;
  env->vars[1] = _var1;
  // ((close _V0header__from__library_lambda9) #f)
...
static void _V0vanity_V0compiler_V0library_V20_k41(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0library_V20_k41, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (set! (close _V0vanity_V0compiler_V0library_V20_k42) (bruijn header-from-library 11 11) (close _V0header__from__library_lambda8))
    V_CALL_FUNC(VSetEnvVar2, env, runtime,
...
static void _V0import__basepath_k93(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0import__basepath_k93" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
  VError("Not enough arguments to _V0import__basepath_k93, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
 V_GC_CHECK2_VARARGS((VFunc)_V0import__basepath_k93, runtime, upenv, 1, argc, _var0) {
  // ((bruijn sprintf 17 8) (bruijn ##k.138 5 0) (##string ##string.202) (bruijn ##x.140 2 0) (bruijn ##x.141 0 0))
V_CALL(VGetArg(upenv, 17-1, 8), runtime,
      VGetArg(upenv, 5-1, 0),
      VEncodePointer(&_V10string_D202.sym, VPOINTER_OTHER),
      upenv->up->vars[0],
      _var0);
 }
}
static void _V0import__basepath_k92(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0import__basepath_k92" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
  VError("Not enough arguments to _V0import__basepath_k92, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
 V_GC_CHECK2_VARARGS((VFunc)_V0import__basepath_k92, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn import-basepath 15 10) (close _V0import__basepath_k93) (bruijn ##x.142 0 0))
V_CALL(VGetArg(upenv, 15-1, 10), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0import__basepath_k93, env)}),
      _var0);
 }
}
static void _V0import__basepath_k91(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0import__basepath_k91" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
  VError("Not enough arguments to _V0import__basepath_k91, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
 V_GC_CHECK2_VARARGS((VFunc)_V0import__basepath_k91, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn cdr 15 4) (close _V0import__basepath_k92) (bruijn import 3 1))
V_CALL(VGetArg(upenv, 15-1, 4), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0import__basepath_k92, env)}),
      upenv->up->up->vars[1]);
 }
}
static void _V0import__basepath_k90(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0import__basepath_k90" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
  VError("Not enough arguments to _V0import__basepath_k90, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
 V_GC_CHECK2_VARARGS((VFunc)_V0import__basepath_k90, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.139 0 0) ((bruijn ##k.138 2 0) (##string ##string.201)) ((bruijn car 14 5) (close _V0import__basepath_k91) (bruijn import 2 1)))
if(VDecodeBool(
_var0)) {
V_CALL(upenv->up->vars[0], runtime,
      VEncodePointer(&_V10string_D201.sym, VPOINTER_OTHER));
} else {
V_CALL(VGetArg(upenv, 14-1, 5), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0import__basepath_k91, env)}),
      upenv->up->vars[1]);
}
 }
}
static void _V0import__basepath_k89(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0import__basepath_k89" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
  VError("Not enough arguments to _V0import__basepath_k89, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
 V_GC_CHECK2_VARARGS((VFunc)_V0import__basepath_k89, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn null? 13 0) (close _V0import__basepath_k90) (bruijn ##x.143 0 0))
V_CALL(VGetArg(upenv, 13-1, 0), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0import__basepath_k90, env)}),
      _var0);
 }
}
static void _V0import__basepath_lambda18(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0, VWORD _var1) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0import__basepath_lambda18, runtime, upenv, 2, argc, _var0, _var1) {
  ...
  env->vars[0] = _var0;
  env->vars[1] = _var1;
  // ((bruijn cdr 12 4) (close _V0import__basepath_k89) (bruijn import 0 1))
V_CALL(VGetArg(upenv, 12-1, 4), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0import__basepath_k89, env)}),
      _var1);
 }
}
static void _V0vanity_V0compiler_V0library_V20_k40(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0library_V20_k40, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (set! (close _V0vanity_V0compiler_V0library_V20_k41) (bruijn import-basepath 10 10) (close _V0import__basepath_lambda18))
    V_CALL_FUNC(VSetEnvVar2, env, runtime,
...
static void _V0import___Gpath_k96(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0import___Gpath_k96" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
  VError("Not enough arguments to _V0import___Gpath_k96, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
 V_GC_CHECK2_VARARGS((VFunc)_V0import___Gpath_k96, runtime, upenv, 1, argc, _var0) {
  // ((bruijn sprintf 14 8) (bruijn ##k.144 3 0) (##string ##string.203) (bruijn ##x.146 0 0))
V_CALL(VGetArg(upenv, 14-1, 8), runtime,
      upenv->up->up->vars[0],
      VEncodePointer(&_V10string_D203.sym, VPOINTER_OTHER),
      _var0);
 }
}
static void _V0import___Gpath_k99(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0import___Gpath_k99" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
  VError("Not enough arguments to _V0import___Gpath_k99, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
 V_GC_CHECK2_VARARGS((VFunc)_V0import___Gpath_k99, runtime, upenv, 1, argc, _var0) {
  // ((bruijn sprintf 16 8) (bruijn ##k.144 5 0) (##string ##string.202) (bruijn ##x.147 2 0) (bruijn ##x.148 0 0))
...
static void _V0import___Gpath_k98(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0import___Gpath_k98" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
  VError("Not enough arguments to _V0import___Gpath_k98, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
 V_GC_CHECK2_VARARGS((VFunc)_V0import___Gpath_k98, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn import->path 14 9) (close _V0import___Gpath_k99) (bruijn ##x.149 0 0))
V_CALL(VGetArg(upenv, 14-1, 9), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0import___Gpath_k99, env)}),
      _var0);
 }
}
static void _V0import___Gpath_k97(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0import___Gpath_k97" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
  VError("Not enough arguments to _V0import___Gpath_k97, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
 V_GC_CHECK2_VARARGS((VFunc)_V0import___Gpath_k97, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn cdr 14 4) (close _V0import___Gpath_k98) (bruijn import 3 1))
V_CALL(VGetArg(upenv, 14-1, 4), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0import___Gpath_k98, env)}),
      upenv->up->up->vars[1]);
 }
}
static void _V0import___Gpath_k95(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0import___Gpath_k95" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
  VError("Not enough arguments to _V0import___Gpath_k95, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
 V_GC_CHECK2_VARARGS((VFunc)_V0import___Gpath_k95, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.145 0 0) ((bruijn car 13 5) (close _V0import___Gpath_k96) (bruijn import 2 1)) ((bruijn car 13 5) (close _V0import___Gpath_k97) (bruijn import 2 1)))
if(VDecodeBool(
_var0)) {
V_CALL(VGetArg(upenv, 13-1, 5), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0import___Gpath_k96, env)}),
      upenv->up->vars[1]);
} else {
V_CALL(VGetArg(upenv, 13-1, 5), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0import___Gpath_k97, env)}),
      upenv->up->vars[1]);
}
 }
}
static void _V0import___Gpath_k94(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0import___Gpath_k94" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
  VError("Not enough arguments to _V0import___Gpath_k94, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
 V_GC_CHECK2_VARARGS((VFunc)_V0import___Gpath_k94, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn null? 12 0) (close _V0import___Gpath_k95) (bruijn ##x.150 0 0))
V_CALL(VGetArg(upenv, 12-1, 0), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0import___Gpath_k95, env)}),
      _var0);
 }
}
static void _V0import___Gpath_lambda19(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0, VWORD _var1) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0import___Gpath_lambda19, runtime, upenv, 2, argc, _var0, _var1) {
  ...
  env->vars[0] = _var0;
  env->vars[1] = _var1;
  // ((bruijn cdr 11 4) (close _V0import___Gpath_k94) (bruijn import 0 1))
V_CALL(VGetArg(upenv, 11-1, 4), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0import___Gpath_k94, env)}),
      _var1);
 }
}
static void _V0vanity_V0compiler_V0library_V20_k39(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0library_V20_k39, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (set! (close _V0vanity_V0compiler_V0library_V20_k40) (bruijn import->path 9 9) (close _V0import___Gpath_lambda19))
    V_CALL_FUNC(VSetEnvVar2, env, runtime,
...
static void _V0valid__import_Q_k101(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0valid__import_Q_k101" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
  VError("Not enough arguments to _V0valid__import_Q_k101, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
 V_GC_CHECK2_VARARGS((VFunc)_V0valid__import_Q_k101, runtime, upenv, 1, argc, _var0) {
  // ((bruijn fold 12 10) (bruijn ##k.151 2 0) (bruijn andf 11 6) #t (bruijn ##x.153 0 0))
...
static void _V0valid__import_Q_k100(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0valid__import_Q_k100" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
  VError("Not enough arguments to _V0valid__import_Q_k100, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
 V_GC_CHECK2_VARARGS((VFunc)_V0valid__import_Q_k100, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.152 0 0) ((bruijn map 11 9) (close _V0valid__import_Q_k101) (bruijn valid-import-element? 10 7) (bruijn import 1 1)) ((bruijn ##k.151 1 0) #f))
if(VDecodeBool(
_var0)) {
V_CALL(VGetArg(upenv, 11-1, 9), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0valid__import_Q_k101, env)}),
...
static void _V0valid__import_Q_lambda20(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0, VWORD _var1) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0valid__import_Q_lambda20, runtime, upenv, 2, argc, _var0, _var1) {
  ...
  env->vars[0] = _var0;
  env->vars[1] = _var1;
  // ((bruijn pair? 10 11) (close _V0valid__import_Q_k100) (bruijn import 0 1))
V_CALL(VGetArg(upenv, 10-1, 11), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0valid__import_Q_k100, env)}),
      _var1);
 }
}
static void _V0vanity_V0compiler_V0library_V20_k38(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0library_V20_k38, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (set! (close _V0vanity_V0compiler_V0library_V20_k39) (bruijn valid-import? 8 8) (close _V0valid__import_Q_lambda20))
    V_CALL_FUNC(VSetEnvVar2, env, runtime,
...
static void _V0valid__import__element_Q_k106(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0valid__import__element_Q_k106" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
  VError("Not enough arguments to _V0valid__import__element_Q_k106, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
 V_GC_CHECK2_VARARGS((VFunc)_V0valid__import__element_Q_k106, runtime, upenv, 1, argc, _var0) {
  // ((bruijn alphanumeric? 13 5) (bruijn ##k.154 5 0) (bruijn ##x.157 0 0))
V_CALL(VGetArg(upenv, 13-1, 5), runtime,
      VGetArg(upenv, 5-1, 0),
      _var0);
 }
}
static void _V0valid__import__element_Q_k105(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0valid__import__element_Q_k105" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
  VError("Not enough arguments to _V0valid__import__element_Q_k105, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
 V_GC_CHECK2_VARARGS((VFunc)_V0valid__import__element_Q_k105, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.156 0 0) ((bruijn symbol->string 13 14) (close _V0valid__import__element_Q_k106) (bruijn x 4 1)) ((bruijn ##k.154 4 0) #f))
if(VDecodeBool(
_var0)) {
V_CALL(VGetArg(upenv, 13-1, 14), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0valid__import__element_Q_k106, env)}),
...
static void _V0valid__import__element_Q_k104(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0valid__import__element_Q_k104" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
  VError("Not enough arguments to _V0valid__import__element_Q_k104, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
 V_GC_CHECK2_VARARGS((VFunc)_V0valid__import__element_Q_k104, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn > 12 13) (close _V0valid__import__element_Q_k105) (bruijn ##x.158 0 0) 0)
V_CALL(VGetArg(upenv, 12-1, 13), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0valid__import__element_Q_k105, env)}),
      _var0,
      VEncodeInt(0l));
 }
}
static void _V0valid__import__element_Q_k103(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0valid__import__element_Q_k103" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
  VError("Not enough arguments to _V0valid__import__element_Q_k103, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
 V_GC_CHECK2_VARARGS((VFunc)_V0valid__import__element_Q_k103, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn string-length 11 12) (close _V0valid__import__element_Q_k104) (bruijn ##x.159 0 0))
V_CALL(VGetArg(upenv, 11-1, 12), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0valid__import__element_Q_k104, env)}),
      _var0);
 }
}
static void _V0valid__import__element_Q_k102(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0valid__import__element_Q_k102" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
  VError("Not enough arguments to _V0valid__import__element_Q_k102, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
 V_GC_CHECK2_VARARGS((VFunc)_V0valid__import__element_Q_k102, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.155 0 0) ((bruijn symbol->string 10 14) (close _V0valid__import__element_Q_k103) (bruijn x 1 1)) ((bruijn ##k.154 1 0) #f))
if(VDecodeBool(
_var0)) {
V_CALL(VGetArg(upenv, 10-1, 14), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0valid__import__element_Q_k103, env)}),
      upenv->vars[1]);
} else {
V_CALL(upenv->vars[0], runtime,
      VEncodeBool(false));
...
static void _V0valid__import__element_Q_lambda21(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0, VWORD _var1) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0valid__import__element_Q_lambda21, runtime, upenv, 2, argc, _var0, _var1) {
  ...
  env->vars[0] = _var0;
  env->vars[1] = _var1;
  // ((bruijn symbol? 9 15) (close _V0valid__import__element_Q_k102) (bruijn x 0 1))
V_CALL(VGetArg(upenv, 9-1, 15), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0valid__import__element_Q_k102, env)}),
      _var1);
 }
}
static void _V0vanity_V0compiler_V0library_V20_k37(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0library_V20_k37, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (set! (close _V0vanity_V0compiler_V0library_V20_k38) (bruijn valid-import-element? 7 7) (close _V0valid__import__element_Q_lambda21))
    V_CALL_FUNC(VSetEnvVar2, env, runtime,
...
static void _V0andf_lambda22(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0, VWORD _var1, VWORD _var2) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0andf_lambda22, runtime, upenv, 3, argc, _var0, _var1, _var2) {
  // (if (bruijn a 0 1) ((bruijn ##k.160 0 0) (bruijn b 0 2)) ((bruijn ##k.160 0 0) #f))
if(VDecodeBool(
_var1)) {
V_CALL(_var0, runtime,
      _var2);
...
static void _V0vanity_V0compiler_V0library_V20_k36(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0library_V20_k36, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (set! (close _V0vanity_V0compiler_V0library_V20_k37) (bruijn andf 6 6) (close _V0andf_lambda22))
    V_CALL_FUNC(VSetEnvVar2, env, runtime,
...
static void _V0alphanumeric_Q_k108(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0alphanumeric_Q_k108" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
  VError("Not enough arguments to _V0alphanumeric_Q_k108, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
 V_GC_CHECK2_VARARGS((VFunc)_V0alphanumeric_Q_k108, runtime, upenv, 1, argc, _var0) {
  // ((bruijn loop 1 0) (bruijn ##k.161 3 0) 0)
V_CALL(upenv->vars[0], runtime,
      upenv->up->up->vars[0],
      VEncodeInt(0l));
 }
...
static void _V0loop_k112(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0loop_k112, runtime, upenv, 1, argc, _var0) {
  // ((bruijn loop 5 0) (bruijn ##k.163 4 0) (bruijn ##x.166 0 0))
...
static void _V0loop_k111(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0loop_k111, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.165 0 0) ((bruijn + 13 17) (close _V0loop_k112) (bruijn i 3 1) 1) ((bruijn ##k.163 3 0) #f))
if(VDecodeBool(
_var0)) {
...
static void _V0loop_k110(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0loop_k110, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn alphanumeric-char? 11 4) (close _V0loop_k111) (bruijn ##x.167 0 0))
V_CALL(VGetArg(upenv, 11-1, 4), runtime,
...
static void _V0loop_k109(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0loop_k109, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.164 0 0) ((bruijn string-ref 11 18) (close _V0loop_k110) (bruijn str 4 1) (bruijn i 1 1)) ((bruijn ##k.163 1 0) #t))
if(VDecodeBool(
_var0)) {
...
static void _V0loop_lambda25(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0, VWORD _var1) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0loop_lambda25, runtime, upenv, 2, argc, _var0, _var1) {
  ...
  env->vars[0] = _var0;
  env->vars[1] = _var1;
  // ((bruijn < 10 16) (close _V0loop_k109) (bruijn i 0 1) (bruijn len 2 0))
...
static void _V0alphanumeric_Q_lambda24(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0alphanumeric_Q_lambda24" };
 VRecordCall2(runtime, &dbg);
 V_GC_CHECK2_VARARGS((VFunc)_V0alphanumeric_Q_lambda24, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (set! (close _V0alphanumeric_Q_k108) (bruijn loop 0 0) (close _V0loop_lambda25))
    V_CALL_FUNC(VSetEnvVar2, env, runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0alphanumeric_Q_k108, env)}),
      VEncodeInt(0l), VEncodeInt(0l),
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0loop_lambda25, env)})
    );
 }
}
static void _V0alphanumeric_Q_k107(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0alphanumeric_Q_k107" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
  VError("Not enough arguments to _V0alphanumeric_Q_k107, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
 V_GC_CHECK2_VARARGS((VFunc)_V0alphanumeric_Q_k107, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((close _V0alphanumeric_Q_lambda24) #f)
...
static void _V0alphanumeric_Q_lambda23(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0, VWORD _var1) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0alphanumeric_Q_lambda23, runtime, upenv, 2, argc, _var0, _var1) {
  ...
  env->vars[0] = _var0;
  env->vars[1] = _var1;
  // ((bruijn string-length 7 12) (close _V0alphanumeric_Q_k107) (bruijn str 0 1))
V_CALL(VGetArg(upenv, 7-1, 12), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0alphanumeric_Q_k107, env)}),
      _var1);
 }
}
static void _V0vanity_V0compiler_V0library_V20_k35(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0library_V20_k35, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (set! (close _V0vanity_V0compiler_V0library_V20_k36) (bruijn alphanumeric? 5 5) (close _V0alphanumeric_Q_lambda23))
    V_CALL_FUNC(VSetEnvVar2, env, runtime,
...
static void _V0alphanumeric__char_Q_k121(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0alphanumeric__char_Q_k121" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
  VError("Not enough arguments to _V0alphanumeric__char_Q_k121, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
 V_GC_CHECK2_VARARGS((VFunc)_V0alphanumeric__char_Q_k121, runtime, upenv, 1, argc, _var0) {
  // ((bruijn <= 15 19) (bruijn ##k.168 9 0) (bruijn ##x.171 1 0) (bruijn i 8 0) (bruijn ##x.172 0 0))
...
static void _V0alphanumeric__char_Q_k120(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0alphanumeric__char_Q_k120" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
  VError("Not enough arguments to _V0alphanumeric__char_Q_k120, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
 V_GC_CHECK2_VARARGS((VFunc)_V0alphanumeric__char_Q_k120, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn char->integer 14 20) (close _V0alphanumeric__char_Q_k121) #\9)
V_CALL(VGetArg(upenv, 14-1, 20), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0alphanumeric__char_Q_k121, env)}),
      VEncodeChar('9'));
 }
}
static void _V0alphanumeric__char_Q_k119(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0alphanumeric__char_Q_k119" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
  VError("Not enough arguments to _V0alphanumeric__char_Q_k119, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
 V_GC_CHECK2_VARARGS((VFunc)_V0alphanumeric__char_Q_k119, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.170 0 0) ((bruijn ##k.168 7 0) (bruijn ##p.170 0 0)) ((bruijn char->integer 13 20) (close _V0alphanumeric__char_Q_k120) #\0))
if(VDecodeBool(
_var0)) {
V_CALL(VGetArg(upenv, 7-1, 0), runtime,
      _var0);
...
V_CALL(VGetArg(upenv, 13-1, 20), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0alphanumeric__char_Q_k120, env)}),
      VEncodeChar('0'));
}
 }
}
static void _V0alphanumeric__char_Q_k118(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0alphanumeric__char_Q_k118" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
  VError("Not enough arguments to _V0alphanumeric__char_Q_k118, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
 V_GC_CHECK2_VARARGS((VFunc)_V0alphanumeric__char_Q_k118, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn <= 12 19) (close _V0alphanumeric__char_Q_k119) (bruijn ##x.173 1 0) (bruijn i 5 0) (bruijn ##x.174 0 0))
V_CALL(VGetArg(upenv, 12-1, 19), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0alphanumeric__char_Q_k119, env)}),
      upenv->vars[0],
      VGetArg(upenv, 5-1, 0),
      _var0);
 }
}
static void _V0alphanumeric__char_Q_k117(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0alphanumeric__char_Q_k117" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
  VError("Not enough arguments to _V0alphanumeric__char_Q_k117, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
 V_GC_CHECK2_VARARGS((VFunc)_V0alphanumeric__char_Q_k117, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn char->integer 11 20) (close _V0alphanumeric__char_Q_k118) #\Z)
V_CALL(VGetArg(upenv, 11-1, 20), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0alphanumeric__char_Q_k118, env)}),
      VEncodeChar('Z'));
 }
}
static void _V0alphanumeric__char_Q_k116(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0alphanumeric__char_Q_k116" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
  VError("Not enough arguments to _V0alphanumeric__char_Q_k116, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
 V_GC_CHECK2_VARARGS((VFunc)_V0alphanumeric__char_Q_k116, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.169 0 0) ((bruijn ##k.168 4 0) (bruijn ##p.169 0 0)) ((bruijn char->integer 10 20) (close _V0alphanumeric__char_Q_k117) #\A))
if(VDecodeBool(
_var0)) {
V_CALL(upenv->up->up->up->vars[0], runtime,
      _var0);
...
V_CALL(VGetArg(upenv, 10-1, 20), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0alphanumeric__char_Q_k117, env)}),
      VEncodeChar('A'));
}
 }
}
static void _V0alphanumeric__char_Q_k115(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0alphanumeric__char_Q_k115, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn <= 9 19) (close _V0alphanumeric__char_Q_k116) (bruijn ##x.175 1 0) (bruijn i 2 0) (bruijn ##x.176 0 0))
V_CALL(VGetArg(upenv, 9-1, 19), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0alphanumeric__char_Q_k116, env)}),
      upenv->vars[0],
      upenv->up->vars[0],
      _var0);
 }
...
static void _V0alphanumeric__char_Q_k114(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0alphanumeric__char_Q_k114, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn char->integer 8 20) (close _V0alphanumeric__char_Q_k115) #\z)
...
static void _V0alphanumeric__char_Q_k113(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0alphanumeric__char_Q_k113, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn char->integer 7 20) (close _V0alphanumeric__char_Q_k114) #\a)
...
static void _V0alphanumeric__char_Q_lambda26(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0, VWORD _var1) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0alphanumeric__char_Q_lambda26, runtime, upenv, 2, argc, _var0, _var1) {
  ...
  env->vars[0] = _var0;
  env->vars[1] = _var1;
  // ((bruijn char->integer 6 20) (close _V0alphanumeric__char_Q_k113) (bruijn c 0 1))
...
static void _V0vanity_V0compiler_V0library_V20_k34(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0library_V20_k34, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (set! (close _V0vanity_V0compiler_V0library_V20_k35) (bruijn alphanumeric-char? 4 4) (close _V0alphanumeric__char_Q_lambda26))
    V_CALL_FUNC(VSetEnvVar2, env, runtime,
...
static void _V0find__library__interface_B_k122(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0find__library__interface_B_k122" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
  VError("Not enough arguments to _V0find__library__interface_B_k122, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
 V_GC_CHECK2_VARARGS((VFunc)_V0find__library__interface_B_k122, runtime, upenv, 1, argc, _var0) {
  // (if (bruijn lookup 0 0) ((bruijn cdr 6 4) (bruijn ##k.177 1 0) (bruijn lookup 0 0)) ((bruijn load-library-interface 5 1) (bruijn ##k.177 1 0) (bruijn import 1 1) (bruijn paths 1 2)))
if(VDecodeBool(
_var0)) {
...
static void _V0find__library__interface_B_lambda27(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0, VWORD _var1, VWORD _var2) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0find__library__interface_B_lambda27, runtime, upenv, 3, argc, _var0, _var1, _var2) {
  ...
  env->vars[1] = _var1;
  env->vars[2] = _var2;
  // ((bruijn assoc 5 21) (close _V0find__library__interface_B_k122) (bruijn import 0 1) (bruijn library-interfaces 4 0))
V_CALL(VGetArg(upenv, 5-1, 21), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0find__library__interface_B_k122, env)}),
      _var1,
      upenv->up->up->up->vars[0]);
 }
}
static void _V0vanity_V0compiler_V0library_V20_k33(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0library_V20_k33, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (set! (close _V0vanity_V0compiler_V0library_V20_k34) (bruijn find-library-interface! 3 3) (close _V0find__library__interface_B_lambda27))
    V_CALL_FUNC(VSetEnvVar2, env, runtime,
...
static void _V0register__library__interface_B_k126(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0register__library__interface_B_k126" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
  VError("Not enough arguments to _V0register__library__interface_B_k126, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
 V_GC_CHECK2_VARARGS((VFunc)_V0register__library__interface_B_k126, runtime, upenv, 1, argc, _var0) {
  // ((bruijn compiler-error 8 7) (bruijn ##k.184 1 0) (##string ##string.204) (bruijn ##x.185 0 0))
...
static void _V0register__library__interface_B_k125(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0register__library__interface_B_k125" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
  VError("Not enough arguments to _V0register__library__interface_B_k125, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
 V_GC_CHECK2_VARARGS((VFunc)_V0register__library__interface_B_k125, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.183 1 0) ((bruijn cadr 7 6) (close _V0register__library__interface_B_k126) (bruijn lib 3 1)) ((bruijn ##k.184 0 0) #f))
if(VDecodeBool(
upenv->vars[0])) {
V_CALL(VGetArg(upenv, 7-1, 6), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0register__library__interface_B_k126, env)}),
      upenv->up->up->vars[1]);
} else {
V_CALL(_var0, runtime,
      VEncodeBool(false));
...
static void _V0register__library__interface_B_k130(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0register__library__interface_B_k130" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
  VError("Not enough arguments to _V0register__library__interface_B_k130, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
 V_GC_CHECK2_VARARGS((VFunc)_V0register__library__interface_B_k130, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (set! (bruijn ##k.178 6 0) (bruijn library-interfaces 9 0) (bruijn ##x.180 0 0))
    V_CALL_FUNC(VSetEnvVar2, env, runtime,
      VGetArg(upenv, 6-1, 0),
      VEncodeInt(9l), VEncodeInt(0l),
      _var0
    );
 }
}
static void _V0register__library__interface_B_k129(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0register__library__interface_B_k129" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
  VError("Not enough arguments to _V0register__library__interface_B_k129, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
 V_GC_CHECK2_VARARGS((VFunc)_V0register__library__interface_B_k129, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn cons 9 22) (close _V0register__library__interface_B_k130) (bruijn ##x.181 0 0) (bruijn library-interfaces 8 0))
V_CALL(VGetArg(upenv, 9-1, 22), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0register__library__interface_B_k130, env)}),
      _var0,
      VGetArg(upenv, 8-1, 0));
 }
}
static void _V0register__library__interface_B_k128(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0register__library__interface_B_k128" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
  VError("Not enough arguments to _V0register__library__interface_B_k128, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
 V_GC_CHECK2_VARARGS((VFunc)_V0register__library__interface_B_k128, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn cons 8 22) (close _V0register__library__interface_B_k129) (bruijn ##x.182 0 0) (bruijn lib 4 1))
V_CALL(VGetArg(upenv, 8-1, 22), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0register__library__interface_B_k129, env)}),
      _var0,
      upenv->up->up->up->vars[1]);
 }
}
static void _V0register__library__interface_B_k127(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0register__library__interface_B_k127" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
  VError("Not enough arguments to _V0register__library__interface_B_k127, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
 V_GC_CHECK2_VARARGS((VFunc)_V0register__library__interface_B_k127, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn cadr 7 6) (close _V0register__library__interface_B_k128) (bruijn lib 3 1))
V_CALL(VGetArg(upenv, 7-1, 6), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0register__library__interface_B_k128, env)}),
      upenv->up->up->vars[1]);
 }
}
static void _V0register__library__interface_B_k124(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0register__library__interface_B_k124, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((close _V0register__library__interface_B_k125) (close _V0register__library__interface_B_k127))
V_CALL_FUNC(_V0register__library__interface_B_k125, env, runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0register__library__interface_B_k127, env)}));
 }
}
static void _V0register__library__interface_B_k123(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0register__library__interface_B_k123, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn assoc 5 21) (close _V0register__library__interface_B_k124) (bruijn ##x.186 0 0) (bruijn library-interfaces 4 0))
V_CALL(VGetArg(upenv, 5-1, 21), runtime,
...
static void _V0register__library__interface_B_lambda28(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0, VWORD _var1) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0register__library__interface_B_lambda28, runtime, upenv, 2, argc, _var0, _var1) {
  ...
  env->vars[0] = _var0;
  env->vars[1] = _var1;
  // ((bruijn cadr 4 6) (close _V0register__library__interface_B_k123) (bruijn lib 0 1))
...
static void _V0vanity_V0compiler_V0library_V20_k32(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0library_V20_k32, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (set! (close _V0vanity_V0compiler_V0library_V20_k33) (bruijn register-library-interface! 2 2) (close _V0register__library__interface_B_lambda28))
    V_CALL_FUNC(VSetEnvVar2, env, runtime,
...
static void _V0load__library__interface_k133(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0load__library__interface_k133, runtime, upenv, 1, argc, _var0) {
  // (if (bruijn fd 1 0) ((bruijn read-all 6 24) (bruijn ##k.195 0 0) (bruijn fd 1 0)) ((bruijn compiler-error 6 7) (bruijn ##k.195 0 0) (##string ##string.205) (bruijn import 3 1)))
if(VDecodeBool(
upenv->vars[0])) {
...
static void _V0load__library__interface_k137(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0load__library__interface_k137" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
  VError("Not enough arguments to _V0load__library__interface_k137, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
 V_GC_CHECK2_VARARGS((VFunc)_V0load__library__interface_k137, runtime, upenv, 1, argc, _var0) {
  // ((bruijn null? 9 0) (bruijn ##k.193 1 0) (bruijn ##x.194 0 0))
V_CALL(VGetArg(upenv, 9-1, 0), runtime,
      upenv->vars[0],
      _var0);
 }
...
static void _V0load__library__interface_k136(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0load__library__interface_k136, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (if (bruijn ##p.192 1 0) ((bruijn cdr 8 4) (close _V0load__library__interface_k137) (bruijn parse 2 0)) ((bruijn ##k.193 0 0) #f))
if(VDecodeBool(
upenv->vars[0])) {
V_CALL(VGetArg(upenv, 8-1, 4), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0load__library__interface_k137, env)}),
      upenv->up->vars[0]);
} else {
V_CALL(_var0, runtime,
      VEncodeBool(false));
...
static void _V0load__library__interface_k139(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0load__library__interface_k139" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
  VError("Not enough arguments to _V0load__library__interface_k139, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
 V_GC_CHECK2_VARARGS((VFunc)_V0load__library__interface_k139, runtime, upenv, 1, argc, _var0) {
  // (if (bruijn ##p.190 1 0) ((bruijn car 9 5) (bruijn ##k.191 0 0) (bruijn parse 3 0)) ((bruijn compiler-error 9 7) (bruijn ##k.191 0 0) (##string ##string.206)))
if(VDecodeBool(
upenv->vars[0])) {
...
static void _V0load__library__interface_k142(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0load__library__interface_k142" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
  VError("Not enough arguments to _V0load__library__interface_k142, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
 V_GC_CHECK2_VARARGS((VFunc)_V0load__library__interface_k142, runtime, upenv, 1, argc, _var0) {
  // ((bruijn ##k.187 8 0) (bruijn parse 2 0))
V_CALL(VGetArg(upenv, 8-1, 0), runtime,
      upenv->up->vars[0]);
 }
}
static void _V0load__library__interface_k141(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0load__library__interface_k141" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
  VError("Not enough arguments to _V0load__library__interface_k141, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
 V_GC_CHECK2_VARARGS((VFunc)_V0load__library__interface_k141, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn register-library-interface! 9 2) (close _V0load__library__interface_k142) (bruijn parse 1 0))
V_CALL(VGetArg(upenv, 9-1, 2), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0load__library__interface_k142, env)}),
      upenv->vars[0]);
 }
}
static void _V0load__library__interface_k140(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0load__library__interface_k140" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
  VError("Not enough arguments to _V0load__library__interface_k140, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
 V_GC_CHECK2_VARARGS((VFunc)_V0load__library__interface_k140, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn close-port 9 23) (close _V0load__library__interface_k141) (bruijn fd 4 0))
V_CALL(VGetArg(upenv, 9-1, 23), runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0load__library__interface_k141, env)}),
      upenv->up->up->up->vars[0]);
 }
}
static void _V0load__library__interface_k138(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 static VDebugInfo dbg = { "_V0load__library__interface_k138" };
 VRecordCall2(runtime, &dbg);
 if(argc != 1) {
  VError("Not enough arguments to _V0load__library__interface_k138, got ~D~N"
  "-- expected 1~N"
  , argc);
 }
 V_GC_CHECK2_VARARGS((VFunc)_V0load__library__interface_k138, runtime, upenv, 1, argc, _var0) {
  struct { VEnv env; VWORD argv[1]; } container;
  VEnv * env = &container.env;
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((close _V0load__library__interface_k139) (close _V0load__library__interface_k140))
V_CALL_FUNC(_V0load__library__interface_k139, env, runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0load__library__interface_k140, env)}));
 }
}
static void _V0load__library__interface_k135(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0load__library__interface_k135, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((close _V0load__library__interface_k136) (close _V0load__library__interface_k138))
V_CALL_FUNC(_V0load__library__interface_k136, env, runtime,
      VEncodeClosure((VClosure[]){VMakeClosure2((VFunc)_V0load__library__interface_k138, env)}));
 }
}
static void _V0load__library__interface_k134(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0load__library__interface_k134, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn pair? 6 11) (close _V0load__library__interface_k135) (bruijn parse 0 0))
...
static void _V0load__library__interface_k131(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0load__library__interface_k131, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn search-open-input-file 4 25) (close _V0load__library__interface_k132) (bruijn ##x.196 0 0) (bruijn paths 1 2))
...
static void _V0load__library__interface_lambda29(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0, VWORD _var1, VWORD _var2) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0load__library__interface_lambda29, runtime, upenv, 3, argc, _var0, _var1, _var2) {
  ...
  env->vars[1] = _var1;
  env->vars[2] = _var2;
  // ((bruijn import->path 2 9) (close _V0load__library__interface_k131) (bruijn import 0 1))
...
static void _V0vanity_V0compiler_V0library_V20_k31(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0library_V20_k31, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (set! (close _V0vanity_V0compiler_V0library_V20_k32) (bruijn load-library-interface 1 1) (close _V0load__library__interface_lambda29))
    V_CALL_FUNC(VSetEnvVar2, env, runtime,
...
static void _V0vanity_V0compiler_V0library_V20_lambda3(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0, VWORD _var1, VWORD _var2, VWORD _var3, VWORD _var4, VWORD _var5, VWORD _var6, VWORD _var7, VWORD _var8, VWORD _var9, VWORD _var10, VWORD _var11, VWORD _var12) {
 static VDebugInfo dbg = { "_V0vanity_V0compiler_V0library_V20_lambda3" };
 VRecordCall2(runtime, &dbg);
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0library_V20_lambda3, runtime, upenv, 13, argc, _var0, _var1, _var2, _var3, _var4, _var5, _var6, _var7, _var8, _var9, _var10, _var11, _var12) {
  ...
  env->vars[11] = _var11;
  env->vars[12] = _var12;
  // (set! (close _V0vanity_V0compiler_V0library_V20_k31) (bruijn library-interfaces 0 0) '())
    V_CALL_FUNC(VSetEnvVar2, env, runtime,
...
static void _V0vanity_V0compiler_V0library_V20_lambda2(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0, VWORD _var1, VWORD _var2, VWORD _var3, VWORD _var4, VWORD _var5, VWORD _var6, VWORD _var7, VWORD _var8, VWORD _var9, VWORD _var10, VWORD _var11, VWORD _var12, VWORD _var13, VWORD _var14, VWORD _var15, VWORD _var16, VWORD _var17, VWORD _var18, VWORD _var19, VWORD _var20, VWORD _var21, VWORD _var22, VWORD _var23, VWORD _var24, VWORD _var25) {
 ...
 VRecordCall2(runtime, &dbg);
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0library_V20_lambda2, runtime, upenv, 26, argc, _var0, _var1, _var2, _var3, _var4, _var5, _var6, _var7, _var8, _var9, _var10, _var11, _var12, _var13, _var14, _var15, _var16, _var17, _var18, _var19, _var20, _var21, _var22, _var23, _var24, _var25) {
  ...
  env->vars[24] = _var24;
  env->vars[25] = _var25;
  // ((close _V0vanity_V0compiler_V0library_V20_lambda3) #f #f #f #f #f #f #f #f #f #f #f #f #f)
...
static void _V0vanity_V0compiler_V0library_V20_k30(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0library_V20_k30, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((close _V0vanity_V0compiler_V0library_V20_lambda2) (bruijn ##x.16 25 0) (bruijn ##x.17 24 0) (bruijn ##x.18 23 0) (bruijn ##x.19 22 0) (bruijn ##x.20 21 0) (bruijn ##x.21 20 0) (bruijn ##x.22 19 0) (bruijn ##x.23 18 0) (bruijn ##x.24 17 0) (bruijn ##x.25 16 0) (bruijn ##x.26 15 0) (bruijn ##x.27 14 0) (bruijn ##x.28 13 0) (bruijn ##x.29 12 0) (bruijn ##x.30 11 0) (bruijn ##x.31 10 0) (bruijn ##x.32 9 0) (bruijn ##x.33 8 0) (bruijn ##x.34 7 0) (bruijn ##x.35 6 0) (bruijn ##x.36 5 0) (bruijn ##x.37 4 0) (bruijn ##x.38 3 0) (bruijn ##x.39 2 0) (bruijn ##x.40 1 0) (bruijn ##x.41 0 0))
...
static void _V0vanity_V0compiler_V0library_V20_k29(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0library_V20_k29, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn ##vcore.import 25 0) (close _V0vanity_V0compiler_V0library_V20_k30) 'search-open-input-file)
...
static void _V0vanity_V0compiler_V0library_V20_k28(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0library_V20_k28, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn ##vcore.import 24 0) (close _V0vanity_V0compiler_V0library_V20_k29) 'read-all)
...
static void _V0vanity_V0compiler_V0library_V20_k27(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0library_V20_k27, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn ##vcore.import 23 0) (close _V0vanity_V0compiler_V0library_V20_k28) 'close-port)
...
static void _V0vanity_V0compiler_V0library_V20_k26(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0library_V20_k26, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn ##vcore.import 22 0) (close _V0vanity_V0compiler_V0library_V20_k27) 'cons)
...
static void _V0vanity_V0compiler_V0library_V20_k25(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0library_V20_k25, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn ##vcore.import 21 0) (close _V0vanity_V0compiler_V0library_V20_k26) 'assoc)
...
static void _V0vanity_V0compiler_V0library_V20_k24(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0library_V20_k24, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn ##vcore.import 20 0) (close _V0vanity_V0compiler_V0library_V20_k25) 'char->integer)
...
static void _V0vanity_V0compiler_V0library_V20_k23(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0library_V20_k23, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn ##vcore.import 19 0) (close _V0vanity_V0compiler_V0library_V20_k24) '<=)
...
static void _V0vanity_V0compiler_V0library_V20_k22(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0library_V20_k22, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn ##vcore.import 18 0) (close _V0vanity_V0compiler_V0library_V20_k23) 'string-ref)
...
static void _V0vanity_V0compiler_V0library_V20_k21(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0library_V20_k21, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn ##vcore.import 17 0) (close _V0vanity_V0compiler_V0library_V20_k22) '+)
...
static void _V0vanity_V0compiler_V0library_V20_k20(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0library_V20_k20, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn ##vcore.import 16 0) (close _V0vanity_V0compiler_V0library_V20_k21) '<)
...
static void _V0vanity_V0compiler_V0library_V20_k19(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0library_V20_k19, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn ##vcore.import 15 0) (close _V0vanity_V0compiler_V0library_V20_k20) 'symbol?)
V_CALL(VGetArg(upenv, 15-1, 0), runtime,
...
static void _V0vanity_V0compiler_V0library_V20_k18(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0library_V20_k18, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn ##vcore.import 14 0) (close _V0vanity_V0compiler_V0library_V20_k19) 'symbol->string)
V_CALL(VGetArg(upenv, 14-1, 0), runtime,
...
static void _V0vanity_V0compiler_V0library_V20_k17(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0library_V20_k17, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn ##vcore.import 13 0) (close _V0vanity_V0compiler_V0library_V20_k18) '>)
V_CALL(VGetArg(upenv, 13-1, 0), runtime,
...
static void _V0vanity_V0compiler_V0library_V20_k16(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0library_V20_k16, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn ##vcore.import 12 0) (close _V0vanity_V0compiler_V0library_V20_k17) 'string-length)
V_CALL(VGetArg(upenv, 12-1, 0), runtime,
...
static void _V0vanity_V0compiler_V0library_V20_k15(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0library_V20_k15, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn ##vcore.import 11 0) (close _V0vanity_V0compiler_V0library_V20_k16) 'pair?)
V_CALL(VGetArg(upenv, 11-1, 0), runtime,
...
static void _V0vanity_V0compiler_V0library_V20_k14(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0library_V20_k14, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn ##vcore.import 10 0) (close _V0vanity_V0compiler_V0library_V20_k15) 'fold)
...
static void _V0vanity_V0compiler_V0library_V20_k13(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0library_V20_k13, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn ##vcore.import 9 0) (close _V0vanity_V0compiler_V0library_V20_k14) 'map)
V_CALL(VGetArg(upenv, 9-1, 0), runtime,
...
static void _V0vanity_V0compiler_V0library_V20_k12(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0library_V20_k12, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn ##vcore.import 8 0) (close _V0vanity_V0compiler_V0library_V20_k13) 'sprintf)
V_CALL(VGetArg(upenv, 8-1, 0), runtime,
...
static void _V0vanity_V0compiler_V0library_V20_k11(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0library_V20_k11, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn ##vcore.import 7 0) (close _V0vanity_V0compiler_V0library_V20_k12) 'compiler-error)
V_CALL(VGetArg(upenv, 7-1, 0), runtime,
...
static void _V0vanity_V0compiler_V0library_V20_k10(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0library_V20_k10, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn ##vcore.import 6 0) (close _V0vanity_V0compiler_V0library_V20_k11) 'cadr)
...
static void _V0vanity_V0compiler_V0library_V20_k9(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0library_V20_k9, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn ##vcore.import 5 0) (close _V0vanity_V0compiler_V0library_V20_k10) 'car)
V_CALL(VGetArg(upenv, 5-1, 0), runtime,
...
static void _V0vanity_V0compiler_V0library_V20_k8(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0library_V20_k8, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn ##vcore.import 4 0) (close _V0vanity_V0compiler_V0library_V20_k9) 'cdr)
V_CALL(upenv->up->up->up->vars[0], runtime,
...
static void _V0vanity_V0compiler_V0library_V20_k7(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0library_V20_k7, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn ##vcore.import 3 0) (close _V0vanity_V0compiler_V0library_V20_k8) 'equal?)
V_CALL(upenv->up->up->vars[0], runtime,
...
static void _V0vanity_V0compiler_V0library_V20_k6(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0library_V20_k6, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn ##vcore.import 2 0) (close _V0vanity_V0compiler_V0library_V20_k7) 'append)
V_CALL(upenv->up->vars[0], runtime,
...
static void _V0vanity_V0compiler_V0library_V20_k5(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0library_V20_k5, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn ##vcore.import 1 0) (close _V0vanity_V0compiler_V0library_V20_k6) 'call/cc)
V_CALL(upenv->vars[0], runtime,
...
static void _V0vanity_V0compiler_V0library_V20_k4(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0library_V20_k4, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // ((bruijn ##vcore.import 0 0) (close _V0vanity_V0compiler_V0library_V20_k5) 'null?)
V_CALL(_var0, runtime,
...
static void _V0vanity_V0compiler_V0library_V20_k3(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0library_V20_k3, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (##vcore.make-import (close _V0vanity_V0compiler_V0library_V20_k4) (##string ##string.207) (bruijn ##x.197 2 0) (bruijn ##x.198 1 0) (bruijn ##x.199 0 0))
...
static void _V0vanity_V0compiler_V0library_V20_k2(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0library_V20_k2, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (##vcore.load-library (close _V0vanity_V0compiler_V0library_V20_k3) (##string ##string.208))
...
static void _V0vanity_V0compiler_V0library_V20_k1(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0library_V20_k1, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (##vcore.load-library (close _V0vanity_V0compiler_V0library_V20_k2) (##string ##string.209))
    V_CALL_FUNC(VLoadLibrary2, NULL, runtime,
...
static void _V0vanity_V0compiler_V0library_V20_lambda1(VRuntime * runtime, VEnv * upenv, int argc, VWORD _var0) {
 ...
 V_GC_CHECK2_VARARGS((VFunc)_V0vanity_V0compiler_V0library_V20_lambda1, runtime, upenv, 1, argc, _var0) {
  ...
  VInitEnv(env, 1, 1, upenv);
  env->vars[0] = _var0;
  // (##vcore.load-library (close _V0vanity_V0compiler_V0library_V20_k1) (##string ##string.210))
    V_CALL_FUNC(VLoadLibrary2, NULL, runtime,
